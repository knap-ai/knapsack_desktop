...
const EmailAutopilotSettings = ({ onClose }: EmailAutopilotSettingsProps) => {
  ...
  return (
    <div className="h-full w-full flex flex-col bg-white p-4 shadow-md overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={onClose}
          className="text-ks-warm-grey-500 hover:text-ks-warm-grey-700"
        >
      ...
      <div className="flex flex-col mb-6">
        ...
        <textarea
          className="text-sm border border-ks-warm-grey-300 rounded-lg p-3 w-full h-36 resize-none focus:ring-2 focus:ring-ks-red-300 focus:border-ks-red-300"
          placeholder="Add specific instructions to customize how your email drafts are generated..."
          value={customInstructions}
          onChange={(e) => setCustomInstructions(e.target.value)}
        />
        <Typography className="mt-1 text-xs text-ks-warm-grey-500">
      ...
      <div className="flex justify-end mt-2">
        <button
          onClick={handleSave}
          className="px-4 py-2 rounded-lg bg-ks-red-600 text-white hover:bg-ks-red-700 transition-colors"
        >
          Save Settings
        </button>
      </div>

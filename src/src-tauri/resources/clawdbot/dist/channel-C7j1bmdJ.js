...
import { Bx as createOpenProviderGroupPolicyWarningCollector, Cx as buildOpenGroupPolicyRestrictSendersWarning, Db as formatAllowFromLowercase, Gb as stripTargetKindPrefix, Jb as adaptScopedAccountAccessor, Qb as createScopedChannelConfigAdapter, Vb as createChatChannelPlugin, Wb as stripChannelTargetPrefix, ax as mapAllowFromEntries, ex as createScopedDmSecurityResolver, wx as buildOpenGroupPolicyWarning, zb as buildChannelOutboundSessionRoute } from "./pi-embedded-CbCYZxIb.js";
...
import { c as jsonResult, h as readStringParam } from "./common-zReYuoMM.js";
...
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-CPDBPNrj.js";
...
import { i as coerceStatusIssueAccountId, o as readStatusIssueFields } from "./extension-shared-B8dMu-tU.js";
import { n as zaloSetupAdapter, t as zaloSetupWizard } from "./api-DlugfmwO.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-DcKwFiLd.js";
import { t as chunkTextForOutbound } from "./text-chunking-B3knjHhK.js";
import { z } from "zod";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-BpZDUKrQ.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-_l04Zc-i.js"));

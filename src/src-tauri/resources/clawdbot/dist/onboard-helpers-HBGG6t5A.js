...
import { C as sleep, S as shortenHomePath, t as CONFIG_DIR, x as shortenHomeInString, y as resolveUserPath } from "./utils-q1rHOG-N.js";
import { t as runCommandWithTimeout } from "./exec-B52LZOrO.js";
import { f as DEFAULT_AGENT_WORKSPACE_DIR, x as ensureAgentWorkspace } from "./agent-scope-Bu62UIQZ.js";
import { F as VERSION, k as isSafeExecutableValue } from "./config-BJWIHf6x.js";
...
import { c as pickPrimaryLanIPv4, o as isValidIPv4 } from "./ws-D56uQr0E.js";
...
function resolveAssistantAvatarUrl(params) {
	...
	if (looksLikeLocalAvatarPath(avatar)) return buildControlUiAvatarUrl(basePath, params.agentId);
	return avatar;
}
...
//#endregion
export { resolveAssistantAvatarUrl as C, normalizeControlUiBasePath as S, summarizeExistingConfig as _, ensureWorkspaceAndSessions as a, CONTROL_UI_AVATAR_PREFIX as b, handleReset as c, openUrl as d, printWizardHeader as f, resolveNodeManagerOptions as g, resolveControlUiLinks as h, detectBrowserOpenSupport as i, moveToTrash as l, randomToken as m, applyWizardMetadata as n, formatControlUiSshHint as o, probeGatewayReachable as p, detectBinary as r, guardCancel as s, DEFAULT_WORKSPACE as t, normalizeGatewayTokenInput as u, validateGatewayPasswordInput as v, buildControlUiAvatarUrl as x, waitForGatewayReachable as y };
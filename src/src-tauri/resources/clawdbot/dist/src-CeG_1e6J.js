...
import { Ib as mergeAllowlist, Nv as dispatchReplyFromConfigWithSettledDispatcher, Rb as summarizeMapping, gg as resolveChannelMediaMaxBytes, pv as resolveMentionGating, uv as resolveInboundSessionEnvelopeContext } from "./pi-embedded-CbCYZxIb.js";
...
import { c as createScopedExpiringIdCache } from "./text-runtime-DVXt5xhi.js";
...
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-D8ugNNDZ.js";
...
import { d as resolveDualTextControlCommandGate, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists, s as resolveEffectiveAllowFromLists } from "./dm-policy-shared-DtcQProI.js";
...
import { A as DEFAULT_WEBHOOK_MAX_BODY_BYTES } from "./webhook-ingress-D-H5frou.js";
import "./system-events-BU_NYynX.js";
import "./ssrf-policy-DYINyIKC.js";
import { a as resolveSenderScopedGroupPolicy, i as evaluateSenderGroupAccessForPolicy } from "./group-access-BlqfIxg6.js";
import { x as buildMediaPayload } from "./reply-payload-CiQ7TPgp.js";
...
import { n as keepHttpServerTaskAlive } from "./channel-lifecycle-DmiShiUP.js";
import "./mcp-config-CDIWSqVk.js";
import "./channel-setup-C5JbULY6.js";
import "./outbound-media-CVWWX2Ba.js";
import "./msteams-ZDipkIMS.js";
import "./runtime-api-1BmXDosj.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy--ZkRKoB5.js";
import { C as resolveAttachmentFetchPolicy, D as safeHostForUrl, E as safeFetchWithPolicy, S as normalizeContentType, T as resolveRequestUrl, _ as inferPlaceholder, b as isRecord, d as ATTACHMENT_TAG_RE, f as GRAPH_ROOT, g as extractInlineImageCandidates, h as extractHtmlFromAttachment, l as createMSTeamsAdapter, m as applyAuthorizationHeaderForUrl, p as IMG_SRC_RE, s as resolveMSTeamsCredentials, u as loadMSTeamsSdkWithAuth, v as isDownloadableAttachment, w as resolveMediaSsrfPolicy, x as isUrlAllowed, y as isLikelyImageAttachment } from "./graph-users-DNF3CvPC.js";
import { o as resolveMSTeamsChannelAllowlist, s as resolveMSTeamsUserAllowlist } from "./resolve-allowlist-DfxbLfpN.js";
import { t as getMSTeamsRuntime } from "./runtime-DO_BAG1B.js";
import { _ as createMSTeamsConversationStoreFs, a as buildConversationReference, c as withRevokedProxyFallback, d as buildFileInfoCard, f as parseFileConsentInvoke, g as formatUnknownError, h as formatMSTeamsSendErrorHint, l as getPendingUpload, m as classifyMSTeamsSendError, o as renderReplyPayloadsToMessages, p as uploadToConsentUrl, s as sendMSTeamsMessages, u as removePendingUpload, v as createMSTeamsPollStoreFs, y as extractMSTeamsPollVote } from "./probe-6CE-jr5k.js";

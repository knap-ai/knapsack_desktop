...
import { t as CONFIG_PATH } from "./paths-BG0ad0P6.js";
import { J as normalizeBaseCompatibilityConfigValues, R as findLegacyConfigIssues, T as validateConfigObjectWithPlugins, X as normalizeLegacyOpenAICodexModelsAddMetadata, Y as normalizeLegacyCommandsConfig, ct as applyLegacyDoctorMigrations, k as migrateLegacySecretRefEnvMarkers, lt as applyChannelDoctorCompatibilityMigrations } from "./io-Dv_xNAZB.js";
...
import { i as runPluginSetupConfigMigrations } from "./setup-registry-Del9y1XK.js";
import { i as listRouteBindings } from "./bindings-CPyZiwzQ.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BLAwnvkT.js";
import { t as note } from "./note-D_Kkgdi2.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-DclvwmMB.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CXiLb2if.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-C2CQmxgl.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-u4kC9IYw.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CqZspTpB.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-hU5LtZJK.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-DfCGHlWO.js");
		emitDoctorNotes({
			note,

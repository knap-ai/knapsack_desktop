...
import { r as resolvePluginCacheInputs } from "./discovery-DmIzxmAL.js";
import { tt as resolveBundledProviderPolicySurface } from "./io-Dv_xNAZB.js";
import { r as normalizeProviderId } from "./provider-id-BLh32HP1.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-qlSEpF_I.js";
import { s as resolveGpt5SystemPromptContribution } from "./gpt5-prompt-overlay-DIaFSR3O.js";
import { n as mergePluginTextTransforms, t as applyPluginTextReplacements } from "./plugin-text-transforms-CSfpsdqt.js";
import { c as serializePluginIdScope, s as normalizePluginIdScope } from "./persisted-auth-state-DdqnHcUm.js";
import { c as resolveCatalogHookProviderPluginIds, f as resolveExternalAuthProfileCompatFallbackPluginIds, p as resolveExternalAuthProfileProviderPluginIds } from "./plugin-auto-enable-BKDUQLPR.js";
import { n as resolvePluginProviders, t as isPluginProvidersLoadInFlight } from "./providers.runtime-w64xsk4r.js";
import { t as resolvePluginDiscoveryProvidersRuntime } from "./provider-discovery.runtime-CiSQDEVA.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-kDl1b_lS.js";
...
//#endregion
export { resolveProviderAuthProfileId as $, resolveProviderModernModelRef as A, resolveProviderUsageSnapshotWithPlugin as B, resolveExternalAuthProfilesWithPlugins as C, resolveProviderCacheTtlEligibility as D, resolveProviderBuiltInModelSuppression as E, resolveProviderSystemPromptContribution as F, shouldDeferProviderSyntheticProfileAuthWithPlugin as G, resolveProviderXHighThinking as H, resolveProviderTextTransforms as I, validateProviderReplayTurnsWithPlugin as J, shouldPreferProviderRuntimeResolvedModel as K, resolveProviderThinkingProfile as L, resolveProviderReplayPolicyWithPlugin as M, resolveProviderStreamFn as N, resolveProviderConfigApiKeyWithPlugin as O, resolveProviderSyntheticAuthWithPlugin as P, resetProviderRuntimeHookCacheForTest as Q, resolveProviderTransportTurnStateWithPlugin as R, refreshProviderOAuthCredentialWithPlugin as S, resolveProviderBinaryThinking as T, runProviderDynamicModel as U, resolveProviderWebSocketSessionPolicyWithPlugin as V, sanitizeProviderReplayHistoryWithPlugin as W, clearProviderRuntimeHookCache as X, resolveRuntimeTextTransforms as Y, prepareProviderExtraParams as Z, normalizeProviderResolvedModelWithPlugin as _, applyProviderResolvedTransportWithPlugin as a, prepareProviderDynamicModel as b, buildProviderMissingAuthMessageWithPlugin as c, createProviderEmbeddingProvider as d, resolveProviderExtraParamsForTransport as et, formatProviderAuthProfileApiKeyWithPlugin as f, normalizeProviderModelIdWithPlugin as g, normalizeProviderConfigWithPlugin as h, applyProviderResolvedModelCompatWithPlugins as i, resolveProviderReasoningOutputModeWithPlugin as j, resolveProviderDefaultThinkingLevel as k, buildProviderUnknownModelHintWithPlugin as l, matchesProviderContextOverflowWithPlugin as m, applyProviderConfigDefaultsWithPlugin as n, resolveProviderRuntimePlugin as nt, augmentModelCatalogWithProviderPlugins as o, inspectProviderToolSchemasWithPlugin as p, transformProviderSystemPrompt as q, applyProviderNativeStreamingUsageCompatWithPlugin as r, wrapProviderStreamFn as rt, buildProviderAuthDoctorHintWithPlugin as s, __testing as t, resolveProviderFollowupFallbackRoute as tt, classifyProviderFailoverReasonWithPlugin as u, normalizeProviderToolSchemasWithPlugin as v, resolveExternalOAuthProfilesWithPlugins as w, prepareProviderRuntimeAuth as x, normalizeProviderTransportWithPlugin as y, resolveProviderUsageAuthWithPlugin as z };

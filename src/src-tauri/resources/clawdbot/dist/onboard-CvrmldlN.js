import { g as restoreTerminalState, h as writeRuntimeJson, m as defaultRuntime } from "./subsystem-CJEvHE2o.js";
import { v as resolveUserPath } from "./utils-CE3P21nG.js";
import { u as resolveGatewayPort } from "./paths-CD8i0MSg.js";
import { f as readConfigFileSnapshot } from "./io-DhtVmzAJ.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-DTXJhyWe.js";
...
import "./daemon-runtime-CDm-glWj.js";
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CHbAUAiB.js";
...
import { t as runSetupWizard } from "./setup-CuyPCHiv.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-BMktcfgd.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-kUSVj66v.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-BhMh3gPz.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-DPriSyGs.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DXmqYf9L.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CtdpLn3s.js");

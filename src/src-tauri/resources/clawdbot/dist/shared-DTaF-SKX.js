...
import { Bb as createChannelPluginBase, Db as formatAllowFromLowercase, JS as listDiscordAccountIds, Jb as adaptScopedAccountAccessor, KS as inspectDiscordAccount, QS as resolveDiscordAccount, Qb as createScopedChannelConfigAdapter, ZS as resolveDefaultDiscordAccountId } from "./pi-embedded-CbCYZxIb.js";
...
import { n as createDiscordSetupWizardProxy } from "./setup-core-BcW9GMrI.js";
//#region extensions/discord/src/shared.ts
const DISCORD_CHANNEL = "discord";
async function loadDiscordChannelRuntime() {
	return await import("./channel.runtime-QkmK0Nnm.js");
}

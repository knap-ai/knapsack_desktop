...
import { r as openBoundaryFile } from "./boundary-file-read-BDEvfiRb.js";
import { _ as resolveAgentConfig } from "./agent-scope-_6dFncNS.js";
import { d as resolveGatewayMessageChannel } from "./message-channel-C2Lnao8s.js";
import { a as createHostWorkspaceEditTool, c as createSandboxedEditTool, d as wrapToolMemoryFlushAppendOnlyWrite, f as wrapToolWorkspaceRootGuard, l as createSandboxedReadTool, o as createHostWorkspaceWriteTool, p as wrapToolWorkspaceRootGuardWithOptions, s as createOpenClawReadTool, t as createOpenClawTools, u as createSandboxedWriteTool } from "./openclaw-tools-BIHCDPUL.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, c as mergeAlsoAllowPolicy, i as collectExplicitAllowlist, m as resolveToolProfilePolicy, n as applyOwnerOnlyToolPolicy, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DArLXMH2.js";
import { n as getPluginToolMeta, t as copyPluginToolMeta } from "./tools-CZr3orc0.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CE0bWSrm.js";
import { i as listChannelAgentTools, t as copyChannelAgentToolMeta } from "./channel-tools-DeYKQo13.js";
import { t as normalizeToolParameterSchema } from "./pi-tools-parameter-schema-FZP6m19P.js";
import { t as bindAbortRelay } from "./fetch-timeout-DjhWl8zC.js";
import { a as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-Tbtq2-gG.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-DrT-K-_k.js";
import { g as writeFileWithinRoot, o as mkdirPathWithinRoot, p as removePathWithinRoot } from "./fs-safe-CezDxq3P.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CpTiXAgR.js";
import { n as assertSandboxPath } from "./sandbox-paths-11MZW8so.js";
import { a as resolveGroupToolPolicy, c as resolveWorkspaceRoot, l as resolvePathFromInput, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy, u as toRelativeSandboxPath } from "./read-capability-NRo6-_mG.js";
...
import { c as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-Cv3Ixmqi.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-D8_CHZdx.js";
import { i as resolveToolFsConfig, t as createToolFsPolicy } from "./tool-fs-policy-rAagG_0W.js";
...
function loadBashToolsModule() {
	bashToolsModulePromise ??= import("./bash-tools-eUrKwEen.js");

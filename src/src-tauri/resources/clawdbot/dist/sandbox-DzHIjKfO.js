...
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_TOOLS_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_USER_FILENAME, n as DEFAULT_AGENT_WORKSPACE_DIR, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_SOUL_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as ensureAgentWorkspace } from "./workspace-DiB6mKpP.js";
import "./config-yDDhhyz6.js";
import { _ as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, h as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-Ve0QlY3Y.js";
import { n as isToolAllowed } from "./tool-policy-Q758zNoT.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-DVWzrbBW.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Bzeqz1g5.js";
import { f as isSameSsrFPolicy } from "./ssrf-MkDHylX_.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-11MZW8so.js";
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "./browser-control-auth-Dc6R3qY8.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-Jc8Xg_Vj.js";
import { C as removeRegistryEntry, E as computeSandboxBrowserConfigHash, S as removeBrowserRegistryEntry, T as updateRegistry, _ as resolveSandboxScopeKey, b as readBrowserRegistry, c as readDockerNetworkDriver, d as appendWorkspaceMountArgs, g as resolveSandboxAgentId, h as splitSandboxBindSpec, i as execDocker, l as readDockerNetworkGateway, m as resolveSandboxHostPathViaExistingAncestor, n as dockerContainerState, o as readDockerContainerEnvVar, p as validateNetworkMode, s as readDockerContainerLabel, t as buildSandboxCreateArgs, u as readDockerPort, v as resolveSandboxWorkspaceDir, w as updateBrowserRegistry, x as readRegistry, y as slugifySessionKey } from "./docker-DBH34Z56.js";
import { C as buildPinnedMkdirpPlan, D as dockerSandboxBackendManager, E as buildPinnedWritePlan, O as runDockerSandboxShellCommand, T as buildPinnedRenamePlan, a as getSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedRemovePlan, y as normalizeContainerPath } from "./browser-bridges-QH5i6Nux.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./port-defaults-Cqg2lup0.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-DEEqQYQf.js"),
				import("./exec-defaults-DOtFSnHO.js"),
				import("./skills-CYOU4kJz.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BnxZaw32.js")).maybePruneSandboxes(cfg);
	...
	const bridgeAuth = cfg.browser.enabled ? await (async () => {
		const cfgForAuth = params.config ?? (await import("./config-NTLYkTUO.js")).loadConfig();

...
import { S as sleep, x as shortenHomePath } from "./utils-CE3P21nG.js";
import { n as isRich, r as theme, t as colorize } from "./theme-D-TumEpz.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-CD8i0MSg.js";
import { i as createConfigIO } from "./io-DhtVmzAJ.js";
import "./config-CJQx-9zo.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-Clj4_p8-.js";
import { d as trimToUndefined, n as isGatewaySecretRefUnavailableError } from "./credentials-DyjdApQe.js";
import { i as parseStrictPositiveInteger } from "./parse-finite-number-BofRXc0O.js";
import { d as loadGatewayTlsRuntime } from "./call-CQ0eH9Ew.js";
import { r as isWSLEnv } from "./wsl-BhLRdu8m.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-CHbAUAiB.js";
import { c as resolveGatewayLogPaths } from "./launchd-BPnToG40.js";
import { r as resolveGatewayService } from "./service-BaabAHxx.js";
import { a as inspectPortUsage, o as classifyPortListener, s as formatPortDiagnostics } from "./ports-C5dh_OwP.js";
import { t as killProcessTree } from "./kill-tree-BmChn7XO.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-B4S0Zwlt.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-Bng_ohlG.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-enHHgxXj.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-Bic6D6VC.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-BXql2fGC.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-C31C4KwQ.js");

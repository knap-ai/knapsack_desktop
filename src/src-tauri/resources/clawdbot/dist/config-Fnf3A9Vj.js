...
import { c as expandToolGroups, l as normalizeToolName } from "./tool-policy-Bk9WQZ0U.js";
...
function expandResolvedPolicy(policy) {
	...
	if (expandedAllow.length > 0 && !expandedDeny.map((value) => value.toLowerCase()).includes("image") && !expandedAllow.map((value) => value.toLowerCase()).includes("image")) expandedAllow = [...expandedAllow, "image"];
	return {
		allow: expandedAllow,
		deny: expandedDeny
	};
...
//#endregion
export { isToolAllowed as a, matchesAnyGlobPattern as c, DEFAULT_SANDBOX_IMAGE as d, SANDBOX_AGENT_WORKSPACE_MOUNT as f, SANDBOX_REGISTRY_PATH as h, classifyToolAgainstSandboxToolPolicy as i, DEFAULT_SANDBOX_BROWSER_IMAGE as l, SANDBOX_BROWSER_SECURITY_HASH_EPOCH as m, resolveSandboxConfigForAgent as n, resolveSandboxToolPolicyForAgent as o, SANDBOX_BROWSER_REGISTRY_PATH as p, resolveSandboxScope as r, compileGlobPatterns as s, resolveSandboxBrowserDockerCreateConfig as t, DEFAULT_SANDBOX_COMMON_IMAGE as u };

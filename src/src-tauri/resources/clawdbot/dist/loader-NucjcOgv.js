...
import { i as openBoundaryFileSync } from "./boundary-file-read-BDEvfiRb.js";
import { l as normalizeTrimmedStringList } from "./string-normalization-Bvcn03I9.js";
import { i as safeStatSync, n as isPathInside } from "./path-safety-DXxMD-vc.js";
...
import { f as resolvePluginRuntimeModulePath, g as shouldPreferNativeJiti, s as normalizeJitiAliasTargetPath, t as buildPluginLoaderAliasMap } from "./sdk-alias-K6JYDrXB.js";
import { t as getCachedPluginJitiLoader } from "./jiti-loader-cache-DU3ns2lI.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-pYrbrdHJ.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-ClU32VIo.js";
import { c as resolveEffectivePluginActivationState, n as createPluginActivationSource, o as normalizePluginsConfig, s as resolveEffectiveEnableState, t as applyTestPluginDefaults, u as resolveMemorySlotDecision } from "./config-state-UvzNc3si.js";
import { a as resolveBundledRuntimeDependencyInstallRoot, n as installBundledRuntimeDeps, r as registerBundledRuntimeDependencyNodePath, s as resolveBundledRuntimeDependencyPackageRoot, t as ensureBundledPluginRuntimeDeps } from "./bundled-runtime-deps-BdEAdjwi.js";
import { t as unwrapDefaultModuleExport } from "./module-export-Crvs86vh.js";
import { c as listChatChannels } from "./registry-B9khhdbq.js";
import { t as validateJsonSchemaValue } from "./schema-validator-BKDxqOUA.js";
import { a as getRuntimeConfigSourceSnapshot, r as getRuntimeConfigSnapshot } from "./runtime-snapshot-C5PRsFS9.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-CCV7oDGt.js";
import { a as hasExplicitPluginIdScope, c as serializePluginIdScope, i as createPluginIdScopeSet, s as normalizePluginIdScope } from "./persisted-auth-state-DdqnHcUm.js";
import { t as buildPluginApi } from "./api-builder-DMWQMIQL.js";
import { t as isChannelConfigured } from "./channel-configured-DUn6ASTQ.js";
import { I as resolveMemoryDreamingConfig, L as resolveMemoryDreamingPluginConfig, _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-K8xreO0H.js";
import { a as restoreDetachedTaskLifecycleRuntimeRegistration, i as registerDetachedTaskLifecycleRuntime, n as getDetachedTaskLifecycleRuntimeRegistration, t as clearDetachedTaskLifecycleRuntimeRegistration } from "./detached-task-runtime-state-Cqr-cii8.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-D71-okqN.js";
import { a as clearPluginCommands, d as restorePluginCommands, i as validatePluginCommandDefinition, l as listRegisteredPluginCommands, n as registerPluginCommand, o as clearPluginCommandsForPlugin } from "./command-registration-lrx31fSB.js";
import { i as initializeGlobalHookRunner, t as getGlobalHookRunner } from "./hook-runner-global-C-5w-v1N.js";
import { a as isConversationHookName, d as clearPluginInteractiveHandlersForPlugin, f as listPluginInteractiveHandlers, h as restorePluginInteractiveHandlers, l as stripPromptMutationFieldsFromLegacyHookResult, o as isPluginHookName, p as registerPluginInteractiveHandler, s as isPromptInjectionHookName, u as clearPluginInteractiveHandlers } from "./types-C419GIfP.js";
import { a as registerMemoryEmbeddingProvider, i as listRegisteredMemoryEmbeddingProviders, n as getRegisteredMemoryEmbeddingProvider, o as restoreRegisteredMemoryEmbeddingProviders } from "./memory-embedding-providers-CT-FmD3i.js";
import { a as getMemoryPromptSectionBuilder, d as registerMemoryCapability, f as registerMemoryCorpusSupplement, g as registerMemoryRuntime, h as registerMemoryPromptSupplement, i as getMemoryFlushPlanResolver, l as listMemoryCorpusSupplements, m as registerMemoryPromptSection, n as clearMemoryPluginState, o as getMemoryRuntime, p as registerMemoryFlushPlanResolver, r as getMemoryCapabilityRegistration, u as listMemoryPromptSupplements, v as restoreMemoryPluginState } from "./memory-state-I5DhT9-V.js";
import { i as withProfile } from "./plugin-load-profile-C7DwtX5h.js";
import { a as sanitizeCommandDescriptorDescription, i as normalizeCommandDescriptorName } from "./command-descriptor-utils-HtpzK-0C.js";
import { r as registerContextEngineForOwner, t as clearContextEnginesForOwner } from "./registry-CWj0q4ZO.js";
import { f as registerInternalHook, h as unregisterInternalHook } from "./internal-hooks-BxzYnhn4.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND } from "./node-commands-DFDl9PuO.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, l as getActivePluginRuntimeSubagentMode, o as getActivePluginRegistryKey, p as recordImportedPluginId, x as setActivePluginRegistry } from "./runtime-BFywV6BM.js";
import { n as normalizeAgentToolResultMiddlewareRuntimeIds, r as normalizeAgentToolResultMiddlewareRuntimes } from "./agent-tool-result-middleware-yRWJju9O.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-C2701fGQ.js";
import { r as withPluginRuntimePluginIdScope } from "./gateway-request-scope-D6nplzWA.js";
...
function prepareBundledPluginRuntimeDistMirror(params) {
	...
	if (sourceDistRootName === "dist-runtime") {
		...
		if (fs.existsSync(sourceCanonicalDistRoot)) {
			if (!(fs.existsSync(targetCanonicalDistRoot) && safeRealpathOrResolve(targetCanonicalDistRoot) === safeRealpathOrResolve(sourceCanonicalDistRoot))) {
				fs.rmSync(targetCanonicalDistRoot, {
					recursive: true,
					force: true
				});
				try {

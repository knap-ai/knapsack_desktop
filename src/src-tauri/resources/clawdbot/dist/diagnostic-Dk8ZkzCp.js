import { n as emitDiagnosticEvent, r as isDiagnosticsEnabled, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-Cz86_awm.js";
import { i as getRuntimeConfig } from "./io-Dv_xNAZB.js";
import "./config-yDDhhyz6.js";
import { a as markDiagnosticActivity, n as getLastDiagnosticActivityAt, o as resetDiagnosticActivityForTest, t as diagnosticLogger } from "./diagnostic-runtime-BrBnwkcx.js";
import { a as resetDiagnosticSessionStateForTest, i as pruneDiagnosticSessionStates, n as getDiagnosticSessionState, r as getDiagnosticSessionStateCountForTest$1, t as diagnosticSessionStates } from "./diagnostic-session-state-BY_MmyXa.js";
import { a as installDiagnosticStabilityFatalHook, d as uninstallDiagnosticStabilityFatalHook, g as resetDiagnosticStabilityRecorderForTest, l as resetDiagnosticStabilityBundleForTest, v as startDiagnosticStabilityRecorder, y as stopDiagnosticStabilityRecorder } from "./diagnostic-stability-bundle-CqC59U0o.js";
...
function loadCommandPollBackoffRuntime() {
	commandPollBackoffRuntimePromise ??= import("./command-poll-backoff.runtime-D9_EizLU.js");
...
function startDiagnosticHeartbeat(config, opts) {
	...
	heartbeatInterval = setInterval(() => {
		...
		const shouldRecordMemorySample = hasRecentDiagnosticActivity(now) || hasOpenDiagnosticWork(work);

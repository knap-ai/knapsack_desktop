import { g as restoreTerminalState } from "./subsystem-CJEvHE2o.js";
import { m as pathExists, v as resolveUserPath } from "./utils-CE3P21nG.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-R-NeOkBt.js";
import { n as resolveCliName } from "./cli-name-C8apcduP.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-Bet4e3T0.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-CHbAUAiB.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BaabAHxx.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-B4S0Zwlt.js";
import { t as listConfiguredWebSearchProviders } from "./runtime-D06HuHUY.js";
...
import { t as runTui } from "./tui-Bqx8VC8_.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CsXiBUyF.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-W54sTf3u.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Os_mmTke.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Os_mmTke.js");

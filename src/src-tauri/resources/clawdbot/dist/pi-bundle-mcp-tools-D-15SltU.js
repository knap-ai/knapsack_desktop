...
import { i as setPluginToolMeta } from "./tools-CZr3orc0.js";
import { l as buildSafeToolName, u as normalizeReservedToolNames } from "./pi-bundle-mcp-runtime-B_SrebwR.js";
...
async function createBundleMcpToolRuntime(params) {
	const runtime = (params.createRuntime ?? (await import("./pi-bundle-mcp-runtime-DhFyH7mH.js")).createSessionMcpRuntime)({

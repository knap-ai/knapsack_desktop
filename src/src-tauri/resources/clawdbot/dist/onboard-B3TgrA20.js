import { u as resolveGatewayPort } from "./paths-ViKUYWUK.js";
import { g as restoreTerminalState, h as writeRuntimeJson, m as defaultRuntime } from "./subsystem-DISldKSB.js";
import { y as resolveUserPath } from "./utils-CS0Ikux6.js";
import { d as readConfigFileSnapshot, g as writeConfigFile } from "./io-y3Az_Onx.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-DgX397vI.js";
...
import "./daemon-runtime-lubXrOfs.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-D5cfC-Ra.js";
...
import { t as runSetupWizard } from "./setup-Cx7PTqei.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-CD6TBMmn.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DGWvUU-R.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BmMDbMbp.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-C77EvOgn.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-q3TtJhDA.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Dea_taSC.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-2Ip3YGGc.js");

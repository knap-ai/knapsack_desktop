...
import { i as resolveMirroredTranscriptText } from "./transcript-C5WPUIcy.js";
import { a as projectOutboundPayloadPlanForDelivery, l as summarizeOutboundPayloadForTransport, t as createOutboundPayloadPlan } from "./payloads-YFQezhXJ.js";
import { C as createReplyToDeliveryPolicy } from "./reply-payload-COWCxmsk.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-NRo6-_mG.js";
import { a as hasReplyPayloadContent, c as normalizeMessagePresentation, u as renderMessagePresentationFallbackText } from "./payload-Cv_QzStf.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, n as chunkByParagraph, s as resolveChunkMode } from "./chunk-CpCakLTa.js";
import { t as loadChannelOutboundAdapter } from "./load-DDBpMLL3.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-CkLZ2mlp.js";
import { c as enqueueDelivery, o as withActiveDeliveryClaim, s as ackDelivery, u as failDelivery } from "./delivery-queue-DBXcTwQv.js";
...
async function loadTranscriptRuntime() {
	transcriptRuntimePromise ??= import("./transcript.runtime-BeBV56Bv.js");
	return await transcriptRuntimePromise;
}
let channelBootstrapRuntimePromise;
async function loadChannelBootstrapRuntime() {
	channelBootstrapRuntimePromise ??= import("./channel-bootstrap.runtime-B9Fz6q81.js");
...
async function deliverOutboundPayloadsCore(params) {
	...
	for (const payload of normalizedPayloads) {
		...
		try {
			...
			const effectivePayload = normalizedEffectivePayload ? normalizeEmptyPayloadForDelivery(normalizedEffectivePayload) : null;

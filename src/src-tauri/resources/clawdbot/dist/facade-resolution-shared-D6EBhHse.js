import { a as resolveBundledPluginSourcePublicSurfacePath, i as resolveBundledPluginPublicSurfacePath, n as normalizeBundledPluginArtifactSubpath, t as PUBLIC_SURFACE_SOURCE_EXTENSIONS } from "./public-surface-runtime-CfEeqjdH.js";
...
function resolveCachedFacadeModuleLocation(params) {
	if (params.cache.has(params.key)) return params.cache.get(params.key) ?? null;
...
function resolveBundledFacadeModuleLocation(params) {
	...
	}) ?? resolveBundledPluginPublicSurfacePath(publicSurfaceParams) : resolveBundledPluginPublicSurfacePath(publicSurfaceParams);
	return modulePath ? {
		modulePath,
...
//#endregion
export { resolveRegistryPluginModuleLocationFromRecords as i, resolveBundledFacadeModuleLocation as n, resolveCachedFacadeModuleLocation as r, createFacadeResolutionKey as t };

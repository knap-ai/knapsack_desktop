...
import { n as PLUGIN_MANIFEST_FILENAME } from "./manifest-UasFm2SQ.js";
import { n as discoverOpenClawPlugins } from "./discovery-DmIzxmAL.js";
import { i as resolveBundledPluginRepoEntryPath, o as normalizeBundledPluginStringList, s as resolveBundledPluginScanDir } from "./bundled-plugin-metadata-DBCPq4zK.js";
import { g as shouldPreferNativeJiti, l as resolveLoaderPackageRoot, t as buildPluginLoaderAliasMap } from "./sdk-alias-K6JYDrXB.js";
import { t as getCachedPluginJitiLoader } from "./jiti-loader-cache-DU3ns2lI.js";
import { r as resolveManifestContractPluginIds, t as loadPluginManifestRegistry } from "./manifest-registry-pYrbrdHJ.js";
...
import { n as withBundledPluginEnablementCompat, r as withBundledPluginVitestCompat } from "./bundled-compat-DMGPGgc3.js";
import { S as createEmptyPluginRegistry } from "./runtime-BFywV6BM.js";
import { n as createCapturedPluginRegistration } from "./captured-registration-BvaNyBxy.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-ocXx1skG.js";
...
function loadProviderContractEntriesForPluginId(pluginId) {
	if (providerContractRegistryCache) return providerContractRegistryCache.filter((entry) => entry.pluginId === pluginId);
	const cache = providerContractRegistryByPluginIdCache ?? /* @__PURE__ */ new Map();
...
//#endregion
export { providerContractLoadError as n, resolveProviderContractPluginIdsForProviderAlias as r, pluginRegistrationContractRegistry as t };

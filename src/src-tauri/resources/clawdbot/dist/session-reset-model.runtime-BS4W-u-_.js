...
import { t as resolveModelDirectiveSelection } from "./model-selection-directive-ziVuWeP7.js";
...
function applySelectionToSession(params) {
	...
	if (storePath) import("./sessions-DcmFrgbH.js").then(({ updateSessionStore }) => updateSessionStore(storePath, (store) => {

...
import { n as require_logging, r as require_axios, t as require_http$2 } from "./http-Bh-HtMAg.js";
import { n as require_lib$2, t as require_dist$2 } from "./dist-DFcedZ9d.js";
import { a as require_storage, i as require_dist$3, n as require_jsonwebtoken, o as require_events$1, r as require_asserts, t as require_jwt_validator } from "./jwt-validator-C9n6_ziQ.js";
import { t as require_Reflect } from "./Reflect-BoJyzBy4.js";
import { t as require_plugin$3 } from "./plugin-CMrRyV1o.js";
import { t as require_dependency } from "./dependency-Cj-3k0So.js";
import { t as require_event$1 } from "./event-CIV8kxIl.js";
...
var require_dist$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var i = require_http$2(), b = require_lib$2();
	...
	function f(n, t, e) {
		let r = {};
		for (let s of t.query ?? []) r[s] = e[s];
		for (let s of t.path ?? []) n = n.replace(`{${s}}`, e[s]);
		return `${n}${b__default.default.stringify(r, {
			addQueryPrefix: true,
			arrayFormat: "comma"
		})}`;
	}
	function m(n, t, e) {
		let r = (n.header ?? []).reduce((s, o) => (t[o] && (s[o] = t[o]), s), {});
		return Object.keys(r).length === 0 ? e : {
			...e,
			headers: {
				...e?.headers,
				...r
	...
	var _ = "https://graph.microsoft.com", u = class {
		baseUrlRoot;
		http;
		betaHttp;
		constructor(t) {
			this.baseUrlRoot = t?.baseUrlRoot ?? _, t ? "request" in t ? this.http = t.clone({
				baseUrl: `${this.baseUrlRoot}/v1.0`,
				headers: {
					"Content-Type": "application/json",
					"User-Agent": "teams.ts[graph]/0.0.0"
				}
			}) : this.http = new i__namespace.Client({
				...t,
				baseUrl: `${this.baseUrlRoot}/v1.0`,
				headers: {
					"Content-Type": "application/json",
		...
		async call(t, ...e) {
			let r = e[e.length - 1], s = e.length > t.length && r && typeof r == "object" && "requestConfig" in r, o = s ? e.slice(0, -1) : e, R = s ? r : void 0, { ver: g = "v1.0", method: a, path: C, paramDefs: p = {}, params: h = {}, body: y } = t(...o), c = f(C, p, h), l = m(p, h, R?.requestConfig), d = this.getHttpClient(g);
			switch (a) {
				case "delete":
				case "get": return (await d[a](c, l)).data;
				case "patch":
				case "post":
				case "put": return (await d[a](c, y, l)).data;
				default: throw new Error(`Unsupported HTTP method: ${a}`);
			}
		}
		getHttpClient(t) {
			return t === "v1.0" ? this.http : (this.betaHttp = this.betaHttp ?? this.http.clone({ baseUrl: `${this.baseUrlRoot}/beta` }), this.betaHttp);
		}
	};
	exports.Client = u;
}));
...
var require_api = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const api = __importStar(require_dist$2());
...
var require_app_oauth = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	async function onTokenExchange(ctx) {
		...
		try {
			...
			ctx.userGraph = new graph.Client(this.client.clone({ token: token.token }));
...
var require_app_plugins = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const plugin_1 = require_plugin$3();
	/**
	* add a plugin
	...
	*/
	var ExpressAdapter = class {
		...
		constructor(server, options) {
			...
			this.server = server || http_1$1.default.createServer();
...
var require_service_token_validator = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var ServiceTokenValidator = class {
		jwtValidator;
		credentials;
		constructor(appId, tenantId, serviceUrl, logger) {
		...
		async check(authHeader, body) {
			...
			return {
				...
				from: "azure",
				fromId: payload.sub || "",
				serviceUrl: body.serviceUrl || payload.serviceurl || "",
				isExpired: () => false
			};
		}
	};
	...
	var HttpServer = class {
		...
		*/
		async initialize(deps) {
			...
			if (this.credentials && !this.skipAuth) this.serviceTokenValidator = new service_token_validator_1.ServiceTokenValidator(this.credentials.clientId, this.credentials.tenantId, void 0, this.logger);
...
var require_jwt_validation_middleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function withJwtValidation(params) {
		...
		let validator;
		if (credentials?.clientId) validator = new service_token_validator_1.ServiceTokenValidator(credentials.clientId, credentials.tenantId, void 0, logger);
		else {
...
//#endregion
//#region node_modules/@azure/msal-common/lib/index-node-Ddjhj5ij.js
	...
	var BaseClient = class {
		...
		*/
		async updateAuthority(cloudInstanceHostname, correlationId) {
			...
			this.authority = await createDiscoveredInstance(`https://${cloudInstanceHostname}/${this.authority.tenant}/`, this.networkClient, this.cacheManager, this.authority.options, this.logger, correlationId, this.performanceClient);
		}
		/**
...
//#endregion
//#region node_modules/@azure/msal-common/lib/index-browser.cjs
/*! @azure/msal-common v15.17.0 2026-03-18 */
...
//#endregion
//#region node_modules/@azure/msal-common/lib/index.cjs
/*! @azure/msal-common v15.17.0 2026-03-18 */
...
var require_token_manager = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var TokenManager = class {
		...
		async getBotToken() {
			return await this.getToken(DEFAULT_BOT_TOKEN_SCOPE, this.resolveTenantId(void 0, DEFAULT_TENANT_FOR_BOT_TOKEN));
		}
...
var require_app = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const app_events_1 = require_app_events$1();
	...
	var App = class {
		...
		*/
		...
		constructor(options = {}) {
			...
			this.api = new api_1.ApiClient(serviceUrl, this.client.clone({ token: () => this.getBotToken() }), this.options.apiClientSettings);
		...
		*/
		async initialize() {
			...
			await this.server.initialize({ credentials: this.credentials });
		...
		*/
		async send(conversationId, activity) {
			if (!this.id) throw new Error("app not started");
			const params = (0, teams_api_1.toActivityParams)(activity);
			const ref = {
				channelId: "msteams",
...
var require_plugin$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(require_plugin$2(), exports);
...
var require_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(require_app_events(), exports);

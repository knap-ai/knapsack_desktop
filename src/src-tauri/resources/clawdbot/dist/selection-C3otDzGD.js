...
import { i as freezeDiagnosticTraceContext, n as createDiagnosticTraceContext, t as createChildDiagnosticTraceContext } from "./diagnostic-trace-context-D6vXBN1-.js";
...
import { Z as normalizeGoogleApiBaseUrl } from "./io-Dv_xNAZB.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-BT0y7mVK.js";
...
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DMdhUxEe.js";
import { f as isWorkspaceBootstrapPending, r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DiB6mKpP.js";
import { h as listAgentEntries, m as resolveSessionAgentIds } from "./agent-scope-_6dFncNS.js";
import { u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-CSfpsdqt.js";
import { u as listRegisteredAgentHarnesses } from "./loader-NucjcOgv.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-C-5w-v1N.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BFywV6BM.js";
import { F as resolveProviderSystemPromptContribution, I as resolveProviderTextTransforms, q as transformProviderSystemPrompt } from "./provider-runtime-C1HXSRlX.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Df60yWjf.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-hTT37jzm.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-C_Djlg3U.js";
...
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-DMk-SEBA.js";
import { a as normalizeUsage, i as makeZeroUsageSnapshot, r as hasNonzeroUsage } from "./usage-xVEV8sHL.js";
import { o as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-BMWW7Uy3.js";
import { t as parseInlineDirectives } from "./directive-tags-DUaKI8c-.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-C_v_J0E7.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-B5OftKVn.js";
import { $ as buildStreamErrorAssistantMessage, B as estimateToolResultReductionPotential, C as limitHistoryTurns, E as estimateMessagesTokens, F as isCacheTtlEligibleProvider, G as installContextEngineLoopHook, I as readLastCacheTtlTimestamp, J as createPreparedEmbeddedPiSettingsManager, K as installToolResultContextGuard, L as resolveTranscriptPolicy, M as applyFinalEffectiveToolPolicy, P as resolveCompactionTimeoutMs, Q as releaseWsSession, R as shouldAllowProviderOwnedThinkingReplay, S as getDmHistoryLimitFromSessionKey, T as SAFETY_MARGIN, V as resolveLiveToolResultMaxChars, W as truncateOversizedToolResultsInSessionManager, X as dropThinkingBlocks, Y as assessLastAssistantMessage, Z as createBundleLspToolRuntime, _ as trackSessionManagerAccess, a as collectAllowedToolNames, b as validateReplayTurns, c as applySystemPromptOverrideToSession, d as describeEmbeddedAgentStreamStrategy, f as resolveEmbeddedAgentApiKey, g as prewarmSessionFile, h as resolveEmbeddedRunSkillEntries, i as PI_RESERVED_TOOL_NAMES, l as buildEmbeddedSystemPrompt, m as resolveEmbeddedAgentStreamFn, n as mapThinkingLevel, o as collectRegisteredToolNames, p as resolveEmbeddedAgentBaseStreamFn, q as repairSessionFileIfNeeded, r as splitSdkTools, s as toSessionToolAllowlist, t as flushPendingToolResultsAfterIdle, tt as resolveChannelCapabilities, u as createSystemPromptOverride, v as normalizeAssistantReplayContent, w as buildEmbeddedExtensionFactories, x as buildEmbeddedMessageActionDiscoveryInput, y as sanitizeSessionHistory, z as guardSessionManager } from "./wait-for-idle-before-flush-CkZJsBmY.js";
import { _ as isEmbeddedMode, g as stripProviderPrefix, h as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-BIHCDPUL.js";
...
import { f as MAX_IMAGE_BYTES } from "./mime-Zn7U6BSf.js";
import { p as normalizeToolName } from "./tool-policy-DArLXMH2.js";
import { n as getPluginToolMeta } from "./tools-CZr3orc0.js";
import { t as redactConfigObject } from "./redact-snapshot-D4wjPRM1.js";
import { n as resolveCommitHash } from "./git-commit-CJyrMWLg.js";
import { t as resolveOsSummary } from "./os-summary-NPMMjZck.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-B3d9VRps.js";
...
import { a as prependBootstrapPromptWarning, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget } from "./bootstrap-budget-Daai1iOb.js";
import { a as resolveContextInjectionMode, i as resolveBootstrapContextForRun, n as hasCompletedBootstrapTurn, r as makeBootstrapWarn, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-fciinZLM.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-Ddsrfa-P.js";
import { a as isMessagingToolDuplicateNormalized, c as downgradeOpenAIFunctionCallReasoningPairs, h as resolveBootstrapTotalMaxChars, l as downgradeOpenAIReasoningBlocks, m as resolveBootstrapPromptTruncationWarningMode, n as validateGeminiTurns, o as normalizeTextForComparison, p as resolveBootstrapMaxChars, t as validateAnthropicTurns } from "./pi-embedded-helpers-C0R2W0ZW.js";
import { T as parseExecApprovalResultText, d as stableStringify$1, f as coerceChatContentText } from "./sanitize-user-facing-text-BDMAKrLb.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-DnpKeLbn.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Bzeqz1g5.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-CLaBkBI7.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-CE0bWSrm.js";
...
import { a as isTimeoutError } from "./failover-error-D72vttCv.js";
import { t as buildModelAliasLines } from "./model-alias-lines-DwhEdfec.js";
import { t as sanitizeForConsole } from "./console-sanitize-DdX5gJgF.js";
import { c as resolveModelAuthMode } from "./model-auth-Di2YDk33.js";
import { i as supportsModelTools, n as normalizeProviderToolSchemas, t as logProviderToolSchemaDiagnostics } from "./tool-schema-runtime-B9xsYCmd.js";
import { t as registerProviderStreamForModel } from "./provider-stream-EGXtbhbQ.js";
import { t as log$3 } from "./logger-Cq8_pd8S.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-CeY_ZCdW.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-KzKcGOUY.js";
import { c as sanitizeTransportPayloadText, h as buildGuardedModelFetch, o as mergeTransportHeaders, p as sanitizeToolUseResultPairing } from "./transport-stream-shared-21GahxfU.js";
import { i as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-B_SrebwR.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-tools-D-15SltU.js";
import { n as setReplyPayloadMetadata } from "./reply-payload-DQu-gtUo.js";
import { r as parseFenceSpans } from "./fences-BAnXTzxj.js";
import { r as splitMediaFromOutput } from "./parse-sRKDduJ4.js";
import { u as parseReplyDirectives } from "./payloads-YFQezhXJ.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-COWCxmsk.js";
import { _ as sanitizeToolResult, b as formatToolAggregate, d as extractToolErrorMessage, f as extractToolResultMediaArtifact, g as isToolResultTimedOut, h as isToolResultError, l as runContextEngineMaintenance, m as filterToolResultMediaUrls, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolResultText, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as extractMessagingToolSend, v as isMessagingTool, y as isMessagingToolSendAction } from "./attempt.tool-run-context-DP5sksCE.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-Co4_Aktj.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-CHc4qFzF.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-cPgi9JDW.js";
import { a as stripDowngradedToolCallText } from "./assistant-visible-text-4z6MTScR.js";
...
import { a as MIN_PROMPT_BUDGET_TOKENS, i as MIN_PROMPT_BUDGET_RATIO, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DnGbeiAj.js";
import { o as diagnosticErrorCategory } from "./pi-tools.before-tool-call-Tbtq2-gG.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-CXI4s2a7.js";
import { n as resolveToolLoopDetectionConfig, t as createOpenClawCodingTools } from "./pi-tools-DSzv5qcy.js";
...
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun, u as updateActiveEmbeddedRunSnapshot } from "./runs-D_jbdUDe.js";
import { t as resolveAgentTimeoutMs } from "./timeout-TgWmyBUs.js";
import { o as resolveSandboxContext } from "./sandbox-DzHIjKfO.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-DEfbMkgI.js";
...
import { t as buildSystemPromptParams } from "./system-prompt-params-e_kmAkyP.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-9yK0WPeJ.js";
import "./tool-loop-detection-dxCym8jO.js";
import { b as visitObjectContentBlocks, i as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-BYe_GyIX.js";
import { n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BSCrTsfs.js";
import { n as buildAgentUserPromptPrefix } from "./system-prompt-C0kqz5AF.js";
...
import { a as shouldUseOpenAIWebSocketTransport, i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DV2K16hl.js";
import { a as prependSystemPromptAddition, c as resolvePromptBuildHookResult, d as shouldWarnOnOrphanedUserRepair, i as mergeOrphanedTrailingUserPrompt, l as resolvePromptModeForSession, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptFsWorkspaceOnly, r as hasPromptSubmissionContent, s as resolveAttemptPrependSystemContext, t as buildAfterTurnRuntimeContext, u as shouldInjectHeartbeatPrompt } from "./attempt.prompt-helpers-BGzsB6M9.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-CfYoHeFf.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CusTgQZH.js";
import { t as detectAndLoadPromptImages } from "./images-CzeTciMv.js";
...
function buildPluginsFromManifest(params) {
	return {
		...
		entries: loadPluginManifestRegistry({
...
function createTrajectoryRuntimeRecorder(params) {
	...
	const writer = params.writer ?? getQueuedFileWriter(writers$2, filePath, { maxFileBytes: 52428800 });
...
async function reconcileSessionStoreCompactionCountAfterSuccess(params) {
	const { reconcileSessionStoreCompactionCountAfterSuccess: reconcile } = await import("./pi-embedded-subscribe.handlers.compaction.runtime-Bm9IZ01v.js");
...
function loadExecApprovalReply() {
	execApprovalReplyModulePromise ??= import("./exec-approval-reply-B70ekWR2.js");
	return execApprovalReplyModulePromise;
}
function loadHookRunnerGlobal() {
	hookRunnerGlobalModulePromise ??= import("./hook-runner-global-DeZ-OzGM.js");
	return hookRunnerGlobalModulePromise;
}
function loadMediaParse() {
	mediaParseModulePromise ??= import("./parse-CKVXSeFm.js");
	return mediaParseModulePromise;
}
function loadBeforeToolCall() {
	beforeToolCallModulePromise ??= import("./pi-tools.before-tool-call-CqGct3y1.js");
...
function observeModelCallResult(result, eventBase, startedAt) {
	...
	if (createIterator) return observeModelCallStream(result, createIterator, eventBase, startedAt);
	emitDiagnosticEvent({
		type: "model.call.completed",
		...eventBase,
		durationMs: Date.now() - startedAt
...
function wrapStreamFnWithDiagnosticModelCallEvents(streamFn, ctx) {
	return ((model, streamContext, options) => {
		const eventBase = baseModelCallEvent(ctx, ctx.nextCallId(), freezeDiagnosticTraceContext(createChildDiagnosticTraceContext(ctx.trace)));
		emitDiagnosticEvent({
		...
		try {
			...
			if (isPromiseLike(result)) return result.then((resolved) => observeModelCallResult(resolved, eventBase, startedAt), (err) => {
				emitDiagnosticEvent({
					type: "model.call.error",
					...eventBase,
					durationMs: Date.now() - startedAt,
			...
			if (shouldAttemptMalformedToolCallRepair(nextPartialJson, event.delta) || repairedArgsByIndex.has(event.contentIndex)) {
				...
				if (repair) {
					...
					if (!loggedRepairIndices.has(event.contentIndex) && repair.kind === "repaired") {
						...
						log$3.warn(`repairing malformed tool call arguments with ${repair.leadingPrefix.length} leading chars and ${repair.trailingSuffix.length} trailing chars`);
					}
				} else {
					repairedArgsByIndex.delete(event.contentIndex);
...
function resolveLlmIdleTimeoutMs(params) {
	...
	if (typeof agentTimeoutSeconds === "number" && Number.isFinite(agentTimeoutSeconds) && agentTimeoutSeconds > 0) return clampImplicitTimeoutMs(agentTimeoutSeconds * 1e3);
...
//#endregion
//#region src/agents/pi-embedded-runner/run/transcript-prompt-rewrite.ts
function extractPromptTextFromMessage(message) {
	const content = message.content;
	if (typeof content === "string") return content;
	if (!Array.isArray(content)) return;
	const textBlocks = content.map((block) => block && typeof block === "object" && typeof block.text === "string" ? block.text : void 0).filter((text) => typeof text === "string");
...
function replacePromptTextInMessage(message, text) {
	...
	const nextContent = [];
	for (const block of content) {
		if (replaced || !block || typeof block !== "object" || typeof block.text !== "string") {
			nextContent.push(block);
			continue;
		}
		replaced = true;
...
function rewriteSubmittedPromptTranscript(params) {
	const transcriptPrompt = params.transcriptPrompt;
	if (transcriptPrompt === void 0 || transcriptPrompt === params.submittedPrompt) return;
	const replacementText = transcriptPrompt.trim() || "[OpenClaw runtime event]";
	const branch = params.sessionManager.getBranch();
	const startIndex = params.previousLeafId ? Math.max(0, branch.findIndex((entry) => entry.id === params.previousLeafId) + 1) : 0;
	const target = branch.slice(startIndex).find((entry) => {
		if (entry.type !== "message" || entry.message.role !== "user") return false;
		return extractPromptTextFromMessage(entry.message) === params.submittedPrompt;
	});
	if (!target || target.type !== "message") return;
	if (rewriteTranscriptEntriesInSessionManager({
		sessionManager: params.sessionManager,
		replacements: [{
			entryId: target.id,
			message: replacePromptTextInMessage(target.message, replacementText)
		}]
	}).changed) emitSessionTranscriptUpdate(params.sessionFile);
}
//#endregion
...
function shouldCreateBundleMcpRuntimeForAttempt(params) {
	...
	return params.toolsAllow.some((toolName) => toolName.includes("__"));
}
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		const toolsRaw = params.disableTools ? [] : applyEmbeddedAttemptToolsAllow(createOpenClawCodingTools({
			agentId: sessionAgentId,
		...
		const tools = params.runtimePlan?.tools.normalize(toolsEnabled ? toolsRaw : [], runtimePlanModelContext) ?? normalizeProviderToolSchemas({
		...
		if (params.runtimePlan) params.runtimePlan.tools.logDiagnostics(effectiveTools, runtimePlanModelContext);
		else logProviderToolSchemaDiagnostics({
			tools: effectiveTools,
			provider: params.provider,
			config: params.config,
			workspaceDir: effectiveWorkspace,
		...
		try {
			...
			const transcriptPolicy = params.runtimePlan?.transcript.resolvePolicy(runtimePlanModelContext) ?? resolveTranscriptPolicy({
				modelApi: params.model?.api,
				provider: params.provider,
				modelId: params.modelId,
				config: params.config,
			...
			if (typeof activeSession.agent.convertToLlm === "function") {
				...
				activeSession.agent.convertToLlm = async (messages) => await baseConvertToLlm(normalizeAssistantReplayContent(messages));
			}
			...
			try {
				...
				if (emptyExplicitToolAllowlistError) {
					...
					log$3.warn(`[tools] ${emptyExplicitToolAllowlistError.message}`);
				}
				...
				try {
					...
					if (!skipPromptSubmission && !hasPromptSubmissionContent({
						prompt: effectivePrompt,
						messages: activeSession.messages,
						imageCount: imageResult.images.length
					})) {
						skipPromptSubmission = true;
						log$3.info(`embedded run prompt skipped: empty prompt/history/images runId=${params.runId} sessionId=${params.sessionId} trigger=${params.trigger} provider=${params.provider}/${params.modelId}`);
...
async function runAgentHarnessAttemptWithFallback(params) {
	...
	if (harness.id === "pi") return applyHarnessResultClassification(harness, await harness.runAttempt(params), params);
	try {
		return applyHarnessResultClassification(harness, await harness.runAttempt(params), params);
	} catch (error) {
...
function resolveAgentHarnessPolicy(params) {
	...
	const runtime = env.OPENCLAW_AGENT_RUNTIME?.trim() ? resolveEmbeddedAgentRuntime(env) : normalizeEmbeddedAgentRuntime(agentPolicy?.runtime ?? defaultsPolicy?.runtime);
	return {
		runtime,
...
function resolveAgentHarnessFallbackPolicy(params) {
	...
	if (params.agentPolicy?.runtime) return normalizeAgentHarnessFallback(params.agentPolicy.fallback, params.runtime);
...
//#endregion
export { safeJsonStringify as C, safeTrajectorySessionFileName as S, createEmbeddedRunReplayState as _, prepareSessionManagerForRun as a, resolveTrajectoryFilePath as b, isLikelyExecutionAckPrompt as c, resolveIncompleteTurnPayloadText as d, resolvePlanningOnlyRetryInstruction as f, resolveRunLivenessState as g, resolveReplayInvalidFlag as h, selectAgentHarness as i, resolveAckExecutionFastPathInstruction as l, resolveReasoningOnlyRetryInstruction as m, resolveAgentHarnessPolicy as n, STRICT_AGENTIC_BLOCKED_TEXT as o, resolvePlanningOnlyRetryLimit as p, runAgentHarnessAttemptWithFallback as r, extractPlanningOnlyPlanDetails as s, maybeCompactAgentHarnessSession as t, resolveEmptyResponseRetryInstruction as u, observeReplayMetadata as v, sanitizeDiagnosticPayload as w, resolveTrajectoryPointerFilePath as x, TRAJECTORY_RUNTIME_FILE_MAX_BYTES as y };

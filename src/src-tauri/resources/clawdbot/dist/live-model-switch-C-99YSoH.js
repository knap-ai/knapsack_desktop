...
import { c as normalizeAgentId, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import { g as listAgentIds } from "./agent-scope-_6dFncNS.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel } from "./thinking-C1TCb8El.js";
...
import { r as resolveExplicitAgentSessionKey } from "./main-session-BzfGEj6I.js";
...
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-BjF1l1uy.js";
...
function resolveSessionKeyForRequest(opts) {
	...
	const storeAgentId = explicitSessionKey ? resolveAgentIdFromSessionKey(explicitSessionKey) : requestedAgentId ?? normalizeAgentId(void 0);

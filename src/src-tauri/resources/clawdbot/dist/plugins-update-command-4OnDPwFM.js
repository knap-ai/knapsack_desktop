...
import { _ as shortenHomePath, m as resolveUserPath, t as CONFIG_DIR } from "./utils-BMRcljdi.js";
...
import { o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-Z2izhiRX.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-Bq8LaeUm.js";
import { l as resolveArchiveKind } from "./archive-I0VbH-E1.js";
import { t as parseFrontmatter } from "./frontmatter-D5aqWj2R.js";
import { t as findBundledPluginSource } from "./bundled-sources-B7zCULWI.js";
import { a as resolvePinnedNpmInstallRecordForCli, n as persistPluginInstall, r as recordHookInstall, t as persistHookPackInstall } from "./plugins-install-persist-tJiSkVHE.js";
import { m as parseClawHubPluginSpec } from "./clawhub-DUtsrJs-.js";
import { n as formatClawHubSpecifier, r as installPluginFromClawHub } from "./clawhub-Bhr6hWl5.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, r as createHookPackInstallLogger, s as formatPluginInstallWithHookFallbackError } from "./plugins-command-helpers-DMQfl4Ue.js";
import { r as resolveBundledInstallPlanForNpmFailure, t as resolveBundledInstallPlanBeforeNpm } from "./plugin-install-plan-BgLzjZWs.js";
import { o as collectChannelDoctorStaleConfigMutations } from "./channel-doctor-DUcrDoUh.js";
import { a as resolveMarketplaceInstallShortcut, n as updateNpmInstalledPlugins, r as installPluginFromMarketplace } from "./update-Bv_4hYzq.js";
import { r as resolvePluginInstallRequestContext, t as resolvePluginInstallInvalidConfigPolicy } from "./plugin-install-config-policy-CRmlyn7Q.js";
import { n as readInstalledPackageVersion, t as expectedIntegrityForUpdate } from "./package-update-utils-CJRHpE7O.js";
...
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-CRy-0dUT.js");
...
function shouldExitOnForcedUnsafeInstall(params) {
	return params.forceUnsafeInstall && (params.code === PLUGIN_INSTALL_ERROR_CODE.SECURITY_SCAN_BLOCKED || params.code === PLUGIN_INSTALL_ERROR_CODE.SECURITY_SCAN_FAILED);
}
...
async function runPluginInstallCommand(params) {
	...
	if (fs.existsSync(resolved)) {
		if (opts.link) {
			...
			if (!probe.ok) {
				if (shouldExitOnForcedUnsafeInstall({
					forceUnsafeInstall,
					code: probe.code
				})) {

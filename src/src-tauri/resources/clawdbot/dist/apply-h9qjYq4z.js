...
import { n as isDeliverableMessageChannel } from "./message-channel-BliByQBl.js";
import { ag as createMediaAttachmentCache, cg as resolveMediaAttachmentLocalRoots, lg as runCapability, mg as resolveAttachmentKind, og as normalizeMediaAttachments, rg as buildProviderRegistry } from "./pi-embedded-CbCYZxIb.js";
import { E as finalizeInboundContext, n as resolveConcurrency } from "./templating-BDXRiJUh.js";
import { c as resolveInputFileLimits, i as extractFileContentFromSource, l as renderFileContextBlock, s as normalizeMimeType } from "./input-files-USwyDyYr.js";
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-DUXLoUYP.js");
...
async function sendTranscriptEcho(params) {
	...
	if (!isDeliverableMessageChannel(normalizedChannel)) {
		if (shouldLogVerbose()) logVerbose(`media: echo-transcript skipped (channel "${String(normalizedChannel)}" is not deliverable)`);
		return;
	}

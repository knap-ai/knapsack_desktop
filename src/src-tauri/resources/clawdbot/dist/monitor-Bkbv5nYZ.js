import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-D7XpmyVq.js";
...
import { h as sendMediaWithLeadingCaption, m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-SzVz53hc.js";
...
import { a as isRequestBodyLimitError, c as requestBodyErrorToText, i as installRequestBodyLimitGuard, s as readRequestBodyWithLimit } from "./http-body-BFWxPfKm.js";
...
import { a as createFeishuClient, c as listEnabledFeishuAccounts, d as resolveFeishuAccount, f as resolveFeishuRuntimeAccount, i as createEventDispatcher, n as raceWithTimeoutAndAbort, o as createFeishuWSClient, r as waitForAbortableDelay, t as probeFeishu } from "./probe-Sr6ZihvE.js";
import { D as deliverCommentThreadText, E as isMentionForwardRequest, I as getFeishuRuntime, N as buildFeishuCommentTarget, P as normalizeCommentFileType, _ as normalizeFeishuExternalKey, b as extractMentionTargets, c as getMessageFeishu, d as sendCardFeishu, g as parsePostContent, i as sendMediaFeishu, l as listFeishuThreadMessages, m as sendStructuredCardFeishu, p as sendMessageFeishu, t as downloadMessageResourceFeishu, u as resolveFeishuCardTemplate, v as buildMentionedCardContent } from "./media-Db1jTPI3.js";
import "./runtime-api-B9CFXC5g.js";
import { r as resolveReceiveIdType } from "./targets-DLSGBpV_.js";
import { a as resolveFeishuReplyPolicy, c as createFeishuCardInteractionEnvelope, l as decodeFeishuCardAction, n as resolveFeishuAllowlistMatch, r as resolveFeishuGroupConfig, s as buildFeishuCardActionTextFallback, t as isFeishuGroupAllowed } from "./policy-EtR629LA.js";
import { t as buildFeishuConversationId } from "./conversation-id-ClQYe69f.js";
import { n as createFeishuThreadBindingManager } from "./thread-bindings-CQbJwC7k.js";
...
function filterFetchedGroupContextMessages(messages, params) {
	return messages.filter((message) => shouldIncludeFetchedGroupContextMessage({
...
async function handleFeishuMessage(params) {
	...
	try {
		...
		if (ctx.parentId) try {
			...
			} else if (quotedMessageInfo) log(`feishu[${account.accountId}]: skipped quoted message from sender ${quotedMessageInfo.senderId ?? "unknown"} due to group sender allowlist`);
		} catch (err) {
		...
		const getRootMessageInfo = async () => {
			...
			if (!rootMessageFetched) {
				...
				if (rootMessageInfo && !shouldIncludeFetchedGroupContextMessage({
					...
					log(`feishu[${account.accountId}]: skipped thread starter from sender ${rootMessageInfo.senderId ?? "unknown"} due to group sender allowlist`);
					rootMessageInfo = null;
				}
			}

...
import { u as resolveDiscoveredProviderPluginIds } from "./plugin-auto-enable-BKDUQLPR.js";
...
function resolveProviderDiscoveryEntryPlugins(params) {
	...
	const pluginRecords = loadPluginManifestRegistry(params).plugins.filter((plugin) => pluginIdSet.has(plugin.id));

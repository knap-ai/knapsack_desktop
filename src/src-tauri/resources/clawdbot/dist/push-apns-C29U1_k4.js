...
import { a as signDevicePayload, n as loadOrCreateDeviceIdentity } from "./device-identity-D-AMPixR.js";
import { O as sniffMimeFromBase64 } from "./pi-embedded-BYdcxQ5A.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-DNVtj23_.js";
import { i as deleteMediaBuffer, l as saveMediaBuffer } from "./store-CCBPdtW9.js";
		...
		for (const [idx, att] of attachments.entries()) {
			...
			if (sizeBytes > OFFLOAD_THRESHOLD_BYTES) {
				...
				try {
					...
					throw new MediaOffloadError(`[Gateway Error] Failed to save intercepted media to disk: ${err instanceof Error ? err.message : String(err)}`, { cause: err });
				}
			}
...
//#endregion
export { resolveApnsAuthConfigFromEnv as a, shouldClearStoredApnsRegistration as c, MediaOffloadError as d, parseMessageWithAttachments as f, registerApnsRegistration as i, resolveApnsRelayConfigFromEnv as l, loadApnsRegistration as n, sendApnsAlert as o, normalizeApnsEnvironment as r, sendApnsBackgroundWake as s, clearApnsRegistrationIfCurrent as t, normalizeRpcAttachmentsToChatAttachments as u };

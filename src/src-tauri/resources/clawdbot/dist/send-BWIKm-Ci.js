...
import { J as danger, X as logVerbose, l as createSubsystemLogger } from "./exec-DBtWJ4Ld.js";
import { E as getFileExtension, H as resolveTelegramAccount, P as mediaKindFromMime, j as normalizeMimeType, k as isGifMedia } from "./image-ops-CQkyIkuI.js";
import { q as isTruthyEnvValue } from "./model-auth-BffKC6OJ.js";
import { n as loadConfig } from "./config-DAGaFnCt.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-Daa2hz8x.js";
import { t as redactSensitiveText } from "./redact-DcuzVizL.js";
import { i as loadWebMedia, n as markdownToIR, o as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-XjRYsEjJ.js";
import { t as renderMarkdownWithMarkers } from "./render-CiikiGbn.js";
import { n as wrapFetchWithAbortSignal, t as resolveFetch } from "./fetch-C7ufkwV6.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BHDtnoEK.js";
...
//#endregion
export { hasBotMention as A, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramThreadSpec as F, formatLocationText as I, toLocationContext as L, resolveTelegramForumThreadId as M, resolveTelegramReplyId as N, expandTextLinks as O, resolveTelegramStreamMode as P, isVoiceCompatibleAudio as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, splitTelegramCaption as _, sendMessageTelegram as a, buildSenderLabel as b, resolveTelegramVoiceSend as c, isRecoverableTelegramNetworkError as d, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, reactMessageTelegram as i, normalizeForwardedContext as j, extractTelegramLocation as k, wasSentByBot as l, renderTelegramHtmlText as m, deleteMessageTelegram as n, sendStickerTelegram as o, markdownToTelegramHtml as p, editMessageTelegram as r, send_exports as s, buildInlineKeyboard as t, makeProxyFetch as u, withTelegramApiErrorLogging as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, parseTelegramTarget as z };
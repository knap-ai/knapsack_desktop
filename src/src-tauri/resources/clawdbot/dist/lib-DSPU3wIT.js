...
import { t as require_content_type } from "./content-type-DRlQpE2g.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-BQ5Yz_MG.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DchXr3Gt.js";
import { l as toRatio, n as decodeString } from "./Util-BSO_95q4.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CXkKcG4c.js";
import { t as APEv2Parser } from "./APEv2Parser-BvwSPGa6.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DmC5pCCb.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CCh8ICY7.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BRpdm053.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BnWw9BTI.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BVttx_qO.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-D7VHXh0u.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DKaqgZPM.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Byh7Aye7.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-vEsSwoIm.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-B6daXZrc.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BbvZCqoc.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BXSFWDMk.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CXAOE5g1.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CyalVMqD.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CNMc16Bb.js")).WaveParser;
	}
};
//#endregion

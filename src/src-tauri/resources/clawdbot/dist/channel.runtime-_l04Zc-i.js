...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CqZztnNr.js";
import { t as sendMessageZalo } from "./send-7nPZlVph.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DEo-PnCv.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CnQY2ctw.js");

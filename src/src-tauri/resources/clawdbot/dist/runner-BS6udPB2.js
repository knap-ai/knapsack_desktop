import { Y as logVerbose, Z as shouldLogVerbose, n as runExec } from "./exec-DYHF__-L.js";
import { H as resolveOpenClawAgentDir, S as resolveApiKeyForProvider, f as normalizeGoogleModelId, o as normalizeProviderId, x as requireApiKey } from "./model-selection-Ch-ZMovh.js";
import { C as detectMime, D as isAudioFileName, J as normalizeChatType, T as getFileExtension, k as kindFromMime } from "./image-ops-DF9AQADy.js";
import { n as loadConfig } from "./config-C94oBlHq.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BynuzqGd.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-Qc6XQcFW.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DWTTaAgY.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-D_8Dz3h-.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
...
//#endregion
export { applyTemplate as _, runCapability as a, modelSupportsVision as c, registerUnhandledRejectionHandler as d, resolveConcurrency as f, CLI_OUTPUT_MAX_BUFFER as g, resolveMediaUnderstandingScope as h, resolveAutoImageModel as i, isAudioAttachment as l, normalizeMediaUnderstandingChatType as m, createMediaAttachmentCache as n, findModelInCatalog as o, resolveTimeoutMs as p, normalizeMediaAttachments as r, loadModelCatalog as s, buildProviderRegistry as t, resolveAttachmentKind as u };
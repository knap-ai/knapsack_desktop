...
import { n as inferEdgeExtension, r as require_drm, t as edgeTTS } from "./tts-DPrY9Wxk.js";
import { mkdirSync, mkdtempSync, readFileSync, rmSync } from "node:fs";
import path from "node:path";
//#region extensions/microsoft/speech-provider.ts
var import_drm = require_drm();
...
function buildMicrosoftVoiceHeaders() {
	...
	return {
		...
		"Sec-MS-GEC": (0, import_drm.generateSecMsGecToken)(),
		"Sec-MS-GEC-Version": `1-${import_drm.CHROMIUM_FULL_VERSION}`
	};
}
...
async function listMicrosoftVoices() {
	const url = `https://speech.platform.bing.com/consumer/speech/synthesize/readaloud/voices/list?trustedclienttoken=${import_drm.TRUSTED_CLIENT_TOKEN}`;

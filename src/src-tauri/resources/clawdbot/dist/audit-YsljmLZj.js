...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-BG0ad0P6.js";
import { o as hasConfiguredSecretInput } from "./types.secrets-Zn5Zyn7M.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Bf5HAAlc.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-D1Q1dhng.js";
...
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-BDAr27rw.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DrT-K-_k.js";
import { l as loadExecApprovals } from "./exec-approvals-BbaGmaa4.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Bm3QYlyr.js";
...
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-CB0Dv3aM.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-D8Ppm3zt.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BxxUsiUv.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DUZSIHk1.js");

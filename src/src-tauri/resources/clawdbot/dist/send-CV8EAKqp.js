...
import { B as resolveUserPath, I as normalizeE164 } from "./exec-DBtWJ4Ld.js";
...
import { i as loadWebMedia, o as resolveMarkdownTableMode } from "./ir-XjRYsEjJ.js";
...
async function sendMessageIMessage(to, text, opts = {}) {
	...
	if (opts.mediaUrl?.trim()) {
		const resolved = await (opts.resolveAttachmentImpl ?? resolveAttachment)(opts.mediaUrl.trim(), maxBytes);

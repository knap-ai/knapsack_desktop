...
import { a as resolveProviderRequestPolicy } from "./provider-attribution-DMdhUxEe.js";
import { n as resolveOpenAIResponsesPayloadPolicy, r as flattenCompletionMessagesToStringContent, t as applyOpenAIResponsesPayloadPolicy } from "./openai-responses-payload-policy-nh4fYQcn.js";
import { t as log } from "./logger-Cq8_pd8S.js";
import { c as resolveProviderRequestPolicyConfig } from "./provider-request-config-Bxj9Jz-Z.js";
import { t as applyAnthropicEphemeralCacheControlMarkers } from "./anthropic-payload-policy-DRJLBLIc.js";
import { o as patchCodexNativeWebSearchPayload, s as resolveCodexNativeSearchActivation } from "./codex-native-web-search-Cv3Ixmqi.js";
import { s as isProxyReasoningUnsupportedModelHint } from "./provider-model-shared-D-iKoymz.js";
import { C as isAnthropicModelRef } from "./provider-stream-shared-BYe_GyIX.js";
...
function createOpenAIThinkingLevelWrapper(baseStreamFn, thinkingLevel) {
	...
	return (model, context, options) => {
		...
		return streamWithPayloadPatch(underlying, model, context, options, (payloadObj) => {
			...
			if (existingReasoning && typeof existingReasoning === "object" && !Array.isArray(existingReasoning)) existingReasoning.effort = mapThinkingLevelToReasoningEffort(thinkingLevel);
		});
	};
}

...
import { _ as resolveHomeDir, d as isRecord } from "./utils-CS0Ikux6.js";
import { S as OpenClawSchema, d as readConfigFileSnapshot } from "./io-y3Az_Onx.js";
import { n as formatConfigIssueLines } from "./issue-format-BtLIwOtN.js";
import { t as note } from "./note-Cq-EkeJ6.js";
...
async function maybeMigrateLegacyConfig() {
	...
	const legacyCandidates = [path.join(home, ".clawdbot", "clawdbot.json"), path.join(home, ".moldbot", "moldbot.json")];
	let legacyPath = null;
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-C3W6JLII.js");

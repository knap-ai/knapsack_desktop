...
import { g as resolveOAuthPath } from "./paths-CD8i0MSg.js";
...
function saveAuthProfileStore(store, agentDir) {
	...
	if (runtimeAuthStoreSnapshots.has(runtimeKey)) runtimeAuthStoreSnapshots.set(runtimeKey, cloneAuthProfileStore(payload));
}
//#endregion
export { loadAuthProfileStoreForSecretsRuntime as a, updateAuthProfileStoreWithLock as c, resolveAuthStorePath as d, resolveAuthStorePathForDisplay as f, log$1 as g, CODEX_CLI_PROFILE_ID as h, loadAuthProfileStoreForRuntime as i, readClaudeCliCredentialsCached as l, CLAUDE_CLI_PROFILE_ID as m, ensureAuthProfileStore as n, replaceRuntimeAuthProfileStoreSnapshots as o, AUTH_STORE_LOCK_OPTIONS as p, loadAuthProfileStore as r, saveAuthProfileStore as s, clearRuntimeAuthProfileStoreSnapshots as t, ensureAuthStoreFile as u };

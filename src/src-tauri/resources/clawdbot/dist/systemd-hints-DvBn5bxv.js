import { I as isBunRuntime, L as isNodeRuntime } from "./logger-kwZIqwuw.js";
import { t as formatCliCommand } from "./command-format-DBQUhADm.js";
import { n as isVersionManagedNodePath, o as resolveSystemNodePath, t as isSystemNodePath, u as getMinimalServicePathPartsFromEnv } from "./runtime-paths-DOEOEFe-.js";
import { a as toPosixPath } from "./runtime-parse-BUn1nl6s.js";
import { c as resolveGatewayLogPaths, l as resolveLaunchAgentPlistPath } from "./launchd-yOx8f787.js";
import { s as resolveSystemdUserUnitPath } from "./systemd-bGhJCG6J.js";
	...
	if (isVersionManagedNodePath(execPath, platform)) {
		...
		if (!isSystemNodePath(execPath, env, platform)) {
			if (!await resolveSystemNodePath(env, platform)) issues.push({
				...
				message: "System Node 22 LTS (22.16+) or Node 24 not found; install it before migrating away from version managers.",
				level: "recommended"
			});
		}
	}
...
//#endregion
export { checkTokenDrift as a, buildPlatformRuntimeLogHints as c, auditGatewayServiceConfig as i, buildPlatformServiceStartHints as l, renderSystemdUnavailableHints as n, needsNodeRuntimeMigration as o, SERVICE_AUDIT_CODES as r, readEmbeddedGatewayToken as s, isSystemdUnavailableDetail as t, formatRuntimeStatus as u };

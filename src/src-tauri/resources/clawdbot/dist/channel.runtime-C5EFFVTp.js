...
import { l as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, s as resolveWebhookTargetWithAuthOrRejectSync } from "./webhook-targets-BxJSNvH9.js";
import "./webhook-ingress-S9T0oiq6.js";
import "./browser-security-runtime-BrD1-zTV.js";
import "./string-coerce-runtime-CWqoMfGN.js";
import { P as resolveBlueBubblesEffectiveAllowPrivateNetwork, _ as normalizeWebhookReaction, g as normalizeWebhookMessage, o as probeBlueBubbles, t as fetchBlueBubblesServerInfo, u as asRecord } from "./probe-Bu8hsxiz.js";
import { t as getBlueBubblesRuntime } from "./runtime-63facrzC.js";
import { n as resolveWebhookPathFromConfig } from "./webhook-shared-CBvfb4Zh.js";
import { a as resolveBlueBubblesMessageId, b as sendMessageBlueBubbles } from "./reactions-Dk1gJo3n.js";
import { i as sendBlueBubblesMedia, n as processMessage, r as processReaction, t as logVerbose } from "./monitor-processing-C33JVnhs.js";
...
async function monitorBlueBubblesProvider(options) {
	...
	return await new Promise((resolve) => {
		...
		import("./catchup-4RxOLF7W.js").then(({ runBlueBubblesCatchup }) => runBlueBubblesCatchup(target)).catch((err) => {

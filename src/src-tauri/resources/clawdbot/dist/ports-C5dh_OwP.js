import { o as isErrno } from "./errors-Bs2h5H8p.js";
import { m as defaultRuntime } from "./subsystem-CJEvHE2o.js";
import { a as shouldLogVerbose, n as info, s as warn, t as danger } from "./globals-BJZkpw-q.js";
...
import { t as resolveLsofCommand } from "./ports-lsof-B9yCj17c.js";
import { t as tryListenOnPort } from "./ports-probe-BcAydAmO.js";
...
function parseListenerAddress(address) {
	...
	if (bracketMatch) {
		...
		return Number.isFinite(port) ? {
			host: bracketMatch[1].toLowerCase(),
			port
		} : null;
	}

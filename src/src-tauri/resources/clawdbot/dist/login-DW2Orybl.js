...
import { _ as resolveJidToE164, d as isSelfChatMode, f as jidToE164, p as normalizeE164, w as toWhatsappJid } from "./utils-CE3P21nG.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-D7XpmyVq.js";
import { a as shouldLogVerbose, n as info, o as success, r as logVerbose, t as danger } from "./globals-BJZkpw-q.js";
import { r as logInfo } from "./logger-Dr2uNJI4.js";
import { c as loadConfig } from "./io-DhtVmzAJ.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { C as resolveGroupSessionKey, i as loadSessionStore, s as recordSessionMetaFromInbound } from "./store-BGmy-Wot.js";
import { l as resolveStorePath } from "./paths-DBIQqSpZ.js";
import { t as createDedupeCache } from "./dedupe-_6bbS8VC.js";
import { o as resolveIdentityNamePrefix, s as resolveMessagePrefix } from "./identity-BVAU5Jb3.js";
...
import { r as formatDurationPrecise } from "./format-duration-C_A6mVzb.js";
...
import { i as shouldComputeCommandAuthorized, t as hasControlCommand } from "./command-detection-Bz_HOEgu.js";
import { t as finalizeInboundContext } from "./inbound-context-1KETU_yq.js";
import { r as formatInboundEnvelope } from "./envelope-CTj2Ympv.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-DcwkFaUr.js";
import { a as normalizeMentionText, n as buildMentionRegexes } from "./mentions-Bfkn0E5p.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-B2dh4tuq.js";
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-cTTW0IRo.js";
...
import { a as resolveDmGroupAccessWithCommandGate, c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-ikRqobo8.js";
import { r as buildHistoryContextFromEntries, u as recordPendingHistoryEntryIfEnabled } from "./history-5RBVRj2e.js";
...
import "./cli-runtime-BgrpjBV4.js";
...
import { l as resolveWhatsAppMediaMaxBytes, s as resolveWhatsAppAccount } from "./accounts-C7z-45Me.js";
import { n as resolveWhatsAppReactionLevel } from "./runtime-api-rROA7VYI.js";
import { i as setActiveWebListener } from "./active-listener-HztIeFkJ.js";
import { r as sendReactionWhatsApp } from "./send-aQ-61ZNj.js";
import { n as checkInboundAccessControl } from "./access-control-BkYVztCs.js";
import { _ as getSenderIdentity, c as readWebSelfId, f as getComparableIdentityValues, g as getSelfIdentity, h as getReplyContext, i as logoutWeb, l as readWebSelfIdentity, m as getPrimaryIdentityId, n as getWebAuthAgeMs, p as getMentionIdentities, v as identitiesOverlap, y as resolveComparableIdentity } from "./auth-store-BHt3Da5y.js";
import { n as getStatusCode, t as formatError } from "./session-errors-DWlRnyTv.js";
import { a as updateLastRouteInBackground, c as whatsappLog, d as resolveHeartbeatSeconds, f as resolveReconnectPolicy, i as trackBackgroundTask, l as whatsappOutboundLog, n as elide, o as whatsappHeartbeatLog, r as isLikelyWhatsAppCryptoError, s as whatsappInboundLog, t as deliverWebReply, u as newConnectionId } from "./deliver-reply-7UuA_Wpg.js";
import { a as waitForWaConnection, c as getContentType, d as DisconnectReason, i as waitForCredsSaveQueueWithTimeout, l as normalizeMessageContent, o as downloadMediaMessage, s as extractMessageContent, t as createWaSocket, u as isJidGroup } from "./session-Cz5uoIxI.js";
...
async function monitorWebInbox(options) {
	...
	try {
		...
		if (shouldLogVerbose()) logVerbose(`Sent global '${presence}' presence on connect`);
	} catch (err) {
	...
	(async () => {
		try {
			...
			if (shouldLogVerbose()) logVerbose(`Hydrated ${Object.keys(groups ?? {}).length} participating groups on connect`);
		} catch (err) {

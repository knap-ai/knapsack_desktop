import { n as getPath, r as setPathCreateStrict } from "./path-utils-BMwQl5-A.js";
//#region src/wizard/setup.plugin-config.ts
let manifestRegistryModulePromise;
function loadManifestRegistryModule() {
	manifestRegistryModulePromise ??= import("./manifest-registry-zSrMSdgR.js");

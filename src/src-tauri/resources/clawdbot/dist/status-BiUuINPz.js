...
import { s as listConfiguredChannelIdsForReadOnlyScope } from "./channel-plugin-ids-Dc_n_j0K.js";
import { t as listReadOnlyChannelPluginsForConfig } from "./read-only-IxGh3z7a.js";
import { r as getConfiguredChannelsCommandSecretTargetIds } from "./command-secret-targets-5rfgNL2Q.js";
import { n as formatTimeAgo } from "./format-relative-DBI0ON8M.js";
import { n as withProgress } from "./progress-DAY5yFVV.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-uAIH9-iX.js";
...
import { a as buildChannelAccountLine, i as appendTokenSourceBits, n as appendEnabledConfiguredLinkedBits, r as appendModeBit, t as appendBaseUrlBit } from "./shared-t6_fy18Q.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-CeaWizHL.js";
...
async function formatConfigChannelsStatusLines(cfg, meta, opts) {
	...
	const plugins = listReadOnlyChannelPluginsForConfig(cfg, { activationSourceConfig: sourceConfig });

...
import "./zod-schema.sensitive-CXV5Jtci.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-pYrbrdHJ.js";
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, a as loadConfig, u as readConfigFileSnapshot } from "./io-Dv_xNAZB.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-_6dFncNS.js";
import "./config-yDDhhyz6.js";
import { r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-DFFiUfXC.js";
import { i as isSensitiveConfigPath } from "./redact-snapshot-D4wjPRM1.js";
...
const GENERATED_BASE_CONFIG_SCHEMA = {
								...
								anyOf: [{ type: "boolean" }, {
									...
									properties: {
										enabled: {
											...
											description: "Master switch for granular OTEL content capture fields. Keep disabled unless your collector is approved for raw prompt, response, or tool content."
										},
										inputMessages: {
											type: "boolean",
											title: "OpenTelemetry Input Messages Capture",
											description: "Capture model input message text on OTEL spans when content capture is enabled."
										},
										outputMessages: {
											type: "boolean",
											title: "OpenTelemetry Output Messages Capture",
											description: "Capture model output message text on OTEL spans when content capture is enabled."
										},
										toolInputs: {
											type: "boolean",
											title: "OpenTelemetry Tool Inputs Capture",
											description: "Capture tool input text on OTEL spans when content capture is enabled."
										},
										toolOutputs: {
											type: "boolean",
											title: "OpenTelemetry Tool Outputs Capture",
											description: "Capture tool output text on OTEL spans when content capture is enabled."
										},
										systemPrompt: {
											type: "boolean",
											title: "OpenTelemetry System Prompt Capture",
											description: "Capture system prompt text on OTEL spans when content capture is enabled. This remains off unless explicitly enabled."
										}
									},
									additionalProperties: false
								}],
								title: "OpenTelemetry Content Capture",
								description: "Opt-in OTEL span content capture. Defaults to off; boolean true captures non-system message/tool content, while the object form lets you enable specific content classes."
							}
						},
						additionalProperties: false,
						title: "OpenTelemetry",
			...
			browser: {
				...
				properties: {
					...
					actionTimeoutMs: {
						...
						description: "Default timeout in milliseconds for browser act requests before the client gives up waiting. Raise this when healthy waits or UI interactions exceed the default request budget."
					},
					color: {
						type: "string",
						...
						additionalProperties: {
							...
							properties: {
								...
								userDataDir: {
									...
									description: "Per-profile Chromium user data directory for existing-session attachment through Chrome DevTools MCP. Use this for Brave, Edge, Chromium, or non-default Chrome profiles when the built-in auto-connect path would pick the wrong browser data directory on the selected host or browser node."
								},
								driver: {
									anyOf: [
										{
									...
									description: "Per-profile browser driver mode. Use \"openclaw\" (or legacy \"clawd\") for CDP-based profiles, or use \"existing-session\" for Chrome DevTools MCP attachment on the selected host or browser node."
								},
								headless: {
									type: "boolean",
										...
										properties: {
											...
											compat: {
												...
												properties: {
													...
													supportsPromptCacheKey: { type: "boolean" },
					...
					defaults: {
						...
						properties: {
							...
							embeddedHarness: {
								...
								properties: {
									runtime: {
										...
										description: "Embedded harness runtime: pi, auto, or a registered plugin harness id such as codex. Omitted runtime uses built-in OpenClaw Pi."
									},
									fallback: {
										type: "string",
										enum: ["pi", "none"],
										title: "Default Embedded Harness Fallback",
										description: "Embedded harness fallback when no plugin harness matches. Auto mode defaults to pi; explicit plugin runtimes default to none and do not inherit broader fallback settings. Selected plugin harness failures surface directly."
									}
								},
								additionalProperties: false,
								title: "Default Agent Runtime Settings",
								description: "Default embedded agent harness policy. Omitted runtime uses built-in OpenClaw Pi. Use runtime=auto for plugin harness selection, or a registered harness id such as codex."
							},
							...
							promptOverlays: {
								...
								properties: { gpt5: {
									...
									properties: { personality: {
										...
										description: "Friendly interaction-style layer for GPT-5-family models (\"friendly\" or \"on\" enables it; \"off\" disables only that layer). The tagged behavior contract remains enabled for matching GPT-5 models."
									} },
									additionalProperties: false,
									title: "GPT-5 Prompt Overlay",
									description: "Shared GPT-5-family prompt overlay applied to matching model ids across providers such as OpenAI, OpenRouter, OpenCode, Codex, and compatible gateways."
								} },
								additionalProperties: false,
								title: "Prompt Overlays",
								description: "Provider-independent prompt overlays applied by model family before provider-specific prompt hooks."
							},
							...
							bootstrapMaxChars: {
								...
								description: "Max characters of each workspace bootstrap file injected into the system prompt before truncation (default: 12000)."
							},
							...
							contextLimits: {
								...
								properties: {
									...
									memoryGetDefaultLines: {
										...
										description: "Default memory_get line window used when requests omit lines. This controls how many source lines are selected before the max-char cap is applied."
									},
									toolResultMaxChars: {
										type: "integer",
										minimum: 1,
										...
										description: "Default max characters kept for a single live tool result before truncation. This affects both persisted live tool-result writes and overflow-recovery truncation heuristics."
									},
							...
							memorySearch: {
								...
								properties: {
									...
									provider: {
										...
										description: "Selects the embedding backend used to build/query memory vectors: \"openai\", \"gemini\", \"voyage\", \"mistral\", \"bedrock\", \"lmstudio\", \"ollama\", or \"local\". Keep your most reliable provider here and configure fallback for resilience."
									},
									remote: {
										type: "object",
										properties: {
									...
									local: {
										...
										properties: {
											...
											contextSize: {
												...
												description: "Context window size passed to node-llama-cpp when creating the embedding context (default: 4096). 4096 safely covers typical memory-search chunks (128–512 tokens) while keeping non-weight VRAM bounded. Lower to 1024–2048 on resource-constrained hosts. Set to \"auto\" to let node-llama-cpp use the model's trained maximum — not recommended for large models (e.g. Qwen3-Embedding-8B trained on 40 960 tokens can push VRAM from ~8.8 GB to ~32 GB)."
											}
										},
										additionalProperties: false
									},
							...
							compaction: {
								...
								properties: {
									...
									truncateAfterCompaction: {
										...
										description: "When enabled, rewrites the session JSONL file after compaction to remove entries that were summarized. Prevents unbounded file growth in long-running sessions with many compaction cycles. Default: false."
									},
									notifyUser: {
										type: "boolean",
										title: "Compaction Notify User",
										description: "When enabled, sends brief compaction notices to the user when compaction starts and when it completes (for example, '🧹 Compacting context...' and '🧹 Compaction complete'). Disabled by default to keep compaction silent and non-intrusive."
									}
								},
								additionalProperties: false,
								title: "Compaction",
					...
					list: {
						...
						items: {
							...
							properties: {
								...
								embeddedHarness: {
									...
									properties: {
										runtime: {
											type: "string",
											title: "Agent Runtime",
											description: "Per-agent embedded harness runtime: pi, auto, or a registered plugin harness id such as codex. Omitted runtime inherits the default OpenClaw Pi behavior."
										},
										fallback: {
											type: "string",
											enum: ["pi", "none"],
											title: "Agent Embedded Harness Fallback",
											description: "Per-agent embedded harness fallback. Auto mode defaults to pi; explicit plugin runtimes default to none and do not inherit broader fallback settings."
										}
									},
									additionalProperties: false,
									title: "Agent Embedded Harness",
									description: "Per-agent embedded harness policy override. Use runtime=codex to force Codex for one agent while defaults stay in auto mode."
								},
								model: { anyOf: [{ type: "string" }, {
									type: "object",
									properties: {
								...
								skillsLimits: {
									type: "object",
									properties: { maxSkillsPromptChars: {
										type: "integer",
										minimum: 0,
										maximum: 9007199254740991,
								...
								contextLimits: {
									...
									properties: {
										...
										memoryGetDefaultLines: {
											...
											description: "Per-agent override for the default memory_get line window when lines is omitted."
										},
										toolResultMaxChars: {
											type: "integer",
											minimum: 1,
											...
											description: "Per-agent override for the live tool-result max character budget."
										},
										postCompactionMaxChars: {
											type: "integer",
											minimum: 1,
					...
					loopDetection: {
						...
						properties: {
							...
							unknownToolThreshold: {
								...
								description: "Block repeated calls to the same unavailable tool after this many misses (default: 10)."
							},
							criticalThreshold: {
								type: "integer",
								exclusiveMinimum: 0,
			...
			gateway: {
				...
				properties: {
					...
					channelStaleEventThresholdMinutes: {
						...
						description: "How many minutes a connected channel can go without provider-proven transport activity before the health monitor treats it as a stale socket and triggers a restart. Default: 30."
					},
					...
					nodes: {
						...
						properties: {
							...
							pairing: {
								...
								description: "Node pairing policy settings. Defaults keep CIDR auto-approval disabled; enable only with explicit trusted CIDR/IP allowlists you control."
							},
							allowCommands: {
								type: "array",
								items: { type: "string" },
								...
								hooks: {
									...
									properties: {
										...
										allowConversationAccess: {
											...
											description: "Controls whether this plugin may read raw conversation content from typed hooks such as `llm_input`, `llm_output`, and `agent_end`. Non-bundled plugins must opt in explicitly."
										}
									},
									additionalProperties: false,
	...
	uiHints: {
		...
		"models.providers.*.models[].baseUrl": { tags: ["models", "url-secret"] },

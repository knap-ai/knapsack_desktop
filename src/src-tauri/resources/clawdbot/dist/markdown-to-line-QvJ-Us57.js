...
import { i as resolveLineAccount } from "./accounts-BYRgvYs6.js";
import { n as validateLineMediaUrl } from "./outbound-media-IDrahEm-.js";
import { r as createReceiptCard } from "./schedule-cards-D17rXSeb.js";
...
function createLineMessagingClient(opts) {
	...
	return {
		account,
		client: new MessagingApiClient({ channelAccessToken: resolveLineChannelAccessToken(opts.channelAccessToken, account) })
	};
}

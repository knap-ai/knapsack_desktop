...
import { h as parseLooseIpAddress, i as isCanonicalDottedDecimalIPv4, l as isLegacyIpv4Literal, m as parseCanonicalIpAddress, n as isBlockedSpecialUseIpv4Address, r as isBlockedSpecialUseIpv6Address, s as isIpv4Address, t as extractEmbeddedIpv4FromIpv6 } from "./ip-CDR21C3h.js";
import { t as normalizeHostname } from "./hostname-CALR2Y-J.js";
...
function isUndiciRuntimeDeps(value) {
	return typeof value === "object" && value !== null && typeof value.Agent === "function" && typeof value.EnvHttpProxyAgent === "function" && typeof value.ProxyAgent === "function";
}
...
function createPinnedDispatcher(pinned, policy, ssrfPolicy) {
	...
	if (!requestTls) return new ProxyAgent(proxyUrl);

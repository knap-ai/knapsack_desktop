...
function captureHttpExchange(params) {
	...
	if (!(params.response && typeof params.response.clone === "function" && typeof params.response.arrayBuffer === "function")) {
		store.recordEvent({
			...
			headersJson: params.response.headers && typeof params.response.headers.entries === "function" ? safeJsonString(redactedCaptureHeaders(params.response.headers)) : void 0,

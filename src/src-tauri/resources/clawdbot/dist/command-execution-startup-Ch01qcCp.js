...
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-BzvSveST.js";
//#region src/cli/plugin-registry-loader.ts
let pluginRegistryModulePromise;
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-OR3bADYu.js");
...
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-BpVa5WWs.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-COv47vuf.js");
	if (params.argv) {

...
import { a as shouldLogVerbose, r as logVerbose } from "./globals-BJZkpw-q.js";
import { o as readSessionUpdatedAt } from "./store-BGmy-Wot.js";
import { t as resolveConversationLabel } from "./conversation-label--6yrMX97.js";
import { a as resolveChannelEntryMatchWithFallback, n as buildChannelKeyCandidates, t as applyChannelMatchMeta } from "./channel-config-BxyOA3tL.js";
...
import { t as evaluateGroupRouteAccessForPolicy } from "./group-access-Cc77nG5J.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-ikRqobo8.js";
import { a as buildPendingHistoryContextFromMap, u as recordPendingHistoryEntryIfEnabled } from "./history-5RBVRj2e.js";
...
import { n as buildUntrustedChannelMetadata } from "./security-runtime-DCa00BFS.js";
...
import { o as resolveSlackReplyToMode } from "./accounts-DHZuUL28.js";
import { a as normalizeAllowList, c as normalizeSlackSlug, f as hasSlackThreadParticipation, i as allowListMatches, l as resolveSlackAllowListMatch, o as normalizeAllowListLower, s as normalizeSlackAllowOwnerEntry, u as resolveSlackUserAllowed } from "./probe-B3VY9yHG.js";
import { t as sendMessageSlack } from "./send-oLUIhqiG.js";
import { _ as resolveSlackThreadHistory, g as resolveSlackMedia, h as resolveSlackAttachmentContent, l as reactSlackMessage, v as resolveSlackThreadStarter } from "./actions-D4m3sief.js";
...
function resolveSlackRoomContextHints(params) {
	...
	const systemPromptParts = [params.isRoomish ? params.channelConfig?.systemPrompt?.trim() || null : null].filter((entry) => Boolean(entry));
	return {
...
async function resolveSlackThreadContextData(params) {
	...
	const starterAllowed = !starter || isSlackThreadContextSenderAllowed({
	...
	if (starter?.text && !starterAllowed) logVerbose("slack: omitted non-allowlisted thread starter from context");
	...
	if (threadInitialHistoryLimit > 0 && !threadSessionPreviousTimestamp) {
		...
		if (threadHistory.length > 0) {
			...
			if (omittedHistoryCount > 0) logVerbose(`slack: omitted ${omittedHistoryCount} non-allowlisted thread message(s) from context`);
			const historyParts = [];
...
//#endregion
export { authorizeSlackSystemEventSender as a, isSlackChannelAllowedByPolicy as c, resolveSlackChannelLabel as d, buildSlackSlashCommandMatcher as f, resolveSlackThreadTargets as i, normalizeSlackChannelType as l, stripSlackMentionsForCommandDetection as m, resolveSlackRoomContextHints as n, resolveSlackEffectiveAllowFrom as o, resolveSlackSlashCommandConfig as p, authorizeSlackDirectMessage as r, createSlackMonitorContext as s, prepareSlackMessage as t, resolveSlackChannelConfig as u };

...
import { t as CONFIG_DIR } from "./utils-CE3P21nG.js";
import { r as logVerbose } from "./globals-BJZkpw-q.js";
import { d as isInboundPathAllowed, g as resolveIMessageRemoteAttachmentRoots } from "./zod-schema.providers-core-BJorTsd7.js";
import { i as normalizeScpRemotePath, r as normalizeScpRemoteHost } from "./scp-host-CmQvPMCZ.js";
import { r as copyFileWithinRoot, t as SafeOpenError } from "./fs-safe-Dv_jH6UN.js";
import { n as assertSandboxPath } from "./sandbox-paths-COznanRn.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DD2udaMP.js";
import { s as getMediaDir, t as MEDIA_MAX_BYTES } from "./store-CCBPdtW9.js";
...
function resolveRawPaths(ctx) {
	...
	return pathsFromArray && pathsFromArray.length > 0 ? pathsFromArray : ctx.MediaPath?.trim() ? [ctx.MediaPath.trim()] : [];
}

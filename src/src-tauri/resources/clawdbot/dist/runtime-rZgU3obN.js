...
import { d as setRuntimeConfigSnapshot, f as setRuntimeConfigSnapshotRefreshHandler, t as clearRuntimeConfigSnapshot } from "./runtime-snapshot-C5PRsFS9.js";
import { b as resolveAgentWorkspaceDir, g as listAgentIds, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
import "./config-yDDhhyz6.js";
import { c as loadAuthProfileStoreForSecretsRuntime, l as loadAuthProfileStoreWithoutExternalProfiles, t as clearRuntimeAuthProfileStoreSnapshots, u as replaceRuntimeAuthProfileStoreSnapshots } from "./store-CfHec0eX.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-Df60yWjf.js";
import "./auth-profiles-DFHxywz9.js";
import { n as getActiveRuntimeWebToolsMetadata$1, r as setActiveRuntimeWebToolsMetadata, t as clearActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-9Z222nvw.js";
...
function loadRuntimeManifestHelpers() {
	runtimeManifestPromise ??= import("./runtime-manifest.runtime-C4DUvtWe.js");
	return runtimeManifestPromise;
}
function loadRuntimePrepareHelpers() {
	runtimePreparePromise ??= import("./runtime-prepare.runtime-8gDrIS8W.js");
...
function hasRuntimeWebToolConfigSurface(config) {
	...
	if (web && typeof web === "object" && ("search" in web || "fetch" in web || "x_search" in web)) return true;
	const entries = config.plugins?.entries;
	if (!entries || typeof entries !== "object" || Array.isArray(entries)) return false;
	return Object.values(entries).some((entry) => {
		if (!entry || typeof entry !== "object" || Array.isArray(entry)) return false;
		const pluginConfig = entry.config;
		return !!pluginConfig && typeof pluginConfig === "object" && !Array.isArray(pluginConfig) && ("webSearch" in pluginConfig || "webFetch" in pluginConfig);
	});
}

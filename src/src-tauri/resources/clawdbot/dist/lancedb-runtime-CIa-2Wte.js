...
const MEMORY_LANCEDB_RUNTIME_MANIFEST = {
	...
	private: true,
	type: "module",
	dependencies: { "@lancedb/lancedb": resolveLanceDbDependencySpec(fileURLToPath(import.meta.url)) }
};

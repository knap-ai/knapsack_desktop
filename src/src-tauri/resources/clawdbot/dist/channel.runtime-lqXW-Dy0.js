...
import { a as createFeishuClient, d as resolveFeishuAccount, f as resolveFeishuRuntimeAccount, t as probeFeishu } from "./probe-Sr6ZihvE.js";
import { F as parseFeishuCommentTarget, c as getMessageFeishu, d as sendCardFeishu, f as sendMarkdownCardFeishu, i as sendMediaFeishu, k as replyComment, m as sendStructuredCardFeishu, p as sendMessageFeishu, s as editMessageFeishu } from "./media-Db1jTPI3.js";
...
import { a as getChatInfo, i as removeReactionFeishu, n as addReactionFeishu, o as getChatMembers, r as listReactionsFeishu, s as getFeishuMemberInfo } from "./reactions-Mn4in08V.js";
import fs from "fs";
...
async function sendCommentThreadReply(params) {
	...
	const result = await replyComment(createFeishuClient(resolveFeishuAccount({
		cfg: params.cfg,
		accountId: params.accountId
	})), {

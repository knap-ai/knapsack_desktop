...
import { $ as resolveStateDir, A as colorize, E as setVerbose, M as theme, h as defaultRuntime, j as isRich, o as createSubsystemLogger } from "./entry.js";
import { S as shortenHomePath, x as shortenHomeInString, y as resolveUserPath } from "./utils-q1rHOG-N.js";
...
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-hOA2wjjf.js";
import { t as formatDocsLink } from "./links-C_tOT2wV.js";
import { r as withManager } from "./cli-utils-r6pQ5iCT.js";
import { n as withProgress, r as withProgressTotals } from "./progress-C4IJwa0T.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-0gx4kHIk.js");
			...
			if (primary) {
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-D5ku6Y-s.js").then((n) => n.t);

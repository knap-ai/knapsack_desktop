import { Q as shouldLogVerbose, X as logVerbose, n as runExec } from "./exec-DBtWJ4Ld.js";
import { A as kindFromMime, E as getFileExtension, O as isAudioFileName, Y as normalizeChatType, w as detectMime } from "./image-ops-CQkyIkuI.js";
import { A as normalizeGoogleModelId, _ as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, r as requireApiKey, w as normalizeProviderId } from "./model-auth-BffKC6OJ.js";
import { n as loadConfig } from "./config-DAGaFnCt.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-CZapiPj9.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-BUVoWGPC.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-Cexg1XRf.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BcmZ1Ksr.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());

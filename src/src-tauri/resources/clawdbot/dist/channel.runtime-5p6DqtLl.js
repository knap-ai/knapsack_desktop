...
import "./accounts--dxGkLNw.js";
import "./runtime-api-CEfEZm3t.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DeHBVfsC.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-CoX9e1jR.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C7xd0ZiL.js");

...
import { d as createDefaultChannelRuntimeState, f as createDependentCredentialStatusIssueCollector, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "../../status-helpers-CtpWf3f1.js";
import { d as resolveOutboundMediaUrls } from "../../reply-payload-SzVz53hc.js";
...
import { A as processLineMessage, B as createImageCard, H as createListCard, J as resolveExactLineGroupConfigKey, L as createReceiptCard, Pt as probeLineBot, R as createActionCard, V as createInfoCard } from "../../runtime-api-Cus5OwFC.js";
import { n as lineSetupAdapter, r as hasLineCredentials, t as lineSetupWizard } from "../../setup-surface-DDy_ro_z.js";
import "../../api-CaLTXw2e2.js";
...
function validateLineMediaUrl(url) {
	let parsed;
	try {
		parsed = new URL(url);
	} catch {
...
async function resolveLineOutboundMedia(mediaUrl, opts = {}) {
	...
	if (isHttpsUrl(trimmedUrl)) {
		...
		if (previewImageUrl) validateLineMediaUrl(previewImageUrl);
		return {
			mediaUrl: trimmedUrl,
...
const lineStatusAdapter = createComputedAccountStatusAdapter({
	...
	probeAccount: async ({ account, timeoutMs }) => await probeLineBot(account.channelAccessToken, timeoutMs),

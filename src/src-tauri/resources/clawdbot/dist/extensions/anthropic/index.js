import { m as CLAUDE_CLI_PROFILE_ID } from "../../store-CY-e50gT.js";
import { t as cloneFirstTemplateModel } from "../../provider-model-shared-B0P3sbBu.js";
...
import { a as fetchClaudeUsage } from "../../provider-usage.fetch-M75Vjeyz.js";
...
import { a as normalizeSecretInputModeInput } from "../../provider-auth-input-cJfyGWtW.js";
import { i as validateAnthropicSetupToken, r as buildTokenProfileId } from "../../provider-auth-rTeK2_Yu.js";
...
import { n as hasClaudeCliAuth, t as buildAnthropicCliMigrationResult } from "../../cli-migration--Wm6YAgL.js";
import { t as anthropicMediaUnderstandingProvider } from "../../media-understanding-provider-B7I69vA8.js";
import { a as resolveAnthropicBetas, i as createAnthropicServiceTierWrapper, n as createAnthropicBetaHeadersWrapper, o as resolveAnthropicFastMode, r as createAnthropicFastModeWrapper, s as resolveAnthropicServiceTier } from "../../stream-wrappers-CepUgL54.js";
	...
	register(api) {
		...
		api.registerProvider({
			...
			wrapStreamFn: (ctx) => {
				...
				if (anthropicBetas?.length) streamFn = createAnthropicBetaHeadersWrapper(streamFn, anthropicBetas);
				const serviceTier = resolveAnthropicServiceTier(ctx.extraParams);
				if (serviceTier) streamFn = createAnthropicServiceTierWrapper(streamFn, serviceTier);
				const fastMode = resolveAnthropicFastMode(ctx.extraParams);
				if (fastMode !== void 0) streamFn = createAnthropicFastModeWrapper(streamFn, fastMode);
				return streamFn;
			},

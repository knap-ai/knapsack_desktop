...
import { a as resolveNostrAccount, c as getNostrRuntime, d as SimplePool, f as verifyEvent, l as setNostrRuntime, m as NostrProfileSchema, u as contentToProfile } from "../../setup-surface-5RDIvp92.js";
import { n as nostrPlugin, r as publishNostrProfile, t as getNostrProfileState } from "../../channel-CSDG9q3b.js";
...
const nip05FormatSchema = zod_exports.z.string().regex(/^[a-z0-9._-]+@[a-z0-9.-]+\.[a-z]{2,}$/i, "Invalid NIP-05 format (user@domain.com)").optional();
const lud16FormatSchema = zod_exports.z.string().regex(/^[a-z0-9._-]+@[a-z0-9.-]+\.[a-z]{2,}$/i, "Invalid Lightning address format").optional();
...
var nostr_default = defineChannelPluginEntry({
	id: "nostr",
	name: "Nostr",
...
//#endregion
export { nostr_default as default, nostrPlugin, setNostrRuntime };

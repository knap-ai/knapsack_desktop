import { a as collectStatusIssuesFromLastError, c as formatPairingApproveHint, i as buildChannelConfigSchema, l as resolveInboundDirectDmAccessWithRuntime, n as NostrProfileSchema, o as createDefaultChannelRuntimeState, r as DEFAULT_ACCOUNT_ID, s as createPreCryptoDirectDmAuthorizer, t as NostrConfigSchema } from "./config-schema-BHVpbt7_.js";
import { t as DEFAULT_RELAYS } from "./default-relays-DLwdWOTu.js";
import { a as resolveDefaultNostrAccountId, c as validatePrivateKey, i as listNostrAccountIds, n as nostrSetupWizard, o as resolveNostrAccount, s as normalizePubkey, t as nostrSetupAdapter } from "./setup-surface-GW7xrEvH.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-BPvuxgOz.js");

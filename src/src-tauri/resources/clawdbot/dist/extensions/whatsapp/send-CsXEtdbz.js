...
import { a as markdownToWhatsApp, s as toWhatsappJid } from "./text-runtime-BvOFWrFo.js";
import { a as resolveWhatsAppOutboundMediaUrls, r as normalizeWhatsAppPayloadText, t as normalizeWhatsAppLoadedMedia } from "./outbound-media-contract--dg4rsHm.js";
...
async function sendMessageWhatsApp(to, body, options) {
	...
	try {
		...
		if (primaryMediaUrl) {
			const media = normalizeWhatsAppLoadedMedia(await loadOutboundMediaFromUrl(primaryMediaUrl, {

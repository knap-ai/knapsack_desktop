...
import { d as isRecord$1, s as resolveFeishuRuntimeAccount } from "./accounts-DJRdWYvk.js";
...
function isMentionForwardRequest(event, botOpenId) {
	...
	return mentions.some((m) => m.id.open_id === botOpenId) && hasOtherMention;
}
/**
...
//#endregion
export { sendCardFeishu as a, sendStructuredCardFeishu as c, extractMentionTargets as d, isMentionForwardRequest as f, normalizeFeishuExternalKey as g, sendMediaFeishu as h, resolveFeishuCardTemplate as i, parsePostContent as l, downloadMessageResourceFeishu as m, getMessageFeishu as n, sendMarkdownCardFeishu as o, isFeishuGroupChatType as p, listFeishuThreadMessages as r, sendMessageFeishu as s, editMessageFeishu as t, buildMentionedCardContent as u };

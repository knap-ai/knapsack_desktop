...
import { c as listEnabledFeishuAccounts, t as probeFeishu } from "../../probe-Sr6ZihvE.js";
import { A as jsonToolResult, B as resolveFeishuToolAccount, C as formatMentionAllForText, E as isMentionForwardRequest, I as getFeishuRuntime, L as setFeishuRuntime, M as unknownToolActionResult, O as registerFeishuDriveTools, R as createFeishuToolClient, S as formatMentionAllForCard, T as formatMentionForText, a as uploadFileFeishu, b as extractMentionTargets, c as getMessageFeishu, d as sendCardFeishu, h as updateCardFeishu, i as sendMediaFeishu, j as toolExecutionErrorResult, n as sendFileFeishu, o as uploadImageFeishu, p as sendMessageFeishu, r as sendImageFeishu, s as editMessageFeishu, v as buildMentionedCardContent, w as formatMentionForCard, x as extractMessageBody, y as buildMentionedMessage, z as resolveAnyEnabledFeishuToolsConfig } from "../../media-Db1jTPI3.js";
import { n as normalizeFeishuTarget } from "../../targets-DLSGBpV_.js";
import { t as feishuPlugin } from "../../channel-CmHlWwef.js";
import { n as parseFeishuConversationId, t as buildFeishuConversationId } from "../../conversation-id-ClQYe69f.js";
import { c as registerFeishuChatTools, i as removeReactionFeishu, n as addReactionFeishu, r as listReactionsFeishu, t as FeishuEmoji } from "../../reactions-Mn4in08V.js";
import { r as getFeishuThreadBindingManager } from "../../thread-bindings-CQbJwC7k.js";
...
function normalizeConvertedBlockTree(blocks, firstLevelIds) {
	...
	}).sort((a, b) => (originalOrder.get(a.block_id ?? "__missing__") ?? 0) - (originalOrder.get(b.block_id ?? "__missing__") ?? 0)).map((block) => block.block_id).filter((blockId) => typeof blockId === "string");
...
function loadFeishuMonitorModule() {
	feishuMonitorPromise ??= import("../../monitor-Bkbv5nYZ.js");

import { a as resolveSlackAccount, c as resolveSlackBotToken, s as resolveSlackAppToken } from "./accounts-pcULq2gv.js";
import { i as isSlackExecApprovalClientEnabled, n as isSlackExecApprovalApprover, r as isSlackExecApprovalAuthorizedSender } from "./exec-approvals-BppKvxNZ.js";
import { r as truncateSlackText } from "./blocks-render-BwIQdgQ5.js";
import { c as resolveSlackWebClientOptions } from "./client-D_RPbTBS.js";
import { n as normalizeAllowList, o as resolveSlackAllowListMatch, s as resolveSlackUserAllowed } from "./allow-list-GR9Gx-es.js";
...
import { D as stripSlackMentionsForCommandDetection, E as resolveSlackSlashCommandConfig, T as buildSlackSlashCommandMatcher, _ as loadConfig$1, b as resolveDefaultGroupPolicy, c as authorizeSlackSystemEventSender, d as isSlackChannelAllowedByPolicy, f as normalizeSlackChannelType, g as isDangerousNameMatchingEnabled, h as resolveSlackChannelLabel, i as parsePluginBindingApprovalCustomId, l as resolveSlackEffectiveAllowFrom, m as resolveSlackChannelConfig, n as authorizeSlackDirectMessage, p as resolveSlackChatType, r as buildPluginBindingResolvedText, s as resolvePluginConversationBindingApproval, t as resolveSlackRoomContextHints, u as createSlackMonitorContext, w as warnMissingProviderGroupPolicyFallbackOnce, x as resolveOpenProviderRuntimeGroupPolicy } from "./room-context-BEHuA2F1.js";
import { t as escapeSlackMrkdwn } from "./mrkdwn-18IzcEAY.js";
import { normalizeResolvedSecretInputString } from "openclaw/plugin-sdk/secret-input";
import { chunkItems, normalizeLowercaseStringOrEmpty, normalizeOptionalString, normalizeStringEntries } from "openclaw/plugin-sdk/text-runtime";
import { normalizeAccountId, normalizeMainKey } from "openclaw/plugin-sdk/routing";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "openclaw/plugin-sdk/approval-handler-adapter-runtime";
import { enqueueSystemEvent, generateSecureToken, parseExecApprovalCommandText } from "openclaw/plugin-sdk/infra-runtime";
...
import { loadConfig, resolveNativeCommandsEnabled, resolveNativeSkillsEnabled, writeConfigFile } from "openclaw/plugin-sdk/config-runtime";
...
function collectBlockUserIds(candidates, value, botUserId) {
	if (Array.isArray(value)) {
		for (const entry of value) collectBlockUserIds(candidates, entry, botUserId);
		return;
	}
...
function loadSlackMessagePipeline() {
	slackMessagePipelinePromise ??= import("./pipeline.runtime-hODDbdYS.js");
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-BAwD7fNo.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-CF4YZPdO.js");
	return slashDispatchRuntimePromise;
}
function loadSlackPluginCommandsRuntime() {
	slackPluginCommandsRuntimePromise ??= import("./slash-plugin-commands.runtime-CTn5PcCC.js");
	return slackPluginCommandsRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-Cg702d_2.js");
...
function buildSlackCommandArgMenuBlocks(params) {
	...
	}] : encodedChoices.length <= SLACK_COMMAND_ARG_BUTTON_ROW_SIZE || !canUseStaticSelect ? chunkItems(encodedChoices, SLACK_COMMAND_ARG_BUTTON_ROW_SIZE).map((choices, rowIndex) => ({
		type: "actions",
...
async function monitorSlackProvider(opts = {}) {
	const cfg = opts.config ?? loadConfig$1();

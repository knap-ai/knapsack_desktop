import { i as resolveSlackChannelId, r as parseSlackTarget } from "./target-parsing-CugsYhBQ.js";
import "./targets-C5NeqQJr.js";
import { i as parseSlackBlocksInput } from "./thread-ts-ks-O8cEG.js";
import { a as readNumberParam, c as withNormalizedTimestamp, n as imageResultFromFile, o as readReactionParams, r as jsonResult, s as readStringParam, t as createActionGate } from "./runtime-api-erJbVGdt.js";
...
function loadSlackActionsRuntime() {
	slackActionsRuntimePromise ??= import("./actions.runtime-PJlqQp0N.js");
...
function assertSlackReadTargetAllowed(params) {
	...
	if (groupPolicy === "disabled" || groupPolicy === "allowlist" && !isSlackChannelAllowedByPolicy({
		groupPolicy,
		channelAllowlistConfigured: channelKeys.length > 0,
		channelAllowed
	})) throw new Error("Slack read target channel is not allowed.");
	if (!channelAllowed && (groupPolicy !== "open" || channelConfig?.matchSource)) throw new Error("Slack read target channel is not allowed.");
}

...
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-_3Knafue.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-DWW7yULa.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-CfFESeq1.js").then((n) => n.n).then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));

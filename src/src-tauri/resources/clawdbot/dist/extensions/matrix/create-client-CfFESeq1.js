...
import { a as resolveMatrixStoragePaths, n as maybeMigrateLegacyStorage, o as writeStorageMeta } from "./storage-D6aZiFNy.js";
import "./config-DWW7yULa.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-w4oFBZGT.js").then((n) => n.n), import("./logging-C_ZM4Xts.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({

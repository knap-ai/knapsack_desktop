...
import { o as isRecord } from "./account-selection-CgvQn_T8.js";
import { n as formatMatrixErrorReason, r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-MCQHf07j.js";
import { t as claimCurrentTokenStorageState } from "./storage-D6aZiFNy.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-DCSlgaaM.js";
import { t as createAsyncLock } from "./async-lock-hEU0xcd9.js";
import { n as LogService, r as noop, t as ConsoleLogger } from "./logger-DsQxmf2q.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-C_ZM4Xts.js";
import { a as matrixEventToRaw, n as createMatrixGuardedFetch, o as parseMxc, t as MatrixAuthedHttpClient } from "./http-client-CEqdqZvn.js";
import { n as isRepairableSecretStorageAccessError, r as MATRIX_IDB_PERSIST_INTERVAL_MS, t as MatrixRecoveryKeyStore } from "./recovery-key-store-If4OMiPE.js";
import { i as throwIfMatrixStartupAborted, n as createMatrixStartupAbortError } from "./startup-abort-_3Knafue.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState } from "./sync-state-DPh6d4dE.js";
...
async function loadMatrixCryptoRuntime() {
	matrixCryptoRuntimePromise ??= import("./crypto-runtime-BadF_8oL.js").then((runtime) => {
...
var MatrixClient = class {
	...
	async verifyWithRecoveryKey(rawRecoveryKey) {
		...
		try {
			...
			const stagedRecoveryKeyValidated = stagedRecoveryKeyUsed && (stagedRecoveryKeyConfirmedBySecretStorage || stagedRecoveryKeyUsed && !stagedRecoveryKeyRejectedBySecretStorage && !stagedRecoveryKeyConfirmedBySecretStorage && !backupUsableBeforeStagedRecovery && backupUsable);
	...
	async bootstrapOwnDeviceVerification(params) {
		...
		try {
			...
			bootstrapSummary = await cryptoBootstrapper.bootstrap(crypto, createMatrixExplicitBootstrapOptions(params));

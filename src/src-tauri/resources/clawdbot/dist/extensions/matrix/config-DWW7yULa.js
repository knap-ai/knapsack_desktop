import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-By89QtsX.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, s as resolveMatrixAccountStringValues } from "./account-selection-CgvQn_T8.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-KF01E9CM.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-CZGZEhLW.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-bmPgwEoA.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BVkbI4aP.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-D6aZiFNy.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-w4oFBZGT.js").then((n) => n.n), import("./logging-C_ZM4Xts.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BxVB78LN.js").then((n) => n.r).then((credentialsReadModule) => ({
...
async function loadMatrixCredentialsWriteRuntime() {
	matrixCredentialsWriteRuntimePromise ??= import("./credentials-write.runtime-D5mZ4i4v.js");
	return await matrixCredentialsWriteRuntimePromise;
}
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-BpdGvD7V.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));

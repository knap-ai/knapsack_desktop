...
import { t as getActiveMatrixClient } from "./active-client-pgPkqpeo.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CoQVU3PI.js").then((n) => n.t), import("./shared-BFRSFfvf.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({

import { a as resolveMatrixAccountConfig, i as resolveMatrixAccountAllowlistConfig } from "./account-config-By89QtsX.js";
import { t as isMatrixQualifiedUserId } from "./target-ids-DEm-icmP.js";
import { t as getMatrixRuntime } from "./runtime-CvAfSP12.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-BQVKwQa7.js";
import { n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-D6QTM9hQ.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-MCQHf07j.js";
import { a as canonicalizeAllowlistWithResolvedIds, c as formatAllowlistMatchMeta, d as logInboundDrop, f as logTypingFailure, h as toLocationContext, i as buildAllowlistResolutionSummary, l as formatLocationText, m as summarizeMapping, n as resolveMatrixRoomConfig, o as createReplyPrefixOptions, p as patchAllowlistUsersInConfigEntries, r as addAllowlistUserEntriesFromConfigEntry, s as createTypingCallbacks, t as resolveMatrixStoredSessionMeta, u as getAgentScopedMediaLocalRoots } from "./session-store-metadata-D7qcyZt6.js";
import { i as resolveMatrixStateFilePath } from "./storage-D6aZiFNy.js";
import { a as sendMessageMatrix, g as isPollStartType, h as isPollEventType, p as formatPollAsText, t as chunkMatrixText, v as parsePollStartContent } from "./send-BBVkqf3C.js";
import { i as promoteMatrixDirectRoomCandidate, s as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY } from "./direct-management-DgL9p3M_.js";
import { i as isStrictDirectMembership, n as hasDirectMatrixMemberFlag, o as readJoinedMatrixMembers } from "./direct-room-Da_xiZDy.js";
...
import { n as LogService } from "./logger-DsQxmf2q.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-CEqdqZvn.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-_3Knafue.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-DPh6d4dE.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-BKo9mxr0.js";
import { n as setActiveMatrixClient } from "./active-client-pgPkqpeo.js";
import { t as isBunRuntime } from "./runtime-tgnRzJQh.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-DWW7yULa.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-BFRSFfvf.js";
import "./client-CoQVU3PI.js";
import { f as resolveThreadBindingIdleTimeoutMsForChannel, l as resolveAllowlistProviderRuntimeGroupPolicy, m as warnMissingProviderGroupPolicyFallbackOnce, p as resolveThreadBindingMaxAgeMsForChannel, t as GROUP_POLICY_BLOCKED_LABEL, u as resolveDefaultGroupPolicy } from "./runtime-api-DAEfcFEA.js";
import { t as resolveMatrixTargets } from "./resolve-targets-BjlGwTOq.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-zTcuVe8M.js";
import { a as EventType, i as resolveMatrixThreadRouting, n as resolveMatrixReplyToEventId, o as RelationType, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-M-d36nCD.js";
...
function resolveMatrixMonitorAccessState(params) {
	const effectiveAllowFrom = normalizeMatrixAllowList([...normalizeMatrixAllowList(params.allowFrom), ...params.storeAllowFrom]);
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-DgL9p3M_.js").then((n) => n.t), import("./direct-room-Da_xiZDy.js").then((n) => n.t)]).then(([directManagementModule, directRoomModule]) => ({
...
function loadMatrixSendModule() {
	matrixSendModulePromise ??= import("./send-BBVkqf3C.js").then((n) => n.l);
...
function loadMatrixReactionEvents() {
	matrixReactionEventsPromise ??= import("./reaction-events-iK2R4iFQ.js");
	return matrixReactionEventsPromise;
}
function loadMatrixDraftStream() {
	matrixDraftStreamPromise ??= import("./draft-stream-KCeQtL9q.js");
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-BMbWC21C.js").then((n) => n.t),
		import("./device-health-CBpA1E9B.js"),
		import("./profile-FSes1x72.js").then((n) => n.n),
		import("./legacy-crypto-restore-CcaRz4m8.js"),
		import("./startup-verification-zn8KAcPi.js")
...
async function monitorMatrixProvider(opts = {}) {
	...
	const streaming = accountConfig.streaming === true || accountConfig.streaming === "partial" ? "partial" : accountConfig.streaming === "quiet" ? "quiet" : "off";

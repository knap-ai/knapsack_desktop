...
import { a as extractMatrixReactionAnnotation } from "./reaction-common-bWVqKJFO.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTarget } from "./approval-reactions-C7zfd3H-.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-M-d36nCD.js";
...
function loadApprovalReactionAuth() {
	approvalReactionAuthPromise ??= import("./approval-reaction-auth-X88P6SMw.js");
	return approvalReactionAuthPromise;
}
function loadExecApprovalResolver() {
	execApprovalResolverPromise ??= import("./exec-approval-resolver-CSaVwAEX.js");

import { a as sendMessageMatrix, c as sendTypingMatrix, o as sendPollMatrix } from "./send-BBVkqf3C.js";
import { t as isBunRuntime } from "./runtime-tgnRzJQh.js";
import { n as resolveMatrixAuth } from "./config-DWW7yULa.js";
import "./client-CoQVU3PI.js";
import { n as listMatrixDirectoryGroupsLive, r as listMatrixDirectoryPeersLive } from "./directory-live-DIAzmKoi.js";
import { d as resolveOutboundSendDep, n as chunkTextForOutbound } from "./runtime-api-DAEfcFEA.js";
...
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-CdVaNHYK.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));

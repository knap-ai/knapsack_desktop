...
import { n as isDangerousNetworkMode, r as normalizeNetworkMode } from "./network-mode-O6UFjmuq.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { a as resolveGatewayAuth } from "./auth-BHAc3x7O.js";
import { n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-Fnf3A9Vj.js";
...
import { u as getBlockedBindReason } from "./docker-C1RKnBmq.js";
import { i as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-BnGxT41w.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-Du04rcS6.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-CZBYj4Ke.js";
import { a as collectSandboxBrowserHashLabelFindings, c as readConfigSnapshotForAudit, i as collectPluginsTrustFindings, o as collectStateDeepFilesystemFindings, s as collectWorkspaceSkillSymlinkEscapeFindings, t as collectIncludeFilePermFindings } from "./audit-extra.async-_6_gAT3C.js";
//#region src/plugins/bundled-web-search-registry.ts
function hasConfiguredCredentialValue(value) {
	if (typeof value === "string") return value.trim().length > 0;
	return value !== void 0 && value !== null;
}
function hasBundledWebSearchCredential(params) {
...
function hasWebSearchKey(cfg, env) {
	return hasBundledWebSearchCredential({
		config: cfg,
		env
	});
}

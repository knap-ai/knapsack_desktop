import { a as parseSessionArchiveTimestamp, i as isUsageCountedSessionTranscriptFileName, n as isPrimarySessionTranscriptFileName, o as parseUsageCountedSessionIdFromFileName, r as isSessionArchiveArtifactName } from "./artifacts-DtJnd71X.js";
import { c as resolveSessionTranscriptsDirForAgent, r as resolveSessionFilePath } from "./paths-DBIQqSpZ.js";
import { i as extractToolCallNames, n as stripMessageIdHints, r as countToolResults, t as stripEnvelope, u as normalizeUsage } from "./chat-envelope-BIAAz1Jw.js";
...
function resolveExistingUsageSessionFile(params) {
	...
	try {
		...
		const entries = fsSync.readdirSync(sessionsDir, { withFileTypes: true }).filter((entry) => {

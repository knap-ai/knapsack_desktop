import { d as readNumberParam, h as readStringParam, l as parseAvailableTags, p as readStringArrayParam } from "./common-RGbDbB5n.js";
...
import { a as readDiscordParentIdParam, n as isDiscordModerationAction, r as readDiscordModerationCommand, t as handleDiscordAction } from "./action-runtime-api-DD-76vf1.js";
...
async function handleDiscordMessageAction(ctx) {
	...
	if (action === "send") {
		...
		const rawComponents = params.components ?? buildDiscordInteractiveComponents(normalizeInteractiveReply(params.interactive));

...
import { b as normalizeModelRef, r as buildConfiguredModelCatalog, y as modelKey } from "./model-selection-shared-grYiFZof.js";
import { c as resolvePersistedOverrideModelRef, p as resolveThinkingDefault, t as buildAllowedModelSet, u as resolveReasoningDefault } from "./model-selection-hTT37jzm.js";
...
import "./model-selection-directive-ziVuWeP7.js";
...
async function createModelSelectionState(params) {
	...
	const hadDirectAutoSessionOverride = sessionEntry?.modelOverrideSource === "auto" && Boolean(directStoredOverride);
	...
	if (sessionEntry && sessionStore && sessionKey && directStoredOverride && !hadDirectAutoSessionOverride) {
	...
	const storedOverride = hadDirectAutoSessionOverride ? void 0 : resolveStoredModelOverride({
		sessionEntry,
		sessionStore,
		sessionKey,
		parentSessionKey,

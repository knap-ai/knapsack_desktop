...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BcN30fL1.js";
import "./webhook-ingress-S9T0oiq6.js";
import { g as resolveRealtimeVoiceAgentConsultToolsAllow, h as resolveRealtimeVoiceAgentConsultTools, s as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./provider-resolver-DacJ9YDL.js";
import { s as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-0bAg9EuU.js";
...
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-ClpQmXwG.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DifxySLa.js";
import { t as resolveVoiceResponseModel } from "./response-model-C5hwFeOx.js";
import { t as isProviderStatusTerminal } from "./call-status-Dv0yhC7z.js";
import { t as getHeader } from "./http-headers-BvvYt5kv.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-BamTFYYD.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-DCQFeeBv.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-gg7sZKAy.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-DagshQOZ.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-B2zR1oKk.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-BCUZ_jXU.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-BUgFmneh.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-CTvvTaoL.js");

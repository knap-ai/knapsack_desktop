...
import { Db as formatAllowFromLowercase, Jb as adaptScopedAccountAccessor, Nx as createAllowlistProviderGroupPolicyWarningCollector, Ux as projectConfigAccountIdWarningCollector, Vb as createChatChannelPlugin, Wb as stripChannelTargetPrefix, Yb as createHybridChannelConfigAdapter, zb as buildChannelOutboundSessionRoute } from "./pi-embedded-CbCYZxIb.js";
...
import { i as createActionGate } from "./common-zReYuoMM.js";
import { n as createMessageToolCardSchema } from "./channel-actions-fV93bLjV.js";
...
import { i as buildProbeChannelStatusSummary, l as createComputedAccountStatusAdapter, u as createDefaultChannelRuntimeState } from "./status-helpers-Cflmo90d.js";
...
import { c as listEnabledFeishuAccounts, d as resolveFeishuAccount, f as resolveFeishuCredentials, i as createFeishuClient, l as listFeishuAccountIds, p as feishuSetupAdapter, t as feishuSetupWizard, u as resolveDefaultFeishuAccountId } from "./setup-surface-DM-pV9Ix.js";
import { a as parseFeishuConversationId } from "./api-Br05XeQp.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-fsOjlmjW.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-zlBKePf0.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-CC9rXiKf.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-D3Akxjuj.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-DqRx65hG.js");
			const account = resolveFeishuAccount({
				cfg: ctx.cfg,

...
import { l as listDeliverableMessageChannels } from "./message-channel-C2Lnao8s.js";
import { n as resolveChannelApprovalCapability } from "./plugins-BZ_I3cWH.js";
import { t as buildMemoryPromptSection } from "./memory-state-I5DhT9-V.js";
import { n as normalizeStructuredPromptSection, t as normalizePromptCapabilityIds } from "./prompt-cache-stability-D3r6Fd59.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-C_v_J0E7.js";
import { t as SYSTEM_PROMPT_CACHE_BOUNDARY } from "./system-prompt-cache-boundary-CeY_ZCdW.js";
import { n as buildLimitedBootstrapPromptLines, t as buildFullBootstrapPromptLines } from "./bootstrap-prompt-Cux0yGJR.js";
...
function buildAgentUserPromptPrefix(params) {
	if (!params.bootstrapMode || params.bootstrapMode === "none") return;
	if (params.bootstrapMode === "limited") return ["[Bootstrap pending]", ...buildLimitedBootstrapPromptLines({
	...
	return ["[Bootstrap pending]", ...buildFullBootstrapPromptLines({
...
//#endregion
export { wrapUntrustedPromptDataBlock as i, buildAgentUserPromptPrefix as n, sanitizeForPromptLiteral as r, buildAgentSystemPrompt as t };

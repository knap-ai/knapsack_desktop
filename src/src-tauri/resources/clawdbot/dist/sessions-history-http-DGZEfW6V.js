...
import { c as stripEnvelopeFromMessages, i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BDLex3kU.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-rIur1Jet.js";
import { d as resolveGatewaySessionStoreTarget, l as resolveFreshestSessionEntryFromStoreKeys } from "./session-utils-0WhEvb4B.js";
...
import { S as sendMethodNotAllowed, a as checkGatewayHttpRequestAuth, b as sendInvalidRequest, h as resolveTrustedHttpOperatorScopes, i as authorizeScopedGatewayHttpRequestOrReply, s as getHeader, w as setSseHeaders, x as sendJson } from "./http-utils-RmXZN896.js";
import { c as sanitizeChatHistoryMessages, n as DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS } from "./chat-DznnoAn8.js";
...
function shouldHideSanitizedHistoryMessage(message) {
...
function filterVisibleSessionHistoryMessages(messages) {
...
function buildSessionHistorySnapshot(params) {
	const history = paginateSessionMessages(filterVisibleSessionHistoryMessages(toSessionHistoryMessages(sanitizeChatHistoryMessages(stripEnvelopeFromMessages(params.rawMessages), params.maxChars ?? 8e3))), params.limit, params.cursor);
...
var SessionHistorySseState = class SessionHistorySseState {
	...
	appendInlineMessage(update) {
		...
		const sanitized = sanitizeChatHistoryMessages(stripEnvelopeFromMessages([attachOpenClawTranscriptMeta(update.message, {
		...
		if (shouldHideSanitizedHistoryMessage(sanitizedMessage)) return null;

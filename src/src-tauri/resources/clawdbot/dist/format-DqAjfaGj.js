...
import { T as resolveTelegramPreviewStreamMode } from "./zod-schema.providers-core-BJorTsd7.js";
import "./routing-Br1fEo8A.js";
import { i as markdownToIR, n as renderMarkdownWithMarkers } from "./tables-Dmh1EQ3k.js";
...
import { a as isAutoLinkedFileRef, c as renderMarkdownIRChunksWithinLimit, i as FILE_REF_EXTENSIONS_WITH_TLD } from "./text-runtime-B0ZpmkER.js";
import "./channel-inbound-BTUonbdp.js";
import { t as formatLocationText } from "./location-ZVNxeZlc.js";
...
function describeReplyTarget(msg) {
	...
	if (!body && replyLike) {
		body = (typeof replyLike.text === "string" ? replyLike.text : typeof replyLike.caption === "string" ? replyLike.caption : "").trim();
		if (!body) {
...
//#endregion
export { hasBotMention as A, resolveTelegramThreadSpec as C, expandTextLinks as D, buildSenderName as E, parseTelegramThreadId as F, isSenderAllowed as I, normalizeAllowFrom as L, resolveTelegramMediaPlaceholder as M, normalizeTelegramReplyToMessageId as N, extractTelegramLocation as O, parseTelegramReplyToMessageId as P, normalizeDmAllowFromWithStore as R, resolveTelegramStreamMode as S, buildSenderLabel as T, resolveTelegramDirectPeerId as _, splitTelegramHtmlChunks as a, resolveTelegramGroupAllowFromContext as b, buildGroupLabel as c, buildTelegramParentPeer as d, buildTelegramRoutingTarget as f, extractTelegramForumFlag as g, describeReplyTarget as h, renderTelegramHtmlText as i, normalizeForwardedContext as j, getTelegramTextParts as k, buildTelegramGroupFrom as l, buildTypingThreadParams as m, markdownToTelegramHtml as n, wrapFileReferencesInHtml as o, buildTelegramThreadParams as p, markdownToTelegramHtmlChunks as r, withTelegramApiErrorLogging as s, markdownToTelegramChunks as t, buildTelegramGroupPeerId as u, resolveTelegramForumFlag as v, withResolvedTelegramForumFlag as w, resolveTelegramReplyId as x, resolveTelegramForumThreadId as y, resolveSenderAllowMatch as z };

import { c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID } from "./session-key-DAhnzjyr.js";
import { d as readConfigFileSnapshot } from "./io-y3Az_Onx.js";
...
async function requireValidConfigSnapshot(runtime, opts) {
	...
	if (opts?.includeCompatibilityAdvisory !== true) return snapshot.config;

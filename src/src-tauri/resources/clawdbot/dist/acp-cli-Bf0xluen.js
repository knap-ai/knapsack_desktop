...
import { f as isKnownCoreToolId, o as resolveOwnerOnlyToolApprovalClass } from "./tool-policy-Bk9WQZ0U.js";
import { r as listThinkingLevels } from "./thinking-EUyzvAQE.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-Bwy9t01K.js";
import { r as isMutatingToolCall } from "./tool-mutation-rkZbEuDz.js";
...
function resolveToolPathCandidate(params, toolName, toolTitle) {
	return readFirstStringValue(asRecord$1(params.toolCall?.rawInput), [
		"path",
		"file_path",
		"filePath"
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-lvEGvI4T.js");

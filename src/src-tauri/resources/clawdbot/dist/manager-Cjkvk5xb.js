...
import { b as truncateUtf16Safe, m as resolveUserPath } from "./utils-BMRcljdi.js";
...
import { t as extractKeywords } from "./query-expansion-Dqgt2KXp.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-EMv6JYvR.js";
...
import { a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-Difqhfo-.js";
import { r as readMemoryFile } from "./backend-config-DWb1FQZG.js";
import { n as listMemoryEmbeddingProviders, r as listRegisteredMemoryEmbeddingProviderAdapters, t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-CqvSqd7e.js";
import { D as createLocalEmbeddingProvider, E as DEFAULT_LOCAL_MODEL, u as enforceEmbeddingMaxInputTokens } from "./engine-embeddings-DVkdyn0v.js";
import "./memory-core-host-engine-embeddings-B2MLAYLv.js";
import "./memory-core-host-engine-foundation-BEn33BmU.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, p as sessionPathForFile } from "./engine-qmd-BblS7k9c.js";
import "./memory-core-host-engine-qmd-CvttOYTZ.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./engine-storage-CWTuzLn8.js";
import "./memory-core-host-engine-storage-BFdwU_xu.js";
import "./provider-env-vars-CSsXhd6g.js";
...
function formatLocalSetupError(err) {
	...
	return [
		...
		missing ? `2) Install optional local embedding runtime next to OpenClaw: npm i -g ${NODE_LLAMA_CPP_INSTALL_SPEC}` : null,

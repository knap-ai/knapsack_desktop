...
import { _ as shortenHomePath, m as resolveUserPath } from "./utils-BMRcljdi.js";
import { n as defaultRuntime } from "./runtime-Dx7oeLYq.js";
import { d as setConsoleTimestampPrefix, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-CWI_MDy_.js";
...
import { _ as resolveStateDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-BG0ad0P6.js";
import { d as resolveGatewayLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-CT9AMIex.js";
import { o as hasConfiguredSecretInput } from "./types.secrets-Zn5Zyn7M.js";
import "./globals-DeRFSEIV.js";
import { n as isContainerEnvironment, t as defaultGatewayBindMode } from "./net-AycWGi8-.js";
import "./auth-CksiX7Zk.js";
import { n as resolveGatewayAuth } from "./auth-resolve-D9xbkIJh.js";
import { a as loadConfig, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, l as readBestEffortConfig, r as createConfigIO, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-Dv_xNAZB.js";
import { b as resolveWorkspaceTemplateDir, v as resolveDefaultAgentWorkspaceDir } from "./workspace-DiB6mKpP.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-D1NntQbq.js";
...
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES } from "./message-channel-C2Lnao8s.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-B716cKY1.js";
import { r as callGateway } from "./call-Gv9tybWD.js";
import { d as writeRestartSentinel } from "./restart-sentinel-C0D17vX5.js";
import { a as markGatewaySigusr1RestartHandled, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart, t as consumeGatewaySigusr1RestartAuthorization } from "./restart-BEePx4vW.js";
import { d as waitForActiveEmbeddedRuns, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun } from "./runs-D_jbdUDe.js";
import { _ as selectDiagnosticStabilitySnapshot, f as writeDiagnosticStabilityBundleForFailureSync, h as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-bundle-CqC59U0o.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-CHQvQw9J.js";
import { n as withProgress } from "./progress-DAY5yFVV.js";
import { n as runCommandWithRuntime } from "./cli-utils-CsLPn__A.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-BQQnUD0r.js";
import { t as formatHelpExamples } from "./help-format-Cn2mAwEx.js";
import { t as readSecretFromFile } from "./secret-file-CCJaitZB.js";
import { n as buildGatewayDiscoveryTarget } from "./gateway-discovery-targets-Cfe9yFe3.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-2BY8uGhf.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-PD4D5_no.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-nuNcYEL3.js";
import { o as handleReset } from "./onboard-helpers-BO_Xr0ZZ.js";
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-BZ0owwGT.js")));
...
function loadConfigModule() {
	configModulePromise ??= import("./read-best-effort-config.runtime-Cvby7t5t.js");
	return configModulePromise;
}
function loadGatewayStatusModule() {
	gatewayStatusModulePromise ??= import("./gateway-status-M6gaXwpM.js");
	return gatewayStatusModulePromise;
}
function loadGatewayHealthModule() {
	gatewayHealthModulePromise ??= import("./health-DuxneEcM.js");
	return gatewayHealthModulePromise;
}
function loadBonjourDiscoveryModule() {
	bonjourDiscoveryModulePromise ??= import("./bonjour-discovery-C9zNQYdh.js");
	return bonjourDiscoveryModulePromise;
}
function loadWideAreaDnsModule() {
	wideAreaDnsModulePromise ??= import("./widearea-dns-DU4TZKmi.js");
	return wideAreaDnsModulePromise;
}
function loadHealthStyleModule() {
	healthStyleModulePromise ??= import("./health-style-Dz3z1ho3.js");
	return healthStyleModulePromise;
}
function loadUsageFormatModule() {
	usageFormatModulePromise ??= import("./usage-format-DtwePY-U.js");
	return usageFormatModulePromise;
}
function loadStabilityBundleModule() {
	stabilityBundleModulePromise ??= import("./diagnostic-stability-bundle-DvKeN2wq.js");
	return stabilityBundleModulePromise;
}
function loadSupportExportModule() {
	supportExportModulePromise ??= import("./diagnostic-support-export-BhGznBVq.js");
	return supportExportModulePromise;
}
function loadDaemonStatusGatherModule() {
	daemonStatusGatherModulePromise ??= import("./status.gather-B9aoTiPo.js");

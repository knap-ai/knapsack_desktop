...
const XAI_DEFAULT_CONTEXT_WINDOW = 256e3;
...
function buildXaiModelDefinition() {
	return toModelDefinition(XAI_MODEL_CATALOG.find((entry) => entry.id === "grok-4") ?? {
		id: "grok-4",
		name: "Grok 4",
		reasoning: false,
		input: ["text"],
...
function resolveXaiCatalogEntry(modelId) {
	...
	if (lower.startsWith("grok-4.20") || lower.startsWith("grok-4-1") || lower.startsWith("grok-4-fast")) return toModelDefinition({
		id: trimmed,
		name: trimmed,
...
//#endregion
export { XAI_DEFAULT_MAX_TOKENS as a, XAI_IMAGE_MODELS as c, XAI_LEGACY_MAX_TOKENS as d, buildXaiCatalogModels as f, XAI_DEFAULT_IMAGE_MODEL as i, XAI_LARGE_CONTEXT_WINDOW as l, resolveXaiCatalogEntry as m, XAI_CODE_CONTEXT_WINDOW as n, XAI_DEFAULT_MODEL_ID as o, buildXaiModelDefinition as p, XAI_DEFAULT_CONTEXT_WINDOW as r, XAI_DEFAULT_MODEL_REF as s, XAI_BASE_URL as t, XAI_LEGACY_CONTEXT_WINDOW as u };

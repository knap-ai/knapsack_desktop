import { r as __exportAll, t as __commonJSMin } from "./chunk-iyeSoAlh.js";
...
const _DRIVE_LETTER_START_RE$2 = /^[A-Za-z]:\//;
function normalizeWindowsPath$2(input = "") {
	if (!input) return input;
	return input.replace(/\\/g, "/").replace(_DRIVE_LETTER_START_RE$2, (r) => r.toUpperCase());
}
...
function parseStacktrace(stack, options = {}) {
	...
	return stacks.map((stack) => {
		...
		const position = getOriginalPosition(new DecodedMap$1(map, stack.file), stack);
...
function createSuiteCollector(name, factory = () => {}, mode, each, suiteOptions) {
	...
	const test = createTest(function(name, optionsOrFn, timeoutOrTest) {
		...
		const test = task(formatName$1(name), {
			...this,
			...options,
			handler
		});
...
function createSuite() {
	function suiteFn(name, factoryOrOptions, optionsOrFactory) {
		...
		return createSuiteCollector(formatName$1(name), factory, mode, this.each, options);
	}
	...
	*/
	...
	taskFn.extend = function(fixturesOrName, optionsOrFn, maybeFn) {
		...
		const _test = createTest(function(name, optionsOrFn, optionsOrTest) {
			fn.call(this, formatName$1(name), optionsOrFn, optionsOrTest);
		});
...
const { clearTimeout: clearTimeout$1, setTimeout: setTimeout$1 } = getSafeTimers();
...
//#endregion
//#region node_modules/vitest/dist/chunks/benchmark.CX_oY03V.js
...
var chai_exports = /* @__PURE__ */ __exportAll({
	Assertion: () => Assertion,
...
async function saveInlineSnapshots(environment, snapshots) {
	const MagicString = (await import("./magic-string.es-D6KAVWTz.js")).default;
...
//#endregion
//#region node_modules/vitest/dist/chunks/test.p_J6dB8a.js
const unsupported = [
	"matchSnapshot",
	"toMatchSnapshot",
...
var NodeBenchmarkRunner = class {
	moduleRunner;
	constructor(config) {
		this.config = config;
	}
	async importTinybench() {
		return await import("./dist-BJt-jV8p.js");
	}
...
const retrieveFileHandlers = /* @__PURE__ */ new Set(), retrieveSourceMapHandlers = /* @__PURE__ */ new Set(), createExecHandlers = (handlers) => ((...args) => {
...
createExecHandlers(retrieveFileHandlers);
createExecHandlers(retrieveSourceMapHandlers);
...
//#endregion
//#region node_modules/vitest/dist/chunks/evaluatedModules.Dg1zASAC.js
var VitestEvaluatedModules = class extends EvaluatedModules {
	getModuleSourceMapById(id) {
		...
		if (map != null && !("_patched" in map)) {
			map._patched = true;
			const dir = dirname$1(map.url);
			map.resolvedSources = (map.map.sources || []).map((s) => resolve$1(dir, s || ""));
		}
		return map;
	}
};
...
//#endregion
//#region node_modules/vitest/dist/chunks/index.DOa3dzoN.js
...
//#endregion
export { onTestFailed as C, test$2 as D, suite as E, it as S, recordArtifact as T, aroundAll as _, TestRunner as a, beforeEach as b, globalExpect as c, vi as d, vitest as f, afterEach as g, afterAll as h, NodeBenchmarkRunner as i, inject as l, bench as m, assertType as n, assert as o, chai_exports as p, VitestEvaluatedModules as r, createExpect as s, import_dist as t, should as u, aroundEach as v, onTestFinished as w, describe as x, beforeAll as y };

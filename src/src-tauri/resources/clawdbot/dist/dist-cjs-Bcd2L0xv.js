...
import { t as require_dist_cjs$3 } from "./dist-cjs-DEkgSK4r.js";
import { t as require_dist_cjs$4 } from "./dist-cjs-CbGKg2vk.js";
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await import("./signin-1Q0OeI2Z.js");
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				...
				const { fromContainerMetadata } = await import("./dist-cjs-CIZLKtL3.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await import("./dist-cjs-CIZLKtL3.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await import("./dist-cjs-Bu6RsOiO.js").then((m) => /* @__PURE__ */ __toESM(m.default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await import("./sts-doJfluR7.js");
	...
	const resolveProcessCredentials = async (options, profile) => import("./dist-cjs-1T-F7VE8.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => import("./dist-cjs-CjqCgTCO2.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromTokenFile }) => fromTokenFile({

...
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-CmW7Xsw3.js";
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-CumtvmvP.js";
import { a as formatTargetDisplay, c as resolveMessageSecretScope, l as CHANNEL_MESSAGE_ACTION_NAMES, n as runMessageAction } from "./message-action-runner-D1gVvkVo.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-D6E4pqJn.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DenfdcDu.js";
...
import { t as collectOption } from "./helpers-WPE6f1fx.js";
...
import { n as ensurePluginRegistryLoaded } from "./plugin-registry-BF68Jsx5.js";
...
function resolveThreadCreateRequest(opts) {
	if ((typeof opts.channel === "string" ? opts.channel.trim().toLowerCase() : "") !== "telegram") return {
	...
	return {
		...
		params: {
			...rest,
			name: typeof threadName === "string" ? threadName : void 0
		}
	};
}

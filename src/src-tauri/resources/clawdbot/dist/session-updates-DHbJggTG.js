...
import "./session-system-events-BM428C6d.js";
import { _ as getSkillsSnapshotVersion, g as ensureSkillsWatcher, t as getRemoteSkillEligibility } from "./skills-remote-fYLkhhDd.js";
...
function canonicalizeAbsoluteSessionFilePath(filePath) {
	...
	try {
		const parentDir = fsSync.realpathSync(path.dirname(resolved));

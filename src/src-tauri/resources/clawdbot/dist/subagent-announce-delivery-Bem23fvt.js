import { c as normalizeOptionalString, s as normalizeOptionalLowercaseString, u as normalizeOptionalThreadValue } from "./string-coerce-C1IzJjqi.js";
...
import { l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import "./config-yDDhhyz6.js";
import { c as isGatewayMessageChannel, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
...
import { i as normalizeDeliveryContext$1, r as mergeDeliveryContext$1 } from "./delivery-context.shared-BRwSoIeK.js";
...
import { n as resolveConversationDeliveryTarget } from "./delivery-context-CEfA2BWP.js";
import { a as getSubagentDepthFromSessionStore } from "./subagent-capabilities-XxJhf1t-.js";
import { r as resolveComparableTargetForLoadedChannel } from "./target-parsing-loaded-nUCFL7QV.js";
...
import { r as normalizeConversationRef } from "./conversation-id-DPN31adK.js";
...
import { a as isEmbeddedPiRunActive, c as resolveActiveEmbeddedRunSessionId, s as queueEmbeddedPiMessage } from "./runs-D_jbdUDe.js";
import { t as enqueueAnnounce } from "./subagent-announce-queue-e4OBmCrw.js";
...
async function sendThreadCompletionFallback(params) {
	...
	if (!channel || !to || !params.threadId || !content) return false;
...
async function sendSubagentAnnounceDirectly(params) {
	...
	try {
		...
		const threadCompletionFallbackText = params.expectsCompletionMessage && deliveryTarget.deliver && deliveryTarget.threadId ? extractThreadCompletionFallbackText(params.internalEvents) : "";
		...
		try {
			...
			if (await sendThreadCompletionFallback({
				cfg,

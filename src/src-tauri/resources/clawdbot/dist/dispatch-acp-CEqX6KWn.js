...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-DahNA8kW.js";
...
import { r as prefixSystemMessage } from "./system-message-CJoqqy2c.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-DC5syTRv.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-DLSWYtDl.js";
import { t as hasInboundMedia } from "./inbound-media-ocZ-FLuE.js";
import { i as toAcpRuntimeError } from "./errors-DbyMWuiR.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-GlHu8rR_.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-DGrzBGn2.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-BmPmSvBh.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-DUGruhFD.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-Ci53E9jN.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Dcb1aNjY.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-4quYn7I4.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-BVI8XetE.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-D8Ppm3zt.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-ChcW0XpB.js");
...
function createAcpDispatchDeliveryCoordinator(params) {
	...
	const startReplyLifecycleOnce = async () => {
		...
		if (params.suppressUserDelivery) return;
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-DpDxZGca.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-09qeEdDr.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-BVI8XetE.js");

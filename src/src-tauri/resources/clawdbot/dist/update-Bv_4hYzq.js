...
import { a as resolveOsHomeRelativePath } from "./home-dir-CfZ08GnU.js";
...
import { s as isPathInside } from "./boundary-path-C2iMx2xR.js";
import { o as redactSensitiveUrlLikeString } from "./redact-sensitive-url-DFFiUfXC.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-DKbwHPzH.js";
import { a as resolvePluginInstallDir, i as installPluginFromPath, r as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-Bq8LaeUm.js";
import { l as resolveArchiveKind } from "./archive-I0VbH-E1.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-B7zCULWI.js";
import { i as resolveNpmSpecMetadata } from "./install-source-utils-DS_xT9sR.js";
import { r as installPluginFromClawHub } from "./clawhub-Bhr6hWl5.js";
import { n as recordPluginInstall, t as buildNpmResolutionInstallFields } from "./installs-BUO8rIX3.js";
...
function stringFieldMatches(recorded, resolved) {
	return !recorded || resolved !== void 0 && recorded === resolved;
}
function shouldSkipUnchangedNpmInstall(params) {
	if (!params.currentVersion || !params.metadata.version) return false;
	if (params.currentVersion !== params.metadata.version) return false;
	return stringFieldMatches(params.record.integrity, params.metadata.integrity) && stringFieldMatches(params.record.shasum, params.metadata.shasum) && stringFieldMatches(params.record.resolvedName, params.metadata.name) && stringFieldMatches(params.record.resolvedSpec, params.metadata.resolvedSpec) && stringFieldMatches(params.record.resolvedVersion, params.metadata.version);
}

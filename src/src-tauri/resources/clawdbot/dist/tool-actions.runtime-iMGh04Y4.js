...
import "./accounts-CPOjCaWO.js";
import "./runtime-api-eE9m_2UG.js";
import { _ as parsePollStart, a as sendMessageMatrix, d as buildPollResponseContent, g as isPollStartType, h as isPollEventType, i as reactMatrixMessage, n as editMessageMatrix, u as resolveMatrixRoomId } from "./send-DiGInKau.js";
import { c as MATRIX_REACTION_EVENT_TYPE, f as selectOwnMatrixReactionEventIds, p as summarizeMatrixReactionEvents, u as buildMatrixReactionRelationsPath } from "./direct-management-BdPeLV7M.js";
import { _ as startMatrixVerification, a as confirmMatrixVerificationSas, b as withResolvedRoomAction, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as scanMatrixVerificationQr, h as restoreMatrixRoomKeyBackup, i as confirmMatrixVerificationReciprocateQr, l as getMatrixVerificationSas, n as bootstrapMatrixVerification, o as generateMatrixVerificationQr, p as requestMatrixVerification, r as cancelMatrixVerification, s as getMatrixEncryptionStatus, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as verifyMatrixRecoveryKey, y as withResolvedActionClient } from "./verification-BOluZ5rY.js";
import { t as applyMatrixProfileUpdate } from "./profile-update-CCbsjr00.js";
import { o as resolveMatrixMessageAttachment, r as resolveMatrixPollRootEventId, s as resolveMatrixMessageBody, t as fetchMatrixPollMessageSummary } from "./poll-summary-DtIBstcl.js";
...
async function handleMatrixAction(params, cfg, opts = {}) {
	...
	if (verificationActions.has(action)) {
		...
		if (action === "verificationStart") {
			const method = readStringParam(params, "method")?.trim().toLowerCase();

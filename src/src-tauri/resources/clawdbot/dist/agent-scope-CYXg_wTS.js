...
import { T as parseAgentSessionKey, c as normalizeAgentId, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-D7XpmyVq.js";
...
function normalizePathForComparison(input) {
	...
	try {
		normalized = fsSync.realpathSync.native(resolved);
	} catch {}

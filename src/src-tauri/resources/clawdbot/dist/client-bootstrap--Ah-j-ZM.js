...
import { t as getActiveMatrixClient } from "./active-client-CYPFV7jI.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-hpk5sSjv.js"), import("./shared-C6BkhoC-.js")]).then(([clientModule, sharedModule]) => ({

...
import { r as theme, t as colorize } from "./theme-D-TumEpz.js";
import { n as VERSION } from "./version-TiEvEN12.js";
import { i as resolveAgentConfig } from "./agent-scope-CYXg_wTS.js";
import { t as sameFileIdentity } from "./file-identity-B8OnIgGC.js";
import { a as logWarn } from "./logger-Dr2uNJI4.js";
import { Et as POSIX_INLINE_COMMAND_FLAGS, Mt as normalizeExecutableToken, Ot as resolveInlineCommandMatch, Tt as unwrapKnownShellMultiplexerInvocation, X as analyzeArgvCommand, _t as resolveExecutableFromPathEnv, c as loadConfig, dt as resolveCommandResolutionFromArgv, jt as unwrapKnownDispatchWrapperInvocation, lt as resolveApprovalAuditCandidatePath, nt as resolvePlannedSegmentArgv, yt as POSIX_SHELL_WRAPPERS } from "./io-DhtVmzAJ.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-B2w9UVHS.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-Clj4_p8-.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-BFCeZTel.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-CEXChkqS.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CDm-glWj.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-D19EDm2g.js";
...
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-Bng_ohlG.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-enHHgxXj.js";
import { t as parsePort } from "./parse-port-BsLLlIPe.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Uj6Bh3k8.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DPATDVgF.js";
import { A as saveExecApprovals, B as detectInterpreterInlineEvalArgv, C as requiresExecApproval, E as resolveExecApprovals, M as evaluateExecAllowlist, N as evaluateShellAllowlist, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as requestJsonlSocket, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot, z as describeInterpreterInlineEval } from "./exec-approvals-D6YTmZxM.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-D0s5bENr.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-BnNUZOb5.js";
import { s as resolveBrowserConfig } from "./browser-config-To3UOSug.js";
import { G as runBrowserProxyCommand } from "./browser-runtime-DL3yg2w9.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BupeSvnP.js";
import { t as formatHelpExamples } from "./help-format-BGm-dbvi.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B59X7N6X.js";
import { t as resolveNodeService } from "./node-service-D-iO0n5j.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-CbWihhn1.js";
...
function hasMutableSymlinkPathComponentSync(targetPath) {
	for (const component of pathComponentsFromRootSync(targetPath)) try {
		if (!fsSync.lstatSync(component).isSymbolicLink()) continue;
...
function resolvesToExistingFileSync(rawOperand, cwd) {
	...
	try {
		return fsSync.statSync(path.resolve(cwd ?? process.cwd(), rawOperand)).isFile();
	} catch {
		return false;
	}
}
...
function resolveCanonicalApprovalCwdSync(cwd) {
	...
	let cwdRealStat;
	try {
		cwdLstat = fsSync.lstatSync(requestedCwd);
		cwdStat = fsSync.statSync(requestedCwd);
		cwdReal = fsSync.realpathSync(requestedCwd);
		cwdRealStat = fsSync.statSync(cwdReal);
	} catch {
		return {
			ok: false,
...
async function evaluateSystemRunPolicyPhase(opts, parsed) {
	...
	if (security === "allowlist" && parsed.shellPayload && !policy.approvedByAsk && !durableApprovalSatisfied) {
		await sendSystemRunDenied(opts, parsed.execution, {
			reason: "approval-required",

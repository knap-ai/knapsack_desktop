...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-DTXJhyWe.js";
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-BW7up38N.js";
import { a as isSecureWebSocketUrl, r as isLoopbackHost } from "./net-D3XSbNNz.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-D19EDm2g.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-D-AMPixR.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-BD-x90QF.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-BsZdqqVw.js";
import { t as rawDataToString } from "./ws-6jAdhZrJ.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CyhH_kCK.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-dFlyjP2J.js";
...
function readStore(filePath) {
	try {
		...
		return safeParseJsonWithSchema(DeviceAuthStoreSchema, fsSync.readFileSync(filePath, "utf8"));
	} catch {
		return null;
	}
}
...
function resolveConnectChallengeTimeoutMs(timeoutMs) {
	return typeof timeoutMs === "number" && Number.isFinite(timeoutMs) ? clampConnectChallengeTimeoutMs(timeoutMs) : DEFAULT_PREAUTH_HANDSHAKE_TIMEOUT_MS;
}
...
//#endregion
export { validateExecApprovalsNodeGetParams as $, validateWizardNextParams as $t, validateConfigGetParams as A, validateSessionsListParams as At, validateCronRunParams as B, validateSkillsInstallParams as Bt, validateChannelsLogoutParams as C, validateSecretsResolveParams as Ct, validateChatInjectParams as D, validateSessionsCompactParams as Dt, validateChatHistoryParams as E, validateSessionsAbortParams as Et, validateConfigSetParams as F, validateSessionsResetParams as Ft, validateDevicePairListParams as G, validateTalkSpeakParams as Gt, validateCronStatusParams as H, validateSkillsUpdateParams as Ht, validateConnectParams as I, validateSessionsResolveParams as It, validateDeviceTokenRevokeParams as J, validateUpdateRunParams as Jt, validateDevicePairRejectParams as K, validateToolsCatalogParams as Kt, validateCronAddParams as L, validateSessionsSendParams as Lt, validateConfigSchemaLookupParams as M, validateSessionsMessagesUnsubscribeParams as Mt, validateConfigSchemaLookupResult as N, validateSessionsPatchParams as Nt, validateChatSendParams as O, validateSessionsCreateParams as Ot, validateConfigSchemaParams as P, validateSessionsPreviewParams as Pt, validateExecApprovalsGetParams as Q, validateWizardCancelParams as Qt, validateCronListParams as R, validateSessionsUsageParams as Rt, validateAgentsUpdateParams as S, validateRequestFrame as St, validateChatAbortParams as T, validateSendParams as Tt, validateCronUpdateParams as U, validateTalkConfigParams as Ut, validateCronRunsParams as V, validateSkillsStatusParams as Vt, validateDevicePairApproveParams as W, validateTalkModeParams as Wt, validateExecApprovalRequestParams as X, validateWebLoginStartParams as Xt, validateDeviceTokenRotateParams as Y, validateWakeParams as Yt, validateExecApprovalResolveParams as Z, validateWebLoginWaitParams as Zt, validateAgentsDeleteParams as _, buildDeviceAuthPayload as _n, validateNodeRenameParams as _t, READ_SCOPE as a, PLUGIN_APPROVAL_TITLE_MAX_LENGTH as an, validateNodeEventParams as at, validateAgentsFilesSetParams as b, validatePollParams as bt, isAdminOnlyMethod as c, buildPluginApprovalRequestMessage as cn, validateNodeListParams as ct, GatewayClient as d, errorShape as dn, validateNodePairRejectParams as dt, validateWizardStartParams as en, validateExecApprovalsNodeSetParams as et, formatValidationErrors as f, parseSessionLabel as fn, validateNodePairRequestParams as ft, validateAgentsCreateParams as g, getPreauthHandshakeTimeoutMsFromEnv as gn, validateNodePendingEnqueueParams as gt, validateAgentWaitParams as h, resolveDeviceAuthConnectErrorDetailCode as hn, validateNodePendingDrainParams as ht, PAIRING_SCOPE as i, PLUGIN_APPROVAL_DESCRIPTION_MAX_LENGTH as in, validateNodeDescribeParams as it, validateConfigPatchParams as j, validateSessionsMessagesSubscribeParams as jt, validateConfigApplyParams as k, validateSessionsDeleteParams as kt, isNodeRoleMethod as l, buildPluginApprovalResolvedMessage as ln, validateNodePairApproveParams as lt, validateAgentParams as m, resolveAuthConnectErrorDetailCode as mn, validateNodePendingAckParams as mt, APPROVALS_SCOPE as n, DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS as nn, validateLogsTailParams as nt, WRITE_SCOPE as o, approvalDecisionLabel as on, validateNodeInvokeParams as ot, validateAgentIdentityParams as p, ConnectErrorDetailCodes as pn, validateNodePairVerifyParams as pt, validateDevicePairRemoveParams as q, validateToolsEffectiveParams as qt, CLI_DEFAULT_OPERATOR_SCOPES as r, MAX_PLUGIN_APPROVAL_TIMEOUT_MS as rn, validateModelsListParams as rt, authorizeOperatorScopesForMethod as s, buildPluginApprovalExpiredMessage as sn, validateNodeInvokeResultParams as st, ADMIN_SCOPE as t, validateWizardStatusParams as tn, validateExecApprovalsSetParams as tt, resolveLeastPrivilegeOperatorScopesForMethod as u, ErrorCodes as un, validateNodePairListParams as ut, validateAgentsFilesGetParams as v, buildDeviceAuthPayloadV3 as vn, validatePluginApprovalRequestParams as vt, validateChannelsStatusParams as w, validateSecretsResolveResult as wt, validateAgentsListParams as x, validatePushTestParams as xt, validateAgentsFilesListParams as y, normalizeFingerprint as yn, validatePluginApprovalResolveParams as yt, validateCronRemoveParams as z, validateSkillsBinsParams as zt };

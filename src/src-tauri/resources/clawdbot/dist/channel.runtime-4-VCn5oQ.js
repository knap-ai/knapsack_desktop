...
import { n as resolveMatrixAuth } from "./config-CKBRoB-O.js";
import "./client-DDs6B46n.js";
import { n as listMatrixDirectoryGroupsLive, r as listMatrixDirectoryPeersLive, t as resolveMatrixTargets } from "./resolve-targets-BQLh2DsB.js";
import { a as sendMessageMatrix, o as sendPollMatrix } from "./send-DiGInKau.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./client-hpk5sSjv.js").then((clientModule) => ({ createMatrixClient: clientModule.createMatrixClient }));

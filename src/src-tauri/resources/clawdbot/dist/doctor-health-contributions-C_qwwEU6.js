...
async function runGatewayConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-B-CmRDIm.js");
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-CO8VsHbb.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-C6FreOrg.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-ChnVrppn.js");
	const { buildGatewayConnectionDetails } = await import("./call-GfQsJ3MY.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runGatewayAuthHealth(ctx) {
	const { resolveSecretInputRef } = await import("./types.secrets-BrjPjyTW.js");
	const { resolveGatewayAuth } = await import("./auth-CId0Ag9v.js");
	const { note } = await import("./note-ZqrBZj-t.js");
	const { randomToken } = await import("./onboard-helpers-T6o6jvuQ.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-Btdt14o9.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-D8EO2n0B.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-CVqusIo7.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-DyZFVVZY.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-8hZTxHYf.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-CgxSS68F.js");
	await noteSessionLockHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore } = await import("./doctor-cron-BGCgilo7.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-CYlsBRrF.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-Bc_njyW6.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-CsifDJLL.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-SmxIZ7-s.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-CkzcgRjL.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-D5KyHfLP.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-Ca_uFlAJ.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { DEFAULT_MODEL, DEFAULT_PROVIDER } = await import("./defaults-Bg4-Ke4I.js");
	const { loadModelCatalog } = await import("./model-catalog-CC3baMxe.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-C5fefleX.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-DB7wQpqv.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DOnxXAzU.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BuD2n6RJ.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-COHb8nUQ.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-Cq8vLX-4.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-enLZ0vGb.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-CjsS9Dx6.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-Dr-FHO0f.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-CAhyV2r8.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-B-CmRDIm.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-T6o6jvuQ.js");
	const { CONFIG_PATH, writeConfigFile } = await import("./config-NTLYkTUO.js");
	const { logConfigUpdated } = await import("./logging-CiwTRtkB.js");
	const { shortenHomePath } = await import("./utils-DMQR8q6t.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-Cl-asc8m.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-8hZTxHYf.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-sJgzOANU.js");
	const { note } = await import("./note-ZqrBZj-t.js");
...
async function runFinalConfigValidationHealth(_ctx) {
	const { readConfigFileSnapshot } = await import("./config-NTLYkTUO.js");

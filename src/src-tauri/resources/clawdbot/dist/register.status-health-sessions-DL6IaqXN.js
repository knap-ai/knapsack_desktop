...
import { d as updateSessionStore, g as enforceSessionDiskBudget, h as resolveMaintenanceConfig, i as loadSessionStore, m as pruneStaleEntries, p as capEntryCount } from "./store-BGmy-Wot.js";
import "./sessions-DC7OiAdD.js";
import { i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-DBIQqSpZ.js";
import { Gt as getTaskById, Ht as cancelTaskById, It as getFlowTaskSummary, Qt as updateTaskNotifyPolicyById, an as listTaskFlowRecords, en as deleteTaskFlowRecordById, in as getTaskFlowRegistryRestoreFailure, jt as cancelFlowById, qt as listTasksForFlowId, rn as getTaskFlowById, sn as resolveTaskFlowForLookupToken, un as updateFlowRecordByIdExpectedRevision } from "./pi-embedded-BYdcxQ5A.js";
...
import { a as reconcileInspectableTasks, c as runTaskRegistryMaintenance, f as listTaskAuditFindings, i as previewTaskRegistryMaintenance, n as getInspectableTaskRegistrySummary, o as reconcileTaskLookupToken, p as summarizeTaskAuditFindings, t as getInspectableTaskAuditSummary } from "./task-registry.maintenance-p7qaiuau.js";
import { t as statusCommand } from "./status-BmsiVxQi.js";
import { a as formatSessionModelCell, c as toSessionDisplayRows, i as formatSessionKeyCell, l as resolveSessionStoreTargetsOrExit, n as formatSessionAgeCell, o as resolveSessionDisplayDefaults, r as formatSessionFlagsCell, s as resolveSessionDisplayModel, t as sessionsCommand } from "./sessions-DhOvVMVg.js";
...
function compareSystemAuditFindings(left, right) {
	...
	const rightAge = right.ageMs ?? -1;
	if (leftAge !== rightAge) return rightAge - leftAge;
	return (left.task?.createdAt ?? left.flow?.createdAt ?? 0) - (right.task?.createdAt ?? right.flow?.createdAt ?? 0);
}
...
async function tasksMaintenanceCommand(opts, runtime) {
	...
	runtime.log(info(`Tasks maintenance (${opts.apply ? "applied" : "preview"}): tasks ${taskMaintenance.reconciled} reconcile · ${taskMaintenance.cleanupStamped} cleanup stamp · ${taskMaintenance.pruned} prune; task-flows ${flowMaintenance.reconciled} reconcile · ${flowMaintenance.pruned} prune`));

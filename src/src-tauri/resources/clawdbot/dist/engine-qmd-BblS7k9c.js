...
import { i as isUsageCountedSessionTranscriptFileName, r as isSessionArchiveArtifactName } from "./artifacts-BKUYGR-f.js";
import { a as stripInternalRuntimeContext } from "./internal-runtime-context-wXjOposv.js";
...
import { r as isHeartbeatUserMessage } from "./heartbeat-filter-B5OftKVn.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-BQJil5Lo.js";
import "./query-expansion-Dqgt2KXp.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CusTgQZH.js";
import { o as hashText } from "./internal-Difqhfo-.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-DZ-HBajV.js";
...
function isDreamingNarrativeTranscriptFromSessionStore(absPath) {
	...
	return loadSessionTranscriptClassificationForSessionsDir(sessionsDir).dreamingNarrativeTranscriptPaths.has(normalizedAbsPath);
}
function isCronRunTranscriptFromSessionStore(absPath) {
	const sessionsDir = path.dirname(absPath);
	const normalizedAbsPath = normalizeComparablePath(absPath);
	return loadSessionTranscriptClassificationForSessionsDir(sessionsDir).cronRunTranscriptPaths.has(normalizedAbsPath);
}
...
async function buildSessionEntry(absPath, opts = {}) {
	try {
		...
		const generatedByCronRun = opts.generatedByCronRun ?? isCronRunTranscriptFromSessionStore(absPath);

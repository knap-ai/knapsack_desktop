...
import { f as resolveConfigDir, m as resolveUserPath, s as ensureDir } from "./utils-BMRcljdi.js";
...
import { n as hasBinary } from "./config-eval-BpYvBUD4.js";
import { l as resolveSkillKey } from "./config-Brv7NXUA.js";
import { t as resolveSkillSource } from "./source-BliQBH7B.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-7Uj_FaPS.js";
import { t as resolveSkillsInstallPreferences } from "./skills-ClcFefyl.js";
import { a as safePathSegmentHashed, t as assertCanonicalPathWithinBase } from "./install-safe-path-Z2izhiRX.js";
import { t as resolveBrewExecutable } from "./brew-Dg1aGpzt.js";
import { a as scanSkillInstallSource } from "./install-security-scan-CgG2HALH.js";
...
async function loadExtractModule() {
	extractModulePromise ??= import("./skills-install-extract-DA9rEfCd.js");
...
async function installSkill(params) {
	...
	const command = buildInstallCommand(spec, deps.resolveSkillsInstallPreferences(params.config));

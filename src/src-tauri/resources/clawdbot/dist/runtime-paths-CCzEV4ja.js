...
function addNixProfileBinDirs(dirs, home, env) {
	...
	if (nixProfiles) for (const profile of nixProfiles.split(/\s+/).toReversed()) addNonEmptyDir(dirs, appendSubdir(profile, "bin"));

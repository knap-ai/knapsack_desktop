...
import { a as coerceSecretRef, c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-Zn5Zyn7M.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-BeQ-3fY_.js";
import { n as info, o as success, t as danger } from "./globals-DeRFSEIV.js";
import { a as resolveSecretRefValue } from "./resolve-CUXgNEHH.js";
import { w as SecretProviderSchema } from "./zod-schema.core-BR1v7ukx.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-Dv_xNAZB.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-Bvpbq4Ya.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-cADw9D2m.js";
import { n as setCommandJsonMode } from "./json-mode-Cci5hkKd.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-B1lL2DPM.js");

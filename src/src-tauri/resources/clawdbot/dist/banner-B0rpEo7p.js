import { A as hasRootVersionAlias } from "./logger-kwZIqwuw.js";
import { o as resolveConfigPath } from "./paths-ViKUYWUK.js";
import { n as isRich, r as theme } from "./theme-CdOoMzRk.js";
import { i as visibleWidth } from "./ansi-BEJF8NKS.js";
...
function readCliBannerTaglineMode(env = process.env) {
	try {
		...
		return parseTaglineMode$1(JSON5.parse(raw).cli?.banner?.taglineMode);
	} catch {
		return;
	}
}

...
import { t as require_src } from "./src-Dhzek8ho.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-5rrCUmqq.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-4zTIAPWD.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-aXk2AcP3.js";
import { l as toRatio, n as decodeString } from "./Util-CcJWNRDT.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-Z71w5zKs.js";
import { t as APEv2Parser } from "./APEv2Parser-q0sbJtsD.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DrwZ-C-J.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BIG66DRy.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DP57hUDH.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Bf-Y53Zr.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Ded9hqkR.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-D98tQ4da.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CHduUMEI.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DJg3fR-n.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-C8P-ZwOy.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-zx92fHL_.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-B13N9FsB.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bk-LYwBr.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BGCR5aqj.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CnTHgP-D.js")).WaveParser;
	}
};
//#endregion

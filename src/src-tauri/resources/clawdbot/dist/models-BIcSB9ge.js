...
import { A as colorize, M as theme, R as CONFIG_PATH, j as isRich$1 } from "./entry.js";
import { A as modelKey, C as resolveOpenClawAgentDir, Ct as shouldEnableShellEnvFallback, D as buildModelAliasIndex, F as resolveConfiguredModelRef, Ft as resolveAuthProfileDisplayLabel, I as resolveDefaultModelForAgent, M as parseModelRef, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, R as resolveModelRefFromString, S as resolveAuthStorePathForDisplay, ft as resolveApiKeyForProvider, g as upsertAuthProfile, h as setAuthProfileOrder, j as normalizeProviderId, mt as resolveEnvApiKey, n as resolveAuthProfileOrder, o as resolveProfileUnusableUntilForDisplay, p as listProfilesForProvider, pt as resolveAwsSdkEnvVarName, ut as getCustomProviderApiKey, v as ensureAuthProfileStore, vt as getShellEnvAppliedKeys } from "./auth-profiles-DnpV8DWM.js";
import { t as formatCliCommand } from "./command-format-CVN3MX2Q.js";
import { S as shortenHomePath } from "./utils-q1rHOG-N.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, i as resolveAgentModelFallbacksOverride, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-Bu62UIQZ.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-EhM2JAQo.js";
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-BJWIHf6x.js";
import { Ct as resolveUsageProviderId, H as describeFailoverError, St as formatUsageWindowSummary, Xn as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES, Yn as resolveModel, Zn as resolveForwardCompatModel, bt as loadProviderUsageSummary, l as runEmbeddedPiAgent } from "./reply-DWlAlSNj.js";
import { s as loadModelCatalog } from "./runner-BY_Cu0GM.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BUvHYVxN.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-D9QhlJYC.js";
import { r as withProgressTotals } from "./progress-C4IJwa0T.js";

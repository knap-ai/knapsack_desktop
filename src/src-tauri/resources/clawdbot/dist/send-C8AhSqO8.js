...
import { v as resolveDiscordAccount, y as normalizeDiscordToken } from "./plugins-CLo5nH74.js";
import { n as ensureTargetId, r as requireTargetKind, t as buildMessagingTarget } from "./targets-CpZE8ILI.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-UPMRcKEG.js";
import { a as loadWebMediaRaw, i as loadWebMedia, o as resolveMarkdownTableMode, p as resolveChunkMode, u as chunkMarkdownTextWithMode } from "./ir-CGIUordM.js";
import { n as recordChannelActivity, r as createDiscordRetryRunner } from "./channel-activity-Ds_g7OEt.js";
import { n as normalizePollInput, t as normalizePollDurationHours } from "./polls-yr-D4xmo.js";
import { t as resolveFetch } from "./fetch-FrV1o__f.js";
import { t as convertMarkdownTables } from "./tables-1llcV3qs.js";
...
function resolveDiscordRest$1(opts) {
	...
	return resolveRest$1(resolveToken$1({
		explicit: opts.token,
...
async function sendDiscordMedia(rest, channelId, text, mediaUrl, replyTo, request, maxLinesPerMessage, embeds, chunkMode, silent) {
	...
	for (const chunk of chunks.slice(1)) {
		...
		await sendDiscordText(rest, channelId, chunk, void 0, request, maxLinesPerMessage, void 0, chunkMode, silent);
	}
	return res;
}
...
async function sendMessageDiscord(to, text, opts = {}) {
	...
	if (isForumLikeType(channelType)) {
		...
		try {
			if (opts.mediaUrl) {
				...
				await sendDiscordMedia(rest, threadId, mediaCaption ?? "", opts.mediaUrl, void 0, request, accountInfo.config.maxLinesPerMessage, void 0, chunkMode, opts.silent);
				for (const chunk of afterMediaChunks) await sendDiscordText(rest, threadId, chunk, void 0, request, accountInfo.config.maxLinesPerMessage, void 0, chunkMode, opts.silent);
			} else for (const chunk of remainingChunks) await sendDiscordText(rest, threadId, chunk, void 0, request, accountInfo.config.maxLinesPerMessage, void 0, chunkMode, opts.silent);
		} catch (err) {
			throw await buildDiscordSendError(err, {
				channelId: threadId,
				rest,
	...
	let result;
	try {
		if (opts.mediaUrl) result = await sendDiscordMedia(rest, channelId, textWithTables, opts.mediaUrl, opts.replyTo, request, accountInfo.config.maxLinesPerMessage, opts.embeds, chunkMode, opts.silent);
		else result = await sendDiscordText(rest, channelId, textWithTables, opts.replyTo, request, accountInfo.config.maxLinesPerMessage, opts.embeds, chunkMode, opts.silent);
	} catch (err) {
		throw await buildDiscordSendError(err, {
			channelId,
			rest,
...
async function sendVoiceMessageDiscord(to, audioPath, opts = {}) {
	...
	try {
		...
		const result = await sendDiscordVoiceMessage(rest, channelId, await fsPromises.readFile(oggPath), metadata, opts.replyTo, request, opts.silent);
		recordChannelActivity({
			channel: "discord",
			accountId: accountInfo.accountId,
			direction: "outbound"
...
//#endregion
export { resolveDiscordMemberAllowed as $, removeRoleDiscord as A, setChannelPermissionDiscord as B, fetchChannelInfoDiscord as C, kickMemberDiscord as D, fetchVoiceStatusDiscord as E, createChannelDiscord as F, listDiscordDirectoryPeersLive as G, parseDiscordTarget as H, deleteChannelDiscord as I, normalizeDiscordAllowList as J, allowListMatches as K, editChannelDiscord as L, listGuildEmojisDiscord as M, uploadEmojiDiscord as N, listGuildChannelsDiscord as O, uploadStickerDiscord as P, resolveDiscordGuildEntry as Q, moveChannelDiscord as R, createScheduledEventDiscord as S, fetchRoleInfoDiscord as T, resolveDiscordChannelId as U, createDiscordClient as V, listDiscordDirectoryGroupsLive as W, resolveDiscordAllowListMatch as X, normalizeDiscordSlug as Y, resolveDiscordChannelConfigWithFallback as Z, readMessagesDiscord as _, removeReactionDiscord as a, formatDiscordUserTag as at, addRoleDiscord as b, sendStickerDiscord as c, fetchDiscord as ct, deleteMessageDiscord as d, applyChannelMatchMeta as dt, resolveDiscordOwnerAllowFrom as et, editMessageDiscord as f, buildChannelKeyCandidates as ft, pinMessageDiscord as g, listThreadsDiscord as h, removeOwnReactionsDiscord as i, formatDiscordReactionEmoji as it, timeoutMemberDiscord as j, listScheduledEventsDiscord as k, sendVoiceMessageDiscord as l, fetchChannelPermissionsDiscord as lt, listPinsDiscord as m, fetchReactionsDiscord as n, resolveGroupDmAllow as nt, sendMessageDiscord as o, resolveDiscordSystemLocation as ot, fetchMessageDiscord as p, resolveChannelEntryMatchWithFallback as pt, isDiscordGroupAllowedByPolicy as q, reactMessageDiscord as r, shouldEmitDiscordReactionNotification as rt, sendPollDiscord as s, resolveTimestampMs as st, send_exports as t, resolveDiscordShouldRequireMention as tt, createThreadDiscord as u, chunkDiscordTextWithMode as ut, searchMessagesDiscord as v, fetchMemberInfoDiscord as w, banMemberDiscord as x, unpinMessageDiscord as y, removeChannelPermissionDiscord as z };
...
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-Db_dol0E.js";
...
import { n as runMessageAction } from "./message-action-runner-XHSiiyAO.js";
...
import { n as ensurePluginRegistryLoaded } from "./runtime-registry-loader-CO1cck7F.js";
import "./plugin-registry-CHtU-aP0.js";
...
async function messageCommand(opts, deps, runtime) {
	...
	const { formatMessageCliText } = await import("./message-format-R_d1Tu7b.js");

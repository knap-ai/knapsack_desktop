...
import { t as require_dist_cjs$21 } from "./dist-cjs-CfWCzEgn.js";
import { t as require_dist_cjs$22 } from "./dist-cjs-By9Wg7Te.js";
import { n as init_client, r as setCredentialFeature, t as client_exports } from "./client-BkxFQCaS.js";
import { n as require_dist_cjs$25, r as require_dist_cjs$24, t as require_dist_cjs$23 } from "./dist-cjs-DdmO6Efw.js";
import { A as extendedEncodeURIComponent, D as endpoints_exports, L as require_dist_cjs$30, M as require_dist_cjs$27, O as init_endpoints, P as require_dist_cjs$29, R as require_dist_cjs$26, S as init_schema, T as NormalizedSchema, _ as require_dist_cjs$31, a as FromStringShapeDeserializer, b as parseRfc3339DateTimeWithOffset, c as RpcProtocol, d as init_serde, f as NumericValue, g as import_dist_cjs$32, h as LazyJsonString, i as HttpInterceptingShapeDeserializer, j as collectBody$1, k as deref, l as HttpBindingProtocol, m as _parseEpochTimestamp, n as init_protocols$1, o as determineTimestampFormat, p as nv, r as HttpInterceptingShapeSerializer, s as requestBuilder, t as require_dist_cjs$28, u as SerdeContext, v as dateToUtcString$2, w as TypeRegistry, x as parseRfc7231DateTime, y as parseEpochTimestamp } from "./dist-cjs-CohSYA3H.js";
import { t as require_dist_cjs$32 } from "./dist-cjs-D3m29-_J.js";
import { t as require_dist_cjs$33 } from "./dist-cjs-DEkgSK4r.js";
import { t as require_dist_cjs$34 } from "./dist-cjs-CbGKg2vk.js";
import { t as require_dist_cjs$35 } from "./dist-cjs-ikSkCB1C.js";
...
function bytesToUtf8(bytes, at, to) {
	...
	return (0, import_dist_cjs$31.toUtf8)(bytes.subarray(at, to));
}
...
var import_dist_cjs$31, USE_TEXT_DECODER, USE_BUFFER$1, payload, dataView$1, textDecoder, _offset, minorValueToArgumentLength;
var init_cbor_decode = __esmMin((() => {
	init_serde();
	import_dist_cjs$31 = require_dist_cjs$23();
	init_cbor_types();
	...
	while (encodeStack.length) {
		...
		if (typeof input === "string") {
			if (USE_BUFFER) {
				...
				const bytes = (0, import_dist_cjs$30.fromUtf8)(input);
...
var import_dist_cjs$30, USE_BUFFER, data, dataView, cursor;
var init_cbor_encode = __esmMin((() => {
	init_serde();
	import_dist_cjs$30 = require_dist_cjs$23();
	init_cbor_types();
...
var import_dist_cjs$29, CborCodec, CborShapeSerializer, CborShapeDeserializer;
var init_CborCodec = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$29 = require_dist_cjs$26();
	init_cbor$1();
	init_parseCborBody();
	...
	CborShapeSerializer = class extends SerdeContext {
		...
		serialize(schema, source) {
			...
			if (ns.isBlobSchema()) {
				if (typeof source === "string") return (this.serdeContext?.base64Decoder ?? import_dist_cjs$29.fromBase64)(source);
				return source;
			}
	...
	CborShapeDeserializer = class extends SerdeContext {
		...
		readValue(_schema, value) {
			...
			if (ns.isBlobSchema()) {
				if (typeof value === "string") return (this.serdeContext?.base64Decoder ?? import_dist_cjs$29.fromBase64)(value);
				return value;
			}
...
var import_dist_cjs$28, SmithyRpcV2CborProtocol;
var init_SmithyRpcV2CborProtocol = __esmMin((() => {
	init_protocols$1();
	init_schema();
	import_dist_cjs$28 = require_dist_cjs$27();
	init_CborCodec();
	init_parseCborBody();
	SmithyRpcV2CborProtocol = class extends RpcProtocol {
		...
		async serializeRequest(operationSchema, input, context) {
			...
			const { service, operation } = (0, import_dist_cjs$28.getSmithyContext)(context);
...
var import_dist_cjs$27, ProtocolLib;
	...
	ProtocolLib = class {
		...
		decorateServiceException(exception, additions = {}) {
			if (this.queryCompat) {
				...
				const error = (0, import_dist_cjs$27.decorateServiceException)(exception, additions);
			...
			return (0, import_dist_cjs$27.decorateServiceException)(exception, additions);
		}
...
var import_dist_cjs$25, import_dist_cjs$26, collectBodyString;
var init_common = __esmMin((() => {
	import_dist_cjs$25 = require_dist_cjs$28();
	import_dist_cjs$26 = require_dist_cjs$23();
	collectBodyString = (streamBody, context) => (0, import_dist_cjs$25.collectBody)(streamBody, context).then((body) => (context?.utf8Encoder ?? import_dist_cjs$26.toUtf8)(body));
}));
//#endregion
...
var import_dist_cjs$24, JsonShapeDeserializer;
var init_JsonShapeDeserializer = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$24 = require_dist_cjs$26();
	...
	JsonShapeDeserializer = class extends SerdeContextConfig {
		...
		_read(schema, value) {
			...
			if (ns.isBlobSchema() && typeof value === "string") return (0, import_dist_cjs$24.fromBase64)(value);
...
var import_dist_cjs$23, JsonShapeSerializer;
var init_JsonShapeSerializer = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$23 = require_dist_cjs$26();
	init_ConfigurableSerdeContext();
	init_jsonReplacer();
		...
		_write(schema, value, container) {
			...
			if (isObject) {
				...
				if (value instanceof Uint8Array && (ns.isBlobSchema() || ns.isDocumentSchema())) {
					...
					return (this.serdeContext?.base64Encoder ?? import_dist_cjs$23.toBase64)(value);
				}
...
var import_dist_cjs$22, awsExpectUnion;
var init_awsExpectUnion = __esmMin((() => {
	import_dist_cjs$22 = require_dist_cjs$28();
	awsExpectUnion = (value) => {
		if (value == null) return;
		if (typeof value === "object" && "__type" in value) delete value.__type;
		return (0, import_dist_cjs$22.expectUnion)(value);
	};
}));
//#endregion
...
var import_dist_cjs$19, import_dist_cjs$20, import_dist_cjs$21, XmlShapeDeserializer;
var init_XmlShapeDeserializer = __esmMin((() => {
	import_dist_cjs$19 = require_dist_cjs$17();
	init_protocols$1();
	init_schema();
	import_dist_cjs$20 = require_dist_cjs$28();
	import_dist_cjs$21 = require_dist_cjs$23();
	init_ConfigurableSerdeContext();
	init_UnionSerde();
	XmlShapeDeserializer = class extends SerdeContextConfig {
		...
		read(schema, bytes, key) {
			...
			const xmlString = (this.serdeContext?.utf8Encoder ?? import_dist_cjs$21.toUtf8)(bytes);
		...
		parseXml(xml) {
			if (xml.length) {
				let parsedObj;
				try {
					parsedObj = (0, import_dist_cjs$19.parseXML)(xml);
				} catch (e) {
				...
				return (0, import_dist_cjs$20.getValueFromTextNode)(parsedObjToReturn);
			}
			return {};
		}
	};
...
var import_dist_cjs$17, import_dist_cjs$18, QueryShapeSerializer;
var init_QueryShapeSerializer = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$17 = require_dist_cjs$28();
		...
		write(schema, value, prefix = "") {
			...
			if (ns.isBlobSchema()) {
				if (typeof value === "string" || value instanceof Uint8Array) {
					...
					this.writeValue((this.serdeContext?.base64Encoder ?? import_dist_cjs$18.toBase64)(value));
				}
				...
				if (value instanceof Date) {
					...
					switch (determineTimestampFormat(ns, this.settings)) {
						case 5:
							...
							break;
						case 6:
							this.writeValue((0, import_dist_cjs$17.dateToUtcString)(value));
							break;
						case 7:
...
var import_dist_cjs$15, import_dist_cjs$16, parseXmlBody, parseXmlErrorBody, loadRestXmlErrorCode;
var init_parseXmlBody = __esmMin((() => {
	...
	parseXmlBody = (streamBody, context) => collectBodyString(streamBody, context).then((encoded) => {
		if (encoded.length) {
			let parsedObj;
			try {
				parsedObj = (0, import_dist_cjs$15.parseXML)(encoded);
			} catch (e) {
			...
			return (0, import_dist_cjs$16.getValueFromTextNode)(parsedObjToReturn);
		}
		return {};
	});
...
var import_dist_cjs$12, import_dist_cjs$13, import_dist_cjs$14, XmlShapeSerializer;
var init_XmlShapeSerializer = __esmMin((() => {
	...
	import_dist_cjs$14 = require_dist_cjs$26();
	init_ConfigurableSerdeContext();
	XmlShapeSerializer = class extends SerdeContextConfig {
		...
		write(schema, value) {
			...
			else if (ns.isBlobSchema()) this.byteBuffer = "byteLength" in value ? value : (this.serdeContext?.base64Decoder ?? import_dist_cjs$14.fromBase64)(value);
			else {
		...
		writeStruct(ns, value, parentXmlns) {
			...
			const structXmlNode = import_dist_cjs$12.XmlNode.of(name);
			...
			for (const [memberName, memberSchema] of ns.structIterator()) {
				...
				if (val != null || memberSchema.isIdempotencyToken()) {
					...
					if (memberSchema.isListSchema()) this.writeList(memberSchema, val, structXmlNode, xmlns);
						...
						const memberNode = import_dist_cjs$12.XmlNode.of(memberSchema.getMergedTraits().xmlName ?? memberSchema.getMemberName());
			...
			if ($unknown && ns.isUnionSchema() && Array.isArray($unknown) && Object.keys(value).length === 1) {
				const [k, v] = $unknown;
				const node = import_dist_cjs$12.XmlNode.of(k);
				if (typeof v !== "string") if (value instanceof import_dist_cjs$12.XmlNode || value instanceof import_dist_cjs$12.XmlText) structXmlNode.addChildNode(value);
		...
		writeList(listMember, array, container, parentXmlns) {
			...
			const writeItem = (container, value) => {
				if (listValueSchema.isListSchema()) this.writeList(listValueSchema, Array.isArray(value) ? value : [value], container, xmlns);
					...
					const listItemNode = import_dist_cjs$12.XmlNode.of(flat ? listTraits.xmlName ?? listMember.getMemberName() : listValueTraits.xmlName ?? "member");
			...
			if (flat) {
				...
				const listNode = import_dist_cjs$12.XmlNode.of(listTraits.xmlName ?? listMember.getMemberName());
		...
		writeMap(mapMember, map, container, parentXmlns, containerIsMap = false) {
			...
			const addKeyValue = (entry, key, val) => {
				const keyNode = import_dist_cjs$12.XmlNode.of(keyTag, key);
				const [keyXmlnsAttr, keyXmlns] = this.getXmlnsAttribute(mapKeySchema, xmlns);
				if (keyXmlns) keyNode.addAttribute(keyXmlnsAttr, keyXmlns);
				entry.addChildNode(keyNode);
				let valueNode = import_dist_cjs$12.XmlNode.of(valueTag);
			...
			if (flat) {
				for (const [key, val] of Object.entries(map)) if (sparse || val != null) {
					const entry = import_dist_cjs$12.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
				...
				let mapNode;
				if (!containerIsMap) {
					mapNode = import_dist_cjs$12.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
					if (xmlns) mapNode.addAttribute(xmlnsAttr, xmlns);
					container.addChildNode(mapNode);
				}
				for (const [key, val] of Object.entries(map)) if (sparse || val != null) {
					const entry = import_dist_cjs$12.XmlNode.of("entry");
					addKeyValue(entry, key, val);
		...
		writeSimple(_schema, value) {
			...
			if (value && typeof value === "object") if (ns.isBlobSchema()) nodeContents = (this.serdeContext?.base64Encoder ?? import_dist_cjs$14.toBase64)(value);
			else if (ns.isTimestampSchema() && value instanceof Date) switch (determineTimestampFormat(ns, this.settings)) {
				case 5:
					nodeContents = value.toISOString().replace(".000Z", "Z");
					break;
				case 6:
					nodeContents = (0, import_dist_cjs$13.dateToUtcString)(value);
					break;
				case 7:
		...
		writeSimpleInto(_schema, value, into, parentXmlns) {
			...
			const ns = NormalizedSchema.of(_schema);
			const content = new import_dist_cjs$12.XmlText(nodeContents);
			const [xmlnsAttr, xmlns] = this.getXmlnsAttribute(ns, parentXmlns);
...
var require_dist_cjs$16 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilHexEncoding = require_dist_cjs$29();
	var utilUtf8 = require_dist_cjs$23();
	var isArrayBuffer = require_dist_cjs$24();
	var protocolHttp = require_dist_cjs$22();
	var utilMiddleware = require_dist_cjs$27();
	var utilUriEscape = require_dist_cjs$30();
...
var import_dist_cjs$11, getSmithyContext$2;
var init_getSmithyContext = __esmMin((() => {
	import_dist_cjs$11 = require_dist_cjs$21();
	getSmithyContext$2 = (context) => context[import_dist_cjs$11.SMITHY_CONTEXT_KEY] || (context[import_dist_cjs$11.SMITHY_CONTEXT_KEY] = {});
}));
//#endregion
...
var import_dist_cjs$10, httpAuthSchemeMiddleware;
var init_httpAuthSchemeMiddleware = __esmMin((() => {
	...
	httpAuthSchemeMiddleware = (config, mwOptions) => (next, context) => async (args) => {
		...
		const smithyContext = (0, import_dist_cjs$10.getSmithyContext)(context);
...
var import_dist_cjs$8, import_dist_cjs$9, defaultErrorHandler, defaultSuccessHandler, httpSigningMiddleware;
var init_httpSigningMiddleware = __esmMin((() => {
	import_dist_cjs$8 = require_dist_cjs$22();
	import_dist_cjs$9 = require_dist_cjs$27();
	defaultErrorHandler = (signingProperties) => (error) => {
		throw error;
	};
	defaultSuccessHandler = (httpResponse, signingProperties) => {};
	httpSigningMiddleware = (config) => (next, context) => async (args) => {
		if (!import_dist_cjs$8.HttpRequest.isInstance(args.request)) return next(args);
		const scheme = (0, import_dist_cjs$9.getSmithyContext)(context).selectedHttpAuthScheme;
...
var import_dist_cjs$6, import_dist_cjs$7, HttpApiKeyAuthSigner;
var init_httpApiKeyAuth = __esmMin((() => {
	import_dist_cjs$6 = require_dist_cjs$22();
	import_dist_cjs$7 = require_dist_cjs$21();
	HttpApiKeyAuthSigner = class {
		async sign(httpRequest, identity, signingProperties) {
			...
			const clonedRequest = import_dist_cjs$6.HttpRequest.clone(httpRequest);
			if (signingProperties.in === import_dist_cjs$7.HttpApiKeyAuthLocation.QUERY) clonedRequest.query[signingProperties.name] = identity.apiKey;
			else if (signingProperties.in === import_dist_cjs$7.HttpApiKeyAuthLocation.HEADER) clonedRequest.headers[signingProperties.name] = signingProperties.scheme ? `${signingProperties.scheme} ${identity.apiKey}` : identity.apiKey;
...
var import_dist_cjs$5, HttpBearerAuthSigner;
var init_httpBearerAuth = __esmMin((() => {
	import_dist_cjs$5 = require_dist_cjs$22();
	HttpBearerAuthSigner = class {
		async sign(httpRequest, identity, signingProperties) {
			const clonedRequest = import_dist_cjs$5.HttpRequest.clone(httpRequest);
...
var require_dist_cjs$10 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	async function checkFeatures(context, config, args) {
		if (args.request?.headers?.["smithy-protocol"] === "rpc-v2-cbor") client.setFeature(context, "PROTOCOL_RPC_V2_CBOR", "M");
		...
		if (typeof config.accountIdEndpointMode === "function") {
			...
			if (String(endpointV2?.url?.hostname).match(ACCOUNT_ID_ENDPOINT_REGEX)) client.setFeature(context, "ACCOUNT_ID_ENDPOINT", "O");
		...
		if (identity?.$source) {
			...
			if (credentials.accountId) client.setFeature(context, "RESOLVED_ACCOUNT_ID", "T");
			for (const [key, value] of Object.entries(credentials.$source ?? {})) client.setFeature(context, key, value);
		}
	}
...
var import_dist_cjs$4, getDateHeader;
var init_getDateHeader = __esmMin((() => {
	import_dist_cjs$4 = require_dist_cjs$22();
	getDateHeader = (response) => import_dist_cjs$4.HttpResponse.isInstance(response) ? response.headers?.date ?? response.headers?.Date : void 0;
}));
//#endregion
...
var import_dist_cjs$3, throwSigningPropertyError, validateSigningProperties, AwsSdkSigV4Signer, AWSSDKSigV4Signer;
var init_AwsSdkSigV4Signer = __esmMin((() => {
	import_dist_cjs$3 = require_dist_cjs$22();
	init_utils();
	...
	AwsSdkSigV4Signer = class {
		async sign(httpRequest, identity, signingProperties) {
			if (!import_dist_cjs$3.HttpRequest.isInstance(httpRequest)) throw new Error("The request is not an instance of `HttpRequest` and cannot be signed");
...
var import_dist_cjs$2, AwsSdkSigV4ASigner;
var init_AwsSdkSigV4ASigner = __esmMin((() => {
	...
	AwsSdkSigV4ASigner = class extends AwsSdkSigV4Signer {
		async sign(httpRequest, identity, signingProperties) {
			if (!import_dist_cjs$2.HttpRequest.isInstance(httpRequest)) throw new Error("The request is not an instance of `HttpRequest` and cannot be signed");
...
var import_dist_cjs$1, resolveAwsSdkSigV4AConfig, NODE_SIGV4A_CONFIG_OPTIONS;
var init_resolveAwsSdkSigV4AConfig = __esmMin((() => {
	init_dist_es();
	import_dist_cjs$1 = require_dist_cjs$33();
	...
	NODE_SIGV4A_CONFIG_OPTIONS = {
		environmentVariableSelector(env) {
			...
			throw new import_dist_cjs$1.ProviderError("AWS_SIGV4A_SIGNING_REGION_SET not set in env.", { tryNextLink: true });
		},
		configFileSelector(profile) {
			if (profile.sigv4a_signing_region_set) return (profile.sigv4a_signing_region_set ?? "").split(",").map((_) => _.trim());
			throw new import_dist_cjs$1.ProviderError("sigv4a_signing_region_set not set in profile.", { tryNextLink: true });
		},
		default: void 0
	};
}));
...
var require_dist_cjs$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilBufferFrom = require_dist_cjs$25();
	var utilUtf8 = require_dist_cjs$23();
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const inferPhysicalRegion = async () => {
		...
		if (!process.env[ENV_IMDS_DISABLED]) try {
			const { getInstanceMetadataEndpoint, httpRequest } = await import("./dist-cjs-CIZLKtL3.js").then((m) => /* @__PURE__ */ __toESM(m.default));
...
//#endregion
export { AwsRestJsonProtocol as A, getHttpSigningPlugin as C, init_protocols as D, require_dist_cjs$16 as E, require_dist_cjs$19 as M, require_dist_cjs$20 as N, protocols_exports as O, DefaultIdentityProviderConfig as S, require_dist_cjs$15 as T, require_dist_cjs$13 as _, require_dist_cjs$4 as a, init_dist_es as b, resolveAwsSdkSigV4Config as c, require_dist_cjs$5 as d, require_dist_cjs$6 as f, require_dist_cjs$11 as g, require_dist_cjs$10 as h, require_dist_cjs$3 as i, require_dist_cjs$18 as j, AwsQueryProtocol as k, NODE_AUTH_SCHEME_PREFERENCE_OPTIONS as l, require_dist_cjs$9 as m, require_dist_cjs$1 as n, httpAuthSchemes_exports as o, require_dist_cjs$8 as p, require_dist_cjs$2 as r, init_httpAuthSchemes as s, require_dist_cjs as t, AwsSdkSigV4Signer as u, require_dist_cjs$14 as v, getHttpAuthSchemeEndpointRuleSetPlugin as w, NoAuthSigner as x, dist_es_exports as y };

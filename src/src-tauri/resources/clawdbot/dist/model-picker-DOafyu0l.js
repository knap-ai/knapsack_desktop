...
import { f as resolveConfiguredModelRef, i as buildModelAliasIndex, y as modelKey } from "./model-selection-shared-grYiFZof.js";
...
import { i as formatTokenK } from "./shared-BRpkDqTT.js";
import { n as isModelPickerVisibleProvider, t as isModelPickerVisibleModelRef } from "./model-picker-visibility-Bx-Wp_3l.js";
...
async function loadModelPickerRuntime() {
	return import("./model-picker.runtime-DE9Y1EYK.js");
}
...
async function promptModelAllowlist(params) {
	...
	const initialKeys = allowedKeySet ? initialSeeds.filter((key) => allowedKeySet.has(key)) : initialSeeds.filter(isModelPickerVisibleModelRef);
	...
	const supplementalKeys = (allowedKeySet ? allowedKeys : existingKeys).filter(isModelPickerVisibleModelRef);

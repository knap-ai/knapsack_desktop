...
import { i as assertOkOrThrowProviderError, n as asObject, t as asBoolean } from "./provider-http-errors-CqyrJgS5.js";
...
import { a as requireInRange, i as normalizeSeed, n as normalizeApplyTextNormalization, r as normalizeLanguageCode } from "./directives-BpjxbYko.js";
import "./provider-http-CCB8gsnj.js";
import "./speech-Dh8SAO7H.js";
import { n as isValidElevenLabsVoiceId, r as normalizeElevenLabsBaseUrl } from "./shared-DK-nONQO.js";
import { r as resolveElevenLabsApiKeyWithProfileFallback } from "./config-compat-DPm3akdR.js";
import "./config-api-Dv_96S1X.js";
			...
			return {
				audioBuffer: await elevenLabsTTS({
					...
					voiceSettings: {
						...
						...asFiniteNumber(overrideVoiceSettings?.stability) == null ? {} : { stability: asFiniteNumber(overrideVoiceSettings?.stability) },
						...asFiniteNumber(overrideVoiceSettings?.similarityBoost) == null ? {} : { similarityBoost: asFiniteNumber(overrideVoiceSettings?.similarityBoost) },
						...asFiniteNumber(overrideVoiceSettings?.style) == null ? {} : { style: asFiniteNumber(overrideVoiceSettings?.style) },
						...asBoolean(overrideVoiceSettings?.useSpeakerBoost) == null ? {} : { useSpeakerBoost: asBoolean(overrideVoiceSettings?.useSpeakerBoost) },
						...asFiniteNumber(overrideVoiceSettings?.speed) == null ? {} : { speed: asFiniteNumber(overrideVoiceSettings?.speed) }
					},

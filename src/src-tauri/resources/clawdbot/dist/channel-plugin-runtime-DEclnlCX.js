...
import { r as createLazyRuntimeModule } from "./lazy-runtime-BxcSgm-I.js";
import { c as normalizeMessagePresentation, l as presentationToInteractiveReply, u as renderMessagePresentationFallbackText } from "./payload-Cv_QzStf.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-CDJmvoGe.js";
import { s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D7luFLJH.js";
import "./text-runtime-B1c54bxG.js";
import { n as describeAccountSnapshot } from "./account-helpers-BXEoBg1h.js";
...
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-C7AkvHZx.js";
...
import { n as formatNormalizedAllowFromEntries } from "./allow-from-BCtr_DMW.js";
import { n as createDangerousNameMatchingMutableAllowlistWarningCollector, r as createRestrictSendersChannelSecurity } from "./channel-policy-z64fOzIr.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-DfROx5KA.js";
import { f as createStandardChannelSetupStatus } from "./setup-wizard-helpers-B8Qrpsoj.js";
import { r as createLoggedPairingApprovalNotifier } from "./channel-pairing-DF6gWII4.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-Jbf-oZqp.js";
...
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-fyM1MW87.js";
import "./ssrf-runtime-DjO5-xxH.js";
import { t as chunkTextForOutbound } from "./text-chunking-CnW9V_2f.js";
import { n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-Q-mKNOcc.js";
import "./channel-config-primitives-De9I_iJV.js";
import "./channel-lifecycle-BDUDmCw3.js";
import { t as zod_exports } from "./zod-DNylboy1.js";
import { g as normalizeMattermostBaseUrl, i as resolveMattermostReplyToMode, n as resolveDefaultMattermostAccountId, r as resolveMattermostAccount, t as listMattermostAccountIds } from "./accounts-CLgmnamP.js";
import { t as resolveMattermostGatewayAuthBypassPaths } from "./gateway-auth-bypass-Cc9-5Os8.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-Dm1voYGb.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-1r9gnnlb.js";
...
const loadMattermostChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-DgzJLqrX.js"));
...
const mattermostPlugin = createChatChannelPlugin({
	base: {
		...
		directory: createChannelDirectoryAdapter({
			listGroups: async (params) => (await loadMattermostChannelRuntime()).listMattermostDirectoryGroups(params),
			listGroupsLive: async (params) => (await loadMattermostChannelRuntime()).listMattermostDirectoryGroups(params),
			listPeers: async (params) => (await loadMattermostChannelRuntime()).listMattermostDirectoryPeers(params),
			listPeersLive: async (params) => (await loadMattermostChannelRuntime()).listMattermostDirectoryPeers(params)
		}),
		messaging: {

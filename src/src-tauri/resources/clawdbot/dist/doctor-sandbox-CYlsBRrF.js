...
import { r as DEFAULT_SANDBOX_BROWSER_IMAGE, u as DEFAULT_SANDBOX_IMAGE } from "./constants-Ve0QlY3Y.js";
import { s as resolveSandboxScope } from "./config-DVWzrbBW.js";
...
async function dockerImageExists(image) {
	try {
		...
		if ((error?.stderr || error?.message || "").includes("No such image")) return false;
		throw error;
	}
}

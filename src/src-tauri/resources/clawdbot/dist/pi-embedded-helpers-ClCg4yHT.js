...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BJjSwt9w.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BJjSwt9w.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { updateSessionStore as $, buildBootstrapContextFiles as $t, isCompactionFailureError as A, resolveBrowserConfig as At, parseImageSizeError as B, assertSandboxPath as Bt, formatAssistantErrorText as C, resolveChannelGroupPolicy as Ct, isAuthAssistantError as D, resolveGroupSessionKey as Dt, getApiErrorPayloadFingerprint as E, resolveConversationLabel as Et, isRateLimitAssistantError as F, buildWorkspaceSkillSnapshot as Ft, extractDeliveryInfo as G, applyOwnerOnlyToolPolicy as Gt, ensureSandboxWorkspaceForSession as H, applySkillEnvOverrides as Ht, isRawApiErrorPayload as I, loadWorkspaceSkillEntries as It, loadSessionStore as J, expandPolicyWithPluginGroups as Jt, appendAssistantMessageToSessionTranscript as K, buildPluginToolGroups as Kt, isTimeoutErrorMessage as L, resolveSkillsPromptForRun as Lt, isFailoverAssistantError as M, getMediaDir as Mt, isFailoverErrorMessage as N, saveMediaBuffer as Nt, isBillingAssistantError as O, createBrowserRouteContext as Ot, isLikelyContextOverflowError as P, buildWorkspaceSkillCommandSpecs as Pt, updateLastRoute as Q, stripPluginOnlyAllowlist as Qt, isTransientHttpError as R, resolvePluginSkillDirs as Rt, classifyFailoverReason as S, resolveIMessageAccount as St, formatRawAssistantErrorForUi as T, resolveChannelGroupToolsPolicy as Tt, resolveSandboxContext as U, applySkillEnvOverridesFromSnapshot as Ut, sanitizeUserFacingText as V, resolveSandboxedMediaSource as Vt, resolveSandboxRuntimeStatus as W, resolveSandboxConfigForAgent as Wt, recordSessionMetaFromInbound as X, normalizeToolName as Xt, readSessionUpdatedAt as Y, expandToolGroups as Yt, saveSessionStore as Z, resolveToolProfilePolicy as Zt, sanitizeSessionMessagesImages as _, canonicalizeMainSessionAlias as _t, formatXHighModelHint as a, mergeDeliveryContext as at, isGoogleModelApi as b, getChannelDock as bt, normalizeReasoningLevel as c, acquireSessionWriteLock as ct, normalizeVerboseLevel as d, resolveChannelResetConfig as dt, ensureSessionHeader$1 as en, updateSessionStoreEntry as et, resolveResponseUsageMode as f, resolveSessionResetPolicy as ft, normalizeTextForComparison as g, resolveFreshSessionTotalTokens as gt, isMessagingToolDuplicateNormalized as h, DEFAULT_RESET_TRIGGERS as ht, formatThinkingLevels as i, resolveSignalAccount as in, deliveryContextKey as it, isContextOverflowError as j, resolveProfile as jt, isCloudCodeAssistFormatError as k, registerBrowserRoutes as kt, normalizeThinkLevel as l, resolveSessionKey as lt, isMessagingToolDuplicate as m, resolveThreadFlag as mt, validateGeminiTurns as n, sanitizeGoogleTurnOrdering as nn, resolveCacheTtlMs as nt, listThinkingLevels as o, normalizeDeliveryContext as ot, supportsXHighThinking as p, resolveSessionResetType as pt, resolveMirroredTranscriptText as q, collectExplicitAllowlist as qt, pickFallbackThinkingLevel as r, listEnabledSignalAccounts as rn, deliveryContextFromSession as rt, normalizeElevatedLevel as s, normalizeSessionDeliveryFields as st, validateAnthropicTurns as t, resolveBootstrapMaxChars as tn, isCacheEnabled as tt, normalizeUsageDisplay as u, evaluateSessionFreshness as ut, downgradeOpenAIReasoningBlocks as v, resolveMainSessionKey as vt, formatBillingErrorMessage as w, resolveChannelGroupRequireMention as wt, BILLING_ERROR_USER_MESSAGE as x, listChannelDocks as xt, isAntigravityClaude as y, deriveSessionMetaPatch as yt, parseImageDimensionError as z, assertMediaNotDataUrl as zt };
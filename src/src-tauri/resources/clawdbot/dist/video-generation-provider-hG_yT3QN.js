...
import { a as postJsonRequest, d as resolveProviderOperationTimeoutMs, f as waitProviderOperationPollInterval, n as createProviderOperationDeadline, u as resolveProviderHttpRequestConfig } from "./shared-C_SB36H2.js";
...
import { t as BYTEPLUS_BASE_URL } from "./models-DOv5jsY2.js";
...
function resolveBytePlusVideoBaseUrl(req) {
	return normalizeOptionalString(req.cfg?.models?.providers?.byteplus?.baseUrl) ?? "https://ark.ap-southeast.bytepluses.com/api/v3";
}

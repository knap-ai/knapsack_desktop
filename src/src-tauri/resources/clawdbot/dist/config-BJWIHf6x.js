...
import { $ as resolveStateDir, B as STATE_DIR, Et as resolveRequiredHomeDir, G as resolveDefaultConfigCandidates, H as resolveCanonicalConfigPath, J as resolveIsNixMode, K as resolveGatewayLockDir, Q as resolveOAuthPath, R as CONFIG_PATH, U as resolveConfigPath, V as isNixMode, W as resolveConfigPathCandidate, X as resolveNewStateDir, Y as resolveLegacyStateDirs, Z as resolveOAuthDir, q as resolveGatewayPort, tt as CHANNEL_IDS, ut as normalizeChatChannelId, z as DEFAULT_GATEWAY_PORT } from "./entry.js";
import { Ct as shouldEnableShellEnvFallback, M as parseModelRef, Mt as DEFAULT_CONTEXT_TOKENS, St as shouldDeferShellEnvFallback, bt as loadShellEnvFallback, xt as resolveShellEnvFallbackTimeoutMs } from "./auth-profiles-DnpV8DWM.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID } from "./session-key-DVvxnFKg.js";
import { d as isRecord, g as resolveConfigDir, u as isPlainObject$2, y as resolveUserPath } from "./utils-q1rHOG-N.js";
import { c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-Bu62UIQZ.js";
import { d as resolveMemorySlotDecision, l as normalizePluginsConfig, t as loadPluginManifestRegistry, u as resolveEnableState } from "./manifest-registry-DlFh5LWe.js";
...
//#endregion
export { INCLUDE_KEY as A, getConfigValueAtPath as C, applyMergePatch as D, unsetConfigValueAtPath as E, VERSION as F, loadDotEnv as I, collectConfigEnvVars as M, resolveAgentMaxConcurrent as N, applyLegacyMigrations as O, resolveSubagentMaxConcurrent as P, unsetConfigOverride as S, setConfigValueAtPath as T, parseDurationMs as _, parseConfigJson5 as a, resetConfigOverrides as b, resolveConfigSnapshotHash as c, OpenClawSchema as d, parseByteSize as f, sensitive as g, resolveTelegramCustomCommands as h, loadConfig as i, MAX_INCLUDE_DEPTH as j, isSafeExecutableValue as k, writeConfigFile as l, normalizeTelegramCommandName as m, migrateLegacyConfig as n, readConfigFileSnapshot as o, TELEGRAM_COMMAND_NAME_PATTERN as p, createConfigIO as r, readConfigFileSnapshotForWrite as s, config_exports as t, validateConfigObjectWithPlugins as u, validateJsonSchemaValue as v, parseConfigPath as w, setConfigOverride as x, getConfigOverrides as y };
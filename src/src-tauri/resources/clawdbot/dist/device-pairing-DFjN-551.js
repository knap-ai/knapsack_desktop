...
import { n as normalizeDeviceAuthScopes } from "./device-auth-BD-x90QF.js";
import { a as resolvePairingPaths, i as reconcilePendingPairingRequests, n as verifyPairingToken, o as resolveMissingRequestedScope, r as pruneExpiredPending, s as roleScopesAllow, t as generatePairingToken } from "./pairing-token-VGfB192W.js";
...
function listEffectivePairedDeviceRoles(device) {
	...
	if (activeTokenRoles && activeTokenRoles.length > 0) return activeTokenRoles;
	if (device.tokens && Object.keys(device.tokens).length > 0) return [];
...
//#endregion
export { listDevicePairing as a, removePairedDevice as c, rotateDeviceToken as d, summarizeDeviceTokens as f, hasEffectivePairedDeviceRole as i, requestDevicePairing as l, verifyDeviceToken as m, ensureDeviceToken as n, listEffectivePairedDeviceRoles as o, updatePairedDeviceMetadata as p, getPairedDevice as r, rejectDevicePairing as s, approveDevicePairing as t, revokeDeviceToken as u };

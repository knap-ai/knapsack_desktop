import { i as formatErrorMessage, n as detectErrorKind } from "./errors-Jbvi20TW.js";
...
import { i as getChildLogger } from "./logger-x0IvPL2B.js";
import { b as truncateUtf16Safe, m as resolveUserPath, s as ensureDir, v as sleep } from "./utils-BMRcljdi.js";
import { n as defaultRuntime } from "./runtime-Dx7oeLYq.js";
import { r as isDiagnosticsEnabled, s as setDiagnosticsEnabledForProcess } from "./diagnostic-events-Cz86_awm.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-CWI_MDy_.js";
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-BgREcPbG.js";
import { t as formatCliCommand } from "./command-format-BFuugklF.js";
import { _ as resolveStateDir, i as isNixMode, r as STATE_DIR } from "./paths-BG0ad0P6.js";
...
import { o as getTailnetHostname } from "./tailscale-DQ4Jxduq.js";
import { t as safeEqualSecret } from "./secret-equal-BBFaVgZ-.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-XeQJXdvi.js";
import { _ as resolveRequestClientIp, a as isLoopbackHost, g as resolveHostName, h as resolveGatewayListenHosts, i as isLoopbackAddress, l as isTrustedProxyAddress, m as resolveGatewayBindHost, n as isContainerEnvironment, o as isPrivateOrLoopbackAddress, p as resolveClientIp, r as isLocalishHost, s as isPrivateOrLoopbackHost, t as defaultGatewayBindMode, u as isValidIPv4 } from "./net-AycWGi8-.js";
import { a as createAuthRateLimiter, i as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, n as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, o as normalizeRateLimitClientIp, r as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH } from "./auth-rate-limit-kdcjI6bF.js";
import { a as hasForwardedRequestHeaders, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as checkBrowserOrigin, t as assertGatewayAuthConfigured } from "./auth-CksiX7Zk.js";
...
import { B as shouldAttemptLastKnownGoodRecovery, _ as registerConfigWriteListener, a as loadConfig, c as promoteConfigSnapshotToLastKnownGood, g as recoverConfigFromLastKnownGood, h as recoverConfigFromJsonRootSuffix, i as getRuntimeConfig, j as applyConfigOverrides, nt as resolveAgentMaxConcurrent, r as createConfigIO, rt as resolveSubagentMaxConcurrent, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-Dv_xNAZB.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DfSK5a3n.js";
import { r as isCronRunSessionKey } from "./session-key-utils-BT0y7mVK.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-C3j_3_su.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import { n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-B2TRwbJD.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
import { t as matchesSkillFilter } from "./filter-CBGNTeP4.js";
import { i as isKnownSecretTargetId } from "./target-registry-Bvpbq4Ya.js";
...
import { n as isRestartEnabled } from "./commands.flags-w1EXgeVc.js";
import "./config-yDDhhyz6.js";
import { r as setSafeTimeout } from "./timer-delay-Co_I1iPe.js";
import { G as validateExecApprovalResolveParams, U as validateExecApprovalGetParams, W as validateExecApprovalRequestParams, _t as validateRequestFrame, an as errorShape, cn as getPreauthHandshakeTimeoutMsFromEnv, in as ErrorCodes, k as validateConnectParams, ln as buildDeviceAuthPayload, mt as validatePluginApprovalResolveParams, pt as validatePluginApprovalRequestParams, r as formatValidationErrors, un as buildDeviceAuthPayloadV3, vt as validateSecretsResolveParams, yt as validateSecretsResolveResult } from "./client-kQ1-TM3I.js";
import { o as verifyDeviceSignature, r as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-Bds8sWW-.js";
import { t as rawDataToString } from "./ws-VGsesElb.js";
import { a as isOperatorUiClient, h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, n as isGatewayCliClient, o as isWebchatClient, s as isDeliverableMessageChannel, t as isBrowserOperatorUiClient, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-3n9pnH3U.js";
import { i as buildPairingConnectErrorMessage, m as resolveDeviceAuthConnectErrorDetailCode, n as buildPairingConnectCloseReason, p as resolveAuthConnectErrorDetailCode, r as buildPairingConnectErrorDetails, t as ConnectErrorDetailCodes } from "./connect-error-details-AqnPMQnc.js";
import { a as approvalDecisionLabel, n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS, o as buildPluginApprovalExpiredMessage, s as buildPluginApprovalRequestMessage, t as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-D_mI2Q6z.js";
import { c as PAIRING_SCOPE, d as WRITE_SCOPE, l as READ_SCOPE, o as ADMIN_SCOPE, s as APPROVALS_SCOPE$1, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-B1c_GUbd.js";
import { n as formatConfigIssueLines } from "./issue-format-DpSVQL-G.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-D1cbU4u6.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-CDjVC_TR.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-BZ_I3cWH.js";
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-C-5w-v1N.js";
import { S as createEmptyPluginRegistry, a as getActivePluginRegistry, b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry, x as setActivePluginRegistry } from "./runtime-BFywV6BM.js";
import { i as canonicalizePathVariant, n as PROTECTED_PLUGIN_ROUTE_PREFIXES, r as canonicalizePathForSecurity } from "./http-route-overlap-C2701fGQ.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-D6nplzWA.js";
import "./logging-DFHb42Bl.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel } from "./thinking-C1TCb8El.js";
import { c as normalizeModelSelection, f as resolveConfiguredModelRef, m as resolveHooksGmailModel } from "./model-selection-shared-grYiFZof.js";
import { i as resolveAllowedModelRef, r as getModelRefStatus, t as isCliProvider } from "./model-selection-cli-tYMeEU6-.js";
import { p as resolveThinkingDefault } from "./model-selection-hTT37jzm.js";
import { o as resetModelCatalogCache, r as loadModelCatalog } from "./model-catalog-CcBUIGOS.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-BzfGEj6I.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-qDHoxMjQ.js";
import { o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DvU8Tgvw.js";
import { t as loadSessionStore } from "./store-load-Cf3NDflc.js";
import { u as setSessionRuntimeModel } from "./types--vJusqfs.js";
import { o as updateSessionStore, s as updateSessionStoreEntry, t as archiveRemovedSessionTranscripts } from "./store-Bm25Mivo.js";
import { n as resolveMainSessionKeyFromConfig } from "./sessions-DIdqAx7y.js";
...
import { c as getAgentRunContext, d as sweepStaleRunContexts, l as onAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-DMk-SEBA.js";
import { o as startGatewayModelPricingRefresh } from "./usage-format-CQv_DQWN.js";
import { n as deriveSessionTotalTokens, r as hasNonzeroUsage } from "./usage-xVEV8sHL.js";
import { i as readSessionMessages, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-BDLex3kU.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-DUaKI8c-.js";
import { a as resolveSessionTranscriptCandidates, i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-rIur1Jet.js";
import { a as loadSessionEntry, d as resolveGatewaySessionStoreTarget, i as loadGatewaySessionRow } from "./session-utils-0WhEvb4B.js";
import { i as enqueueCommandInLane, s as getTotalQueueSize, u as setCommandLaneConcurrency } from "./command-queue-B716cKY1.js";
import { n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-C_v_J0E7.js";
import { s as stripHeartbeatToken } from "./heartbeat-DKgfsHcO.js";
import { r as normalizeCronJobInput } from "./openclaw-tools-BIHCDPUL.js";
import { t as getMachineDisplayName } from "./machine-name-DCMjedLv.js";
import { t as detectMime } from "./mime-Zn7U6BSf.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-D72vttCv.js";
import { t as SsrFBlockedError } from "./ssrf-MkDHylX_.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-DKbwHPzH.js";
import { o as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-B_SrebwR.js";
import "./pi-bundle-mcp-tools-D-15SltU.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-C4I_N3QF.js";
import { T as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-BbaGmaa4.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-rZgU3obN.js";
import { n as assertSafeCronSessionTargetId, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-GrfNsneR.js";
import { c as setPreRestartDeferralCheck, n as deferGatewayRestartUntilIdle, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy } from "./restart-BEePx4vW.js";
import { r as cleanOldMedia } from "./store-B9O3InEv.js";
import { a as CANVAS_HOST_PATH, c as injectCanvasLiveReload, l as normalizeUrlPath, s as handleA2uiHttpRequest, u as resolveFileWithinRoot } from "./web-media-CA1OunRg.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-secret-gateway-CDSwZO_q.js";
import { i as evaluateGatewayAuthSurfaceStates, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-CM5vF7po.js";
import { n as resolveConfiguredDeferredChannelPluginIds, r as resolveGatewayStartupPluginIds } from "./channel-plugin-ids-Dc_n_j0K.js";
import { t as deliverOutboundPayloads } from "./deliver-pZGUQZmf.js";
import { r as resetDirectoryCache } from "./target-resolver-8o_pahhn.js";
...
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-D2eWnRin.js";
import { r as getActiveEmbeddedRunCount } from "./runs-D_jbdUDe.js";
import { h as stopDiagnosticHeartbeat, m as startDiagnosticHeartbeat } from "./diagnostic-Dk8ZkzCp.js";
import { _ as onSessionLifecycleEvent, c as initSubagentRegistry } from "./subagent-registry-Cx_UMX3T.js";
import { t as resolveAgentTimeoutMs } from "./timeout-TgWmyBUs.js";
import { c as resolveHookExternalContentSource, o as isExternalHookSession, s as mapHookExternalContentSource } from "./external-content-BNyMCWFo.js";
...
import { t as createPluginRuntime } from "./runtime-CpD1CO96.js";
import { o as getTotalPendingReplies } from "./dispatch-Dw_9PM8V.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-OtSG9lyE.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-ChpqktqJ.js";
import { c as formatExecApprovalExpiresIn, f as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-reply-D_fr2N-O.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-BwkoGmmE.js";
import { n as sanitizeExecApprovalDisplayText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BNdt3-ZG.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-DVKB0Um4.js";
import { i as watchChannelRuntimeContexts, n as getChannelRuntimeContext, t as createTaskScopedChannelRuntime } from "./channel-runtime-context-ox-DA4Av.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BgRCZAYL.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-x8RlGnHR.js";
import { i as onHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-D5nIKHUQ.js";
import { n as resolveAgentOutboundIdentity } from "./identity-BZhaX0q4.js";
import { r as registerSkillsChangeListener } from "./refresh-state-BnK3h63w.js";
import { i as resolveNodeCommandAllowlist, r as normalizeDeclaredNodeCommands } from "./node-command-policy-CJr8CKnd.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs, t as formatForLog } from "./ws-log-BpAFVX4j.js";
import { i as safeParseJson } from "./nodes.helpers-DF8WtLOs.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-Diqv6UQu.js";
import { c as roleScopesAllow } from "./pairing-token-DBydzQ85.js";
import { a as refreshRemoteBinsForConnectedNodes, c as setSkillsRemoteRegistry, h as updatePairedNodeMetadata, i as recordRemoteNodeInfo, m as requestNodePairing, n as primeRemoteSkillsCache, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo, u as getPairedNode } from "./skills-remote-DhFcvH40.js";
import { r as resolveBootstrapProfileScopesForRole } from "./device-bootstrap-profile-G_w2eTHB.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-DFwfBQIP.js";
import { a as redeemDeviceBootstrapTokenProfile, n as getBoundDeviceBootstrapProfile, o as revokeDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as verifyDeviceBootstrapToken } from "./device-bootstrap-JSLx_Ss2.js";
import { t as createDefaultDeps } from "./deps-DWoMp43P.js";
import { i as buildSystemRunApprovalEnvBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-CfjlV1SF.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-C-elhxlO.js";
import { t as closeMcpLoopbackServer } from "./mcp-http-CFgfguST.js";
import { A as getHookSessionKeyPrefixError, B as resolveHookIdempotencyKey, C as setDefaultSecurityHeaders, D as extractHookToken, F as normalizeHookHeaders, H as resolveHookTargetAgentId, I as normalizeWakePayload, K as logRejectedLargePayload, L as readJsonBody, M as isSessionKeyAllowedByPrefix, N as normalizeAgentPayload, O as getHookAgentPolicyError, P as normalizeHookDispatchSessionKey, R as resolveHookChannel, U as resolveHooksConfig, V as resolveHookSessionKey, W as applyHookMappings, _ as loadGatewayModelCatalog, d as resolveHttpBrowserOriginPolicy, g as __resetModelCatalogCacheForTest, h as resolveTrustedHttpOperatorScopes, j as isHookAgentAllowed, k as getHookChannelError, o as getBearerToken, r as authorizeGatewayHttpRequestOrReply, s as getHeader, y as sendGatewayAuthFailure, z as resolveHookDeliver } from "./http-utils-RmXZN896.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Rn_HVA-Z.js";
import { C as TICK_INTERVAL_MS, S as MAX_PREAUTH_PAYLOAD_BYTES, _ as DEDUPE_MAX, b as MAX_BUFFERED_BYTES, f as isSuppressedControlReplyLeadFragment, m as abortChatRunById, p as isSuppressedControlReplyText, v as DEDUPE_TTL_MS, x as MAX_PAYLOAD_BYTES, y as HEALTH_REFRESH_INTERVAL_MS } from "./chat-DznnoAn8.js";
import "./refresh-BtWsrv_4.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-Dpq41UQA.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-C1khoDvK.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-CbifOHxA.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-2BY8uGhf.js";
import { t as GatewayLockError } from "./gateway-lock-PD4D5_no.js";
import { t as getHealthSnapshot } from "./health-DpiT_nOq.js";
import { t as runSetupWizard } from "./setup-bpxff6pc.js";
import { d as startTaskRegistryMaintenance, f as stopTaskRegistryMaintenance, g as markCronJobActive, h as clearCronJobActive, n as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-C10CbBGQ.js";
import { i as migrateOrphanedSessionKeys } from "./state-migrations-CNzJ59iT.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-Dy87ilE4.js";
import { t as createCronExecutionId } from "./run-id-Cuu6cpuA.js";
import { a as resolveHeartbeatAckMaxChars$1, i as resolveCronPayloadOutcome, t as isHeartbeatOnlyResponse } from "./helpers-C4N_JmaS.js";
import { a as resolveCronChannelOutputPolicy, n as markCronSessionPreRun, r as persistCronSkillsSnapshotIfChanged, t as createPersistCronSessionEntry } from "./run-session-state-HGCvtl4v.js";
import { t as runChannelPluginStartupMaintenance } from "./lifecycle-startup-DIRyyNfS.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-B3FaldPb.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-LOaUnfiY.js";
import { C as resolveGatewayReloadSettings, D as roleCanSkipDeviceIdentity, E as parseGatewayRole, O as pruneStaleControlPlaneBuckets, S as diffConfigPaths, T as buildGatewayReloadPlan, _ as appendCronRunLog, a as coreGatewayHandlers, b as resolveCronDeliveryPlan, c as listSystemPresence, d as CANVAS_CAPABILITY_TTL_MS, f as buildCanvasScopedHostUrl, g as loadVoiceWakeConfig, h as formatError, i as setFallbackGatewayContextResolver, l as upsertPresence, m as normalizeCanvasScopedUrl, o as handleGatewayRequest, p as mintCanvasCapabilityToken, s as broadcastPresenceSnapshot, t as loadGatewayStartupPlugins, u as clearNodeWakeState, v as resolveCronRunLogPath, w as startGatewayConfigReloader, x as resolveFailureDestination, y as resolveCronRunLogPruneOptions } from "./server-plugin-bootstrap-DBjRPg3N.js";
import { i as resolveCronSession, n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-CjYcq5k0.js";
import { n as stopGmailWatcher, t as startGmailWatcherWithLogs } from "./gmail-watcher-lifecycle-BtiQxfpJ.js";
import "./paths-nEitK80H.js";
import { t as getUpdateAvailable } from "./update-startup-D6QOQPIX.js";
import { t as hasConfiguredInternalHooks } from "./configured-CBx8Q0oB.js";
...
function loadExecApprovalForwarderRuntime() {
	execApprovalForwarderRuntimePromise ??= import("./exec-approval-forwarder.runtime-CpzsMlgO.js");
...
async function loadSkillsSnapshotRuntime() {
	skillsSnapshotRuntimePromise ??= import("./skills-snapshot.runtime-Cq_hr4K_.js");
...
function resolveMessagingToolSentTargets(params) {
	...
	return [{
		...
		...params.resolvedDelivery.threadId ? { threadId: String(params.resolvedDelivery.threadId) } : {}
	}];
}
...
async function loadCliRunnerRuntime() {
	return await import("./cli-runner.runtime-CjS9wP4p.js");
}
async function loadUsageFormatRuntime() {
	return await import("./usage-format-DtwePY-U.js");
}
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-Cr203n29.js");
		const { deliverOutboundPayloads } = await import("./deliver-DKcbzGYs.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-mQedG9j5.js");
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-x_AEw1Iy.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CR1O4csV.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-BLkOenEM.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-D8S5HMue.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DNil9O6m.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DFobw3Ww.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-BJuqBOiC.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DGZEfW6V.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-D8BQdi6c.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-DxEbZW3I.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-Br7YPipa.js");
...
const NODE_ALLOWED_EVENTS = new Set(["voicewake.changed"]);
...
async function hasGatewayStartupInternalHookListeners() {
	const { hasInternalHookListeners } = await import("./internal-hooks-CVZWEVD3.js");
	return hasInternalHookListeners("gateway", "startup");
}
async function prewarmConfiguredPrimaryModel(params) {
	const { resolveAgentModelPrimaryValue } = await import("./model-input-C5catQfI.js");
	const explicitPrimary = resolveAgentModelPrimaryValue(params.cfg.agents?.defaults?.model)?.trim();
	if (!explicitPrimary) return;
	const { normalizeProviderId } = await import("./provider-id-CdK5Gumd.js");
	...
	const [{ resolveOpenClawAgentDir }, { DEFAULT_MODEL, DEFAULT_PROVIDER }, { selectAgentHarness }, { isCliProvider, resolveConfiguredModelRef }, { ensureOpenClawModelsJson }, { resolveModel, resolveModelAsync }, { resolveEmbeddedAgentRuntime }] = await Promise.all([
		import("./agent-paths-Df9SsfNT.js"),
		import("./defaults-Bg4-Ke4I.js"),
		import("./selection-2q7rj9j5.js"),
		import("./model-selection-C5fefleX.js"),
		import("./models-config-DxcgoTwu.js"),
		import("./model-vwgohX5o.js"),
		import("./runtime-3HrONy7s.js")
	]);
...
async function startGatewaySidecars(params) {
	await measureStartup(params.startupTrace, "sidecars.session-locks", async () => {
		try {
			const [{ resolveStateDir }, { resolveAgentSessionDirs }, { cleanStaleLockFiles }] = await Promise.all([
				import("./paths-B9gDVNgd.js"),
				import("./session-dirs-BqvOcxrO.js"),
				import("./session-write-lock-DR_YHSqA.js")
			]);
			...
			for (const sessionsDir of sessionDirs) {
				...
				if (result.cleaned.length > 0) {
					const { markRestartAbortedMainSessionsFromLocks } = await import("./main-session-restart-recovery-CR5EoE4V.js");
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-watch", async () => {
		if (params.cfg.hooks?.enabled && params.cfg.hooks.gmail?.account) {
			const { startGmailWatcherWithLogs } = await import("./gmail-watcher-lifecycle-D04ns3-S.js");
			await startGmailWatcherWithLogs({
				cfg: params.cfg,
				log: params.logHooks
			});
	...
	await measureStartup(params.startupTrace, "sidecars.gmail-model", async () => {
		if (params.cfg.hooks?.gmail?.model) {
			const [{ DEFAULT_MODEL, DEFAULT_PROVIDER }, { loadModelCatalog }, { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel }] = await Promise.all([
				import("./defaults-Bg4-Ke4I.js"),
				import("./model-catalog-CC3baMxe.js"),
				import("./model-selection-C5fefleX.js")
			]);
	...
	await measureStartup(params.startupTrace, "sidecars.internal-hooks", async () => {
		try {
			if (internalHooksConfigured) {
				const [{ setInternalHooksEnabled }, { loadInternalHooks }] = await Promise.all([import("./internal-hooks-CVZWEVD3.js"), import("./loader-DguMM_LA.js")]);
	...
	if (internalHooksConfigured || await hasGatewayStartupInternalHookListeners()) setTimeout(() => {
		import("./internal-hooks-CVZWEVD3.js").then(({ createInternalHookEvent, triggerInternalHook }) => {
	...
	await measureStartup(params.startupTrace, "sidecars.plugin-services", async () => {
		try {
			const { startPluginServices } = await import("./services-DD7sZb1Q.js");
	...
	if (params.cfg.acp?.enabled) {
		const [{ getAcpSessionManager }, { ACP_SESSION_IDENTITY_RENDERER_VERSION }] = await Promise.all([import("./manager-DldW_kFR.js"), import("./session-identifiers-CrRWq42M.js")]);
		getAcpSessionManager().reconcilePendingSessionIdentities({ cfg: params.cfg }).then((result) => {
	...
	await measureStartup(params.startupTrace, "sidecars.memory", async () => {
		...
		setImmediate(() => {
			import("./server-startup-memory-kT6lKCrb.js").then(({ startGatewayMemoryBackend }) => startGatewayMemoryBackend({
				cfg: params.cfg,
				log: params.log
			})).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.restart-sentinel", async () => {
		...
		const { hasRestartSentinel } = await import("./restart-sentinel-BLetiNOM.js");
		if (!await hasRestartSentinel()) return;
		setTimeout(() => {
			import("./server-restart-sentinel-mQedG9j5.js").then(({ scheduleRestartSentinelWake }) => scheduleRestartSentinelWake({ deps: params.deps })).catch((err) => {
	...
	await measureStartup(params.startupTrace, "sidecars.subagent-recovery", async () => {
		const { scheduleSubagentOrphanRecovery } = await import("./subagent-registry-D1a2QmRY.js");
		scheduleSubagentOrphanRecovery();
	});
	await measureStartup(params.startupTrace, "sidecars.main-session-recovery", async () => {
		const { scheduleRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-CR5EoE4V.js");
		scheduleRestartAbortedMainSessionRecovery();
	});
	return { pluginServices };
}
const defaultGatewayPostAttachRuntimeDeps = {
	getGlobalHookRunner: async () => (await import("./hook-runner-global-DeZ-OzGM.js")).getGlobalHookRunner(),
	logGatewayStartup: async (params) => (await import("./server-startup-log-B9JxhIZA.js")).logGatewayStartup(params),
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-Bx3MDqdR.js")).scheduleGatewayUpdateCheck(...args),
	startGatewaySidecars,
	startGatewayTailscaleExposure: async (...args) => (await import("./server-tailscale-CXQcRXwE.js")).startGatewayTailscaleExposure(...args)
};
...
function shouldAllowSilentLocalPairing(params) {
	...
	if (params.reason === "metadata-upgrade" && (params.locality === "cli_container_local" || params.locality === "shared_secret_loopback_local")) return true;
	return false;
}
...
function createGatewayStartupTrace() {
	...
	const emit = (name, durationMs, totalMs) => {
		if (enabled) log.info(`startup trace: ${name} ${durationMs.toFixed(1)}ms total=${totalMs.toFixed(1)}ms`);
	};
	return {
		mark(name) {
	...
	try {
		...
		if (!minimalTestGateway) {
			if (deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-fKTDDDB0.js");

import { B as theme, R as colorize, k as info, t as createSubsystemLogger, u as defaultRuntime, z as isRich } from "./subsystem-QRNIBE7-.js";
import { Er as peekSystemEvents, F as resolveHeartbeatSenderContext, Ln as resolveUserTimezone, Mn as resolveEffectiveMessagesConfig, P as resolveHeartbeatDeliveryTarget, _r as resolveHeartbeatPrompt$1, ar as getQueueSize, gr as isHeartbeatContentEffectivelyEmpty, hr as DEFAULT_HEARTBEAT_EVERY, ht as setHeartbeatWakeHandler, mr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, mt as requestHeartbeatNow, t as getReplyFromConfig, ur as CommandLane, vr as stripHeartbeatToken } from "./reply-BNEkWD6b.js";
import { d as resolveAgentIdFromSessionKey, h as toAgentStoreSessionKey, l as normalizeAgentId } from "./session-key-BWxPj0z_.js";
import { t as runCommandWithTimeout } from "./exec-BDyx_yxc.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-CnzGNXsk.js";
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-DMGrQp5u.js";
import { t as isTruthyEnvValue } from "./env-BSjH4KuP.js";
import { _ as parseDurationMs, i as loadConfig } from "./config-CWifpzL_.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-CLo5nH74.js";
import { A as resolveAgentMainSessionKey, i as loadSessionStore, k as canonicalizeMainSessionAlias, l as updateSessionStore, s as saveSessionStore } from "./sessions-ezP1qtWM.js";
import { n as formatErrorMessage } from "./errors-BeAy8PFi.js";
import { c as resolveStorePath } from "./paths-BuQbsACT.js";
import { C as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-BUfUVLsa.js";
...
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as appendCronStyleCurrentTimeLine, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-B_LxQECx.js";
...
function buildCronEventPrompt(pendingEvents) {
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fsPromises.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason && !isCronEventReason && !isWakeReason) {
			emitHeartbeatEvent({
				status: "skipped",
	...
	const ctx = {
		Body: appendCronStyleCurrentTimeLine(hasExecCompletion ? EXEC_EVENT_PROMPT : hasCronEvents ? buildCronEventPrompt(cronEvents) : resolveHeartbeatPrompt(cfg, heartbeat), cfg, startedAt),
		From: sender,
		To: sender,
...
function startHeartbeatRunner(opts) {
	...
	const wakeHandler = async (params) => run({ reason: params.reason });
...
//#endregion
export { runHeartbeatOnce as a, formatHealthCheckFailure as c, resolveControlUiDistIndexPathForRoot as d, resolveControlUiRootOverrideSync as f, resolveHeartbeatSummaryForAgent as i, ensureControlUiAssetsBuilt as l, getHealthSnapshot as n, setHeartbeatsEnabled as o, resolveControlUiRootSync as p, healthCommand as r, startHeartbeatRunner as s, formatHealthChannelLines as t, resolveControlUiDistIndexHealth as u };
...
import { N as resolveProviderStreamFn, R as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-C1HXSRlX.js";
import { c as detectOpenAICompletionsCompat } from "./provider-model-compat-C_Djlg3U.js";
import { a as resolveOpenAIReasoningEffortForModel, i as normalizeOpenAIReasoningEffort, n as resolveOpenAIResponsesPayloadPolicy, r as flattenCompletionMessagesToStringContent, t as applyOpenAIResponsesPayloadPolicy } from "./openai-responses-payload-policy-nh4fYQcn.js";
import { i as getModelProviderRequestTransport } from "./provider-request-config-Bxj9Jz-Z.js";
...
import { n as applyAnthropicPayloadPolicyToParams, r as resolveAnthropicPayloadPolicy } from "./anthropic-payload-policy-DRJLBLIc.js";
import { r as hasCopilotVisionInput, t as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-Cjo05vxn.js";
import { a as finalizeTransportStream, c as sanitizeTransportPayloadText, h as buildGuardedModelFetch, i as failTransportStream, l as transformTransportMessages, n as createEmptyTransportUsage, o as mergeTransportHeaders, r as createWritableTransportEventStream, s as mergeTransportMetadata, t as coerceTransportToolCallArguments } from "./transport-stream-shared-21GahxfU.js";
import { randomUUID } from "node:crypto";
import { calculateCost, createAssistantMessageEventStream, getApiProvider, getEnvApiKey, parseStreamingJson, registerApiProvider } from "@mariozechner/pi-ai";
...
//#endregion
export { prepareTransportAwareSimpleModel as a, mapOpenAIReasoningEffortForModel as c, createBoundaryAwareStreamFnForModel as i, resolveOpenAIStrictToolSetting as l, ensureCustomApiRegistered as n, normalizeOpenAIStrictToolParameters as o, buildTransportAwareSimpleStreamFn as r, resolveOpenAIStrictToolFlagForInventory as s, registerProviderStreamForModel as t };

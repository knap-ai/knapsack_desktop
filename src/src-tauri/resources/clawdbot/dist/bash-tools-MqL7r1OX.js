...
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-Btzm9BXg.js";
import { a as logWarn, r as logInfo } from "./logger-bvytzgs1.js";
import { G as getShellPathFromLoginShell, K as resolveShellEnvFallbackTimeoutMs } from "./io-Dv_xNAZB.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-BT0y7mVK.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-D1Q1dhng.js";
import { t as killProcessTree } from "./kill-tree-Dpy6bZkg.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-BRwSoIeK.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DArLXMH2.js";
import { C as formatExecDeniedUserMessage, T as parseExecApprovalResultText, u as sanitizeUserFacingText, w as isExecDeniedResultText } from "./sanitize-user-facing-text-BDMAKrLb.js";
import { o as failedTextResult, v as textResult } from "./common-B4WrK_Ib.js";
import { t as callGatewayTool } from "./gateway-ChidttH0.js";
import { t as splitShellArgs } from "./shell-argv-CCHEDreI.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-BDAr27rw.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DrT-K-_k.js";
...
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BFd_6aSa.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-Cayaq47p.js";
import "./delivery-context-CEfA2BWP.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-BeXIJGUe.js";
import { t as sendMessage } from "./message-C1nEanJA.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-cmVsa-aC.js";
...
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-BI_u3aB-.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-D_fr2N-O.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-Dhwdea3U.js";
import { t as getProcessSupervisor } from "./supervisor-C-TehxnY.js";
import { C as setJobTtlMs, S as markExited, _ as getFinishedSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listRunningSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as drainSession, h as deleteSession, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getSession, w as tail, x as markBackgrounded, y as listFinishedSessions } from "./bash-tools.exec-runtime-DHmKQe9a.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-C-elhxlO.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-D0D4E-Bs.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-CciCxcJF.js");

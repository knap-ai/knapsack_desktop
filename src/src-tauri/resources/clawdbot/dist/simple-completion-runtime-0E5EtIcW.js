...
import { n as resolveAgentEffectiveModelPrimary, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
import { a as prepareProviderRuntimeAuth } from "./provider-runtime.runtime-CPcX_E9g.js";
import { g as splitTrailingAuthProfile, h as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-grYiFZof.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-hTT37jzm.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-Di2YDk33.js";
import { t as resolveModel } from "./model-8YSRxxGm.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-uZbCJPwT.js");

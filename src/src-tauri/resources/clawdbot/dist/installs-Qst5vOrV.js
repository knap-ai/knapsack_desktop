...
import { g as resolvePackageExtensionEntries } from "./min-host-version-RMBWtIAR.js";
import { t as buildNpmResolutionFields } from "./install-source-utils-C3NuFv6M.js";
import { a as unscopedPackageName, i as safePathSegmentHashed, n as resolveSafeInstallDir, r as safeDirName } from "./install-safe-path-glAp3aTO.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/plugins/install.ts
let pluginInstallRuntimePromise;
async function loadPluginInstallRuntime() {
	pluginInstallRuntimePromise ??= import("./install.runtime-DDmlaKdG.js");
...
//#endregion
export { installPluginFromNpmSpec as a, installPluginFromArchive as i, recordPluginInstall as n, installPluginFromPath as o, PLUGIN_INSTALL_ERROR_CODE as r, resolvePluginInstallDir as s, buildNpmResolutionInstallFields as t };

...
import { t as danger } from "./globals-DeRFSEIV.js";
...
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-B2TRwbJD.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-SKQWPWlq.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-TGDlD7dJ.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CErkrrS9.js";
...
import { t as parseLogLine } from "./parse-log-line-CIgPKzdp.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-YAkWWUlT.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-C2vIjPok.js";
import { c as requireValidConfig, l as shouldUseWizard, o as channelLabel, s as formatChannelAccountLabel } from "./shared-t6_fy18Q.js";
import { t as channelsListCommand } from "./list-CotP0LeY.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BiUuINPz.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-DKw7LDSD.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-DBwmUkyk.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-c0D22A2F.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-C3uqPliF.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-C8lT_4pB.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = !useWizard && rawChannel && (!channel || !getChannelPlugin(channel)) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CGPmGIqx.js");

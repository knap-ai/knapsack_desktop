...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-DMXXugcC.js";
import { n as require_extend, t as require_package$1 } from "./package-Ba7QPmKG.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-D5RpnSXj.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-DXQK8Hfj.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.

...
import { o as getRuntimeConfigSnapshot } from "./io-DhtVmzAJ.js";
import { a as registerSessionBindingAdapter, o as unregisterSessionBindingAdapter } from "./session-binding-service-CAxmjUEJ.js";
import { pn as readAcpSessionEntry } from "./pi-embedded-BYdcxQ5A.js";
import { _ as resolveThreadBindingFarewellText, s as resolveThreadBindingIdleTimeoutMs, u as resolveThreadBindingMaxAgeMs, v as resolveThreadBindingIntroText, y as resolveThreadBindingThreadName } from "./thread-bindings-policy-ypJ47uk9.js";
import "./routing-Br1fEo8A.js";
import "./runtime-env-CoykX19-.js";
import "./config-runtime-CmISCurQ.js";
import { t as resolveThreadBindingConversationIdFromBindingId } from "./conversation-runtime-DIsQmaYR.js";
...
import { M as createDiscordRestClient } from "./send.components-sVt5Smd7.js";
import { A as resolveThreadBindingsPath, C as resetThreadBindingsForTests, D as resolveThreadBindingInactivityExpiresAt, E as resolveThreadBindingIdleTimeoutMs$1, F as DEFAULT_THREAD_BINDING_IDLE_TIMEOUT_MS, I as THREAD_BINDINGS_SWEEP_INTERVAL_MS, M as setBindingRecord, N as shouldDefaultPersist, O as resolveThreadBindingMaxAgeExpiresAt, P as shouldPersistBindingMutations, S as removeBindingRecord, T as resolveBindingRecordKey, _ as normalizeTargetKind, a as isThreadArchived, b as rememberRecentUnboundWebhookEcho, c as summarizeDiscordError, d as PERSIST_BY_ACCOUNT_ID, f as THREAD_BINDING_TOUCH_PERSIST_MIN_INTERVAL_MS, h as getThreadBindingToken, i as isDiscordThreadGoneError, j as saveBindingsToDisk, k as resolveThreadBindingMaxAgeMs$1, l as BINDINGS_BY_THREAD_ID, m as forgetThreadBindingToken, n as createWebhookForChannel, o as maybeSendBindingMessage, p as ensureBindingsLoaded, r as findReusableWebhook, s as resolveChannelIdForBinding, t as createThreadForBinding, u as MANAGERS_BY_ACCOUNT_ID, v as normalizeThreadBindingDurationMs, w as resolveBindingIdsForSession, x as rememberThreadBindingToken, y as normalizeThreadId } from "./thread-bindings.discord-api-WOO9VoBT.js";
...
function createThreadBindingManager(params = {}) {
	...
	const manager = {
		...
		bindTarget: async (bindParams) => {
			...
			const record = {
				...
				idleTimeoutMs,
				maxAgeMs,
				metadata: bindParams.metadata && typeof bindParams.metadata === "object" ? { ...bindParams.metadata } : void 0
			};
	...
	const sessionBindingAdapter = {
		...
		resolveByConversation: (ref) => {
			...
			return binding ? toSessionBindingRecord(binding, {
				idleTimeoutMs,
				maxAgeMs
			}) : null;
		},
...
//#endregion
export { setThreadBindingIdleTimeoutBySessionKey as a, __testing as c, getThreadBindingManager as d, resolveDiscordThreadBindingIdleTimeoutMs as f, reconcileAcpThreadBindingsOnStartup as i, createNoopThreadBindingManager as l, listThreadBindingsBySessionKey as n, setThreadBindingMaxAgeBySessionKey as o, resolveDiscordThreadBindingMaxAgeMs as p, listThreadBindingsForAccount as r, unbindThreadBindingsBySessionKey as s, autoBindSpawnedDiscordSubagent as t, createThreadBindingManager as u };

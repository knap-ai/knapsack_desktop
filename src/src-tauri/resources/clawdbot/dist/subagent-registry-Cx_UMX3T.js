import { c as readErrorName, i as formatErrorMessage } from "./errors-Jbvi20TW.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-DMk-SEBA.js";
import { A as subagentRuns, C as SUBAGENT_ENDED_OUTCOME_ERROR, D as SUBAGENT_ENDED_REASON_ERROR, E as SUBAGENT_ENDED_REASON_COMPLETE, O as SUBAGENT_ENDED_REASON_KILLED, S as resolveSubagentSessionStatus, T as SUBAGENT_ENDED_OUTCOME_TIMEOUT, a as countActiveRunsForSessionFromRuns, b as getSubagentSessionRuntimeMs, c as getSubagentRunByChildSessionKeyFromRuns, d as listRunsForControllerFromRuns, i as countActiveDescendantRunsFromRuns, k as SUBAGENT_TARGET_KIND_SUBAGENT, n as persistSubagentRunsToDisk, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listDescendantRunsForRequesterFromRuns, v as isStaleUnendedSubagentRun, w as SUBAGENT_ENDED_OUTCOME_KILLED, x as getSubagentSessionStartedAt } from "./subagent-registry-state-BdxY8kqY.js";
import { a as isSilentReplyText } from "./tokens-C_v_J0E7.js";
import { s as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-B_SrebwR.js";
import "./pi-bundle-mcp-tools-D-15SltU.js";
import { r as callGateway } from "./call-Gv9tybWD.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-DMFXr5JS.js";
import { i as failTaskRunByRunId, o as setDetachedTaskDeliveryStatusByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-D2eWnRin.js";
import "./subagent-announce-queue-e4OBmCrw.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-49CgZWUJ.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-D4bBoO2Y.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-DxUH9sbg.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-CxOvUv9q.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-B7rwbSQg.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-CxOvUv9q.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-Bqq0_cC8.js").then(({ scheduleOrphanRecovery }) => {

...
import { t as require_dist_cjs$33 } from "./dist-cjs-WSNQnW7p.js";
import { t as require_dist_cjs$34 } from "./dist-cjs-g8U_euY0.js";
import { a as setCredentialFeature, i as setFeature$2, n as init_client, o as emitWarningIfUnsupportedVersion, r as setTokenFeature, s as state } from "./client-Cta4m6Io.js";
import { C as require_dist_cjs$40, S as require_dist_cjs$37, d as endpoints_exports, f as init_endpoints, h as require_dist_cjs$36, i as requestBuilder$1, m as require_dist_cjs$39, n as init_protocols$3, t as require_dist_cjs$41, v as require_dist_cjs$35, y as require_dist_cjs$38 } from "./dist-cjs-Bw_je4qJ.js";
import { n as require_dist_cjs$43, t as require_dist_cjs$42 } from "./dist-cjs-DPPy6JFe.js";
import { t as require_dist_cjs$44 } from "./dist-cjs-C-v0A3hP.js";
import { n as require_dist_cjs$45, r as require_dist_cjs$47, t as require_dist_cjs$46 } from "./dist-cjs-Cpxgp4nL.js";
//#region node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/utils/getDateHeader.js
var import_dist_cjs$49, getDateHeader;
var init_getDateHeader = __esmMin((() => {
	import_dist_cjs$49 = require_dist_cjs$34();
	getDateHeader = (response) => import_dist_cjs$49.HttpResponse.isInstance(response) ? response.headers?.date ?? response.headers?.Date : void 0;
}));
//#endregion
...
var import_dist_cjs$48, throwSigningPropertyError, validateSigningProperties, AwsSdkSigV4Signer, AWSSDKSigV4Signer;
var init_AwsSdkSigV4Signer = __esmMin((() => {
	import_dist_cjs$48 = require_dist_cjs$34();
	init_utils();
	...
	AwsSdkSigV4Signer = class {
		async sign(httpRequest, identity, signingProperties) {
			if (!import_dist_cjs$48.HttpRequest.isInstance(httpRequest)) throw new Error("The request is not an instance of `HttpRequest` and cannot be signed");
...
var import_dist_cjs$47, AwsSdkSigV4ASigner;
var init_AwsSdkSigV4ASigner = __esmMin((() => {
	import_dist_cjs$47 = require_dist_cjs$34();
	init_utils();
	init_AwsSdkSigV4Signer();
	AwsSdkSigV4ASigner = class extends AwsSdkSigV4Signer {
		async sign(httpRequest, identity, signingProperties) {
			if (!import_dist_cjs$47.HttpRequest.isInstance(httpRequest)) throw new Error("The request is not an instance of `HttpRequest` and cannot be signed");
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/getSmithyContext.js
var init_getSmithyContext$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/httpAuthSchemeMiddleware.js
var init_httpAuthSchemeMiddleware$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemeEndpointRuleSetPlugin.js
var init_getHttpAuthSchemeEndpointRuleSetPlugin$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemePlugin.js
var init_getHttpAuthSchemePlugin$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/index.js
var init_middleware_http_auth_scheme$2 = __esmMin((() => {
	init_httpAuthSchemeMiddleware$2();
	init_getHttpAuthSchemeEndpointRuleSetPlugin$2();
	init_getHttpAuthSchemePlugin$2();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-signing/httpSigningMiddleware.js
var init_httpSigningMiddleware$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-signing/getHttpSigningMiddleware.js
var init_getHttpSigningMiddleware$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/middleware-http-signing/index.js
var init_middleware_http_signing$2 = __esmMin((() => {
	init_httpSigningMiddleware$2();
	init_getHttpSigningMiddleware$2();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/normalizeProvider.js
var normalizeProvider$2;
var init_normalizeProvider$2 = __esmMin((() => {
	normalizeProvider$2 = (input) => {
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/collect-stream-body.js
var import_dist_cjs$46, collectBody$1;
var init_collect_stream_body$1 = __esmMin((() => {
	import_dist_cjs$46 = require_dist_cjs$35();
	collectBody$1 = async (streamBody = new Uint8Array(), context) => {
		if (streamBody instanceof Uint8Array) return import_dist_cjs$46.Uint8ArrayBlobAdapter.mutate(streamBody);
		if (!streamBody) return import_dist_cjs$46.Uint8ArrayBlobAdapter.mutate(new Uint8Array());
		const fromContext = context.streamCollector(streamBody);
		return import_dist_cjs$46.Uint8ArrayBlobAdapter.mutate(await fromContext);
	};
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/extended-encode-uri-component.js
function extendedEncodeURIComponent$1(str) {
	return encodeURIComponent(str).replace(/[!'()*]/g, function(c) {
		return "%" + c.charCodeAt(0).toString(16).toUpperCase();
	});
}
var init_extended_encode_uri_component$1 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/deref.js
var deref;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/schemas/operation.js
var init_operation = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/middleware/getSchemaSerdePlugin.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/schemas/translateTraits.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/schemas/NormalizedSchema.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/schemas/sentinels.js
var init_sentinels = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/TypeRegistry.js
var TypeRegistry;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/schema/index.js
var init_schema = __esmMin((() => {
	init_deref();
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/copyDocumentWithTransform.js
var init_copyDocumentWithTransform = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/parse-utils.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/date-utils.js
...
var DAYS, MONTHS, RFC3339_WITH_OFFSET$1, parseRfc3339DateTimeWithOffset, IMF_FIXDATE$1, RFC_850_DATE$1, ASC_TIME$1, parseRfc7231DateTime, parseEpochTimestamp, buildDate, parseTwoDigitYear, FIFTY_YEARS_IN_MILLIS, adjustRfc850Year, parseMonthByShortName, DAYS_IN_MONTH, validateDayOfMonth, isLeapYear, parseDateValue, parseMilliseconds, parseOffsetToMilliseconds, stripLeadingZeroes;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/generateIdempotencyToken.js
var import_dist_cjs$45;
var init_generateIdempotencyToken = __esmMin((() => {
	import_dist_cjs$45 = require_dist_cjs$36();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/lazy-json.js
var LazyJsonString;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/quote-header.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/schema-serde-lib/schema-date-utils.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/split-every.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/split-header.js
var splitHeader;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/value/NumericValue.js
function nv(input) {
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/serde/index.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/SerdeContext.js
var SerdeContext;
var init_SerdeContext$1 = __esmMin((() => {
	SerdeContext = class {
		serdeContext;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/HttpProtocol.js
var import_dist_cjs$44, HttpProtocol;
var init_HttpProtocol$1 = __esmMin((() => {
	init_schema();
	import_dist_cjs$44 = require_dist_cjs$34();
	init_SerdeContext$1();
	HttpProtocol = class extends SerdeContext {
		...
		getRequestType() {
			return import_dist_cjs$44.HttpRequest;
		}
		getResponseType() {
			return import_dist_cjs$44.HttpResponse;
		}
		setSerdeContext(serdeContext) {
			this.serdeContext = serdeContext;
		...
		async loadEventStreamCapability() {
			const { EventStreamSerde } = await import("./event-streams-x9F3Kuz5.js");
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/HttpBindingProtocol.js
var import_dist_cjs$42, import_dist_cjs$43, HttpBindingProtocol;
var init_HttpBindingProtocol$1 = __esmMin((() => {
	init_schema();
	init_serde();
	import_dist_cjs$42 = require_dist_cjs$34();
	import_dist_cjs$43 = require_dist_cjs$35();
	init_collect_stream_body$1();
	init_extended_encode_uri_component$1();
	init_HttpProtocol$1();
	HttpBindingProtocol = class extends HttpProtocol {
		async serializeRequest(operationSchema, _input, context) {
			...
			let payload;
			const request = new import_dist_cjs$42.HttpRequest({
				protocol: "",
				hostname: "",
				port: void 0,
				path: "",
			...
			for (const [memberName, memberNs] of ns.structIterator()) {
				...
				if (memberTraits.httpPayload) {
					...
					if (request.path.includes(`{${memberName}+}`)) request.path = request.path.replace(`{${memberName}+}`, replacement.split("/").map(extendedEncodeURIComponent$1).join("/"));
					else if (request.path.includes(`{${memberName}}`)) request.path = request.path.replace(`{${memberName}}`, extendedEncodeURIComponent$1(replacement));
					delete input[memberName];
		...
		async deserializeHttpMessage(schema, context, response, arg4, arg5) {
			...
			for (const [memberName, memberSchema] of ns.structIterator()) {
				...
				if (memberTraits.httpPayload) {
					...
					else dataObject[memberName] = (0, import_dist_cjs$43.sdkStreamMixin)(response.body);
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/RpcProtocol.js
var import_dist_cjs$41, RpcProtocol;
var init_RpcProtocol$1 = __esmMin((() => {
	init_schema();
	import_dist_cjs$41 = require_dist_cjs$34();
	init_collect_stream_body$1();
	init_HttpProtocol$1();
	RpcProtocol = class extends HttpProtocol {
		async serializeRequest(operationSchema, input, context) {
			...
			let payload;
			const request = new import_dist_cjs$41.HttpRequest({
				protocol: "",
				hostname: "",
				port: void 0,
				path: "/",
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/resolve-path.js
var init_resolve_path$1 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/requestBuilder.js
var init_requestBuilder$4 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/serde/determineTimestampFormat.js
...
var init_determineTimestampFormat$1 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/serde/FromStringShapeDeserializer.js
var import_dist_cjs$39, import_dist_cjs$40, FromStringShapeDeserializer;
var init_FromStringShapeDeserializer$1 = __esmMin((() => {
	init_schema();
	init_serde();
	import_dist_cjs$39 = require_dist_cjs$37();
	import_dist_cjs$40 = require_dist_cjs$42();
	init_SerdeContext$1();
	init_determineTimestampFormat$1();
	FromStringShapeDeserializer = class extends SerdeContext {
		...
		read(_schema, data) {
			...
			if (ns.isBlobSchema()) return (this.serdeContext?.base64Decoder ?? import_dist_cjs$39.fromBase64)(data);
		...
		base64ToUtf8(base64String) {
			return (this.serdeContext?.utf8Encoder ?? import_dist_cjs$40.toUtf8)((this.serdeContext?.base64Decoder ?? import_dist_cjs$39.fromBase64)(base64String));
		}
	};
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/serde/HttpInterceptingShapeDeserializer.js
var import_dist_cjs$38, HttpInterceptingShapeDeserializer;
var init_HttpInterceptingShapeDeserializer$1 = __esmMin((() => {
	init_schema();
	import_dist_cjs$38 = require_dist_cjs$42();
	init_SerdeContext$1();
	init_FromStringShapeDeserializer$1();
	HttpInterceptingShapeDeserializer = class extends SerdeContext {
		...
		read(schema, data) {
			const ns = NormalizedSchema.of(schema);
			const traits = ns.getMergedTraits();
			const toString = this.serdeContext?.utf8Encoder ?? import_dist_cjs$38.toUtf8;
			if (traits.httpHeader || traits.httpResponseCode) return this.stringDeserializer.read(ns, toString(data));
			if (traits.httpPayload) {
				if (ns.isBlobSchema()) {
					const toBytes = this.serdeContext?.utf8Decoder ?? import_dist_cjs$38.fromUtf8;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/serde/ToStringShapeSerializer.js
var import_dist_cjs$37, ToStringShapeSerializer;
var init_ToStringShapeSerializer$1 = __esmMin((() => {
	init_schema();
	init_serde();
	import_dist_cjs$37 = require_dist_cjs$37();
	init_SerdeContext$1();
	init_determineTimestampFormat$1();
			...
			switch (typeof value) {
				case "object":
					...
					if (ns.isBlobSchema() && "byteLength" in value) {
						this.stringBuffer = (this.serdeContext?.base64Encoder ?? import_dist_cjs$37.toBase64)(value);
						return;
					}
				...
				case "string":
					...
					if (mediaType) {
						...
						if (ns.getMergedTraits().httpHeader) {
							this.stringBuffer = (this.serdeContext?.base64Encoder ?? import_dist_cjs$37.toBase64)(intermediateValue.toString());
							return;
						}
					}
					this.stringBuffer = value;
					break;
				default: if (ns.isIdempotencyToken()) this.stringBuffer = (0, import_dist_cjs$45.v4)();
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/serde/HttpInterceptingShapeSerializer.js
var HttpInterceptingShapeSerializer;
var init_HttpInterceptingShapeSerializer$1 = __esmMin((() => {
	init_schema();
	init_ToStringShapeSerializer$1();
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/protocols/index.js
var init_protocols$2 = __esmMin((() => {
	init_collect_stream_body$1();
	init_extended_encode_uri_component$1();
	init_HttpBindingProtocol$1();
	init_HttpProtocol$1();
	init_RpcProtocol$1();
	init_requestBuilder$4();
	init_resolve_path$1();
	init_FromStringShapeDeserializer$1();
	init_HttpInterceptingShapeDeserializer$1();
	init_HttpInterceptingShapeSerializer$1();
	init_ToStringShapeSerializer$1();
	init_determineTimestampFormat$1();
	init_SerdeContext$1();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/request-builder/requestBuilder.js
var init_requestBuilder$3 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/setFeature.js
var init_setFeature$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/DefaultIdentityProviderConfig.js
var init_DefaultIdentityProviderConfig$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/httpApiKeyAuth.js
var init_httpApiKeyAuth$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/httpBearerAuth.js
var init_httpBearerAuth$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/noAuth.js
var init_noAuth$2 = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/index.js
var init_httpAuthSchemes$3 = __esmMin((() => {
	init_httpApiKeyAuth$2();
	init_httpBearerAuth$2();
	init_noAuth$2();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/memoizeIdentityProvider.js
var createIsIdentityExpiredFunction$2, EXPIRATION_MS$2, isIdentityExpired$2, doesIdentityRequireRefresh$2, memoizeIdentityProvider$2;
var init_memoizeIdentityProvider$2 = __esmMin((() => {
	createIsIdentityExpiredFunction$2 = (expirationMs) => function isIdentityExpired(identity) {
		return doesIdentityRequireRefresh$2(identity) && identity.expiration.getTime() - Date.now() < expirationMs;
	};
	EXPIRATION_MS$2 = 3e5;
	isIdentityExpired$2 = createIsIdentityExpiredFunction$2(EXPIRATION_MS$2);
	doesIdentityRequireRefresh$2 = (identity) => identity.expiration !== void 0;
	memoizeIdentityProvider$2 = (provider, isExpired, requiresRefresh) => {
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/util-identity-and-auth/index.js
var init_util_identity_and_auth$2 = __esmMin((() => {
	init_DefaultIdentityProviderConfig$2();
	init_httpAuthSchemes$3();
	init_memoizeIdentityProvider$2();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/index.js
var init_dist_es$3 = __esmMin((() => {
	init_getSmithyContext$2();
	init_middleware_http_auth_scheme$2();
	init_middleware_http_signing$2();
	init_normalizeProvider$2();
	init_requestBuilder$3();
	init_setFeature$2();
	init_util_identity_and_auth$2();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/property-provider/dist-cjs/index.js
var require_dist_cjs$32 = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.ProviderError = class ProviderError extends Error {
		name = "ProviderError";
		tryNextLink;
...
var import_dist_cjs$36, resolveAwsSdkSigV4AConfig, NODE_SIGV4A_CONFIG_OPTIONS;
var init_resolveAwsSdkSigV4AConfig = __esmMin((() => {
	init_dist_es$3();
	import_dist_cjs$36 = require_dist_cjs$32();
	resolveAwsSdkSigV4AConfig = (config) => {
		config.sigv4aSigningRegionSet = normalizeProvider$2(config.sigv4aSigningRegionSet);
		return config;
	};
	NODE_SIGV4A_CONFIG_OPTIONS = {
		environmentVariableSelector(env) {
			if (env.AWS_SIGV4A_SIGNING_REGION_SET) return env.AWS_SIGV4A_SIGNING_REGION_SET.split(",").map((_) => _.trim());
			throw new import_dist_cjs$36.ProviderError("AWS_SIGV4A_SIGNING_REGION_SET not set in env.", { tryNextLink: true });
		},
		configFileSelector(profile) {
			if (profile.sigv4a_signing_region_set) return (profile.sigv4a_signing_region_set ?? "").split(",").map((_) => _.trim());
			throw new import_dist_cjs$36.ProviderError("sigv4a_signing_region_set not set in profile.", { tryNextLink: true });
		},
		default: void 0
	};
}));
//#endregion
//#region node_modules/@smithy/signature-v4/node_modules/@smithy/is-array-buffer/dist-cjs/index.js
var require_dist_cjs$31 = /* @__PURE__ */ __commonJSMin(((exports) => {
	const isArrayBuffer = (arg) => typeof ArrayBuffer === "function" && arg instanceof ArrayBuffer || Object.prototype.toString.call(arg) === "[object ArrayBuffer]";
	exports.isArrayBuffer = isArrayBuffer;
}));
//#endregion
//#region node_modules/@smithy/signature-v4/node_modules/@smithy/util-buffer-from/dist-cjs/index.js
var require_dist_cjs$30 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var isArrayBuffer = require_dist_cjs$31();
...
//#endregion
//#region node_modules/@smithy/signature-v4/node_modules/@smithy/util-utf8/dist-cjs/index.js
var require_dist_cjs$29 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilBufferFrom = require_dist_cjs$30();
...
//#endregion
//#region node_modules/@smithy/signature-v4/node_modules/@smithy/util-middleware/dist-cjs/index.js
var require_dist_cjs$28 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var types = require_dist_cjs$33();
...
var require_dist_cjs$27 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var isArrayBuffer = require_dist_cjs$31();
	var protocolHttp = require_dist_cjs$34();
	var utilMiddleware = require_dist_cjs$28();
	var utilUriEscape = require_dist_cjs$39();
...
function normalizeCredentialProvider(config, { credentials, credentialDefaultProvider }) {
	...
	if (credentials) if (!credentials?.memoized) credentialsProvider = memoizeIdentityProvider$2(credentials, isIdentityExpired$2, doesIdentityRequireRefresh$2);
	else credentialsProvider = credentials;
	else if (credentialDefaultProvider) credentialsProvider = normalizeProvider$2(credentialDefaultProvider(Object.assign({}, config, { parentClientConfig: config })));
...
var import_dist_cjs$35, resolveAwsSdkSigV4Config, resolveAWSSDKSigV4Config;
var init_resolveAwsSdkSigV4Config = __esmMin((() => {
	init_client();
	init_dist_es$3();
	import_dist_cjs$35 = require_dist_cjs$27();
	resolveAwsSdkSigV4Config = (config) => {
		...
		let signer;
		if (config.signer) signer = normalizeProvider$2(config.signer);
		else if (config.regionInfoProvider) signer = () => normalizeProvider$2(config.region)().then(async (region) => [await config.regionInfoProvider(region, {
			...
			return new (config.signerConstructor || import_dist_cjs$35.SignatureV4)(params);
		});
		else signer = async (authScheme) => {
			authScheme = Object.assign({}, {
				name: "sigv4",
				signingName: config.signingName || config.defaultSigningName,
				signingRegion: await normalizeProvider$2(config.region)(),
				properties: {}
			}, authScheme);
...
var init_httpAuthSchemes$2 = __esmMin((() => {
	init_aws_sdk();
	init_getBearerTokenEnvKey();
}));
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/cbor-types.js
function alloc(size) {
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/cbor-decode.js
...
function bytesToUtf8(bytes, at, to) {
	...
	return (0, import_dist_cjs$34.toUtf8)(bytes.subarray(at, to));
}
...
var import_dist_cjs$34, USE_TEXT_DECODER, USE_BUFFER$1, payload, dataView$1, textDecoder, _offset, minorValueToArgumentLength;
var init_cbor_decode = __esmMin((() => {
	init_serde();
	import_dist_cjs$34 = require_dist_cjs$42();
	init_cbor_types();
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/cbor-encode.js
	...
	while (encodeStack.length) {
		...
		if (typeof input === "string") {
			if (USE_BUFFER) {
				...
				const bytes = (0, import_dist_cjs$33.fromUtf8)(input);
...
var import_dist_cjs$33, USE_BUFFER, data, dataView, cursor;
var init_cbor_encode = __esmMin((() => {
	init_serde();
	import_dist_cjs$33 = require_dist_cjs$42();
	init_cbor_types();
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/cbor.js
var cbor;
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/parseCborBody.js
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/CborCodec.js
var import_dist_cjs$32, CborCodec, CborShapeSerializer, CborShapeDeserializer;
var init_CborCodec = __esmMin((() => {
	init_protocols$2();
	init_schema();
	init_serde();
	import_dist_cjs$32 = require_dist_cjs$37();
	init_cbor$1();
	init_parseCborBody();
	...
	CborShapeSerializer = class extends SerdeContext {
		...
		serialize(schema, source) {
			const ns = NormalizedSchema.of(schema);
			if (source == null) {
				if (ns.isIdempotencyToken()) return (0, import_dist_cjs$45.v4)();
				return source;
			}
			if (ns.isBlobSchema()) {
				if (typeof source === "string") return (this.serdeContext?.base64Decoder ?? import_dist_cjs$32.fromBase64)(source);
				return source;
			}
			if (ns.isTimestampSchema()) {
	...
	CborShapeDeserializer = class extends SerdeContext {
		...
		readValue(_schema, value) {
			...
			if (ns.isBlobSchema()) {
				if (typeof value === "string") return (this.serdeContext?.base64Decoder ?? import_dist_cjs$32.fromBase64)(value);
				return value;
			}
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/SmithyRpcV2CborProtocol.js
var import_dist_cjs$31, SmithyRpcV2CborProtocol;
var init_SmithyRpcV2CborProtocol = __esmMin((() => {
	init_protocols$2();
	init_schema();
	import_dist_cjs$31 = require_dist_cjs$40();
	init_CborCodec();
	init_parseCborBody();
	SmithyRpcV2CborProtocol = class extends RpcProtocol {
		...
		async serializeRequest(operationSchema, input, context) {
			...
			const { service, operation } = (0, import_dist_cjs$31.getSmithyContext)(context);
...
//#endregion
//#region node_modules/@aws-sdk/core/node_modules/@smithy/core/dist-es/submodules/cbor/index.js
...
var import_dist_cjs$30, ProtocolLib;
var init_ProtocolLib = __esmMin((() => {
	init_schema();
	import_dist_cjs$30 = require_dist_cjs$41();
	ProtocolLib = class {
		queryCompat;
		...
		decorateServiceException(exception, additions = {}) {
			if (this.queryCompat) {
				...
				const error = (0, import_dist_cjs$30.decorateServiceException)(exception, additions);
			...
			return (0, import_dist_cjs$30.decorateServiceException)(exception, additions);
		}
...
var import_dist_cjs$28, import_dist_cjs$29, collectBodyString;
var init_common = __esmMin((() => {
	import_dist_cjs$28 = require_dist_cjs$41();
	import_dist_cjs$29 = require_dist_cjs$42();
	collectBodyString = (streamBody, context) => (0, import_dist_cjs$28.collectBody)(streamBody, context).then((body) => (context?.utf8Encoder ?? import_dist_cjs$29.toUtf8)(body));
}));
//#endregion
...
var import_dist_cjs$27, JsonShapeDeserializer;
var init_JsonShapeDeserializer = __esmMin((() => {
	init_protocols$2();
	init_schema();
	init_serde();
	import_dist_cjs$27 = require_dist_cjs$37();
	...
	JsonShapeDeserializer = class extends SerdeContextConfig {
		...
		_read(schema, value) {
			...
			if (ns.isBlobSchema() && typeof value === "string") return (0, import_dist_cjs$27.fromBase64)(value);
			const mediaType = ns.getMergedTraits().mediaType;
...
var import_dist_cjs$26, JsonShapeSerializer;
var init_JsonShapeSerializer = __esmMin((() => {
	init_protocols$2();
	init_schema();
	init_serde();
	import_dist_cjs$26 = require_dist_cjs$37();
	init_ConfigurableSerdeContext();
	init_jsonReplacer();
		...
		_write(schema, value, container) {
			...
			if (isObject) {
				...
				if (value instanceof Uint8Array && (ns.isBlobSchema() || ns.isDocumentSchema())) {
					...
					return (this.serdeContext?.base64Encoder ?? import_dist_cjs$26.toBase64)(value);
				}
			...
			if (ns.isStringSchema()) {
				if (typeof value === "undefined" && ns.isIdempotencyToken()) return (0, import_dist_cjs$45.v4)();
				const mediaType = ns.getMergedTraits().mediaType;
...
var import_dist_cjs$25, awsExpectUnion;
var init_awsExpectUnion = __esmMin((() => {
	import_dist_cjs$25 = require_dist_cjs$41();
	awsExpectUnion = (value) => {
		if (value == null) return;
		if (typeof value === "object" && "__type" in value) delete value.__type;
		return (0, import_dist_cjs$25.expectUnion)(value);
	};
}));
//#endregion
...
var import_dist_cjs$22, import_dist_cjs$23, import_dist_cjs$24, XmlShapeDeserializer;
var init_XmlShapeDeserializer = __esmMin((() => {
	import_dist_cjs$22 = require_dist_cjs$26();
	init_protocols$2();
	init_schema();
	import_dist_cjs$23 = require_dist_cjs$41();
	import_dist_cjs$24 = require_dist_cjs$42();
	init_ConfigurableSerdeContext();
	init_UnionSerde();
	XmlShapeDeserializer = class extends SerdeContextConfig {
		...
		read(schema, bytes, key) {
			...
			const xmlString = (this.serdeContext?.utf8Encoder ?? import_dist_cjs$24.toUtf8)(bytes);
		...
		parseXml(xml) {
			if (xml.length) {
				let parsedObj;
				try {
					parsedObj = (0, import_dist_cjs$22.parseXML)(xml);
				} catch (e) {
				...
				return (0, import_dist_cjs$23.getValueFromTextNode)(parsedObjToReturn);
			}
			return {};
		}
	};
...
var import_dist_cjs$20, import_dist_cjs$21, QueryShapeSerializer;
var init_QueryShapeSerializer = __esmMin((() => {
	init_protocols$2();
	init_schema();
	init_serde();
	import_dist_cjs$20 = require_dist_cjs$41();
	import_dist_cjs$21 = require_dist_cjs$37();
	init_ConfigurableSerdeContext();
	QueryShapeSerializer = class extends SerdeContextConfig {
		...
		write(schema, value, prefix = "") {
			...
			if (ns.isBlobSchema()) {
				if (typeof value === "string" || value instanceof Uint8Array) {
					...
					this.writeValue((this.serdeContext?.base64Encoder ?? import_dist_cjs$21.toBase64)(value));
				}
				...
				if (value != null) {
					...
					this.writeKey(prefix);
					this.writeValue((0, import_dist_cjs$45.v4)());
				}
				...
				if (value instanceof Date) {
					...
					switch (determineTimestampFormat(ns, this.settings)) {
						case 5:
							...
							break;
						case 6:
							this.writeValue((0, import_dist_cjs$20.dateToUtcString)(value));
							break;
						case 7:
		...
		writeKey(key) {
			...
			this.buffer += `&${extendedEncodeURIComponent$1(key)}=`;
		}
		writeValue(value) {
			this.buffer += extendedEncodeURIComponent$1(value);
		}
	};
}));
//#endregion
...
var import_dist_cjs$18, import_dist_cjs$19, parseXmlBody, parseXmlErrorBody, loadRestXmlErrorCode;
var init_parseXmlBody = __esmMin((() => {
	import_dist_cjs$18 = require_dist_cjs$26();
	import_dist_cjs$19 = require_dist_cjs$41();
	init_common();
	parseXmlBody = (streamBody, context) => collectBodyString(streamBody, context).then((encoded) => {
		if (encoded.length) {
			let parsedObj;
			try {
				parsedObj = (0, import_dist_cjs$18.parseXML)(encoded);
			} catch (e) {
			...
			return (0, import_dist_cjs$19.getValueFromTextNode)(parsedObjToReturn);
		}
		return {};
	});
...
var import_dist_cjs$15, import_dist_cjs$16, import_dist_cjs$17, XmlShapeSerializer;
var init_XmlShapeSerializer = __esmMin((() => {
	import_dist_cjs$15 = require_dist_cjs$26();
	init_protocols$2();
	init_schema();
	init_serde();
	import_dist_cjs$16 = require_dist_cjs$41();
	import_dist_cjs$17 = require_dist_cjs$37();
	init_ConfigurableSerdeContext();
	XmlShapeSerializer = class extends SerdeContextConfig {
		...
		write(schema, value) {
			...
			else if (ns.isBlobSchema()) this.byteBuffer = "byteLength" in value ? value : (this.serdeContext?.base64Decoder ?? import_dist_cjs$17.fromBase64)(value);
			else {
		...
		writeStruct(ns, value, parentXmlns) {
			...
			const structXmlNode = import_dist_cjs$15.XmlNode.of(name);
			...
			for (const [memberName, memberSchema] of ns.structIterator()) {
				...
				if (val != null || memberSchema.isIdempotencyToken()) {
					...
					if (memberSchema.isListSchema()) this.writeList(memberSchema, val, structXmlNode, xmlns);
						...
						const memberNode = import_dist_cjs$15.XmlNode.of(memberSchema.getMergedTraits().xmlName ?? memberSchema.getMemberName());
			...
			if ($unknown && ns.isUnionSchema() && Array.isArray($unknown) && Object.keys(value).length === 1) {
				const [k, v] = $unknown;
				const node = import_dist_cjs$15.XmlNode.of(k);
				if (typeof v !== "string") if (value instanceof import_dist_cjs$15.XmlNode || value instanceof import_dist_cjs$15.XmlText) structXmlNode.addChildNode(value);
		...
		writeList(listMember, array, container, parentXmlns) {
			...
			const writeItem = (container, value) => {
				if (listValueSchema.isListSchema()) this.writeList(listValueSchema, Array.isArray(value) ? value : [value], container, xmlns);
					...
					const listItemNode = import_dist_cjs$15.XmlNode.of(flat ? listTraits.xmlName ?? listMember.getMemberName() : listValueTraits.xmlName ?? "member");
			...
			if (flat) {
				...
				const listNode = import_dist_cjs$15.XmlNode.of(listTraits.xmlName ?? listMember.getMemberName());
		...
		writeMap(mapMember, map, container, parentXmlns, containerIsMap = false) {
			...
			const addKeyValue = (entry, key, val) => {
				const keyNode = import_dist_cjs$15.XmlNode.of(keyTag, key);
				const [keyXmlnsAttr, keyXmlns] = this.getXmlnsAttribute(mapKeySchema, xmlns);
				if (keyXmlns) keyNode.addAttribute(keyXmlnsAttr, keyXmlns);
				entry.addChildNode(keyNode);
				let valueNode = import_dist_cjs$15.XmlNode.of(valueTag);
			...
			if (flat) {
				for (const [key, val] of Object.entries(map)) if (sparse || val != null) {
					const entry = import_dist_cjs$15.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
				...
				let mapNode;
				if (!containerIsMap) {
					mapNode = import_dist_cjs$15.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
					if (xmlns) mapNode.addAttribute(xmlnsAttr, xmlns);
					container.addChildNode(mapNode);
				}
				for (const [key, val] of Object.entries(map)) if (sparse || val != null) {
					const entry = import_dist_cjs$15.XmlNode.of("entry");
					addKeyValue(entry, key, val);
		...
		writeSimple(_schema, value) {
			...
			if (value && typeof value === "object") if (ns.isBlobSchema()) nodeContents = (this.serdeContext?.base64Encoder ?? import_dist_cjs$17.toBase64)(value);
			else if (ns.isTimestampSchema() && value instanceof Date) switch (determineTimestampFormat(ns, this.settings)) {
				case 5:
					nodeContents = value.toISOString().replace(".000Z", "Z");
					break;
				case 6:
					nodeContents = (0, import_dist_cjs$16.dateToUtcString)(value);
					break;
				case 7:
			...
			if (ns.isStringSchema()) if (value === void 0 && ns.isIdempotencyToken()) nodeContents = (0, import_dist_cjs$45.v4)();
		...
		writeSimpleInto(_schema, value, into, parentXmlns) {
			...
			const ns = NormalizedSchema.of(_schema);
			const content = new import_dist_cjs$15.XmlText(nodeContents);
			const [xmlnsAttr, xmlns] = this.getXmlnsAttribute(ns, parentXmlns);
...
var require_recursionDetectionMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const protocol_http_1 = require_dist_cjs$34();
...
var import_dist_cjs$14, getSmithyContext$5;
var init_getSmithyContext$1 = __esmMin((() => {
	import_dist_cjs$14 = require_dist_cjs$33();
	getSmithyContext$5 = (context) => context[import_dist_cjs$14.SMITHY_CONTEXT_KEY] || (context[import_dist_cjs$14.SMITHY_CONTEXT_KEY] = {});
}));
//#endregion
//#region node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/resolveAuthOptions.js
var resolveAuthOptions$1;
var init_resolveAuthOptions$1 = __esmMin((() => {
	resolveAuthOptions$1 = (candidateAuthOptions, authSchemePreference) => {
...
function convertHttpAuthSchemesToMap$1(httpAuthSchemes) {
	const map = /* @__PURE__ */ new Map();
	for (const scheme of httpAuthSchemes) map.set(scheme.schemeId, scheme);
	return map;
}
var import_dist_cjs$13, httpAuthSchemeMiddleware$1;
var init_httpAuthSchemeMiddleware$1 = __esmMin((() => {
	import_dist_cjs$13 = require_dist_cjs$40();
	init_resolveAuthOptions$1();
	httpAuthSchemeMiddleware$1 = (config, mwOptions) => (next, context) => async (args) => {
		const resolvedOptions = resolveAuthOptions$1(config.httpAuthSchemeProvider(await mwOptions.httpAuthSchemeParametersProvider(config, context, args.input)), config.authSchemePreference ? await config.authSchemePreference() : []);
		const authSchemes = convertHttpAuthSchemesToMap$1(config.httpAuthSchemes);
		const smithyContext = (0, import_dist_cjs$13.getSmithyContext)(context);
...
var httpAuthSchemeEndpointRuleSetMiddlewareOptions$1, getHttpAuthSchemeEndpointRuleSetPlugin$1;
var init_getHttpAuthSchemeEndpointRuleSetPlugin$1 = __esmMin((() => {
	init_httpAuthSchemeMiddleware$1();
	httpAuthSchemeEndpointRuleSetMiddlewareOptions$1 = {
		step: "serialize",
	...
	getHttpAuthSchemeEndpointRuleSetPlugin$1 = (config, { httpAuthSchemeParametersProvider, identityProviderConfigProvider }) => ({ applyToStack: (clientStack) => {
		clientStack.addRelativeTo(httpAuthSchemeMiddleware$1(config, {
...
var httpAuthSchemeMiddlewareOptions$1, getHttpAuthSchemePlugin$1;
var init_getHttpAuthSchemePlugin$1 = __esmMin((() => {
	init_httpAuthSchemeMiddleware$1();
	httpAuthSchemeMiddlewareOptions$1 = {
		step: "serialize",
		tags: ["HTTP_AUTH_SCHEME"],
		name: "httpAuthSchemeMiddleware",
		override: true,
	...
	getHttpAuthSchemePlugin$1 = (config, { httpAuthSchemeParametersProvider, identityProviderConfigProvider }) => ({ applyToStack: (clientStack) => {
		clientStack.addRelativeTo(httpAuthSchemeMiddleware$1(config, {
			httpAuthSchemeParametersProvider,
			identityProviderConfigProvider
		}), httpAuthSchemeMiddlewareOptions$1);
...
var init_middleware_http_auth_scheme$1 = __esmMin((() => {
	init_httpAuthSchemeMiddleware$1();
	init_getHttpAuthSchemeEndpointRuleSetPlugin$1();
	init_getHttpAuthSchemePlugin$1();
}));
//#endregion
//#region node_modules/@smithy/core/dist-es/middleware-http-signing/httpSigningMiddleware.js
var import_dist_cjs$11, import_dist_cjs$12, defaultErrorHandler$1, defaultSuccessHandler$1, httpSigningMiddleware$1;
var init_httpSigningMiddleware$1 = __esmMin((() => {
	import_dist_cjs$11 = require_dist_cjs$34();
	import_dist_cjs$12 = require_dist_cjs$40();
	defaultErrorHandler$1 = (signingProperties) => (error) => {
		throw error;
	};
	defaultSuccessHandler$1 = (httpResponse, signingProperties) => {};
	httpSigningMiddleware$1 = (config) => (next, context) => async (args) => {
		if (!import_dist_cjs$11.HttpRequest.isInstance(args.request)) return next(args);
		const scheme = (0, import_dist_cjs$12.getSmithyContext)(context).selectedHttpAuthScheme;
...
var httpSigningMiddlewareOptions$1, getHttpSigningPlugin$1;
var init_getHttpSigningMiddleware$1 = __esmMin((() => {
	init_httpSigningMiddleware$1();
	httpSigningMiddlewareOptions$1 = {
	...
	getHttpSigningPlugin$1 = (config) => ({ applyToStack: (clientStack) => {
		clientStack.addRelativeTo(httpSigningMiddleware$1(config), httpSigningMiddlewareOptions$1);
	} });
}));
//#endregion
//#region node_modules/@smithy/core/dist-es/middleware-http-signing/index.js
var init_middleware_http_signing$1 = __esmMin((() => {
	init_httpSigningMiddleware$1();
	init_getHttpSigningMiddleware$1();
}));
//#endregion
...
function createPaginator$1(ClientCtor, CommandCtor, inputTokenName, outputTokenName, pageSizeTokenName) {
	return async function* paginateOperation(config, input, ...additionalArguments) {
		...
		while (hasNext) {
			...
			if (config.client instanceof ClientCtor) page = await makePagedClientRequest$1(CommandCtor, config.client, input, config.withCommand, ...additionalArguments);
			else throw new Error(`Invalid client, expected instance of ${ClientCtor.name}`);
			yield page;
			const prevToken = token;
			token = get$1(page, outputTokenName);
			hasNext = !!(token && (!config.stopOnSameToken || token !== prevToken));
		}
		return void 0;
	};
}
var makePagedClientRequest$1, get$1;
var init_createPaginator$1 = __esmMin((() => {
	makePagedClientRequest$1 = async (CommandCtor, client, input, withCommand = (_) => _, ...args) => {
		let command = new CommandCtor(input);
		command = withCommand(command) ?? command;
		return await client.send(command, ...args);
	};
	get$1 = (fromObject, path) => {
...
var init_requestBuilder$2 = __esmMin((() => {
	init_protocols$3();
}));
//#endregion
...
var DefaultIdentityProviderConfig$1;
var init_DefaultIdentityProviderConfig$1 = __esmMin((() => {
	DefaultIdentityProviderConfig$1 = class {
...
var import_dist_cjs$9, import_dist_cjs$10, HttpApiKeyAuthSigner$1;
var init_httpApiKeyAuth$1 = __esmMin((() => {
	import_dist_cjs$9 = require_dist_cjs$34();
	import_dist_cjs$10 = require_dist_cjs$33();
	HttpApiKeyAuthSigner$1 = class {
		async sign(httpRequest, identity, signingProperties) {
			...
			const clonedRequest = import_dist_cjs$9.HttpRequest.clone(httpRequest);
			if (signingProperties.in === import_dist_cjs$10.HttpApiKeyAuthLocation.QUERY) clonedRequest.query[signingProperties.name] = identity.apiKey;
			else if (signingProperties.in === import_dist_cjs$10.HttpApiKeyAuthLocation.HEADER) clonedRequest.headers[signingProperties.name] = signingProperties.scheme ? `${signingProperties.scheme} ${identity.apiKey}` : identity.apiKey;
...
var import_dist_cjs$8, HttpBearerAuthSigner$1;
var init_httpBearerAuth$1 = __esmMin((() => {
	import_dist_cjs$8 = require_dist_cjs$34();
	HttpBearerAuthSigner$1 = class {
		async sign(httpRequest, identity, signingProperties) {
			const clonedRequest = import_dist_cjs$8.HttpRequest.clone(httpRequest);
...
var NoAuthSigner$1;
var init_noAuth$1 = __esmMin((() => {
	NoAuthSigner$1 = class {
		async sign(httpRequest, identity, signingProperties) {
			return httpRequest;
		}
	};
...
var init_httpAuthSchemes$1 = __esmMin((() => {
	init_httpApiKeyAuth$1();
	init_httpBearerAuth$1();
	init_noAuth$1();
}));
//#endregion
//#region node_modules/@smithy/core/dist-es/util-identity-and-auth/memoizeIdentityProvider.js
var createIsIdentityExpiredFunction$1, EXPIRATION_MS$1, isIdentityExpired$1, doesIdentityRequireRefresh$1, memoizeIdentityProvider$1;
var init_memoizeIdentityProvider$1 = __esmMin((() => {
	createIsIdentityExpiredFunction$1 = (expirationMs) => function isIdentityExpired(identity) {
		return doesIdentityRequireRefresh$1(identity) && identity.expiration.getTime() - Date.now() < expirationMs;
	};
	EXPIRATION_MS$1 = 3e5;
	isIdentityExpired$1 = createIsIdentityExpiredFunction$1(EXPIRATION_MS$1);
	doesIdentityRequireRefresh$1 = (identity) => identity.expiration !== void 0;
	memoizeIdentityProvider$1 = (provider, isExpired, requiresRefresh) => {
		if (provider === void 0) return;
		const normalizedProvider = typeof provider !== "function" ? async () => Promise.resolve(provider) : provider;
		let resolved;
		let pending;
...
var init_util_identity_and_auth$1 = __esmMin((() => {
	init_DefaultIdentityProviderConfig$1();
	init_httpAuthSchemes$1();
	init_memoizeIdentityProvider$1();
}));
//#endregion
//#region node_modules/@smithy/core/dist-es/index.js
var dist_es_exports$1 = /* @__PURE__ */ __exportAll({
	DefaultIdentityProviderConfig: () => DefaultIdentityProviderConfig$1,
	EXPIRATION_MS: () => EXPIRATION_MS$1,
	HttpApiKeyAuthSigner: () => HttpApiKeyAuthSigner$1,
	HttpBearerAuthSigner: () => HttpBearerAuthSigner$1,
	NoAuthSigner: () => NoAuthSigner$1,
	createIsIdentityExpiredFunction: () => createIsIdentityExpiredFunction$1,
	createPaginator: () => createPaginator$1,
	doesIdentityRequireRefresh: () => doesIdentityRequireRefresh$1,
	getHttpAuthSchemeEndpointRuleSetPlugin: () => getHttpAuthSchemeEndpointRuleSetPlugin$1,
	getHttpAuthSchemePlugin: () => getHttpAuthSchemePlugin$1,
	getHttpSigningPlugin: () => getHttpSigningPlugin$1,
	getSmithyContext: () => getSmithyContext$5,
	httpAuthSchemeEndpointRuleSetMiddlewareOptions: () => httpAuthSchemeEndpointRuleSetMiddlewareOptions$1,
	httpAuthSchemeMiddleware: () => httpAuthSchemeMiddleware$1,
	httpAuthSchemeMiddlewareOptions: () => httpAuthSchemeMiddlewareOptions$1,
	httpSigningMiddleware: () => httpSigningMiddleware$1,
	httpSigningMiddlewareOptions: () => httpSigningMiddlewareOptions$1,
	isIdentityExpired: () => isIdentityExpired$1,
	memoizeIdentityProvider: () => memoizeIdentityProvider$1,
	normalizeProvider: () => normalizeProvider$1,
	requestBuilder: () => requestBuilder$1,
	setFeature: () => setFeature$1
});
var init_dist_es$1 = __esmMin((() => {
	init_getSmithyContext$1();
	init_middleware_http_auth_scheme$1();
	init_middleware_http_signing$1();
	init_normalizeProvider$1();
	init_createPaginator$1();
	init_requestBuilder$2();
	init_setFeature$1();
	init_util_identity_and_auth$1();
}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/getSmithyContext.js
var import_dist_cjs$7, getSmithyContext$2;
var init_getSmithyContext = __esmMin((() => {
	import_dist_cjs$7 = require_dist_cjs$33();
	getSmithyContext$2 = (context) => context[import_dist_cjs$7.SMITHY_CONTEXT_KEY] || (context[import_dist_cjs$7.SMITHY_CONTEXT_KEY] = {});
}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/util-middleware/dist-cjs/index.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/resolveAuthOptions.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/httpAuthSchemeMiddleware.js
function convertHttpAuthSchemesToMap(httpAuthSchemes) {
	const map = /* @__PURE__ */ new Map();
	for (const scheme of httpAuthSchemes) map.set(scheme.schemeId, scheme);
	return map;
}
var import_dist_cjs$6, httpAuthSchemeMiddleware;
var init_httpAuthSchemeMiddleware = __esmMin((() => {
	import_dist_cjs$6 = require_dist_cjs$22();
	...
	httpAuthSchemeMiddleware = (config, mwOptions) => (next, context) => async (args) => {
		...
		const smithyContext = (0, import_dist_cjs$6.getSmithyContext)(context);
		const failureReasons = [];
		for (const option of resolvedOptions) {
			const scheme = authSchemes.get(option.schemeId);
			if (!scheme) {
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemeEndpointRuleSetPlugin.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/getHttpAuthSchemePlugin.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-auth-scheme/index.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-signing/httpSigningMiddleware.js
var import_dist_cjs$4, import_dist_cjs$5, defaultErrorHandler, defaultSuccessHandler, httpSigningMiddleware;
var init_httpSigningMiddleware = __esmMin((() => {
	import_dist_cjs$4 = require_dist_cjs$34();
	...
	httpSigningMiddleware = (config) => (next, context) => async (args) => {
		if (!import_dist_cjs$4.HttpRequest.isInstance(args.request)) return next(args);
		const scheme = (0, import_dist_cjs$5.getSmithyContext)(context).selectedHttpAuthScheme;
		if (!scheme) throw new Error(`No HttpAuthScheme was selected: unable to sign request`);
		const { httpAuthOption: { signingProperties = {} }, identity, signer } = scheme;
		const output = await next({
			...args,
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-signing/getHttpSigningMiddleware.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/middleware-http-signing/index.js
var init_middleware_http_signing = __esmMin((() => {
	init_httpSigningMiddleware();
	init_getHttpSigningMiddleware();
}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/normalizeProvider.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/pagination/createPaginator.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/collect-stream-body.js
var init_collect_stream_body = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/extended-encode-uri-component.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/SerdeContext.js
var init_SerdeContext = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/HttpProtocol.js
var init_HttpProtocol = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/HttpBindingProtocol.js
var init_HttpBindingProtocol = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/RpcProtocol.js
var init_RpcProtocol = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/resolve-path.js
var resolvedPath;
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/requestBuilder.js
function requestBuilder(input, context) {
	return new RequestBuilder(input, context);
}
var import_dist_cjs$3, RequestBuilder;
var init_requestBuilder$1 = __esmMin((() => {
	import_dist_cjs$3 = require_dist_cjs$34();
	init_resolve_path();
	RequestBuilder = class {
		...
		async build() {
			...
			return new import_dist_cjs$3.HttpRequest({
				protocol,
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/serde/determineTimestampFormat.js
var init_determineTimestampFormat = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/serde/FromStringShapeDeserializer.js
var init_FromStringShapeDeserializer = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/serde/HttpInterceptingShapeDeserializer.js
var init_HttpInterceptingShapeDeserializer = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/serde/ToStringShapeSerializer.js
var init_ToStringShapeSerializer = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/serde/HttpInterceptingShapeSerializer.js
var init_HttpInterceptingShapeSerializer = __esmMin((() => {}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/submodules/protocols/index.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/request-builder/requestBuilder.js
var init_requestBuilder = __esmMin((() => {
	init_protocols();
}));
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/setFeature.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/DefaultIdentityProviderConfig.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/httpApiKeyAuth.js
var import_dist_cjs$1, import_dist_cjs$2, HttpApiKeyAuthSigner;
var init_httpApiKeyAuth = __esmMin((() => {
	import_dist_cjs$1 = require_dist_cjs$34();
	import_dist_cjs$2 = require_dist_cjs$33();
	HttpApiKeyAuthSigner = class {
		async sign(httpRequest, identity, signingProperties) {
			...
			if (!signingProperties.in) throw new Error("request could not be signed with `apiKey` since the `in` signer property is missing");
			if (!identity.apiKey) throw new Error("request could not be signed with `apiKey` since the `apiKey` is not defined");
			const clonedRequest = import_dist_cjs$1.HttpRequest.clone(httpRequest);
			if (signingProperties.in === import_dist_cjs$2.HttpApiKeyAuthLocation.QUERY) clonedRequest.query[signingProperties.name] = identity.apiKey;
			else if (signingProperties.in === import_dist_cjs$2.HttpApiKeyAuthLocation.HEADER) clonedRequest.headers[signingProperties.name] = signingProperties.scheme ? `${signingProperties.scheme} ${identity.apiKey}` : identity.apiKey;
			else throw new Error("request can only be signed with `apiKey` locations `query` or `header`, but found: `" + signingProperties.in + "`");
			return clonedRequest;
		}
	};
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/httpBearerAuth.js
var import_dist_cjs, HttpBearerAuthSigner;
var init_httpBearerAuth = __esmMin((() => {
	import_dist_cjs = require_dist_cjs$34();
	HttpBearerAuthSigner = class {
		async sign(httpRequest, identity, signingProperties) {
			const clonedRequest = import_dist_cjs.HttpRequest.clone(httpRequest);
			if (!identity.token) throw new Error("request could not be signed with `token` since the `token` is not defined");
			clonedRequest.headers["Authorization"] = `Bearer ${identity.token}`;
			return clonedRequest;
		}
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/noAuth.js
var NoAuthSigner;
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/httpAuthSchemes/index.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/memoizeIdentityProvider.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/util-identity-and-auth/index.js
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/core/dist-es/index.js
...
//#endregion
//#region node_modules/@aws-sdk/util-endpoints/node_modules/@smithy/util-endpoints/dist-cjs/index.js
...
var require_dist_cjs$20 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilEndpoints = require_dist_cjs$21();
	var urlParser = require_dist_cjs$44();
...
//#endregion
//#region node_modules/@aws-sdk/middleware-user-agent/node_modules/@smithy/util-retry/dist-cjs/index.js
...
var require_dist_cjs$17 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var utilEndpoints = require_dist_cjs$20();
	var protocolHttp = require_dist_cjs$34();
	var core$1 = (init_dist_es$2(), __toCommonJS(dist_es_exports$2));
...
var require_dist_cjs$14 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilConfigProvider = require_dist_cjs$16();
	var utilMiddleware = require_dist_cjs$40();
...
var require_getEndpointUrlConfig = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const shared_ini_file_loader_1 = require_dist_cjs$45();
...
var require_getEndpointFromConfig = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const node_config_provider_1 = require_dist_cjs$46();
	const getEndpointUrlConfig_1 = require_getEndpointUrlConfig();
	const getEndpointFromConfig = async (serviceId) => (0, node_config_provider_1.loadConfig)((0, getEndpointUrlConfig_1.getEndpointUrlConfig)(serviceId ?? ""))();
	exports.getEndpointFromConfig = getEndpointFromConfig;
}));
//#endregion
//#region node_modules/@smithy/middleware-endpoint/node_modules/@smithy/querystring-parser/dist-cjs/index.js
...
//#endregion
//#region node_modules/@smithy/middleware-endpoint/node_modules/@smithy/url-parser/dist-cjs/index.js
var require_dist_cjs$11 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var querystringParser = require_dist_cjs$12();
	const parseUrl = (url) => {
...
var require_dist_cjs$9 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var urlParser = require_dist_cjs$11();
	var core = (init_dist_es$1(), __toCommonJS(dist_es_exports$1));
	var utilMiddleware = require_dist_cjs$40();
	var middlewareSerde = require_dist_cjs$10();
...
//#endregion
//#region node_modules/@smithy/util-retry/node_modules/@smithy/service-error-classification/dist-cjs/index.js
...
var require_dist_cjs$7 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var serviceErrorClassification = require_dist_cjs$8();
	exports.RETRY_MODES = void 0;
	(function(RETRY_MODES) {
		RETRY_MODES["STANDARD"] = "standard";
		RETRY_MODES["ADAPTIVE"] = "adaptive";
...
//#endregion
//#region node_modules/@smithy/middleware-retry/node_modules/@smithy/service-error-classification/dist-cjs/index.js
...
var require_dist_cjs$5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilRetry = require_dist_cjs$7();
	var protocolHttp = require_dist_cjs$34();
	var serviceErrorClassification = require_dist_cjs$6();
	var uuid = require_dist_cjs$36();
	var utilMiddleware = require_dist_cjs$40();
	var smithyClient = require_dist_cjs$41();
...
var require_dist_cjs$4 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var middlewareUserAgent = require_dist_cjs$17();
...
var require_dist_cjs$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var utilBufferFrom = require_dist_cjs$43();
	var utilUtf8 = require_dist_cjs$42();
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var configResolver = require_dist_cjs$14();
	var nodeConfigProvider = require_dist_cjs$46();
	var propertyProvider = require_dist_cjs$47();
	...
	const inferPhysicalRegion = async () => {
		...
		if (!process.env[ENV_IMDS_DISABLED]) try {
			const { getInstanceMetadataEndpoint, httpRequest } = await import("./dist-cjs-DHGjYoGG.js").then((m) => /* @__PURE__ */ __toESM(m.default));
...
var require_stsRegionDefaultResolver = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const config_resolver_1 = require_dist_cjs$14();
	const node_config_provider_1 = require_dist_cjs$46();
...
//#endregion
export { init_httpAuthSchemes$2 as A, dist_es_exports$2 as C, AwsQueryProtocol as D, protocols_exports as E, require_dist_cjs$27 as M, NODE_AUTH_SCHEME_PREFERENCE_OPTIONS as N, AwsRestJsonProtocol as O, AwsSdkSigV4Signer as P, require_dist_cjs$25 as S, init_protocols$1 as T, DefaultIdentityProviderConfig$1 as _, require_dist_cjs$4 as a, require_dist_cjs$23 as b, require_dist_cjs$9 as c, require_dist_cjs$15 as d, require_dist_cjs$17 as f, NoAuthSigner$1 as g, init_dist_es$1 as h, require_dist_cjs$3 as i, resolveAwsSdkSigV4Config as j, httpAuthSchemes_exports as k, require_dist_cjs$13 as l, dist_es_exports$1 as m, require_dist_cjs$1 as n, require_dist_cjs$5 as o, require_dist_cjs$20 as p, require_dist_cjs$2 as r, require_dist_cjs$7 as s, require_dist_cjs as t, require_dist_cjs$14 as u, getHttpSigningPlugin$1 as v, init_dist_es$2 as w, require_dist_cjs$24 as x, getHttpAuthSchemeEndpointRuleSetPlugin$1 as y };

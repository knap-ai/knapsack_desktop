...
function resolveProviderRequestCapabilities(input, env = process.env) {
	...
	const isKnownNativeEndpoint = endpointClass === "anthropic-public" || endpointClass === "github-copilot-native" || endpointClass === "moonshot-native" || endpointClass === "modelstudio-native" || endpointClass === "openai-public" || endpointClass === "openai-codex" || endpointClass === "azure-openai" || endpointClass === "openrouter" || endpointClass === "google-generative-ai" || endpointClass === "google-vertex";
	...
	return {
		...
		supportsNativeStreamingUsageCompat: provider === "moonshot" && endpointClass === "moonshot-native" || provider === "modelstudio" && endpointClass === "modelstudio-native",
		compatibilityFamily
	};
}
//#endregion
export { resolveProviderRequestCapabilities as n, resolveProviderRequestPolicy as r, resolveProviderEndpoint as t };

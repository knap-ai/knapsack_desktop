...
import { a as resolveOsHomeRelativePath } from "./home-dir-BnP38vVl.js";
...
import { a as redactSensitiveUrlLikeString } from "./redact-sensitive-url-DvOJVkbi.js";
...
import { a as resolvePluginInstallDir, i as installPluginFromPath, r as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-V93VXjQN.js";
import { r as installPluginFromClawHub } from "./clawhub-D4amINPA.js";
import { n as recordPluginInstall, t as buildNpmResolutionInstallFields } from "./installs-CroOEF35.js";
...
async function loadMarketplace(params) {
	const loadResolvedLocalMarketplace = async (local, sourceLabel) => {
		const parsed = parseMarketplaceManifest(await fs.readFile(local.manifestPath, "utf-8"), local.manifestPath);
	...
	const parsed = parseMarketplaceManifest(await fs.readFile(manifestPath, "utf-8"), manifestPath);
	if (!parsed.ok) {
		await cloned.cleanup();
		return parsed;
	}

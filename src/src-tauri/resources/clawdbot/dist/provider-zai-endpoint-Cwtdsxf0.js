...
const ZAI_CN_BASE_URL = loadFacadeModule()["ZAI_CN_BASE_URL"];
const ZAI_CODING_CN_BASE_URL = loadFacadeModule()["ZAI_CODING_CN_BASE_URL"];
const ZAI_CODING_GLOBAL_BASE_URL = loadFacadeModule()["ZAI_CODING_GLOBAL_BASE_URL"];
loadFacadeModule()["ZAI_DEFAULT_MODEL_ID"];
loadFacadeModule()["ZAI_DEFAULT_MODEL_REF"];
const ZAI_GLOBAL_BASE_URL = loadFacadeModule()["ZAI_GLOBAL_BASE_URL"];
//#endregion

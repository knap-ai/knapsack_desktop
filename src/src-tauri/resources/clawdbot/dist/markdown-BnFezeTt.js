...
import { i as normalizeToken, o as resolveTwitchToken } from "./twitch-wher9JDv.js";
import { a as __read, i as __generator, n as __decorate, o as __spreadArray, r as __extends, s as init_tslib_es6, t as __awaiter } from "./tslib.es6-C1stzq2c.js";
...
var WebSocketConnection = class extends AbstractConnection {
	...
	clearSocket() {
		if (this._socket) {
			...
			if (this._socket.terminate) this._socket.terminate();
...
let ChatClient = ChatClient_1 = class ChatClient extends EventEmitter {
	...
	* @param msg The full message object containing all message and user information.
	*/
	onViewerMilestone = this.registerEvent();
	/**
...
//#endregion
export { accessTokenIsExpired as A, extractUserId as C, CustomError$1 as D, rtfm as E, Enumerable as F, mapNullable as M, mapOptional as N, DataObject as O, arrayToObject as P, HttpStatusCodeError as S, HellFreezesOverError as T, InvalidTokenError as _, removeClientManager as a, handleTwitchApiResponseError as b, Cacheable as c, CustomError as d, createLogger as f, TokenInfo as g, EventEmitter as h, getOrCreateClientManager as i, promiseWithResolvers as j, rawDataSymbol as k, PartitionedTimeBasedRateLimiter as l, StaticAuthProvider as m, stripMarkdownForTwitch as n, ChatClient as o, require_detect_node as p, getClientManager as r, CachedGetter as s, chunkTextForTwitch as t, RateLimitReachedError as u, callTwitchApi as v, extractUserName as w, transformTwitchApiResponse as x, callTwitchApiRaw as y };

...
import { c as normalizePairingConnectRequestId, d as readConnectPairingRequiredMessage, f as readPairingConnectErrorDetails } from "./connect-error-details-AqnPMQnc.js";
import { n as withProgress } from "./progress-DAY5yFVV.js";
import { t as logGatewayConnectionDetails } from "./status.gateway-connection-BQc_4_91.js";
import { a as resolveStatusSecurityAudit, d as buildStatusOverviewSurfaceFromScan, i as resolveStatusRuntimeSnapshot, n as resolveStatusGatewayHealth, s as resolveStatusUsageSummary, t as loadStatusProviderUsageModule } from "./status-runtime-shared-BN6yVN8q.js";
import { t as runStatusJsonCommand } from "./status-json-command-BiUaanZi.js";
import { n as statusChannelsTableColumns, t as buildStatusChannelsTableRows } from "./channels-table-gH5mmrlE.js";
import { S as statusHealthColumns, _ as buildStatusPluginCompatibilityLines, b as buildStatusSystemEventsRows, c as buildStatusOverviewSection, d as buildStatusUsageSection, g as buildStatusPairingRecoveryLines, h as buildStatusHealthRows, l as buildStatusSessionsSection, m as buildStatusFooterLines, o as buildStatusChannelsTableSection, p as buildStatusCommandOverviewRows, s as buildStatusHealthSection, t as appendStatusReportSections, u as buildStatusSystemEventsSection, v as buildStatusSecurityAuditLines, x as buildStatusSystemEventsTrailer, y as buildStatusSessionsRows } from "./text-report-oxqGsEVG.js";
import "./status.summary-C01SEF7j.js";
...
function loadStatusScanModule() {
	statusScanModulePromise ??= import("./status.scan-JI_06N2T.js");
	return statusScanModulePromise;
}
function loadStatusScanFastJsonModule() {
	statusScanFastJsonModulePromise ??= import("./status.scan.fast-json-C13TRW1c.js");
	return statusScanFastJsonModulePromise;
}
function loadStatusAllModule() {
	statusAllModulePromise ??= import("./status-all-CxApAReS.js");
	return statusAllModulePromise;
}
function loadStatusCommandTextRuntime() {
	statusCommandTextRuntimePromise ??= import("./status.command.text-runtime-DapymhVl.js");
	return statusCommandTextRuntimePromise;
}
function loadStatusGatewayConnectionRuntime() {
	statusGatewayConnectionRuntimePromise ??= import("./status.gateway-connection.runtime-B0mJpi2Y.js");
	return statusGatewayConnectionRuntimePromise;
}
function loadStatusNodeModeModule() {
	statusNodeModeModulePromise ??= import("./status.node-mode-D0l2byyj.js");

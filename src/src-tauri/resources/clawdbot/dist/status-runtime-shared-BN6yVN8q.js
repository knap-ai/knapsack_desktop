import { n as readGatewayServiceState, r as resolveGatewayService } from "./service-DKsVbGBH.js";
import { n as resolveReadOnlyChannelPluginsForConfig } from "./read-only-IxGh3z7a.js";
import { t as resolveNodeService } from "./node-service-sJmMkKsl.js";
import { a as buildStatusOverviewSurfaceRows, t as buildGatewayStatusJsonPayload } from "./format-BpOtpT1F.js";
import { t as formatDaemonRuntimeShort } from "./status.format-DTy3waft.js";
...
function loadProviderUsage() {
	providerUsagePromise ??= import("./provider-usage-DMKLePmN.js");
	return providerUsagePromise;
}
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-K_DViGrg.js");
...
async function resolveStatusSecurityAudit(params) {
	...
	const readOnlyPlugins = resolveReadOnlyChannelPluginsForConfig(params.config, { activationSourceConfig: params.sourceConfig });

...
import { r as ensureAuthProfileStoreForLocalUpdate } from "./store-CfHec0eX.js";
...
import { c as cloneFirstTemplateModel, l as matchesExactOrPrefix } from "./provider-model-shared-D-iKoymz.js";
...
import { r as loginOpenAICodexOAuth } from "./provider-auth-login-CRY7Rv8w.js";
import { o as findCatalogTemplate } from "./provider-catalog-shared-BIM0n3KJ.js";
import { i as fetchCodexUsage } from "./provider-usage-Bi4CRsxy.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-DSXAAO7b.js";
import { n as isOpenAICodexBaseUrl, t as isOpenAIApiBaseUrl } from "./base-url-Cb290EJs.js";
import { n as buildOpenAIResponsesProviderHooks, r as buildOpenAISyntheticCatalogEntry } from "./shared-o8Ieu6vJ.js";
import { a as OPENAI_CODEX_LOGIN_HINT, i as OPENAI_CODEX_DEVICE_PAIRING_LABEL, o as OPENAI_CODEX_LOGIN_LABEL, r as OPENAI_CODEX_DEVICE_PAIRING_HINT, s as OPENAI_CODEX_WIZARD_GROUP } from "./auth-choice-copy-Cu-LB_-X.js";
import { r as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-8bRriTdz.js";
import { n as buildOpenAICodexProvider } from "./openai-codex-catalog-BM5XiSMS.js";
import { t as loginOpenAICodexDeviceCode } from "./openai-codex-device-code-BXcNXmLo.js";
...
function buildOpenAICodexProviderPlugin() {
	return {
		...
		suppressBuiltInModel: ({ provider, modelId }) => normalizeProviderId(provider) === PROVIDER_ID && normalizeLowercaseStringOrEmpty(modelId) === "gpt-5.3-codex-spark" ? {
			suppress: true,
			errorMessage: "gpt-5.3-codex-spark is no longer exposed by the OpenAI or Codex catalogs. Use openai/gpt-5.5."
		} : void 0,

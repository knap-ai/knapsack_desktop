...
import { l as isRecord$1, m as resolveUserPath, x as isPlainObject } from "./utils-BMRcljdi.js";
import { t as resolveBundledPluginsDir } from "./bundled-dir-DXKS8sgC.js";
import { r as normalizeChatChannelId, t as CHANNEL_IDS } from "./ids-2bZIXJNM.js";
...
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-DJwlTQbU.js";
import { r as applyConfigEnvVars } from "./state-dir-dotenv-ZLC8-JVP.js";
import { _ as resolveStateDir, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath } from "./paths-BG0ad0P6.js";
import { n as VERSION } from "./version-DZq9J0ei.js";
import { a as coerceSecretRef, f as parseLegacySecretRefEnvMarker, r as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-Zn5Zyn7M.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-BMYro-gI.js";
import { t as ensureOwnerDisplaySecret } from "./owner-display-BRW5UTTL.js";
...
import { c as resolveEffectivePluginActivationState, o as normalizePluginsConfig, u as resolveMemorySlotDecision } from "./config-state-UvzNc3si.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-B-QlK0xY.js";
import { i as listPluginDoctorLegacyConfigRules, n as collectRelevantDoctorPluginIds, r as collectRelevantDoctorPluginIdsForTouchedPaths, t as applyPluginDoctorCompatibilityMigrations } from "./doctor-contract-registry-B7KYXsHO.js";
import { a as resolveGatewayPortWithDefault, i as isGatewayNonLoopbackBindMode, r as hasConfiguredControlUiAllowedOrigins, t as buildDefaultControlUiAllowedOrigins } from "./gateway-control-ui-origins-DfSK5a3n.js";
...
import { t as resolveSingleAccountKeysToMove } from "./setup-promotion-helpers-DwbAevZF.js";
...
import { t as loadDotEnv } from "./dotenv-BuPmTDqR.js";
import { t as sanitizeTerminalText } from "./safe-text-D7y8Lw2W.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-D78R0cWm.js";
import { i as applyMergePatch, n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-BKDxqOUA.js";
import { V as normalizeSafeBinProfileFixtures, i as normalizeTrustedSafeBinDirs } from "./exec-safe-bin-trust-D1Q1dhng.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-CS7WynNS.js";
import { a as getRuntimeConfigSourceSnapshot, c as registerRuntimeConfigWriteListener, i as getRuntimeConfigSnapshotRefreshHandler, n as finalizeRuntimeSnapshotWrite, o as loadPinnedRuntimeConfig, r as getRuntimeConfigSnapshot, s as notifyRuntimeConfigWriteListeners } from "./runtime-snapshot-C5PRsFS9.js";
import { t as listKnownChannelEnvVarNames } from "./channel-env-vars-Cpw7TOAF.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-DsK9fGJ1.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-_6dFncNS.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-DMGPGgc3.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-B2eBfvwf.js";
import { i as setPathExistingStrict } from "./path-utils-BMwQl5-A.js";
import { n as discoverConfigSecretTargets } from "./target-registry-Bvpbq4Ya.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-Dj8tpGXm.js";
import { t as OpenClawSchema } from "./zod-schema-Q-_hlOBD.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-4WdZjB8E.js";
...
function resolveConfiguredRuntime(params) {
	...
	if (params.agentId) {
		const agentRuntime = params.cfg?.agents?.list?.find((entry) => normalizeAgentId(entry.id) === normalizeAgentId(params.agentId ?? ""))?.embeddedHarness?.runtime?.trim();
...
function ensureEmbeddedHarnessRuntime(raw, selectedRuntime) {
	if (!isRecord$1(raw)) return {
		value: { runtime: selectedRuntime },
		changed: true
	};
...
function loadShellEnvFallback(opts) {
	...
	if (opts.expectedKeys.some((key) => hasExplicitEnvBinding(opts.env, key))) {
		lastAppliedKeys = [];
		return {
			ok: true,
			applied: [],
	...
	for (const key of opts.expectedKeys) {
		if (hasExplicitEnvBinding(opts.env, key)) continue;
...
async function recoverConfigFromJsonRootSuffixWithDeps(params) {
	...
	if (!validateConfigObjectWithPlugins(resolveLegacyConfigForRead(resolveConfigForRead(resolved, params.deps.env).resolvedConfigRaw, suffixRecovery.parsed).effectiveConfigRaw, { env: params.deps.env }).ok) return false;
...
//#endregion
export { normalizeTalkSection as $, resolveShellEnvExpectedKeys as A, shouldAttemptLastKnownGoodRecovery as B, validateConfigObjectRaw as C, collectPluginSchemaMetadata as D, collectChannelSchemaMetadata as E, unsetConfigOverride as F, getShellPathFromLoginShell as G, formatInvalidConfigDetails as H, asResolvedSourceConfig as I, normalizeBaseCompatibilityConfigValues as J, resolveShellEnvFallbackTimeoutMs as K, asRuntimeConfig as L, getConfigOverrides as M, resetConfigOverrides as N, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as O, setConfigOverride as P, buildTalkConfigResponse as Q, findLegacyConfigIssues as R, validateConfigObject as S, validateConfigObjectWithPlugins as T, maintainConfigBackups as U, createInvalidConfigError as V, getShellEnvAppliedKeys as W, normalizeLegacyOpenAICodexModelsAddMetadata as X, normalizeLegacyCommandsConfig as Y, normalizeGoogleApiBaseUrl as Z, registerConfigWriteListener as _, loadConfig as a, isLegacyRuntimeModelProvider as at, normalizeOpenClawVersionBase as b, promoteConfigSnapshotToLastKnownGood as c, applyLegacyDoctorMigrations as ct, readConfigFileSnapshotForWrite as d, resolveActiveTalkProviderConfig as et, readSourceConfigBestEffort as f, recoverConfigFromLastKnownGood as g, recoverConfigFromJsonRootSuffix as h, getRuntimeConfig as i, isLegacyModelsAddCodexMetadataModel as it, applyConfigOverrides as j, migrateLegacySecretRefEnvMarkers as k, readBestEffortConfig as l, applyChannelDoctorCompatibilityMigrations as lt, readSourceConfigSnapshotForWrite as m, clearConfigCache as n, resolveAgentMaxConcurrent as nt, parseConfigJson5 as o, listLegacyRuntimeModelProviderAliases as ot, readSourceConfigSnapshot as p, shouldEnableShellEnvFallback as q, createConfigIO as r, resolveSubagentMaxConcurrent as rt, projectConfigOntoRuntimeSourceSnapshot as s, resolveCliRuntimeExecutionProvider as st, ConfigRuntimeRefreshError as t, resolveBundledProviderPolicySurface as tt, readConfigFileSnapshot as u, resolveConfigSnapshotHash as v, validateConfigObjectRawWithPlugins as w, collectUnsupportedSecretRefPolicyIssues as x, writeConfigFile as y, isPluginLocalInvalidConfigSnapshot as z };

...
import { s as loadAuthProfileStoreForRuntime } from "./store-CfHec0eX.js";
import { n as resolvePluginProviders } from "./providers.runtime-w64xsk4r.js";
import "./model-selection-shared-grYiFZof.js";
import { n as listProfilesForProvider } from "./profile-list-CPl71h59.js";
import { n as clearAuthProfileCooldown } from "./usage-DiHkmNRE.js";
import { i as upsertAuthProfile } from "./profiles-RuCKjoVP.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-SJ4kA8LK.js";
...
import { a as loadValidConfigOrThrow, u as updateConfig } from "./shared-BRpkDqTT.js";
...
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BsVugK5R.js";
...
async function resolveModelsAuthAgentDir() {
	const config = await loadValidConfigOrThrow();
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-T6o6jvuQ.js");
				await openUrl(url);
			},
...
async function modelsAuthSetupTokenCommand(opts, runtime) {
	...
	const { config, agentDir, workspaceDir, providers } = await resolveModelsAuthContext({ requestedProvider: opts.provider });
...
//#endregion
export { resolveRequestedLoginProviderOrThrow as a, modelsAuthSetupTokenCommand as i, modelsAuthLoginCommand as n, modelsAuthPasteTokenCommand as r, modelsAuthAddCommand as t };

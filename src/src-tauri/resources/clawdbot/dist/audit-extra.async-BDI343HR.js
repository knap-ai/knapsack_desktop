...
import { h as resolveOAuthDir } from "./paths-BG0ad0P6.js";
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Bf5HAAlc.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-DJpPaKAg.js";
import { n as MANIFEST_KEY } from "./legacy-names-4mm_GxYL.js";
import { a as normalizePluginId, o as normalizePluginsConfig } from "./config-state-UvzNc3si.js";
...
import { _ as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-Ve0QlY3Y.js";
import { a as execDockerRaw } from "./docker-DBH34Z56.js";
import { t as resolveSkillSource } from "./source-BliQBH7B.js";
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-DV_DGrBP.js";
import { r as resolveNativeSkillsEnabled } from "./commands-BZgXSI56.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BTGzrLGK.js";
import { n as readInstalledPackageVersion } from "./package-update-utils-CJRHpE7O.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DwKdS4_9.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-DT1tQ-F2.js";
...
async function loadPluginTrustPolicyDeps() {
	pluginTrustPolicyDepsPromise ??= Promise.all([
		import("./config-DMvai6R8.js"),
		import("./tool-policy-DXqfGJcq2.js"),
		import("./tool-policy-match-7uKa0w2w.js"),
		import("./tool-policy-BA1vznxW.js"),
		import("./audit-tool-policy-CjELhBy6.js")
...
async function listInstalledPluginDirs$1(params) {
...
async function collectPluginsTrustFindings(params) {
	const findings = [];
	const { extensionsDir, pluginDirs } = await listInstalledPluginDirs$1({ stateDir: params.stateDir });
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-CYOU4kJz.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-NTLYkTUO.js");
...
//#endregion
export { collectStateDeepFilesystemFindings as a, collectPluginsTrustFindings as c, collectSandboxBrowserHashLabelFindings as i, collectInstalledSkillsCodeSafetyFindings as n, collectWorkspaceSkillSymlinkEscapeFindings as o, collectPluginsCodeSafetyFindings as r, readConfigSnapshotForAudit as s, collectIncludeFilePermFindings as t };

...
import { a as clampNumber, i as clampInt, y as resolveUserPath } from "./utils-CS0Ikux6.js";
import { i as resolveAgentConfig } from "./agent-scope-bjWqU22i.js";
import { a as isMemoryMultimodalEnabled, o as normalizeMemoryMultimodalSettings, s as supportsMemoryMultimodalEmbeddings } from "./multimodal-B8yEZcl5.js";
...
function resolveMemorySearchConfig(cfg, agentId) {
	...
	if (multimodalActive && !supportsMemoryMultimodalEmbeddings({
		provider: resolved.provider,
		model: resolved.model
	})) throw new Error("agents.*.memorySearch.multimodal requires memorySearch.provider = \"gemini\" and model = \"gemini-embedding-2-preview\".");

...
import { a as logWarn, t as logDebug } from "./logger-Dr2uNJI4.js";
import { h as loadWorkspaceBootstrapFiles } from "./workspace-R-NeOkBt.js";
import { c as loadEnabledBundleMcpConfig } from "./loader-BkOjign1.js";
import { O as resolveProviderReasoningOutputModeWithPlugin } from "./provider-runtime-Dhor2yYF.js";
import { a as redactSensitiveUrlLikeString, i as redactSensitiveUrl } from "./redact-sensitive-url-DvOJVkbi.js";
import { n as normalizeConfiguredMcpServers } from "./mcp-config-ztT_GRMy.js";
...
function resolveReasoningOutputMode(params) {
	...
	if (normalized === "google" || normalized === "google-gemini-cli" || normalized === "google-generative-ai") return "tagged";
	return "native";
}
/**
...
function getRequestedTransport(rawServer) {
	...
	return (rawServer.transport ?? "").trim().toLowerCase();
}
...
function resolveMcpTransport(serverName, rawServer) {
	...
	return {
		transport: new SSEClientTransport(new URL(resolved.url), {
			...
			eventSourceInit: hasHeaders ? { fetch: buildSseEventSourceFetch(headers) } : void 0
		}),
		description: resolved.description,
		transportType: "sse",
		connectionTimeoutMs: resolved.connectionTimeoutMs
					...
					try {
						...
						for (const tool of listedTools) {
							...
							tools.push({
								...
								toolName,
								title: tool.title,
								description: tool.description?.trim() || void 0,
...
//#endregion
export { materializeBundleMcpToolsForRun as a, loadEmbeddedPiMcpConfig as c, clearBootstrapSnapshot as d, clearBootstrapSnapshotOnSessionRollover as f, createBundleMcpToolRuntime as i, describeStdioMcpServerLaunchConfig as l, isReasoningTagProvider as m, resolveAgentTimeoutMs as n, disposeSessionMcpRuntime as o, getOrLoadBootstrapFiles as p, resolveConversationIdFromTargets as r, getOrCreateSessionMcpRuntime as s, collectTextContentBlocks as t, resolveStdioMcpServerLaunchConfig as u };

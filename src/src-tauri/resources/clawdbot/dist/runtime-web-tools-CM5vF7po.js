...
import { p as resolveSecretInputRef } from "./types.secrets-Zn5Zyn7M.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-Cyojk0Yv.js";
import { u as secretRefKey } from "./ref-contract-BeQ-3fY_.js";
import "./shared-BkZJwMus.js";
import { o as resolveSecretRefValues } from "./resolve-CUXgNEHH.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-NCgrvsYW.js";
import { l as resolveEnableState, o as normalizePluginsConfig } from "./config-state-UvzNc3si.js";
import { b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-_6dFncNS.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-CtupFS30.js";
import { n as resolvePluginConfigContractsById, t as collectPluginConfigContractMatches } from "./config-contracts-DoyE9bX2.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CkOd5v2f.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-ocXx1skG.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-BxcSgm-I.js";
import { n as resolvePluginCapabilityProviders } from "./capability-provider-runtime-DlsoCSX1.js";
import { i as normalizeMediaProviderId, n as resolveEffectiveMediaEntryCapabilities, r as resolveImageCapableConfigProviderIds, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-CBFffG8g.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-BmS3FAtS.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-C2s4ytdQ.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-BVsGv7JI.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-C5ld6vcr.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-BMqFq_cT.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-MGl9uAOx.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-C5ld6vcr.js"), (mod) => mod);

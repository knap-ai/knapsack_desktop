import { f as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-C1IzJjqi.js";
...
import { d as pathExists, m as resolveUserPath } from "./utils-BMRcljdi.js";
...
async function resolveCanonicalRootMemoryFile(workspaceDir) {
	try {
		const entries = await fs$1.readdir(workspaceDir, { withFileTypes: true });
...
//#endregion
export { resolveCanonicalRootMemoryFile as C, shouldSkipRootMemoryAuxiliaryPath as D, resolveRootMemoryRepairDir as E, LEGACY_ROOT_MEMORY_FILENAME as S, resolveLegacyRootMemoryPath as T, reconcileWorkspaceBootstrapCompletion as _, DEFAULT_IDENTITY_FILENAME as a, resolveWorkspaceTemplateDir as b, DEFAULT_TOOLS_FILENAME as c, filterBootstrapFilesForSession as d, isWorkspaceBootstrapPending as f, loadWorkspaceBootstrapFiles as g, loadExtraBootstrapFilesWithDiagnostics as h, DEFAULT_HEARTBEAT_FILENAME as i, DEFAULT_USER_FILENAME as l, loadExtraBootstrapFiles as m, DEFAULT_AGENT_WORKSPACE_DIR as n, DEFAULT_MEMORY_FILENAME as o, isWorkspaceSetupCompleted as p, DEFAULT_BOOTSTRAP_FILENAME as r, DEFAULT_SOUL_FILENAME as s, DEFAULT_AGENTS_FILENAME as t, ensureAgentWorkspace as u, resolveDefaultAgentWorkspaceDir as v, resolveCanonicalRootMemoryPath as w, CANONICAL_ROOT_MEMORY_FILENAME as x, resolveWorkspaceBootstrapStatus as y };

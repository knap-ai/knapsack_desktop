...
import { d as createDefaultChannelRuntimeState, n as buildBaseChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CtpWf3f1.js";
...
import { f as createAllowlistProviderOpenWarningCollector, l as composeAccountWarningCollectors } from "./group-policy-warnings-B8ZU4B4D.js";
	...
	base: {
		...
		directory: createChannelDirectoryAdapter({
			...
			listGroups: async (params) => {
				return (await listIrcDirectoryGroupsFromConfig(params)).map((entry) => ({
					...entry,
					name: entry.id
				}));
			}

...
import { n as require_ms, t as require_src$1 } from "./src-Dhzek8ho.js";
import { t as require_jws } from "./jws-CfgSi3sw.js";
import { n as require_logging, t as require_http } from "./http-Bh-HtMAg.js";
import { t as require_semver } from "./semver-RRDRVaDt.js";
...
var require_jwt_validator = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const teams_common_1 = require_dist();
		...
		*/
		...
		getJwksClient() {
			switch (this.options.jwksUriOptions.type) {
				case "tenantId": {
					...
					this.jwksCache.set(`${this.options.tenantId}`, (0, jwks_rsa_1.default)({ jwksUri: `https://login.microsoftonline.com/${this.options.tenantId}/discovery/v2.0/keys` }));
		...
		validateIssuer(iss) {
			...
			if ("allowedTenantIds" in validateIssuer) {
				...
				if (!allowedTenantIds.some((tenantId) => iss.startsWith(`https://login.microsoftonline.com/${tenantId}/`))) throw new Error(`Token issuer '${iss}' not in allowed tenant IDs: ${allowedTenantIds.join(", ")}`);
			}
		}
...
//#endregion
export { require_storage as a, require_dist as i, require_jsonwebtoken as n, require_events as o, require_asserts as r, require_jwt_validator as t };

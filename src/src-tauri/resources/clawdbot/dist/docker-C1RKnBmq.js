...
import { a as resolvePathViaExistingAncestorSync } from "./file-identity-B8OnIgGC.js";
import { t as getBlockedNetworkModeReason } from "./network-mode-O6UFjmuq.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { t as acquireSessionWriteLock } from "./session-write-lock-BjZ5BFRg.js";
import { r as writeJsonAtomic } from "./json-files-R-JecRHb.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-BsZdqqVw.js";
import { d as DEFAULT_SANDBOX_IMAGE, f as SANDBOX_AGENT_WORKSPACE_MOUNT, h as SANDBOX_REGISTRY_PATH, p as SANDBOX_BROWSER_REGISTRY_PATH } from "./config-Fnf3A9Vj.js";
import { t as sanitizeEnvVars } from "./sanitize-env-vars-BvpMkDN5.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-Bwy9t01K.js";
...
//#endregion
export { updateRegistry as C, updateBrowserRegistry as S, slugifySessionKey as _, execDockerRaw as a, removeBrowserRegistryEntry as b, readDockerPort as c, validateNetworkMode as d, resolveSandboxHostPathViaExistingAncestor as f, resolveSandboxWorkspaceDir as g, resolveSandboxScopeKey as h, execDocker as i, appendWorkspaceMountArgs as l, resolveSandboxAgentId as m, dockerContainerState as n, readDockerContainerEnvVar as o, splitSandboxBindSpec as p, ensureSandboxContainer as r, readDockerContainerLabel as s, buildSandboxCreateArgs as t, getBlockedBindReason as u, readBrowserRegistry as v, computeSandboxBrowserConfigHash as w, removeRegistryEntry as x, readRegistry as y };

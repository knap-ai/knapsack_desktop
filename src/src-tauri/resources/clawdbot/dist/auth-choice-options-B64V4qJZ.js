import { i as resolveProviderSetupFlowContributions, t as resolveManifestProviderSetupFlowContributions } from "./provider-flow-p9sXANlM.js";
import { a as resolveLegacyAuthChoiceAliasesForCli } from "./auth-choice-legacy-kUSVj66v.js";
...
function formatAuthChoiceChoicesForCli(params) {
	const values = [...formatStaticAuthChoiceChoicesForCli(params).split("|"), ...resolveManifestProviderSetupFlowContributions({
		...params,
		scope: "text-inference"

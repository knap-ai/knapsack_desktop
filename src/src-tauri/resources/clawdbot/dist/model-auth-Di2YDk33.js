...
import { W as getShellEnvAppliedKeys } from "./io-Dv_xNAZB.js";
...
import { O as readCodexCliCredentialsCached, n as ensureAuthProfileStore } from "./store-CfHec0eX.js";
import { h as resolveOwningPluginIdsForProvider } from "./plugin-auto-enable-BKDUQLPR.js";
import { G as shouldDeferProviderSyntheticProfileAuthWithPlugin, P as resolveProviderSyntheticAuthWithPlugin, c as buildProviderMissingAuthMessageWithPlugin } from "./provider-runtime-C1HXSRlX.js";
import { i as NON_ENV_SECRETREF_MARKER, l as isKnownEnvApiKeyMarker, t as CUSTOM_LOCAL_AUTH_MARKER, u as isNonSecretApiKeyMarker } from "./model-auth-markers-CZrGSAU9.js";
...
function resolveUsableCustomProviderApiKey(params) {
	const apiKeyRef = coerceSecretRef(resolveProviderConfig(params.cfg, params.provider)?.apiKey);
	if (apiKeyRef) {

...
import { m as resolveUserPath, r as clampInt } from "./utils-BMRcljdi.js";
...
import { a as clearPluginManifestRegistryCache } from "./manifest-registry-pYrbrdHJ.js";
import { F as unsetConfigOverride, M as getConfigOverrides, N as resetConfigOverrides, P as setConfigOverride, T as validateConfigObjectWithPlugins, u as readConfigFileSnapshot, y as writeConfigFile } from "./io-Dv_xNAZB.js";
...
import { i as normalizeChannelId$1, t as getChannelPlugin } from "./registry-B2TRwbJD.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-CS7WynNS.js";
import { b as resolveAgentWorkspaceDir, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
import { t as parseDurationMs } from "./parse-duration-DH3x5y_9.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-w1EXgeVc.js";
import "./config-yDDhhyz6.js";
import { g as GATEWAY_CLIENT_NAMES, h as GATEWAY_CLIENT_MODES, r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import { n as resolveChannelApprovalCapability } from "./plugins-BZ_I3cWH.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BxzYnhn4.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-C1HXSRlX.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BVdekRwH.js";
import { g as resolveResponseUsageMode, m as normalizeUsageDisplay } from "./thinking-C1TCb8El.js";
...
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-DvU8Tgvw.js";
...
import { i as formatUsd, r as formatTokenCount } from "./usage-format-CQv_DQWN.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DaDVfj8b.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-BrBnwkcx.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-B3d9VRps.js";
import { C as safeJsonStringify, S as safeTrajectorySessionFileName, b as resolveTrajectoryFilePath, w as sanitizeDiagnosticPayload, x as resolveTrajectoryPointerFilePath, y as TRAJECTORY_RUNTIME_FILE_MAX_BYTES } from "./selection-C3otDzGD.js";
import { S as setTtsProvider, _ as setLastTtsAttempt, a as getTtsMaxLength, b as setTtsEnabled, c as isTtsEnabled, h as resolveTtsPrefsPath, i as getResolvedSpeechProviderConfig, l as isTtsProviderConfigured, m as resolveTtsConfig, o as getTtsProvider, r as getLastTtsAttempt, s as isSummarizationEnabled, v as setSummarizationEnabled, w as textToSpeech, x as setTtsMaxLength } from "./tts-VTd__uez.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-Daai1iOb.js";
import { h as resolveBootstrapTotalMaxChars, p as resolveBootstrapMaxChars } from "./pi-embedded-helpers-C0R2W0ZW.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Bzeqz1g5.js";
import { i as resolveImageSanitizationLimits, n as sanitizeImageBlocks } from "./tool-images-CE0bWSrm.js";
...
import { m as stripToolResultDetails } from "./transport-stream-shared-21GahxfU.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-jNr989PC.js";
...
import { l as triggerOpenClawRestart, o as scheduleGatewaySigusr1Restart } from "./restart-BEePx4vW.js";
import { i as resolveReplyToMode } from "./reply-threading-CKrwAPQs.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-D7luFLJH.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-CfMmk4Zz.js";
...
import { h as replyRunRegistry, i as getActiveEmbeddedRunSnapshot } from "./runs-D_jbdUDe.js";
import "./diagnostic-Dk8ZkzCp.js";
import { t as formatDurationCompact } from "./format-duration-CIk89v72.js";
import "./sandbox-DzHIjKfO.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-9yK0WPeJ.js";
import { n as estimateTokensFromChars } from "./cjk-chars-Cw_Ytzp3.js";
...
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-DeM9wUEE.js";
import { t as isApprovalNotFoundError } from "./approval-errors-BuFHKM2N.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-RdSq7yWA.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-C2wR3G1B.js";
import "./commands-registry-D1HuZY_U.js";
import { n as formatTimeAgo } from "./format-relative-DBI0ON8M.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-8V4_s3MO.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-BKH4g4IL.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BqyKPFa6.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-Bq8LaeUm.js";
import { l as resolveArchiveKind } from "./archive-I0VbH-E1.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-6zM7eEzu.js";
import { n as parseActivationCommand } from "./group-activation-DBUyCcKk.js";
import { t as resolveFastModeState } from "./fast-mode-Dg0WyQf7.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-Cu-0dtRK.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CKaKK6Jd.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CQYorQe-.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-Bfe-t6aN.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory--HD_uS52.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-DZuOsEV3.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CkoR-F1W.js";
import { t as extractBtwQuestion } from "./btw-command-AtDXIGV-.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BiA95c9o.js";
...
import { a as requireGatewayClientScopeForInternalChannel, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BX2khtdv.js";
import { t as handleAcpCommand } from "./commands-acp-Dv2fS_I9.js";
...
import { _ as getFinishedSession, v as getSession } from "./bash-tools.exec-runtime-DHmKQe9a.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BmJTm0yc.js";
import { r as handleModelsCommand } from "./commands-models-C2HGwidV.js";
import { n as setPluginEnabledInConfig } from "./enable-y339R98P.js";
import { r as createExecTool } from "./bash-tools-MqL7r1OX.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./status-text-XdpcxHQc.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-ek17QIHL.js";
import { d as resolveChannelAccountId, f as resolveCommandSurfaceChannel, l as resolveSubagentsAction, o as resolveHandledPrefix, s as resolveRequesterSessionKey, u as stopWithText } from "./shared-DOdpx7Ch.js";
import { t as buildToolsMessage } from "./status-8_Isqp17.js";
import { t as parseConfigValue } from "./config-value-CPN42qpy.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-CH3D0hPA.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-2WBfmkS-.js";
import { t as buildStatusReply } from "./commands-status-P01QMjvy.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-tJiSkVHE.js";
import { m as parseClawHubPluginSpec } from "./clawhub-DUtsrJs-.js";
import { r as installPluginFromClawHub } from "./clawhub-Bhr6hWl5.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginSnapshotReport, t as buildAllPluginInspectReports } from "./status-Clo7fOEI.js";
import { a as decidePreferredClawHubFallback, i as createPluginInstallLogger, n as buildPreferredClawHubSpec, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-DMQfl4Ue.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BrTsjwcB.js";
...
function loadCompactRuntime() {
	compactRuntimePromise ??= import("./commands-compact.runtime-BxVFb6jJ.js");
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-B6Q_dQ6u.js");
...
async function abortEmbeddedPiRunForSession(sessionId) {
	const { abortEmbeddedPiRun } = await import("./runs-DVHoNi9Y.js");
...
function loadAgentsAction() {
	actionAgentsPromise ??= import("./action-agents-NlSggj6p.js");
	return actionAgentsPromise;
}
function loadFocusAction() {
	actionFocusPromise ??= import("./action-focus-B286E6v1.js");
	return actionFocusPromise;
}
function loadHelpAction() {
	actionHelpPromise ??= import("./action-help-B2kKOeq3.js");
	return actionHelpPromise;
}
function loadInfoAction() {
	actionInfoPromise ??= import("./action-info-BKz29AWn.js");
	return actionInfoPromise;
}
function loadKillAction() {
	actionKillPromise ??= import("./action-kill-CMw1Zb2S.js");
	return actionKillPromise;
}
function loadListAction() {
	actionListPromise ??= import("./action-list-Cn8Ud4ir.js");
	return actionListPromise;
}
function loadLogAction() {
	actionLogPromise ??= import("./action-log-BGCPpi2_.js");
	return actionLogPromise;
}
function loadSendAction() {
	actionSendPromise ??= import("./action-send-BreUrviS.js");
	return actionSendPromise;
}
function loadSpawnAction() {
	actionSpawnPromise ??= import("./action-spawn-B1dOaCQs.js");
	return actionSpawnPromise;
}
function loadUnfocusAction() {
	actionUnfocusPromise ??= import("./action-unfocus-N-nnHK96.js");
	return actionUnfocusPromise;
}
function loadControlRuntime() {
	controlRuntimePromise ??= import("./commands-subagents-control.runtime-pjax2MPG.js");

...
import { F as requireOpenAllowFrom, a as DmPolicySchema, c as GroupPolicySchema, m as MarkdownConfigSchema, y as ReplyRuntimeConfigSchemaShape } from "./zod-schema.core-Cx4hqkoC.js";
...
import { d as createDefaultChannelRuntimeState, s as buildWebhookChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CtpWf3f1.js";
import { n as fetchWithSsrFGuard } from "./fetch-guard-Lvq2pw52.js";
import { r as deliverFormattedTextWithAttachments } from "./reply-payload-SzVz53hc.js";
import { r as describeWebhookAccountSnapshot, s as resolveMergedAccountConfig, t as createAccountListHelpers } from "./account-helpers-DqNwQN08.js";
import { c as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-B0S2z66F.js";
import { i as tryReadSecretFileSync } from "./secret-file-DtXtlZpO.js";
import { r as createChatChannelPlugin, t as buildChannelOutboundSessionRoute } from "./core-BghMcc08.js";
...
import { J as setSetupChannelEnabled, f as createStandardChannelSetupStatus, j as promptParsedAllowFromForAccount, m as createTopLevelChannelDmPolicy, v as mergeAllowFromEntries, z as resolveSetupAccountId } from "./setup-wizard-helpers-BfrhuTOh.js";
...
import { m as createAllowlistProviderRouteAllowlistWarningCollector } from "./group-policy-warnings-B8ZU4B4D.js";
...
import "./setup-runtime-C2k29LGe.js";
...
import { n as resolveAccountWithDefaultFallback } from "./account-resolution-CahYTlaB.js";
import { n as logInboundDrop } from "./logging-N7W67_op.js";
import { i as createPairingPrefixStripper, n as createChannelPairingController, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-Nk7oRFrM.js";
import { r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-memory-guards-B61rc1wa.js";
import { c as resolveLoggerBackedRuntime, l as runStoppablePassiveMonitor, s as requireChannelOpenAllowFrom } from "./extension-shared-gP7gKXlS.js";
...
import "./runtime-api-BX8nKCC9.js";
...
function normalizeNextcloudTalkApproverId(value) {
	return String(value).trim().replace(/^(nextcloud-talk|nc-talk|nc):/i, "").trim().toLowerCase() || void 0;
}
...
async function resolveNextcloudTalkRoomKind(params) {
	...
	try {
		const { response, release } = await fetchWithSsrFGuard({
			...
			policy: account.config?.allowPrivateNetwork ? { allowPrivateNetwork: true } : void 0
		});
		try {
			if (!response.ok) {
				roomCache.set(key, {

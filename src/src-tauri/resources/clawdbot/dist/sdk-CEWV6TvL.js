...
import { n as LogService, r as noop, t as ConsoleLogger } from "./logger-a6JNXTRe.js";
import { i as parseMxc, n as createMatrixGuardedFetch, r as matrixEventToRaw, t as MatrixAuthedHttpClient } from "./http-client-COwW1KRl.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-FG5h56t4.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-cAZedXjS.js";
import { t as createAsyncLock } from "./async-lock-BvF5r459.js";
import { t as isMatrixNotFoundError } from "./errors-MT_RWGl1.js";
import { t as MatrixRecoveryKeyStore } from "./recovery-key-store-26SPaa6M.js";
import { readFileSync } from "node:fs";
import fs from "node:fs/promises";
import { EventEmitter } from "node:events";
import { Category, ClientEvent, MatrixEventEvent, MemoryStore, Preset, SyncAccumulator, createClient } from "matrix-js-sdk/lib/matrix.js";
...
var FileBackedMatrixSyncStore = class extends MemoryStore {
	...
	async deleteAllData() {
		...
		this.cleanShutdown = false;
		await fs.rm(this.storagePath, { force: true }).catch(() => void 0);
	}
	markCleanShutdown() {
...
async function loadMatrixCryptoRuntime() {
	matrixCryptoRuntimePromise ??= import("./crypto-runtime-B81bpxAp.js").then((runtime) => {
...
var MatrixClient = class {
	...
	async bootstrapCryptoIfNeeded() {
		...
		const initial = await cryptoBootstrapper.bootstrap(crypto, { allowAutomaticCrossSigningReset: false });

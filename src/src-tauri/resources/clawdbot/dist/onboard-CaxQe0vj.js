...
import "./daemon-runtime-BFK5T_3J.js";
import { c as isValidEnvSecretRefId, p as resolveSecretInputRef } from "./types.secrets-Zn5Zyn7M.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-BeQ-3fY_.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BmFKG0kh.js";
import { u as readConfigFileSnapshot } from "./io-Dv_xNAZB.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BO_Xr0ZZ.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DAJV-epr.js";
import { t as runSetupWizard } from "./setup-bpxff6pc.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-C4xZK5uZ.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-Dc03y3Ta.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-9gJKn8d7.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B1kmisFJ.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DLko_YFK.js");

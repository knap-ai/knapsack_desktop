import { c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString } from "./string-coerce-C1IzJjqi.js";
...
import { an as errorShape, in as ErrorCodes, sn as parseSessionLabel } from "./client-kQ1-TM3I.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel, m as normalizeUsageDisplay, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels, u as normalizeElevatedLevel } from "./thinking-C1TCb8El.js";
import { d as resolveSubagentConfiguredModelSelection, i as resolveAllowedModelRef, o as resolveDefaultModelForAgent } from "./model-selection-hTT37jzm.js";
import { _ as normalizeExecTarget } from "./exec-approvals-BbaGmaa4.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DIP-LQp_.js";
import { t as normalizeSendPolicy } from "./send-policy-CeDRAbMh.js";
import { t as normalizeGroupActivation } from "./group-activation-DBUyCcKk.js";
import { i as parseVerboseOverride, n as applyVerboseOverride, r as parseTraceOverride, t as applyTraceOverride } from "./level-overrides-xpqKLTb9.js";
...
async function applySessionsPatchToStore(params) {
	...
	if (next.thinkingLevel) {
		...
		if (!thinkingLevel) delete next.thinkingLevel;
			...
			if ("thinkingLevel" in patch) return invalid(`thinkingLevel "${thinkingLevel}" is not supported for ${effectiveProvider}/${effectiveModel} (use ${formatThinkingLevels(effectiveProvider, effectiveModel, "|")})`);

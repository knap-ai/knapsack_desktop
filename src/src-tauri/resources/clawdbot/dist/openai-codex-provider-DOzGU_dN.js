import { h as CODEX_CLI_PROFILE_ID, n as ensureAuthProfileStore } from "./store-CY-e50gT.js";
import "./defaults-BwiMD7ye.js";
import { r as normalizeProviderId } from "./provider-id-CTiEzT1T.js";
import { n as matchesExactOrPrefix, o as normalizeModelCompat, t as cloneFirstTemplateModel } from "./provider-model-shared-B0P3sbBu.js";
import { n as listProfilesForProvider } from "./profiles-RmR8EAZC.js";
import { i as fetchCodexUsage } from "./provider-usage.fetch-M75Vjeyz.js";
import { n as createOpenAIAttributionHeadersWrapper } from "./openai-stream-wrappers-D4CWCCrG.js";
import "./provider-auth-rTeK2_Yu.js";
import { t as buildOauthProviderAuthResult } from "./provider-auth-result-BhR-PQxr.js";
import { r as loginOpenAICodexOAuth } from "./provider-auth-login-CCR3cWWX.js";
import { r as findCatalogTemplate } from "./provider-catalog-shared-AMCB3s4J.js";
import "./provider-stream-D_iORY-e.js";
import "./provider-usage-CSda3T6F.js";
import { t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-CxlMm34P.js";
import { n as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-Bw4l98Vv.js";
import { n as buildOpenAICodexProvider } from "./openai-codex-catalog-D0q7E9F0.js";
import { n as isOpenAIApiBaseUrl } from "./shared-Cp6NTdok.js";
//#region extensions/openai/openai-codex-provider.ts
const PROVIDER_ID = "openai-codex";
const OPENAI_CODEX_BASE_URL = "https://chatgpt.com/backend-api";
const OPENAI_CODEX_GPT_54_MODEL_ID = "gpt-5.4";
const OPENAI_CODEX_GPT_54_CONTEXT_TOKENS = 272e3;
...
function buildOpenAICodexProviderPlugin() {
	return {
		...
		augmentModelCatalog: (ctx) => {
			...
			return [buildSyntheticCatalogEntry(gpt54Template, {

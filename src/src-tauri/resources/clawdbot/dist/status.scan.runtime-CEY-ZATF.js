...
import { a as asRecord } from "./record-coerce-BpObaVhi.js";
import { n as sha256HexPrefix } from "./redact-identifier-BrH99Tco.js";
...
import { n as buildChannelAccountSnapshot, r as formatChannelAllowFrom, t as resolveInspectedChannelAccount } from "./account-inspection-DNYM3Edk.js";
import { t as formatChannelStatusState } from "./status-state-CWbszISe.js";
import "./format-BpOtpT1F.js";
...
async function buildChannelsTable(cfg, opts) {
	...
	for (const plugin of listReadOnlyChannelPluginsForConfig(cfg, { activationSourceConfig: sourceConfig })) {

...
import { Gt as collectPluginSchemaMetadata, Kt as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, Wt as collectChannelSchemaMetadata, c as loadConfig, f as readConfigFileSnapshot } from "./io-DhtVmzAJ.js";
import "./zod-schema.sensitive-UYE6KH9T.js";
import { i as CHANNEL_IDS } from "./chat-meta-Cdrnv7R-.js";
...
import { a as redactSensitiveUrlLikeString, n as hasSensitiveUrlHintTag, r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-DvOJVkbi.js";
...
function assertNoRedactedSentinel(value, path) {
	...
	if (value && typeof value === "object") for (const [key, item] of Object.entries(value)) assertNoRedactedSentinel(item, path ? `${path}.${key}` : key);
}
	...
	schema: {
		...
		properties: {
				...
				properties: {
					...
					stream: {
						...
						properties: {
							...
							repeatSuppression: { type: "boolean" },
							deliveryMode: { anyOf: [{
								type: "string",
								const: "live"
							}, {
				...
				properties: {
					defaults: {
						...
						properties: {
							...
							bootstrapPromptTruncationWarning: { anyOf: [
								{
									type: "string",
									const: "off"
								},
							...
							compaction: {
								...
								properties: {
									...
									identifierInstructions: { type: "string" },
									recentTurnsPreserve: {
										type: "integer",
										minimum: 0,
										maximum: 12
									...
									memoryFlush: {
										...
										properties: {
											...
											forceFlushTranscriptBytes: { anyOf: [{
												type: "integer",
												minimum: 0,
												maximum: 9007199254740991
											}, { type: "string" }] },
							...
							embeddedPi: {
								type: "object",
								properties: { projectSettingsPolicy: { anyOf: [
									{
										type: "string",
										const: "trusted"
									},
							...
							heartbeat: {
								...
								properties: {
									...
									suppressToolErrorWarnings: { type: "boolean" },
								...
								properties: {
									...
									docker: {
										...
										properties: {
											...
											dangerouslyAllowContainerNamespaceJoin: { type: "boolean" }
										},
										additionalProperties: false
									},
									ssh: {
			...
			tools: {
				...
				properties: {
					...
					message: {
						type: "object",
						properties: {
							allowCrossContextSend: { type: "boolean" },
							crossContext: {
								type: "object",
								properties: {
									allowWithinProvider: { type: "boolean" },
									allowAcrossProviders: { type: "boolean" },
									marker: {
										type: "object",
										properties: {
											enabled: { type: "boolean" },
			...
			media: {
				type: "object",
				properties: {
					preserveFilenames: { type: "boolean" },
					ttlHours: {
						type: "integer",
						minimum: 1,
						maximum: 168
			...
			messages: {
				...
				properties: {
					...
					suppressToolErrors: { type: "boolean" },
					tts: {
						type: "object",
						properties: {
							auto: {
			...
			commands: {
				...
				properties: {
					...
					ownerDisplaySecret: { type: "string" },
					allowFrom: {
						type: "object",
						propertyNames: { type: "string" },
						additionalProperties: {
				...
				properties: {
					...
					maintenance: {
						...
						properties: {
							...
							pruneAfter: { anyOf: [{ type: "string" }, { type: "number" }] },
							pruneDays: {
								type: "integer",
								exclusiveMinimum: 0,
								maximum: 9007199254740991
							...
							rotateBytes: { anyOf: [{ type: "string" }, { type: "number" }] },
							resetArchiveRetention: { anyOf: [
								{ type: "string" },
								{ type: "number" },
								{
									type: "boolean",
							...
							maxDiskBytes: { anyOf: [{ type: "string" }, { type: "number" }] },
							highWaterBytes: { anyOf: [{ type: "string" }, { type: "number" }] }
						},
						additionalProperties: false
					}
				},
			...
			cron: {
				...
				properties: {
					...
					webhookToken: { anyOf: [{ type: "string" }, { oneOf: [
						{
							type: "object",
							properties: {
								source: {
					...
					sessionRetention: { anyOf: [{ type: "string" }, {
						type: "boolean",
						const: false
					}] },
					runLog: {
						type: "object",
						properties: {
							maxBytes: { anyOf: [{ type: "string" }, { type: "number" }] },
							keepLines: {
								type: "integer",
								exclusiveMinimum: 0,
								maximum: 9007199254740991
				...
				properties: {
					...
					http: {
						...
						properties: {
							...
							securityHeaders: {
								type: "object",
								properties: { strictTransportSecurity: { anyOf: [{ type: "string" }, {
									type: "boolean",
									const: false
								}] } },
								additionalProperties: false
				...
				properties: {
					...
					qmd: {
						...
						properties: {
							...
							includeDefaultMemory: { type: "boolean" },
							paths: {
								type: "array",
								items: {
									type: "object",
							...
							update: {
								...
								properties: {
									...
									onBoot: { type: "boolean" },
									waitForBootSync: { type: "boolean" },
									embedInterval: { type: "string" },
									commandTimeoutMs: {
										type: "integer",
										minimum: 0,
										maximum: 9007199254740991
					...
					entries: {
						...
						additionalProperties: {
							...
							properties: {
								...
								hooks: {
									type: "object",
									properties: { allowPromptInjection: { type: "boolean" } },
									additionalProperties: false
								},
								subagent: {
									type: "object",
									properties: {
										allowModelOverride: { type: "boolean" },
										allowedModels: {
											type: "array",
											items: { type: "string" }
										}
					...
					installs: {
						...
						additionalProperties: {
							...
							properties: {
								...
								marketplaceSource: { type: "string" },
								marketplacePlugin: { type: "string" }
							},
							required: ["source"],
							additionalProperties: false
						}

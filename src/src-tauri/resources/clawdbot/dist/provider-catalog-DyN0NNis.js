import { r as supportsNativeStreamingUsageCompat, t as applyProviderNativeStreamingUsageCompat } from "./provider-catalog-shared-BIM0n3KJ.js";
...
function buildMoonshotProvider() {
	return {
		...
		models: MOONSHOT_MODEL_CATALOG.map((model) => Object.assign({}, model, { input: [...model.input] }))
	};
}
//#endregion

import { A as getResolvedLoggerSettings, O as getChildLogger, S as logVerbose, a as setConsoleSubsystemFilter, c as sanitizeForLog, k as getLogger, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger, w as setVerbose } from "./subsystem-BDbeCphF.js";
import { g as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-dQ_clcF4.js";
import { n as isRich, r as theme, t as colorize } from "./theme-H80Q3Qtv.js";
import "./boolean-DTgd5CzD.js";
import { a as logAcceptedEnvOption, i as isTruthyEnvValue } from "./entry.js";
import { $c as validateNodeInvokeParams, $d as resolveTtsConfig, $f as readSessionPreviewItemsFromTranscript, $g as isAvatarImageDataUrl, $l as loadOrCreateDeviceIdentity, $n as updatePairedNodeMetadata, $r as buildDefaultToolPolicyPipelineSteps, $s as PAIRING_SCOPE$1, $u as CommandLane, A as resolveAllowedModelRef, Ac as validateCronAddParams, Ag as createConfigIO, Ah as isLocalishHost, Ai as readLatestAssistantReply, Al as validateTalkModeParams, Ao as normalizeHttpWebhookUrl, Ar as resolveSendPolicy, Av as normalizeThinkLevel, B as createPluginRuntime, B_ as runGlobalGatewayStopSafely, Bc as validateDevicePairRemoveParams, Bg as OpenClawSchema, Bh as resolveGatewayListenHosts, Bl as ErrorCodes, Bo as normalizePayloadToSystemText, Bp as GATEWAY_CLIENT_IDS, Br as getActiveEmbeddedRunCount, Bs as missingSystemRunApprovalBinding, C as isCliProvider, Cc as validateConfigGetParams, Cd as isRestartEnabled, Cg as loadModelCatalog, Ch as readGatewayTokenEnv, Ci as emitAgentEvent, Cl as validateSessionsResolveParams, Cn as setCliSessionId, Co as consumeRestartSentinel, Cr as DEFAULT_INPUT_TIMEOUT_MS, Cv as formatThinkingLevels, D as normalizeModelSelection, D_ as resolveAgentMaxConcurrent, Dc as validateConfigSchemaParams, Dd as ToolInputError, Dh as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Dl as validateSkillsStatusParams, Do as summarizeRestartSentinel, Dr as resolveInputFileLimits, Dv as normalizeElevatedLevel, E_ as buildTalkConfigResponse, Ec as validateConfigSchemaLookupResult, Eh as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Ei as registerAgentRunContext, El as validateSkillsInstallParams, En as resolveSessionAuthProfileOverride, Er as normalizeMimeList, Fc as validateCronStatusParams, Ff as loadSessionStore, Fg as readConfigFileSnapshotForWrite, Fh as isValidIPv4, Fi as resolvePreferredSessionKeyForSessionIdMatches, Fl as validateWebLoginWaitParams, Fo as resolveDefaultCronStaggerMs, Fs as resolveSystemRunApprovalRuntimeContext, Ft as normalizeControlUiBasePath, G as formatHelpExamples, Gc as validateExecApprovalsGetParams, Gf as mergeDeliveryContext, Gg as parseByteSize, Gh as safeEqualSecret, Gi as loadCombinedSessionStoreForGateway, Gl as resolveDeviceAuthConnectErrorDetailCode, Gm as resolveConfiguredSecretInputString, Gn as refreshRemoteNodeBins, Gr as resolveBootstrapWarningSignaturesSeen, Gu as enqueueCommandInLane, Ha as buildOutboundSessionContext, Hc as validateDeviceTokenRotateParams, Hl as parseSessionLabel, Hm as ensureGatewayStartupAuth, Hn as primeRemoteSkillsCache, Hp as GATEWAY_CLIENT_NAMES, Hr as waitForEmbeddedPiRunEnd, Hs as toSystemRunApprovalMismatchError, I as resolveSubagentConfiguredModelSelection, Ic as validateCronUpdateParams, Ig as resolveConfigSnapshotHash, Ih as normalizeHostHeader, Ii as applyModelOverrideToSessionEntry, Il as validateWizardCancelParams, Ip as isWebchatClient, It as resolveAssistantAvatarUrl, Ja as normalizeReplyPayloadsForDelivery, Jc as validateExecApprovalsSetParams, Jd as getTtsProvider, Jf as archiveFileOnDisk, Jh as enableTailscaleFunnel, Ji as resolveGatewaySessionStoreTarget, Jl as normalizeDeviceMetadataForAuth, Jn as approveNodePairing, Jp as isPidAlive, Ju as getTotalQueueSize, Kc as validateExecApprovalsNodeGetParams, Kf as normalizeSessionDeliveryFields, Kh as disableTailscaleFunnel, Ki as loadSessionEntry, Kl as buildDeviceAuthPayload, Kn as removeRemoteNodeInfo, Kr as resolveFastModeState, Ks as callGateway, Ku as getActiveTaskCount, L as resolveThinkingDefault, Lc as validateDevicePairApproveParams, Ld as SILENT_REPLY_TOKEN, Lh as pickPrimaryLanIPv4, Li as loadProviderUsageSummary, Ll as validateWizardNextParams, Ln as getChannelActivity, Lo as normalizeOptionalAgentId, Lp as normalizeMessageChannel, Lr as runEmbeddedPiAgent, Ls as resolveSystemRunCommandRequest, M as resolveConfiguredModelRef, Mc as validateCronRemoveParams, Md as resolveUserTimezone, Mf as parseSessionThreadInfo, Mg as parseConfigJson5, Mh as isLoopbackHost, Ml as validateUpdateRunParams, Mn as parseVerboseOverride, Mo as normalizeCronJobPatch, Mp as isDeliverableMessageChannel, Mu as resolvePluginTools, Mv as normalizeVerboseLevel, N as resolveDefaultModelForAgent, Na as resolveOutboundTarget, Nc as validateCronRunParams, Ng as readBestEffortConfig, Nl as validateWakeParams, Nn as unbindThreadBindingsBySessionKey, No as normalizeCronStaggerMs, Np as isGatewayCliClient, Nr as isAbortRequestText, Nt as CONTROL_UI_AVATAR_PREFIX, O_ as resolveSubagentMaxConcurrent, Oc as validateConfigSetParams, Oh as createAuthRateLimiter, Ol as validateSkillsUpdateParams, Ov as normalizeFastMode, P as resolveHooksGmailModel, Pa as resolveSessionDeliveryTarget, Pc as validateCronRunsParams, Pf as archiveRemovedSessionTranscripts, Pg as readConfigFileSnapshot, Ph as isTrustedProxyAddress, Pi as resolveNestedAgentLane, Pl as validateWebLoginStartParams, Po as resolveCronStaggerMs, Pp as isGatewayMessageChannel, Pr as stopSubagentsForRequester, Ps as resolveSystemRunApprovalRequestContext, Pt as buildControlUiAvatarUrl, Pv as supportsXHighThinking, Qc as validateNodeEventParams, Qd as resolveTtsAutoMode, Qf as readSessionMessages, Qg as isAvatarHttpUrl, Qi as lookupContextTokens, Ql as deriveDeviceIdFromPublicKey, Qn as requestNodePairing, Qr as applyToolPolicyPipeline, Qs as APPROVALS_SCOPE$1, Qu as waitForActiveTasks, Rc as validateDevicePairListParams, Rg as writeConfigFile, Rh as resolveClientIp, Rl as validateWizardStartParams, Ro as normalizeOptionalSessionKey, Rs as buildSystemRunApprovalBinding, Rt as resolveExecApprovalCommandDisplay, S as getModelRefStatus, Sc as validateConfigApplyParams, Sf as estimateBase64DecodedBytes, Sh as readGatewayPasswordEnv, Si as clearAgentRunContext, Sl as validateSessionsResetParams, Sn as getCliSessionId, So as triggerOpenClawRestart, Sr as DEFAULT_INPUT_IMAGE_MIMES, Sv as DEFAULT_PROVIDER, Tc as validateConfigSchemaLookupParams, Th as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ti as onAgentEvent, Tl as validateSkillsBinsParams, Tm as cleanOldMedia, To as formatRestartSentinelMessage, Tr as extractImageContentFromSource, U as withProgress, Ua as deliverOutboundPayloads, Uc as validateExecApprovalRequestParams, Uh as pickPrimaryTailnetIPv4, Ui as listAgentsForGateway, Ul as ConnectErrorDetailCodes, Um as mergeGatewayAuthConfig, Un as recordRemoteNodeInfo, Uo as parseAbsoluteTimeMs, Up as hasGatewayClientCap, Uu as clearBootstrapSnapshot, Vc as validateDeviceTokenRevokeParams, Vh as resolveRequestClientIp, Vi as canonicalizeSpawnedByForAgent, Vl as errorShape, Vn as getRemoteSkillEligibility, Vo as normalizeRequiredName, Vp as GATEWAY_CLIENT_MODES, Vr as waitForActiveEmbeddedRuns, Wc as validateExecApprovalResolveParams, Wd as resolveAgentIdentity, Wf as deliveryContextFromSession, Wh as pickPrimaryTailnetIPv6, Wi as listSessionsFromStore, Wl as resolveAuthConnectErrorDetailCode, Wm as mergeGatewayTailscaleConfig, Wn as refreshRemoteBinsForConnectedNodes, Wo as normalizeLegacyDeliveryInput, Wp as normalizeGatewayClientMode, Ws as buildExecApprovalPendingReplyPayload, Wt as resolveAgentAvatar, Wu as clearBootstrapSnapshotOnSessionRollover, Xa as resolveOutboundChannelPlugin, Xc as validateModelsListParams, Xd as isTtsProviderConfigured, Xf as capArrayByJsonBytes, Xl as normalizeDeviceAuthScopes, Xn as rejectNodePairing, Xp as readJsonFile, Xt as createReplyPrefixOptions, Xu as resetAllLanes, Yc as validateLogsTailParams, Yd as isTtsEnabled, Yf as archiveSessionTranscripts, Yh as enableTailscaleServe, Yi as resolveSessionModelRef, Yn as listNodePairing, Yp as createAsyncLock, Yr as resolveCronStyleNow, Yu as markGatewayDraining, Za as applyPluginAutoEnable, Zc as validateNodeDescribeParams, Zd as resolveTtsApiKey, Zf as cleanupArchivedSessionTranscripts, Zg as AVATAR_MAX_BYTES, Zh as getTailnetHostname, Zl as loadGatewayTlsRuntime$1, Zn as renamePairedNode, Zp as writeJsonAtomic, Zr as resolveToolLoopDetectionConfig, Zs as ADMIN_SCOPE$3, Zt as buildHistoryContextFromEntries, Zu as setCommandLaneConcurrency, _c as validateChannelsStatusParams, _g as fetchWithSsrFGuard, _h as isLocalDirectRequest, _l as validateSessionsCompactParams, _o as isGatewaySigusr1RestartExternallyAllowed, _p as resolveExplicitAgentSessionKey, _r as getSkillsSnapshotVersion, _s as isKnownSecretTargetId, aa as normalizeGroupActivation, ac as formatValidationErrors, af as OPENAI_TTS_MODELS, ag as resolveToolProfilePolicy, al as validateNodePairRequestParams, ao as resolveMessageChannelSelection, ap as normalizeInputProvenance, as as closeTrackedBrowserTabsForSessions, at as resolveAgentOutboundIdentity, au as isSystemEventContextChanged, bc as validateChatInjectParams, bg as registerUnhandledRejectionHandler, bi as normalizeSpawnedRunMetadata, bl as validateSessionsPatchParams, bn as resolveCronStorePath, bo as setGatewaySigusr1RestartPolicy, bp as snapshotSessionOrigin, bt as handleReset, cc as validateAgentWaitParams, cg as listCoreToolSections, ci as countActiveDescendantRuns, cl as validateNodePendingDrainParams, co as runWithModelFallback, cp as evaluateSessionFreshness, cs as activateSecretsRuntimeSnapshot, dc as validateAgentsFilesGetParams, di as initSubagentRegistry, dl as validatePollParams, ds as prepareSecretsRuntimeSnapshot, e_ as looksLikeAvatarPath, ea as computeBackoff, ef as resolveTtsPrefsPath, el as validateNodeInvokeResultParams, eo as buildChannelUiCatalog, ep as resolveSessionTranscriptCandidates, er as verifyNodeToken, eu as normalizeDevicePublicKeyBase64Url, fa as parseTimeoutMsWithFallback, fc as validateAgentsFilesListParams, fl as validatePushTestParams, fm as createBrowserRouteDispatcher, fp as mergeSessionEntry, fs as resolveCommandSecretsFromActiveRuntimeSnapshot, fu as setHeartbeatsEnabled, g_ as ensureControlUiAllowedOriginsForNonLoopbackBind, gc as validateChannelsLogoutParams, gg as extractTextFromChatContent, gh as authorizeWsControlUiGatewayConnect, gl as validateSendParams, gn as getTotalPendingReplies, go as emitGatewayRestart, gp as resolveAgentMainSessionKey, gu as ensureExecApprovals, h_ as applyLegacyMigrations, ha as resolveOutboundSessionRoute, hc as validateAgentsUpdateParams, hh as authorizeHttpGatewayConnect, hl as validateSecretsResolveResult, hn as createReplyDispatcher, ho as deferGatewayRestartUntilIdle, hp as canonicalizeMainSessionAlias, id as isDiagnosticsEnabled, if as textToSpeech, ig as mergeAlsoAllowPolicy, ii as resolveSubagentToolPolicy, il as validateNodePairRejectParams, io as resetDirectoryCache, ip as stripInlineDirectiveTagsFromMessageForDisplay, is as isExternalHookSession, iu as enqueueSystemEvent, jc as validateCronListParams, jf as extractDeliveryInfo, jg as loadConfig, jh as isLoopbackAddress, ji as resolveAnnounceTargetFromKey, jl as validateToolsCatalogParams, jn as applyVerboseOverride, jo as normalizeCronJobCreate, jp as INTERNAL_MESSAGE_CHANNEL, ju as getPluginToolMeta, jv as normalizeUsageDisplay, kc as validateConnectParams, kf as resolveAgentSessionDirs, kg as migrateLegacyConfig, kh as normalizeRateLimitClientIp, kl as validateTalkConfigParams, ko as writeRestartSentinel, kr as normalizeSendPolicy, ku as saveExecApprovals, kv as normalizeReasoningLevel, lc as validateAgentsCreateParams, ld as resolveMemorySearchConfig, lg as resolveCoreToolProfiles, ll as validateNodePendingEnqueueParams, ls as clearSecretsRuntimeSnapshot, m_ as applyMergePatch, ma as ensureOutboundSessionEntry, mc as validateAgentsListParams, md as getAcpSessionManager, mh as assertGatewayAuthConfigured, ml as validateSecretsResolveParams, mm as startBrowserControlServiceFromConfig, mn as dispatchInboundMessage, mo as consumeGatewaySigusr1RestartAuthorization, mp as setSessionRuntimeModel, ms as evaluateGatewayAuthSurfaceStates, mu as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, nc as authorizeOperatorScopesForMethod, nd as stopDiagnosticHeartbeat, nf as setTtsEnabled, ni as resolveEffectiveToolPolicy, nl as validateNodePairApproveParams, np as stripEnvelopeFromMessages, ns as detectSuspiciousPatterns, nt as buildTelegramExecApprovalButtons, oc as validateAgentIdentityParams, of as OPENAI_TTS_VOICES, og as PROFILE_OPTIONS, oi as runBeforeToolCallHook, ol as validateNodePairVerifyParams, oo as normalizePollInput, op as jsonUtf8Bytes, or as listAgentWorkspaceDirs, os as applyBrowserProxyPaths, pc as validateAgentsFilesSetParams, pd as stripHeartbeatToken, pi as listDescendantRunsForRequester, pl as validateRequestFrame, pm as createBrowserControlContext, po as resolveFailoverReasonFromError, ps as GATEWAY_AUTH_SURFACE_PATHS, qc as validateExecApprovalsNodeSetParams, qh as disableTailscaleServe, qi as migrateAndPruneGatewaySessionStoreKey, ql as buildDeviceAuthPayloadV3, qn as setSkillsRemoteRegistry, qp as cleanStaleLockFiles, ra as clearSessionQueues, rc as isNodeRoleMethod, rf as setTtsProvider, rg as collectExplicitAllowlist, ri as resolveGroupToolPolicy, rl as validateNodePairListParams, ro as maybeResolveIdLikeTarget, rp as stripInlineDirectiveTagsForDisplay, rs as getHookType, rt as resolveExecApprovalSessionTarget, ru as verifyDeviceSignature, sc as validateAgentParams, si as createOpenClawTools, sl as validateNodePendingAckParams, sn as sendTypingTelegram, sr as formatZonedTimestamp, ss as persistBrowserProxyFiles, st as handleSlackHttpRequest, ta as sleepWithAbort, tc as WRITE_SCOPE, td as startDiagnosticHeartbeat, tf as resolveTtsProviderOrder, tl as validateNodeListParams, tp as stripEnvelopeFromMessage, ts as buildSafeExternalPrompt, tu as publicKeyRawBase64UrlFromPem, uc as validateAgentsDeleteParams, ud as getMachineDisplayName, ul as validateNodeRenameParams, up as resolveSessionResetPolicy, us as getActiveSecretsRuntimeSnapshot, uu as requestHeartbeatNow, vc as validateChatAbortParams, vg as SsrFBlockedError, vh as resolveGatewayAuth, vi as resolveAgentTimeoutMs, vl as validateSessionsDeleteParams, vm as movePathToTrash, vn as buildBareSessionResetPrompt, vo as markGatewaySigusr1RestartHandled, vp as resolveMainSessionKey, vr as registerSkillsChangeListener, wc as validateConfigPatchParams, wi as getAgentRunContext, wl as validateSessionsUsageParams, wm as rawDataToString, wn as runCliAgent, wo as formatDoctorNonInteractiveHint, wr as extractFileContentFromSource, wu as readExecApprovalsSnapshot, wv as formatXHighModelHint, xc as validateChatSendParams, xi as resolveIngressWorkspaceOverrideForSpawnedRun, xl as validateSessionsPreviewParams, xn as saveCronStore, xo as setPreRestartDeferralCheck, xr as DEFAULT_INPUT_IMAGE_MAX_BYTES, xu as normalizeExecApprovals, xv as DEFAULT_MODEL, y as buildAllowedModelSet, ya as readChannelAllowFromStoreSync, yc as validateChatHistoryParams, yl as validateSessionsListParams, yn as loadCronStore, yo as scheduleGatewaySigusr1Restart, yp as resolveMainSessionKeyFromConfig, yu as mergeExecApprovalsSocketDefaults, yv as normalizeSecretInput, z as loadOpenClawPlugins, z_ as getGlobalHookRunner, zc as validateDevicePairRejectParams, zd as isSilentReplyText, zf as updateSessionStore, zg as validateConfigObjectWithPlugins, zh as resolveGatewayBindHost, zl as validateWizardStatusParams, zo as normalizeOptionalText$1, zp as GATEWAY_CLIENT_CAPS, zr as abortEmbeddedPiRun, zs as matchSystemRunApprovalBinding, zt as sanitizeExecApprovalDisplayText } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-CZIF93u7.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey, S as isAcpSessionKey, T as isSubagentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-51LnISpq.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-B88a096J.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-Bb0WDUIN.js";
import { i as logWarn, t as logDebug } from "./logger-D0msxOz2.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CdZJtviz.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CbcBJZgO.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BvNoSfUf.js";
import "./github-copilot-token-DQd7axD5.js";
import { C as createInternalHookEvent, S as clearInternalHooks, T as triggerInternalHook, b as canonicalizePathVariant, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, w as registerInternalHook, y as canonicalizePathForSecurity } from "./registry-DtTKJfN8.js";
import { T as isTestDefaultMemorySlotDisabled, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-CtzUimzY.js";
import { f as hasBinary } from "./frontmatter-D0K3qXQH.js";
import "./env-overrides-D7R3RscC.js";
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-DcA9ITyc.js";
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-CR5cykjp.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, ut as resolveChannelDefaultAccountId } from "./plugins-C-z6VZlO.js";
import { B as readLocalFileSafely, H as writeFileWithinRoot, L as openFileWithinRoot, N as SafeOpenError, W as detectMime } from "./query-expansion-E78fX0en.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-DrUa2v4S.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-Bgu5Y3JI.js";
import "./fetch-BmEnSimV.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-C2fEXRX9.js";
import { l as ensurePortAvailable, m as formatPortDiagnostics, o as cleanStaleGatewayProcessesSync, u as inspectPortUsage } from "./cmd-argv-Cnl266PT.js";
import "./delivery-queue-uotfwRH3.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-B9q4Ev3T.js";
import { c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-B7YSslo_.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-vZAAwjhY.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-Cl0txu8e.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CGdAPHxr.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BQrJ_PWn.js";
import { t as readSecretFromFile } from "./secret-file-CvW_tFrN.js";
import { n as inheritOptionFromParent } from "./command-options-DqfI-XB8.js";
import { t as WizardCancelledError } from "./prompts-D9rbgHwf.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DfeGsm62.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import "./install-safe-path-DZM2JHcC.js";
import "./skill-scanner-Ms0uZYdw.js";
import { n as formatConfigIssueLines } from "./issue-format-DSEqPkwx.js";
import { t as buildChannelAccountSnapshot } from "./status-H_1uYq8w.js";
import "./channels-status-issues-D0D1GN5e.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-BKHRCJTv.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-3SwEUYfq.js";
...
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-DnTV_bc7.js";
import { c as isGatewayArgv, l as parseProcCmdline } from "./service-B6O2Y9L1.js";
import "./systemd---Z1c197.js";
import "./lifecycle-core-BWGEd8ra.js";
import "./systemd-hints-C5pH3Xds.js";
import { t as parsePort$1 } from "./parse-port-D6GsOzX2.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-Cfj5GfCC.js";
import { r as probeGateway } from "./probe-auth-B1lyIY0x.js";
import "./diagnostics-BHRgvw1Q.js";
import "./inspect-C1wHV4Kt.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-DlX-uPg2.js";
import "./table-BF1XI13C.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-ZL3DJHax.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DQaUKtE4.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-pFHDAA9i.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-DD1nkUHK.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-DSTtGBUV.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-CzhlcoLa.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-2PDMZv23.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D_0axdYi.js";
import "./onboarding.secret-input-BhEDjlfg.js";
import { t as runOnboardingWizard } from "./onboarding-E9frfTZz.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-v5UJ5kg-.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-C7zAzhbC.js";
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-DwRB0HyE.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent-DtkrV7dn.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-Byx2jedy.js";
import { _ as resolveHookTargetAgentId, a as getHookAgentPolicyError, b as resolveFunctionModuleExport, c as normalizeAgentPayload, d as normalizeWakePayload, f as readJsonBody, g as resolveHookSessionKey, h as resolveHookIdempotencyKey, i as extractHookToken, l as normalizeHookDispatchSessionKey, m as resolveHookDeliver, n as collectEnabledInsecureOrDangerousFlags, o as getHookChannelError, p as resolveHookChannel, s as isHookAgentAllowed, u as normalizeHookHeaders, v as resolveHooksConfig, y as applyHookMappings } from "./audit-B7jSQKAT.js";
import "./node-service-7yIc6RRY.js";
import "./status.update-BDMAkJyU.js";
import { t as installSkill } from "./skills-install-CklgHUaY.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-BlDHIQ9V.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CccLtXdM.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BLGDfe4N.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-B7YSslo_.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-Hmku-f38.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-uotfwRH3.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./auth-profiles-DRjqKE3G.js").then((n) => n.Wa);

...
import { M as theme, h as defaultRuntime, n as isTruthyEnvValue, o as createSubsystemLogger, x as info } from "./entry.js";
import { d as resolveAgentIdFromSessionKey, h as toAgentStoreSessionKey, l as normalizeAgentId } from "./session-key-DVvxnFKg.js";
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-Bu62UIQZ.js";
import { _ as parseDurationMs, i as loadConfig } from "./config-BJWIHf6x.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-DsHRVW6o.js";
import { $n as getQueueSize, F as resolveHeartbeatSenderContext, Fr as isHeartbeatContentEffectivelyEmpty, Ir as resolveHeartbeatPrompt$1, Lr as stripHeartbeatToken, Mr as resolveUserTimezone, Nr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, P as resolveHeartbeatDeliveryTarget, Pr as DEFAULT_HEARTBEAT_EVERY, ht as setHeartbeatWakeHandler, ir as CommandLane, kn as resolveEffectiveMessagesConfig, mr as peekSystemEvents, mt as requestHeartbeatNow, t as getReplyFromConfig } from "./reply-DWlAlSNj.js";
import { n as formatErrorMessage } from "./errors-C34O4jLW.js";
import { C as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-CPbyDZgw.js";
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as appendCronStyleCurrentTimeLine, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-DE8-7WEw.js";
import { O as canonicalizeMainSessionAlias, i as loadSessionStore, k as resolveAgentMainSessionKey, l as updateSessionStore, s as saveSessionStore } from "./sessions-DGtM0qOW.js";
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fs.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason && !isCronEventReason && !isWakeReason) {
			emitHeartbeatEvent({
				status: "skipped",
...
//#endregion
export { resolveHeartbeatSummaryForAgent as a, startHeartbeatRunner as c, health_exports as i, getHealthSnapshot as n, runHeartbeatOnce as o, healthCommand as r, setHeartbeatsEnabled as s, formatHealthChannelLines as t };
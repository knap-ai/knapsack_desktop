import { a as clampNumber, i as clampInt, v as resolveUserPath } from "./utils-CE3P21nG.js";
import { _ as resolveStateDir } from "./paths-CD8i0MSg.js";
import { i as resolveAgentConfig } from "./agent-scope-CYXg_wTS.js";
import { t as getMemoryEmbeddingProvider } from "./memory-embedding-providers-DHmXGqSq.js";
import { a as isMemoryMultimodalEnabled, o as normalizeMemoryMultimodalSettings } from "./multimodal-D2Ic0vzl.js";
...
function resolveMemorySearchConfig(cfg, agentId) {
	...
	if (multimodalActive && !multimodalProvider?.supportsMultimodalEmbeddings?.({ model: resolved.model })) throw new Error("agents.*.memorySearch.multimodal requires a provider adapter that supports multimodal embeddings for the configured model.");
...
//#endregion
export { resolveMemorySearchConfig as t };

import { g as resolveHomeDir, u as isRecord } from "./utils-CE3P21nG.js";
import { t as CONFIG_PATH } from "./paths-CD8i0MSg.js";
import { R as OpenClawSchema, f as readConfigFileSnapshot } from "./io-DhtVmzAJ.js";
import "./config-CJQx-9zo.js";
import { n as formatConfigIssueLines } from "./issue-format-DnqtJUII.js";
import { t as note } from "./note-B5Cxa9lg.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-pjhL7xAn.js");

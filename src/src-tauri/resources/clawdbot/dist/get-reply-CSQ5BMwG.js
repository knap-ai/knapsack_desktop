...
import { n as CHAT_CHANNEL_ORDER } from "./ids-2bZIXJNM.js";
...
import { t as getLoadedChannelPluginById } from "./registry-loaded-DdctO-79.js";
...
import { n as DEFAULT_AGENT_WORKSPACE_DIR, u as ensureAgentWorkspace } from "./workspace-DiB6mKpP.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, h as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
import "./config-yDDhhyz6.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import "./message-channel-core-3ccLmc54.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-IJ6YNe09.js";
import { d as resetRegisteredAgentHarnessSessions } from "./loader-NucjcOgv.js";
import "./plugins-BZ_I3cWH.js";
import { n as fireAndForgetHook } from "./fire-and-forget-4WqkBWgE.js";
...
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-BFywV6BM.js";
import { f as normalizeThinkLevel, h as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-C1TCb8El.js";
import { h as resolveModelRefFromString } from "./model-selection-shared-grYiFZof.js";
import "./model-selection-hTT37jzm.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BzfGEj6I.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DvU8Tgvw.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-BRwSoIeK.js";
import { s as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-Cf3NDflc.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types--vJusqfs.js";
import { f as deriveSessionMetaPatch, g as resolveGroupSessionKey, l as resolveSessionStoreEntry, o as updateSessionStore } from "./store-Bm25Mivo.js";
...
import { a as resolveAndPersistSessionFile } from "./transcript-C5WPUIcy.js";
import { n as parseSessionThreadInfoFast } from "./thread-info-c05DuncS.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-B716cKY1.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-C_v_J0E7.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-DArLXMH2.js";
import { t as isReasoningTagProvider } from "./provider-utils-sfWCz_Ux.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache--9ULmphw.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CkLZ2mlp.js";
import { i as generateSecureToken } from "./secure-random-D0one-pn.js";
import { n as resolveSilentReplySettings } from "./silent-reply-CGbonvcD.js";
...
import { t as resolveQueueSettings } from "./queue-DHEUr0Dd.js";
...
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-7b-pqA3M.js";
import { a as resolveParentForkMaxTokens, i as forkSessionFromParent } from "./subagent-spawn-BxkfDpwx.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DTlDefVb.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-RdSq7yWA.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-C2wR3G1B.js";
import { t as hasControlCommand } from "./command-detection-C6edkeaW.js";
import "./commands-registry-D1HuZY_U.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-L85D_ILk.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-OtSG9lyE.js";
import { t as finalizeInboundContext } from "./inbound-context-CLbSDMst.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DDp7QU_Z.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-8V4_s3MO.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-XQ1v_XLT.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CMkd-jDt.js";
import { t as normalizeGroupActivation } from "./group-activation-DBUyCcKk.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-znOCuJiT.js";
import { t as resolveFastModeState } from "./fast-mode-Dg0WyQf7.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DLSWYtDl.js";
import { t as buildCommandContext } from "./commands-context-BBEV0orr.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-CdoJgz4j.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-DD6xUfd-.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-CinyiuQZ.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-BgrzDmih.js";
import { n as parseSoftResetCommand, t as isResetAuthorizedForContext } from "./reset-authorization-SBlkqg1_.js";
...
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-D1kWVnGF.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-Bfe-t6aN.js";
import { t as hasInboundMedia } from "./inbound-media-ocZ-FLuE.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-I8LrAqcy.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-B-nFflXI.js";
...
import { t as drainFormattedSystemEvents } from "./session-system-events-CizPTwXH.js";
import { r as getCliSessionBinding } from "./cli-session-BNhxyNEg.js";
import { t as resolveResetPreservedSelection } from "./reset-preserved-selection-DaQ_cmzj.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-DiIq2Cw8.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DZuOsEV3.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-DpIXCVTk.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-oBIhO66S.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BaKJlK8e.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-Cs9bR09b.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-fJWIriHN.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-CJwOV2O_.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DQ7IygwK.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-B4OibQQ6.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-oKXHOjVy.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-oKXHOjVy.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-BUnUwwi3.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-CoKUbcnY.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-Oe4ZtkfX.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-BE-PYxVi.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-Dw0d5gOG.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-CbAg9IpO.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-EbmY3a5J.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-DsNlZXli.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-C-S7rTkI.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BS4W-u-_.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-DvMc2APG.js");
	return stageSandboxMediaRuntimePromise;
}
function loadMediaUnderstandingApplyRuntime() {
	mediaUnderstandingApplyRuntimePromise ??= import("./apply.runtime-BuUiiVT_.js");
	return mediaUnderstandingApplyRuntimePromise;
}
function loadLinkUnderstandingApplyRuntime() {
	linkUnderstandingApplyRuntimePromise ??= import("./apply.runtime-Br63rge2.js");
	return linkUnderstandingApplyRuntimePromise;
}
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-CDoM3WZR.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-DeZ-OzGM.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-BnlkFhJs.js");

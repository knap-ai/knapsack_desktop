import { i as formatErrorMessage, o as hasErrnoCode } from "./errors-Jbvi20TW.js";
...
import { c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import { t as getChannelPlugin } from "./registry-B2TRwbJD.js";
import { i as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-DiB6mKpP.js";
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, x as resolveDefaultAgentId } from "./agent-scope-_6dFncNS.js";
import "./config-yDDhhyz6.js";
import { n as resolveSafeTimeoutDelayMs, t as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timer-delay-Co_I1iPe.js";
...
import { r as resolveEffectiveMessagesConfig } from "./identity-lSr9N8UI.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-BzfGEj6I.js";
import { u as resolveStorePath } from "./paths-DvU8Tgvw.js";
import { t as loadSessionStore } from "./store-load-Cf3NDflc.js";
import { i as saveSessionStore, o as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-Bm25Mivo.js";
import { c as resolveSessionResetPolicy, o as evaluateSessionFreshness } from "./reset-BjF1l1uy.js";
import { o as getQueueSize } from "./command-queue-B716cKY1.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-C_v_J0E7.js";
import { a as parseHeartbeatTasks, i as isTaskDue, o as resolveHeartbeatPrompt$1, r as isHeartbeatContentEffectivelyEmpty, s as stripHeartbeatToken } from "./heartbeat-DKgfsHcO.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-BNS5obcW.js";
...
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-BFEf9-hz.js";
import { a as resolveHeartbeatReasonKind, n as requestHeartbeatNow, r as setHeartbeatWakeHandler, t as areHeartbeatsEnabled } from "./heartbeat-wake-gACR6ANS.js";
import { s as peekSystemEventEntries, t as consumeSystemEventEntries, u as resolveSystemEventDeliveryContext } from "./system-events-B6vO-QxY.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-foeF2E4h.js";
import { i as resolveUserTimezone } from "./date-time-CvWUojm_.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-GUMQXnlj.js";
...
import { n as emitHeartbeatEvent, o as resolveIndicatorType, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-D5nIKHUQ.js";
import { i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-DZ-HBajV.js";
...
function resolveCronSession(params) {
	...
	return {
		...
		store,
		sessionEntry: {
			...entry ? isNewSession ? sanitizeFreshCronSessionEntry(entry, { preserveAmbientContext: !params.forceNew }) : entry : void 0,
			sessionId,
...
function loadHeartbeatRunnerRuntime() {
	heartbeatRunnerRuntimePromise ??= import("./heartbeat-runner.runtime-GyI3S0Xz.js");
...
After completing all due tasks, reply HEARTBEAT_OK.`;
	...
	return {
		prompt: appendHeartbeatWorkspacePathHint(hasExecCompletion ? buildExecEventPrompt(execEvents, { deliverToUser: params.canRelayToUser }) : hasCronEvents ? buildCronEventPrompt(cronEvents, { deliverToUser: params.canRelayToUser }) : resolveHeartbeatPrompt(params.cfg, params.heartbeat), params.workspaceDir),
		hasExecCompletion,
		hasCronEvents
	};
}
async function runHeartbeatOnce(opts) {
	...
	if ((opts.deps?.getQueueSize ?? getQueueSize)("main") > 0) return {
		status: "skipped",
...
//#endregion
export { resolveCronSession as i, runHeartbeatOnce as n, startHeartbeatRunner as r, resolveHeartbeatPrompt as t };

import { $ as resolveStateDir, A as colorize, B as STATE_DIR, E as setVerbose, F as getResolvedLoggerSettings, K as resolveGatewayLockDir, M as theme, N as getChildLogger, P as getLogger, R as CONFIG_PATH, U as resolveConfigPath, V as isNixMode, d as setConsoleTimestampPrefix, dt as getActivePluginRegistry, h as defaultRuntime, j as isRich, n as isTruthyEnvValue, o as createSubsystemLogger, q as resolveGatewayPort, r as logAcceptedEnvOption, rt as DEFAULT_CHAT_CHANNEL, s as runtimeForLogger, tt as CHANNEL_IDS, u as setConsoleSubsystemFilter, wt as expandHomePrefix } from "./entry.js";
import { F as resolveConfiguredModelRef, I as resolveDefaultModelForAgent, L as resolveHooksGmailModel, Mt as DEFAULT_CONTEXT_TOKENS, N as resolveAllowedModelRef, Nt as DEFAULT_MODEL, O as getModelRefStatus, Pt as DEFAULT_PROVIDER, _t as normalizeSecretInput, k as isCliProvider, z as resolveThinkingDefault } from "./auth-profiles-DnpV8DWM.js";
...
import { E as truncateUtf16Safe, S as shortenHomePath, n as clamp, s as ensureDir, t as CONFIG_DIR, u as isPlainObject, y as resolveUserPath } from "./utils-q1rHOG-N.js";
import { a as logDebug, c as logWarn, n as runExec, t as runCommandWithTimeout } from "./exec-B52LZOrO.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BKsZvO6K.js";
import { T as resolveWorkspaceTemplateDir, _ as DEFAULT_MEMORY_FILENAME, b as DEFAULT_USER_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, g as DEFAULT_MEMORY_ALT_FILENAME, h as DEFAULT_IDENTITY_FILENAME, i as resolveAgentModelFallbacksOverride, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, v as DEFAULT_SOUL_FILENAME, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-Bu62UIQZ.js";
import "./github-copilot-token-C4G0wDDt.js";
import "./pi-model-discovery-EhM2JAQo.js";
import { D as applyMergePatch, F as VERSION, N as resolveAgentMaxConcurrent, O as applyLegacyMigrations, P as resolveSubagentMaxConcurrent, _ as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, g as sensitive, i as loadConfig, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins } from "./config-BJWIHf6x.js";
import { c as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DlFh5LWe.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DsHRVW6o.js";
import "./logging-B5vJSgy6.js";
import "./accounts-CXiTuiOz.js";
import "./send-DQh-tTYV.js";
import "./send-C34nHKc5.js";
import { $ as formatRestartSentinelMessage, $t as buildHistoryContextFromEntries, A as stripEnvelopeFromMessages, At as getRemoteSkillEligibility, Bn as resolveTtsAutoMode, Bt as requestNodePairing, C as resolveSessionModelRef, Cn as clearAgentRunContext, Cr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, D as readSessionMessages, Dn as registerAgentRunContext, Dr as normalizeMimeList, Dt as requestBodyErrorToText, E as capArrayByJsonBytes, En as onAgentEvent, Er as extractImageContentFromSource, Et as readJsonBodyWithLimit, Fn as triggerInternalHook, Ft as setSkillsRemoteRegistry, G as emitGatewayRestart, Gn as setTtsProvider, Gt as buildSafeExternalPrompt, Hn as resolveTtsPrefsPath, Ht as verifyNodeToken, I as resolveOutboundTarget, In as getTtsProvider, It as approveNodePairing, J as scheduleGatewaySigusr1Restart, Jn as OPENAI_TTS_VOICES, Jt as isExternalHookSession, K as isGatewaySigusr1RestartExternallyAllowed, Kn as textToSpeech, Kt as detectSuspiciousPatterns, L as resolveSessionDeliveryTarget, Ln as isTtsEnabled, Lr as stripHeartbeatToken, Lt as listNodePairing, M as ensureOutboundSessionEntry, Mn as clearInternalHooks, Mr as resolveUserTimezone, Mt as recordRemoteNodeInfo, N as resolveOutboundSessionRoute, Nn as createInternalHookEvent, Nr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Nt as refreshRemoteBinsForConnectedNodes, O as readSessionPreviewItemsFromTranscript, On as resolveAgentIdentity, Pn as registerInternalHook, Pt as refreshRemoteNodeBins, Q as formatDoctorNonInteractiveHint, Qn as getActiveTaskCount, Rn as isTtsProviderConfigured, Rt as rejectNodePairing, S as resolveGatewaySessionStoreTarget, Sr as DEFAULT_INPUT_PDF_MAX_PIXELS, T as archiveSessionTranscripts, Tn as getAgentRunContext, Tr as extractFileContentFromSource, Tt as handleSlackHttpRequest, U as consumeGatewaySigusr1RestartAuthorization, Un as resolveTtsProviderOrder, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, Vn as resolveTtsConfig, Vt as updatePairedNodeMetadata, W as deferGatewayRestartUntilIdle, Wn as setTtsEnabled, Wt as registerSkillsChangeListener, X as setPreRestartDeferralCheck, Y as setGatewaySigusr1RestartPolicy, Yt as createReplyPrefixOptions, Z as consumeRestartSentinel, _ as listAgentsForGateway, _n as stopSubagentsForRequester, _r as DEFAULT_INPUT_FILE_MIMES, _t as loadOpenClawPlugins, an as dispatchInboundMessage, ar as startDiagnosticHeartbeat, at as normalizeCronJobPatch, b as loadSessionEntry, bn as initSubagentRegistry, br as DEFAULT_INPUT_MAX_REDIRECTS, bt as loadProviderUsageSummary, c as clearSessionQueues, ct as normalizeOptionalText, d as getActiveEmbeddedRunCount, dr as parseVerboseOverride, dt as migrateLegacyCronPayload, er as getTotalQueueSize, f as waitForEmbeddedPiRunEnd, fr as enqueueSystemEvent, g as canonicalizeSpawnedByForAgent, gn as isAbortTrigger, gr as DEFAULT_INPUT_FILE_MAX_CHARS, gt as getPluginToolMeta, h as resolveAnnounceTargetFromKey, hr as DEFAULT_INPUT_FILE_MAX_BYTES, i as runCliAgent, ir as CommandLane, it as normalizeCronJobCreate, jt as primeRemoteSkillsCache, k as resolveSessionTranscriptCandidates, kr as resolveAgentTimeoutMs, l as runEmbeddedPiAgent, lr as applyModelOverrideToSessionEntry, lt as normalizePayloadToSystemText, m as createOpenClawTools, mt as requestHeartbeatNow, n as getCliSessionId, nr as setCommandLaneConcurrency, o as normalizeSendPolicy, on as createReplyDispatcher, or as stopDiagnosticHeartbeat, ot as inferLegacyName, pn as formatZonedTimestamp, pr as isSystemEventContextChanged, q as markGatewaySigusr1RestartHandled, qn as OPENAI_TTS_MODELS, qt as getHookType, r as setCliSessionId, rr as waitForActiveTasks, rt as writeRestartSentinel, s as resolveSendPolicy, sn as getTotalPendingReplies, sr as isDiagnosticsEnabled, st as normalizeOptionalAgentId, tr as resetAllLanes, tt as summarizeRestartSentinel, u as abortEmbeddedPiRun, ur as applyVerboseOverride, ut as normalizeRequiredName, v as listSessionsFromStore, vr as DEFAULT_INPUT_IMAGE_MAX_BYTES, vt as normalizeGroupActivation, w as archiveFileOnDisk, wn as emitAgentEvent, wr as DEFAULT_INPUT_TIMEOUT_MS, x as pruneLegacyStoreKeys, xn as runSubagentAnnounceFlow, xr as DEFAULT_INPUT_PDF_MAX_PAGES, y as loadCombinedSessionStoreForGateway, yr as DEFAULT_INPUT_IMAGE_MIMES, z as resetDirectoryCache, zn as resolveTtsApiKey, zt as renamePairedNode } from "./reply-DWlAlSNj.js";
import "./media-EWF5qDpT.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-D-iPIX3C.js";
import "./render-DyRjoIgA.js";
import "./tables-DuWEJJJ_.js";
import { n as normalizePollInput } from "./polls-Cut2U_mM.js";
import { o as detectMime } from "./image-ops-BuOO2fiP.js";
import "./fetch-CiM7YqYo.js";
import "./tool-images-Do-zTkGT.js";
import { t as ToolInputError } from "./common-2Kd-SlSi.js";
import { r as movePathToTrash } from "./server-context-DSQVDg5o.js";
import { n as pickPrimaryTailnetIPv6, t as pickPrimaryTailnetIPv4 } from "./tailnet-3BgKN5Il.js";
import { a as isTrustedProxyAddress, d as resolveGatewayListenHosts, i as isPrivateOrLoopbackAddress, l as resolveGatewayBindHost, n as isLoopbackAddress, r as isLoopbackHost, t as rawDataToString, u as resolveGatewayClientIp } from "./ws-D56uQr0E.js";
import "./chrome-Biwk6Xdw.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, c as safeEqualSecret, d as enableTailscaleFunnel, f as enableTailscaleServe, i as resolveGatewayAuth, l as disableTailscaleFunnel, m as getTailnetHostname, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured, u as disableTailscaleServe } from "./auth-DaQXd14b.js";
import "./control-auth-B-AeOmM1.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-C34O4jLW.js";
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-C5vKQsaq.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-BWKREGJh.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, x as getGlobalHookRunner } from "./deliver-CPbyDZgw.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, s as resolveCronStyleNow, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-DE8-7WEw.js";
import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-Bgii3Law.js";
import { A as resolveExplicitAgentSessionKey, M as resolveMainSessionKeyFromConfig, P as snapshotSessionOrigin, _ as normalizeSessionDeliveryFields, h as mergeDeliveryContext, i as loadSessionStore, j as resolveMainSessionKey, k as resolveAgentMainSessionKey, l as updateSessionStore, p as deliveryContextFromSession, t as extractDeliveryInfo } from "./sessions-DGtM0qOW.js";
import { f as registerUnhandledRejectionHandler, s as loadModelCatalog } from "./runner-BY_Cu0GM.js";
import "./image-qihRjcmd.js";
import "./models-config-BUvHYVxN.js";
import { _ as normalizeToolName, h as expandPolicyWithPluginGroups, m as collectExplicitAllowlist, p as buildPluginToolGroups, v as resolveToolProfilePolicy, y as stripPluginOnlyAllowlist } from "./sandbox-yPHyBnUy.js";
import { h as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-C1pxUa-I.js";
import "./routes-BpW33PMu.js";
import { r as saveMediaBuffer } from "./store-C2n2K571.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-D9QhlJYC.js";
import "./redact-Bt-krp_b.js";
import "./tool-display-Dq-NBueh.js";
import { t as lookupContextTokens } from "./context-DPQWp4WP.js";
import { n as getMachineDisplayName, t as createBrowserRouteDispatcher } from "./dispatcher-CLCH2DxP.js";
import "./send-C0RXgj4W.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-C--Zm-5F.js";
import "./manager-D5ku6Y-s.js";
import "./sqlite-hOA2wjjf.js";
import "./retry-CO00OgwL.js";
import "./commands-registry-B3DBZLId.js";
import { $ as validateNodePairRequestParams, A as validateCronStatusParams, B as validateExecApprovalsNodeGetParams, Bt as verifyDeviceSignature, C as validateConfigSetParams, Ct as validateWizardCancelParams, D as validateCronRemoveParams, Dt as PROTOCOL_VERSION, E as validateCronListParams, Et as validateWizardStatusParams, F as validateDeviceTokenRevokeParams, Ft as buildDeviceAuthPayload, G as validateNodeDescribeParams, H as validateExecApprovalsSetParams, I as validateDeviceTokenRotateParams, J as validateNodeInvokeResultParams, K as validateNodeEventParams, L as validateExecApprovalRequestParams, Lt as deriveDeviceIdFromPublicKey, M as validateDevicePairApproveParams, N as validateDevicePairListParams, O as validateCronRunParams, Ot as ErrorCodes, P as validateDevicePairRejectParams, Pt as normalizeInputProvenance, Q as validateNodePairRejectParams, R as validateExecApprovalResolveParams, S as validateConfigSchemaParams, St as validateWebLoginWaitParams, T as validateCronAddParams, Tt as validateWizardStartParams, U as validateLogsTailParams, V as validateExecApprovalsNodeSetParams, W as validateModelsListParams, X as validateNodePairApproveParams, Y as validateNodeListParams, Z as validateNodePairListParams, _ as validateChatInjectParams, _t as validateTalkConfigParams, a as validateAgentWaitParams, at as validateSessionsCompactParams, b as validateConfigGetParams, bt as validateWakeParams, c as validateAgentsFilesGetParams, ct as validateSessionsPatchParams, d as validateAgentsListParams, dt as validateSessionsResolveParams, et as validateNodePairVerifyParams, f as validateAgentsUpdateParams, ft as validateSessionsUsageParams, g as validateChatHistoryParams, gt as validateSkillsUpdateParams, h as validateChatAbortParams, ht as validateSkillsStatusParams, i as validateAgentParams, it as validateSendParams, j as validateCronUpdateParams, jt as parseSessionLabel, k as validateCronRunsParams, kt as errorShape, l as validateAgentsFilesListParams, lt as validateSessionsPreviewParams, m as validateChannelsStatusParams, mt as validateSkillsInstallParams, n as formatValidationErrors, nt as validatePollParams, o as validateAgentsCreateParams, ot as validateSessionsDeleteParams, p as validateChannelsLogoutParams, pt as validateSkillsBinsParams, q as validateNodeInvokeParams, r as validateAgentIdentityParams, rt as validateRequestFrame, s as validateAgentsDeleteParams, st as validateSessionsListParams, tt as validateNodeRenameParams, u as validateAgentsFilesSetParams, ut as validateSessionsResetParams, v as validateChatSendParams, vt as validateTalkModeParams, w as validateConnectParams, wt as validateWizardNextParams, x as validateConfigPatchParams, xt as validateWebLoginStartParams, y as validateConfigApplyParams, yt as validateUpdateRunParams, z as validateExecApprovalsGetParams, zt as normalizeDevicePublicKeyBase64Url } from "./client-DV6vI7ic.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-FZUZ5EU4.js";
import { t as getChannelActivity } from "./channel-activity-CuiCbmeL.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-CTtzXtkF.js";
import "./send-CnpwMynh.js";
import { C as resolveAssistantAvatarUrl, S as normalizeControlUiBasePath, b as CONTROL_UI_AVATAR_PREFIX, c as handleReset, x as buildControlUiAvatarUrl } from "./onboard-helpers-HBGG6t5A.js";
import "./prompt-style-f1NZuGno.js";
import "./pairing-labels-CxEJEpbD.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-DOubaz12.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-zmv7sMbY.js";
import { a as normalizeExecApprovals, d as resolveExecApprovalsSocketPath, f as saveExecApprovals, n as ensureExecApprovals, o as readExecApprovalsSnapshot } from "./exec-approvals-Bj53aIIP.js";
import "./nodes-screen-ChgT1pbh.js";
import { t as parseAbsoluteTimeMs } from "./parse-Ct1L1t7A.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CHRRzvpU.js";
import "./delivery-queue-BFRO68fM.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-C8edjgRD.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Mb_Vhtp_.js";
import "./note-68V10H-1.js";
import { t as WizardCancelledError } from "./prompts-DxnxCHKt.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-nebh58LK.js";
import "./onboard-channels-orChigJn.js";
import "./archive-unczA8_5.js";
import "./skill-scanner-DFG_N86N.js";
import "./installs-D1z7Sba0.js";
import { t as buildChannelAccountSnapshot } from "./status-CkGK7iEK.js";
import "./channels-status-issues-BO3fKgRs.js";
import "./register.subclis-_zfREDBy.js";
import "./completion-cli-BSCl5sV2.js";
import "./daemon-runtime-CPrv-rEf.js";
import "./service-q_Baxtp9.js";
import "./systemd-BmDw_juR.js";
import "./shared-B3kg6sBC.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-BS_4J_PM.js";
import "./diagnostics-D5dLtThb.js";
import "./service-audit-b749O_L6.js";
import "./table-DvO2pSzv.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BL3z20Oj.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CsNqJtaM.js";
import { a as resolveNodeCommandAllowlist, i as isNodeCommandAllowed, o as probeGateway } from "./audit-Bo597wyw.js";
import { m as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-BwrWiu8R.js";
import { c as startHeartbeatRunner, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-ifSF2YWo.js";
import { a as createOutboundSendDeps, i as resolveAgentOutboundTarget, o as createDefaultDeps, r as resolveAgentDeliveryPlan, s as createOutboundSendDeps$1, t as agentCommand } from "./agent-BHfZ5DKY.js";
import { a as resolveControlUiRootOverrideSync, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync } from "./health-format-Bm9KnFIU.js";
import { a as checkUpdateStatus, c as resolveNpmChannelTag, g as normalizeUpdateChannel, o as compareSemverStrings, u as DEFAULT_PACKAGE_CHANNEL } from "./status.update-uo3ZMBFb.js";
import "./auth-choice-D4mJmR9L.js";
import "./github-copilot-auth-CzffPdhi.js";
import "./logging-By_aaJZy.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-DcIvepJB.js";
import { n as forceFreePortAndWait, r as runOnboardingWizard } from "./ports-BCHumgyl.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C0KraF77.js";
import "./tui-DnMcbuoR.js";
import { t as runGatewayUpdate } from "./update-runner-sgHYPKhC.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-CWGn1acA.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-CsWPMtZ_.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-C0brrAe1.js";
import { r as getStatusSummary } from "./status-CJQ1y5Q3.js";
import "./node-service-DuMGgo77.js";
	...
	*/
	register(record, timeoutMs) {
		...
		entry.timer = setTimeout(() => {
			...
			resolvePromise(null);
			setTimeout(() => {
				if (this.pending.get(record.id) === entry) this.pending.delete(record.id);
...
async function resolveDeliveryTarget(cfg, agentId, jobPayload) {
	...
	const threadId = resolved.threadId && resolved.to && resolved.to === resolved.lastTo ? resolved.threadId : void 0;
...
async function runCronIsolatedAgentTurn(params) {
	...
	if (deliveryRequested && !skipHeartbeatDelivery && !skipMessagingToolDelivery) {
		...
		if (deliveryPayloadHasStructuredContent) try {
...
async function onTimer(state) {
	...
	try {
		...
		for (const { id, job } of dueJobs) {
			...
			const jobTimeoutMs = job.payload.kind === "agentTurn" && typeof job.payload.timeoutSeconds === "number" ? job.payload.timeoutSeconds * 1e3 : DEFAULT_JOB_TIMEOUT_MS;
			try {
				let timeoutId;
				const result = await Promise.race([executeJobCore(state, job), new Promise((_, reject) => {
					timeoutId = setTimeout(() => reject(/* @__PURE__ */ new Error("cron: job execution timed out")), jobTimeoutMs);
...
*/
async function executeJob(state, job, _nowMs, _opts) {
	if (!job.state) job.state = {};
	const startedAt = state.deps.nowMs();
	job.state.runningAtMs = startedAt;
	job.state.lastError = void 0;
...
function appendAssistantTranscriptMessage(params) {
	...
	try {
		return {
			ok: true,
			messageId: SessionManager.open(transcriptPath).appendMessage(messageBody),
			message: messageBody
		};
	} catch (err) {
		return {
...
const FIELD_HELP = {
	...
	"channels.discord.proxy": "Proxy URL for Discord gateway WebSocket connections. Set per account via channels.discord.accounts.<id>.proxy.",
...
const configHandlers = {
	...
	"config.apply": async ({ params, respond }) => {
		...
		const restartDelayMsRaw = params.restartDelayMs;
		const restartDelayMs = typeof restartDelayMsRaw === "number" && Number.isFinite(restartDelayMsRaw) ? Math.max(0, Math.floor(restartDelayMsRaw)) : void 0;
		const { deliveryContext: deliveryContextApply, threadId: threadIdApply } = extractDeliveryInfo(sessionKey);
		const payload = {
			kind: "config-apply",
			status: "ok",
			ts: Date.now(),
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-Bmp74N3v.js");
...
const sessionsHandlers = {
	...
	"sessions.delete": async ({ params, respond }) => {
		...
		const archived = deleteTranscript ? archiveSessionTranscriptsForSession({
			sessionId,
			storePath,
			sessionFile: entry?.sessionFile,
			agentId: target.agentId,
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-DOubaz12.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-BWKREGJh.js").then((n) => n.t);
...
async function resolveGatewayRuntimeConfig(params) {
	...
	if (!isLoopbackHost(bindHost) && !hasSharedSecret) throw new Error(`refusing to bind gateway to ${bindHost}:${params.port} without auth (set gateway.auth.token/password, or set OPENCLAW_GATEWAY_TOKEN/OPENCLAW_GATEWAY_PASSWORD)`);
	return {
		bindHost,
		controlUiEnabled,
...
function createHooksRequestHandler(opts) {
	...
	const recordHookAuthFailure = (clientKey, nowMs) => {
		if (!hookAuthFailures.has(clientKey) && hookAuthFailures.size >= HOOK_AUTH_FAILURE_TRACK_MAX) {
			for (const [key, entry] of hookAuthFailures) if (nowMs - entry.windowStartedAtMs >= HOOK_AUTH_FAILURE_WINDOW_MS) hookAuthFailures.delete(key);
		...
		if (hookAuthFailures.has(clientKey)) hookAuthFailures.delete(clientKey);
...
async function startGatewayMemoryBackend(params) {
	...
	if (resolved.backend !== "qmd" || !resolved.qmd) return;
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BFRO68fM.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CPbyDZgw.js").then((n) => n.n);

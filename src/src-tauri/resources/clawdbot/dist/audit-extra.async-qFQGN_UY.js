import { h as resolveOAuthDir } from "./paths-ViKUYWUK.js";
import { c as normalizeAgentId } from "./session-key-DAhnzjyr.js";
import { m as resolveDefaultAgentId } from "./agent-scope-bjWqU22i.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-DgX397vI.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-DKkCswtk.js";
import { a as normalizePluginsConfig } from "./config-state-Br0ucqMb.js";
import { n as MANIFEST_KEY } from "./legacy-names-CAEkmrUg.js";
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-DTQIjp2r.js";
import { t as formatCliCommand } from "./command-format-DBQUhADm.js";
import { a as resolveNativeSkillsEnabled } from "./commands-C6oAw_H-.js";
import { E as resolveSandboxConfigForAgent, G as resolveToolProfilePolicy, I as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, a as execDockerRaw, k as resolveSandboxToolPolicyForAgent } from "./docker-Bhjg8g2t.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DqDLiRvZ.js";
import { r as pickSandboxToolPolicy, t as isToolAllowedByPolicies } from "./tool-policy-match-DQWWRSN4.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-Cp-qCAUj.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DHhjttda.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-Dx7r0alA.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-BaO3yYka.js");

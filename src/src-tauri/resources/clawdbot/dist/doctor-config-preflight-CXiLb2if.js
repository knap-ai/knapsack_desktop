...
import { h as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-Dv_xNAZB.js";
import { n as formatConfigIssueLines } from "./issue-format-DpSVQL-G.js";
import { t as note } from "./note-D_Kkgdi2.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-DclvwmMB.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-D8EO2n0B.js");

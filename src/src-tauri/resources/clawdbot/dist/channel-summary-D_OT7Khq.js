...
async function listChannelSummaryPlugins(params) {
	const { listReadOnlyChannelPluginsForConfig } = await import("./read-only-lGLurJdE.js");
	return listReadOnlyChannelPluginsForConfig(params.cfg, { activationSourceConfig: params.sourceConfig });
}

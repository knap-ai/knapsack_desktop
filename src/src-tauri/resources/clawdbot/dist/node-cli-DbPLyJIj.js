...
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-Btzm9BXg.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-CT9AMIex.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-fVpeywJV.js";
import { n as VERSION } from "./version-DZq9J0ei.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-CCzEV4ja.js";
...
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Ds3BmUx6.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-DFDl9PuO.js";
...
import { _ as resolvePlannedSegmentArgv, c as describeInterpreterInlineEval, d as analyzeArgvCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BDAr27rw.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-DrT-K-_k.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-Dv29TGLv.js";
import { t as formatHelpExamples } from "./help-format-Cn2mAwEx.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CfjlV1SF.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-C1khoDvK.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-D2xgQ0dn.js";
import { t as resolveNodeService } from "./node-service-sJmMkKsl.js";
...
async function loadSystemRunConfig(opts) {
	...
	const { loadConfig } = await import("./config-NTLYkTUO.js");
	return loadConfig();
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-cisBVUzW.js");

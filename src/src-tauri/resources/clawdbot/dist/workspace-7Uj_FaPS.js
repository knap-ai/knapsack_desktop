...
import { i as resolveOsHomeDir } from "./home-dir-CfZ08GnU.js";
import { n as resolveOpenClawPackageRootSync } from "./openclaw-root-BNWw3cXT.js";
import { m as resolveUserPath, p as resolveHomeDir, t as CONFIG_DIR } from "./utils-BMRcljdi.js";
import { t as createSubsystemLogger } from "./subsystem-CWI_MDy_.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-DJpPaKAg.js";
import { s as isPathInside } from "./boundary-path-C2iMx2xR.js";
import { t as openVerifiedFileSync } from "./safe-open-sync-X8Q1U9Y1.js";
import { c as resolveEffectivePluginActivationState, l as resolveMemorySlotDecision, s as normalizePluginsConfigWithResolver, t as loadPluginManifestRegistry } from "./manifest-registry-pYrbrdHJ.js";
import { r as hasKind } from "./slots-ClU32VIo.js";
import { n as normalizeSkillFilter } from "./filter-CBGNTeP4.js";
import { n as resolveEffectiveAgentSkillsLimits, t as resolveEffectiveAgentSkillFilter } from "./agent-filter-BGZE_T6U.js";
import { a as resolveSandboxPath } from "./sandbox-paths-11MZW8so.js";
import { a as shouldIncludeSkill, c as resolveSkillInvocationPolicy, o as parseFrontmatter, s as resolveOpenClawMetadata } from "./config-Brv7NXUA.js";
	...
	const loadSkills = (params) => {
		...
		if (fs.existsSync(rootSkillMd)) {
			...
			return filterLoadedSkillRecordsInsideRoot({
				records: unwrapLoadedSkillRecords(loadSkillsFromDirSafe({
					dir: baseDir,
					source: params.source,
		...
		for (const name of limitedChildren) {
			...
			loadedSkills.push(...filterLoadedSkillRecordsInsideRoot({
		...
		if (loadedSkills.length > limits.maxSkillsLoadedPerSource) return loadedSkills.slice().sort((a, b) => a.skill.name.localeCompare(b.skill.name, "en")).slice(0, limits.maxSkillsLoadedPerSource);
		return loadedSkills;
	};

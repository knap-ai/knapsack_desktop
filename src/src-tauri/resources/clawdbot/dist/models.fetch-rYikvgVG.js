...
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-CbTtvIcl.js";
import { l as isKnownEnvApiKeyMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-CZrGSAU9.js";
...
import { c as SELF_HOSTED_DEFAULT_COST, l as SELF_HOSTED_DEFAULT_MAX_TOKENS } from "./provider-self-hosted-setup-Ck8tsJYW.js";
...
import { a as resolveApiKeyForProvider } from "./provider-auth-runtime-CWqLpFd_.js";
...
function resolveLmstudioReasoningCapability(entry) {
	...
	const allowedOptions = Array.isArray(allowedOptionsRaw) ? allowedOptionsRaw.map((option) => normalizeReasoningOption(option)).filter((option) => option !== null) : [];
...
function normalizeLmstudioProviderConfig(provider) {
	...
	return normalizedBaseUrl === provider.baseUrl ? provider : {
		...provider,
...
//#endregion
export { LMSTUDIO_MODEL_PLACEHOLDER as A, LMSTUDIO_DEFAULT_API_KEY_ENV_VAR as C, LMSTUDIO_DEFAULT_LOAD_CONTEXT_LENGTH as D, LMSTUDIO_DEFAULT_INFERENCE_BASE_URL as E, LMSTUDIO_PROVIDER_LABEL as M, LMSTUDIO_DEFAULT_MODEL_ID as O, resolveLoadedContextWindow as S, LMSTUDIO_DEFAULT_EMBEDDING_MODEL as T, normalizeLmstudioConfiguredCatalogEntry as _, resolveLmstudioConfiguredApiKey as a, resolveLmstudioReasoningCapability as b, resolveLmstudioRuntimeApiKey as c, shouldUseLmstudioApiKeyPlaceholder as d, shouldUseLmstudioSyntheticAuth as f, normalizeLmstudioConfiguredCatalogEntries as g, mapLmstudioWireModelsToConfig as h, buildLmstudioAuthHeaders as i, LMSTUDIO_PROVIDER_ID as j, LMSTUDIO_LOCAL_API_KEY_PLACEHOLDER as k, hasLmstudioAuthorizationHeader as l, mapLmstudioWireEntry as m, ensureLmstudioModelLoaded as n, resolveLmstudioProviderHeaders as o, buildLmstudioModelName as p, fetchLmstudioModels as r, resolveLmstudioRequestContext as s, discoverLmstudioModels as t, resolveLmstudioProviderAuthMode as u, normalizeLmstudioProviderConfig as v, LMSTUDIO_DEFAULT_BASE_URL as w, resolveLmstudioServerBase as x, resolveLmstudioInferenceBase as y };

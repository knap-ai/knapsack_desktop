...
import { l as normalizeMainKey, p as scopedHeartbeatWakeOptions } from "./session-key-D7XpmyVq.js";
...
import { S as requestHeartbeatNow } from "./model-runtime-D4KJqIwp.js";
...
import { r as resolveOutboundTarget } from "./targets-DjOu09mG.js";
import { i as deleteMediaBuffer } from "./store-CCBPdtW9.js";
import { c as migrateAndPruneGatewaySessionStoreKey, d as resolveGatewayModelSupportsImages, m as resolveSessionModelRef, s as loadSessionEntry } from "./session-utils-CttsvsO6.js";
import { n as sanitizeInboundSystemTags } from "./inbound-text-DSOFY9xn.js";
import { n as agentCommandFromIngress } from "./agent-command-BwUGaHZD.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-BgT6g6N3.js";
import { t as formatForLog } from "./ws-log-BMrC-EZ3.js";
import "./agent-KHj7-umf.js";
import { f as parseMessageWithAttachments, i as registerApnsRegistration, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-C29U1_k4.js";
...
const handleNodeEvent = async (ctx, nodeId, evt) => {
	switch (evt.event) {
		...
		case "notifications.changed": {
			...
			const title = compactNotificationEventText(sanitizeInboundSystemTags(normalizeNonEmptyString(obj.title) ?? ""));
			const text = compactNotificationEventText(sanitizeInboundSystemTags(normalizeNonEmptyString(obj.text) ?? ""));

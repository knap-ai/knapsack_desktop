import { o as getResolvedLoggerSettings } from "./logger-BCzP_yik.js";
import { o as resolveRequiredHomeDir } from "./home-dir-BnP38vVl.js";
import { m as defaultRuntime, p as createNonExitingRuntime } from "./subsystem-CJEvHE2o.js";
import { t as sanitizeForLog } from "./ansi-B_0KjIJj.js";
import { t as isTruthyEnvValue$1 } from "./env-CjUKd1aw.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-CE3P21nG.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-CY-e50gT.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-bVW1e9Dr.js";
...
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-8a6zD_aX.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-CD8i0MSg.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-D7XpmyVq.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CYXg_wTS.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-nWahKiCu.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-Q4UoS1xk.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-R-NeOkBt.js";
import { Bt as normalizeTalkSection, J as listRiskyConfiguredSafeBins, K as normalizeTrustedSafeBinDirs, Lt as resolveNormalizedProviderModelMaxTokens, M as migrateLegacyConfig, Rt as LEGACY_TALK_PROVIDER_ID, U as getTrustedSafeBinDirs, W as isTrustedSafeBinPath, Yt as migrateLegacyXSearchConfig, dt as resolveCommandResolutionFromArgv, f as readConfigFileSnapshot, x as writeConfigFile } from "./io-DhtVmzAJ.js";
import { a as mergeMissing } from "./legacy.shared-CVRCIczI.js";
import { C as resolveSlackNativeStreaming, S as resolveDiscordPreviewStreamMode, T as resolveTelegramPreviewStreamMode, b as formatSlackStreamingBooleanMigrationMessage, w as resolveSlackStreamingMode, y as formatSlackStreamModeMigrationMessage } from "./zod-schema.providers-core-BJorTsd7.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-DTXJhyWe.js";
import { r as normalizeChatChannelId } from "./chat-meta-Cdrnv7R-.js";
import "./registry-DTO_OK4F.js";
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-zclcq4hc.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-BSmqODu2.js";
import "./config-CJQx-9zo.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-DppUIlSY.js";
import { t as describeUnknownError } from "./shared-CkQ4yE36.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-CJ_D8C7W.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-CfT1BuIb.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-Clj4_p8-.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-CEXChkqS.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BH-V0oY-.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CDm-glWj.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-Bl1h0VsT.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-D3XSbNNz.js";
import { u as readGatewayTokenEnv } from "./credentials-DyjdApQe.js";
import { a as resolveGatewayAuth } from "./auth-BHAc3x7O.js";
import { i as loadSessionStore } from "./store-BGmy-Wot.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DtJnd71X.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-fiJfPVib.js";
import "./plugins-DF32jmMU.js";
import { i as resolveMainSessionKey } from "./main-session-CFwamLE8.js";
import { i as resolveAgentSessionDirs } from "./sessions-DC7OiAdD.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DBIQqSpZ.js";
...
import { n as cleanStaleLockFiles } from "./session-write-lock-BjZ5BFRg.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-CQ0eH9Ew.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-BsZdqqVw.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BhLRdu8m.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-CHbAUAiB.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-OcTW6hhx.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BPnToG40.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BaabAHxx.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-C5dh_OwP.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-B4S0Zwlt.js";
import { c as buildPlatformRuntimeLogHints, d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-enHHgxXj.js";
import "./logging-C0VWvR36.js";
import { n as formatConfigIssueLines } from "./issue-format-DnqtJUII.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-9ATuSkYC.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BG9TH9c2.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CSzyOKo2.js";
import { t as resolvePluginProviders } from "./providers.runtime-DfKoBqxo.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-CjYO5YkF.js";
import { Ar as LowercaseNonEmptyStringFieldSchema, Cr as inferLegacyName, Er as normalizeOptionalText, Mr as parseOptionalField, an as listTaskFlowRecords, c as analyzeBootstrapBudget, jr as TrimmedNonEmptyStringFieldSchema, kr as DeliveryThreadIdFieldSchema, l as buildBootstrapInjectionStats, qr as resolveBootstrapContextForRun, qt as listTasksForFlowId } from "./pi-embedded-BYdcxQ5A.js";
import { Y as resolveBootstrapMaxChars, Z as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-CGU2Pfj9.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-Fnf3A9Vj.js";
import { s as resolveApiKeyForProvider } from "./model-auth-BxuwOp1l.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-BnVhJVMd.js";
import { l as loadExecApprovals } from "./exec-approvals-D6YTmZxM.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-D0s5bENr.js";
import "./sandbox-DD2udaMP.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-B4-85uDC.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DenfdcDu.js";
import { i as listRouteBindings } from "./bindings-DwYMv--S.js";
import { nt as readBrowserVersion, rt as resolveGoogleChromeExecutableForPlatform, tt as parseBrowserMajorVersion } from "./browser-runtime-DL3yg2w9.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-Cwhkcxba.js";
import { t as resolveMemorySearchConfig } from "./memory-search-B4nMT_Ka.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-D4DOHGRO.js";
import { a as readChannelAllowFromStore } from "./pairing-store-DxNrxr_7.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-ikRqobo8.js";
...
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-B1150NOt.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-B9i5z3_o.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-C5tf25Tf.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-CbuUnzTK.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-B9UkF4fl.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-BE21mMlW.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-ByKrIbEl.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-CSAcp0sq.js";
import "./memory-core-host-engine-storage-DdyEWu0Y.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-6dqJ2gft.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-DrwAkOFC.js";
import { t as note$1 } from "./note-B5Cxa9lg.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-C5ss5bJn.js";
import { r as healthCommand } from "./health-CSwP30Jx.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DYuJ0rj8.js";
import { g as coerceFiniteScheduleNumber, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-BAUV8BrW.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-CBTMH_tP.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-Bt0OqcBv.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-BI7ZZ_5T.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-BCu9BskZ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CPG5FUG2.js";
import { t as formatHealthCheckFailure } from "./health-format-UpsF4E4b.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-Cg1UyzrI.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-CIgnxnoc.js";
import { n as doctorShellCompletion } from "./doctor-completion-BBiOhpiD.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-C6xIygWI.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DKW05GoB.js";
import "./doctor-state-migrations-CMG5ufvV.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-BZX0LUuL.js";
...
//#region src/config/legacy-web-fetch.ts
...
function normalizeCompatibilityConfigValues(cfg) {
	...
	const normalizePreviewStreamingAliases = (params) => {
		...
		if (params.pathPrefix.startsWith("channels.discord") && resolved === "off" && hadLegacyStreamMode) changes.push(`${params.pathPrefix}.streaming remains off by default to avoid Discord preview-edit rate limits; set ${params.pathPrefix}.streaming="partial" to opt in explicitly.`);
		return {
			entry: updated,
			changed
		};
...
function collectDiscordNumericIdWarnings(params) {
	...
	if (repairableHits.length > 0) {
		...
		lines.push(`- Discord allowlists contain ${repairableHits.length} numeric ${repairableHits.length === 1 ? "entry" : "entries"} (e.g. ${samplePath}=${sampleEntry}).`, `- Discord IDs must be strings; run "${params.doctorFixCommand}" to convert numeric IDs to quoted strings.`);
	}
...
function collectBlockedDiscordNumericIdRepairWarnings(params) {
	...
	if (blockedHits.length === 0) return [];
	const sample = blockedHits[0];
	const samplePath = sanitizeForLog(sample.path);
	return [`- Discord allowlists contain ${blockedHits.length} numeric ${blockedHits.length === 1 ? "entry" : "entries"} in lists that could not be auto-repaired (e.g. ${samplePath}).`, `- These lists include invalid or precision-losing numeric IDs; manually quote the original values in your config file, then rerun "${params.doctorFixCommand}".`];
}
function maybeRepairDiscordNumericIds(cfg, params) {
	...
	const warnings = params?.doctorFixCommand === void 0 ? [] : collectBlockedDiscordNumericIdRepairWarnings({
		hits,
...
async function maybeRepairTelegramAllowFromUsernames(cfg) {
	...
	for (const accountId of listTelegramAccountIds(resolvedConfig)) {
		...
		if (inspected.tokenStatus === "configured_unavailable") tokenResolutionWarnings.push(`- Telegram account ${accountId}: failed to inspect bot token (configured but unavailable in this command path).`);
		if (!(inspected.tokenSource === "none" ? "" : inspected.token.trim())) continue;
		resolverAccountIds.push(accountId);
	}
	const telegramResolver = getChannelPlugin("telegram")?.resolver?.resolveTargets;
	if (resolverAccountIds.length === 0 || !telegramResolver) return {
		config: cfg,
		changes: [...tokenResolutionWarnings, hasConfiguredUnavailableToken ? `- Telegram allowFrom contains @username entries, but configured Telegram bot credentials are unavailable in this command path; cannot auto-resolve (start the gateway or make the secret source available, then rerun doctor --fix).` : !telegramResolver ? `- Telegram allowFrom contains @username entries, but the Telegram channel resolver is unavailable; cannot auto-resolve in this command path.` : `- Telegram allowFrom contains @username entries, but no Telegram bot token is configured; cannot auto-resolve (run setup or replace with numeric sender IDs).`]
	};
	...
	const resolveUserId = async (raw) => {
		...
		for (const accountId of resolverAccountIds) try {
			...
			if (resolved?.resolved && resolved.id) return resolved.id;
		} catch {}
		return null;
	};
	const changes = [];
...
function maybeRepairStalePluginConfig(cfg, env) {
	if (isStalePluginAutoRepairBlocked(cfg, env)) return {
		config: cfg,
		changes: []
	};
...
async function runDoctorRepairSequence(params) {
	...
	applyMutation(maybeRepairDiscordNumericIds(state.candidate, { doctorFixCommand: params.doctorFixCommand }));
...
function collectDoctorPreviewWarnings(params) {
	...
	if (channelPluginBlockerHits.length > 0) warnings.push(collectConfiguredChannelPluginBlockerWarnings(channelPluginBlockerHits).join("\n"));
...
function noteSourceInstallIssues(root) {
	...
	if (!fsSync.existsSync(workspaceMarker)) return;
	const warnings = [];
	const nodeModules = path.join(root, "node_modules");
	const pnpmStore = path.join(nodeModules, ".pnpm");
	const tsxBin = path.join(nodeModules, ".bin", "tsx");
	const srcEntry = path.join(root, "src", "entry.ts");
	if (fsSync.existsSync(nodeModules) && !fsSync.existsSync(pnpmStore)) warnings.push("- node_modules was not installed by pnpm (missing node_modules/.pnpm). Run: pnpm install");
	if (fsSync.existsSync(path.join(root, "package-lock.json"))) warnings.push("- package-lock.json present in a pnpm workspace. If you ran npm install, remove it and reinstall with pnpm.");
	if (fsSync.existsSync(srcEntry) && !fsSync.existsSync(tsxBin)) warnings.push("- tsx binary is missing for source runs. Run: pnpm install");
...
async function noteMacLaunchAgentOverrides() {
	...
	const markerPath = [path.join(home, ".openclaw", "disable-launchagent")].find((candidate) => fsSync.existsSync(candidate));
...
async function launchctlGetenv(name) {
	try {
		const result = await execFileAsync$1("/bin/launchctl", ["getenv", name], { encoding: "utf8" });
...
async function noteAuthProfileHealth(params) {
	...
	if (issues.length > 0) note$1((await Promise.all(issues.map((issue) => formatAuthIssueLine({
		profileId: issue.profileId,
		provider: issue.provider,
		status: issue.status,
...
function collectBundledPluginRuntimeDeps(params) {
	...
	for (const entry of fsSync.readdirSync(params.extensionsDir, { withFileTypes: true })) {
		...
		try {
			...
			for (const [name, rawVersion] of Object.entries(collectRuntimeDeps(packageJson))) {
				...
				const byVersion = versionMap.get(name) ?? /* @__PURE__ */ new Map();
				const pluginIds = byVersion.get(version) ?? /* @__PURE__ */ new Set();
...
function scanBundledPluginRuntimeDeps(params) {
	...
	if (!fsSync.existsSync(extensionsDir)) return {
		missing: [],
		conflicts: []
	};
	const { deps, conflicts } = collectBundledPluginRuntimeDeps({ extensionsDir });
	return {
		missing: deps.filter((dep) => !fsSync.existsSync(path.join(params.packageRoot, dependencySentinelPath(dep.name)))),
		conflicts
	};
}
...
async function maybeRepairBundledPluginRuntimeDeps(params) {
	...
	if (conflicts.length > 0) note$1([
		"Bundled plugin runtime deps use conflicting versions.",
		...conflicts.flatMap((conflict) => [`- ${conflict.name}: ${conflict.versions.join(", ")}`, ...conflict.versions.flatMap((version) => {
	...
	try {
		...
		note$1(`Installed bundled plugin deps: ${missingSpecs.join(", ")}`, "Bundled plugins");
	} catch (error) {
...
function copyTopLevelAgentTurnFields(raw, payload) {
	...
	if (!("threadId" in payload) && (typeof raw.threadId === "number" && Number.isFinite(raw.threadId) || typeof raw.threadId === "string" && raw.threadId.trim())) {
	...
	if (!loaded) {
		if (process.platform === "linux") {
			if (!await isSystemdUserServiceAvailable().catch(() => false)) {
				note$1(renderSystemdUnavailableHints({
					wsl: await isWSL(),
...
async function maybeRepairGatewayServiceConfig(cfg, mode, runtime, prompter) {
	...
	if (needsNodeRuntime && !systemNodePath) {
		...
		note$1("System Node 22 LTS (22.14+) or Node 24 not found. Install via Homebrew/apt/choco and rerun doctor to migrate off Bun/version managers.", "Gateway runtime");
	}
...
function resolveSuggestedRemoteMemoryProvider() {
	return listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata().find((provider) => provider.transport === "remote")?.providerId;
}
/**
...
async function noteMemorySearchHealth(cfg, opts) {
	...
	if (!backendConfig) {
		note$1("No active memory plugin is registered for the current config.", "Memory search");
		return;
	}
	...
	const autoSelectProviders = listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata().filter((provider) => provider.transport === "remote");
...
function resolvePrimaryMemoryProviderEnvVar(provider) {
	return getBuiltinMemoryEmbeddingProviderDoctorMetadata(provider)?.envVars[0] ?? `${provider.toUpperCase()}_API_KEY`;
}
...
function readManifestJson(manifestPath) {
	try {
		return safeParseJsonWithSchema(JsonRecordSchema, fsSync.readFileSync(manifestPath, "utf-8"));
	} catch {
		return null;
	}
}
...
async function maybeRepairLegacyPluginManifestContracts(params) {
	...
	note$1(["Legacy plugin manifest capability keys detected.", ...migrations.flatMap((migration) => migration.changeLines)].join("\n"), "Plugin manifests");
	if (!(params.prompter.shouldRepair || await params.prompter.confirmAutoFix({
	...
	for (const migration of migrations) try {
		fsSync.writeFileSync(migration.manifestPath, `${JSON.stringify(migration.nextRaw, null, 2)}\n`, "utf-8");
	...
	if (applied.length > 0) note$1(applied.join("\n"), "Doctor changes");
}
//#endregion
...
function tryReadLinuxMountInfo() {
	try {
		return fsSync.readFileSync("/proc/self/mountinfo", "utf8");
	} catch {
		return null;
	}
}
...
async function noteStateIntegrity(cfg, prompter, configPath) {
	...
	if (stateDirExists && !canWriteDir(stateDir)) {
		...
		if (await prompter.confirmRuntimeRepair({
			...
			const target = addUserRwx(fsSync.statSync(stateDir).mode);
			fsSync.chmodSync(stateDir, target);
	...
	if (stateDirExists && process.platform !== "win32") try {
		const dirLstat = fsSync.lstatSync(stateDir);
		const isDirSymlink = dirLstat.isSymbolicLink();
		const stat = isDirSymlink ? fsSync.statSync(stateDir) : dirLstat;
		if (!(isDirSymlink ? fsSync.realpathSync(stateDir) : stateDir).startsWith("/nix/store/") && (stat.mode & 63) !== 0) {
	...
	if (configPath && existsFile(configPath) && process.platform !== "win32") try {
		const configLstat = fsSync.lstatSync(configPath);
		const isSymlink = configLstat.isSymbolicLink();
		const stat = isSymlink ? fsSync.statSync(configPath) : configLstat;
		if (!(isSymlink ? fsSync.realpathSync(configPath) : configPath).startsWith("/nix/store/") && (stat.mode & 63) !== 0) {
			...
			if (await prompter.confirmRuntimeRepair({
				...
				fsSync.chmodSync(configPath, 384);
		...
		for (const [dir, label] of dirCandidates) {
			...
			if (!canWriteDir(dir)) {
				...
				if (await prompter.confirmRuntimeRepair({
					...
					const target = addUserRwx(fsSync.statSync(dir).mode);
					fsSync.chmodSync(dir, target);
	...
	if (existsDir(sessionsDir)) {
		...
		const orphanTranscriptPaths = fsSync.readdirSync(sessionsDir, { withFileTypes: true }).filter((entry) => entry.isFile() && isPrimarySessionTranscriptFileName(entry.name)).map((entry) => path.resolve(path.join(sessionsDir, entry.name))).filter((filePath) => !referencedTranscriptPaths.has(filePath));
		if (orphanTranscriptPaths.length > 0 && !suppressOrphanTranscriptWarning) {
			...
			if (await prompter.confirmRuntimeRepair({
				...
				for (const orphanPath of orphanTranscriptPaths) {
					...
					try {
						fsSync.renameSync(orphanPath, archivedPath);
						archived += 1;
					} catch (err) {
...
function noteWorkspaceBackupTip(workspaceDir) {
	...
	if (fsSync.existsSync(gitMarker)) return;
	note$1([
...
async function shouldSuggestMemorySystem(workspaceDir) {
	...
	for (const memoryPath of memoryPaths) try {
		await fsSync.promises.access(memoryPath);
		return false;
	} catch {}
	const agentsPath = path.join(workspaceDir, DEFAULT_AGENTS_FILENAME);
	try {
		const content = await fsSync.promises.readFile(agentsPath, "utf-8");
...
async function runGatewayConfigHealth(ctx) {
	if (!ctx.cfg.gateway?.mode) {
		...
		if (!fsSync.existsSync(ctx.configPath)) lines.push(`Missing config: run ${formatCliCommand("openclaw setup")} first.`);
		note$1(lines.join("\n"), "Gateway");
	}
	if (resolveDoctorMode(ctx.cfg) === "local" && hasAmbiguousGatewayAuthModeConfig(ctx.cfg)) note$1([
...
async function runAuthProfileHealth(ctx) {
	...
	if (ctx.gatewayDetails.remoteFallbackNote) note$1(ctx.gatewayDetails.remoteFallbackNote, "Gateway");
}
async function runGatewayAuthHealth(ctx) {
	...
	if (!(auth.mode !== "password" && (auth.mode !== "token" || !auth.token))) return;
	if (gatewayTokenRef) {
		note$1([
...
async function runStartupMatrixHealth(ctx) {
...
async function runHooksModelHealth(ctx) {
	...
	if (!hooksModelRef) {
		note$1(`- hooks.gmail.model "${ctx.cfg.hooks.gmail.model}" could not be resolved`, "Hooks");
		return;
	}
...
async function runWriteConfigHealth(ctx) {
	if (ctx.configResult.shouldWriteConfig || JSON.stringify(ctx.cfg) !== JSON.stringify(ctx.cfgForPersistence)) {
		...
		if (fsSync.existsSync(backupPath)) ctx.runtime.log(`Backup: ${shortenHomePath(backupPath)}`);
		return;
	}
...
async function doctorCommand(runtime = defaultRuntime, options = {}) {
	...
	await runDoctorHealthContributions({
		runtime,
		options,
		prompter,
		configResult,

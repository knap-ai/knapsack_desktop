...
import "./accounts-Cv21KlkW.js";
import "./runtime-api-_spW_dC0.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-BtTRQ_PO.js";
import { t as sendMessageZalo } from "./send-DH2PfGAW.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Bpz_nda1.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CFEFi_m1.js");

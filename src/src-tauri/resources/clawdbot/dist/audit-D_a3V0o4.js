import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-CD8i0MSg.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-D7XpmyVq.js";
import { J as listRiskyConfiguredSafeBins, K as normalizeTrustedSafeBinDirs } from "./io-DhtVmzAJ.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-DTXJhyWe.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BtglGA88.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { a as resolveGatewayAuth } from "./auth-BHAc3x7O.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-C3S8ml6i.js";
import { n as resolveSandboxConfigForAgent } from "./config-Fnf3A9Vj.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-BWlfjI7J.js";
import { V as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-D6YTmZxM.js";
...
import { c as resolveBrowserControlAuth, l as resolveProfile, o as redactCdpUrl, s as resolveBrowserConfig } from "./browser-config-To3UOSug.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CFhQVTFH.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-C_I9d7IN.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DZenRW5N.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-nfN27Gwh.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-_iTEJyrs.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BXql2fGC.js"),
		import("./probe-auth-DfZ-cDOk.js"),
		import("./probe-C31C4KwQ.js")

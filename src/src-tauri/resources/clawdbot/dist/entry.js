...
if (!ensureExperimentalWarningSuppressed()) {
	...
	import("./run-main-H7DPmb50.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { resolveStateDir as $, colorize as A, STATE_DIR as B, isYes as C, normalizeProfileName as Ct, shouldLogVerbose as D, setVerbose as E, resolveRequiredHomeDir as Et, getResolvedLoggerSettings as F, resolveDefaultConfigCandidates as G, resolveCanonicalConfigPath as H, toPinoLikeLogger as I, resolveIsNixMode as J, resolveGatewayLockDir as K, normalizeLogLevel as L, theme as M, getChildLogger as N, success as O, getLogger as P, resolveOAuthPath as Q, CONFIG_PATH as R, isVerbose as S, shouldMigrateStateFromPath as St, logVerboseConsole as T, resolveEffectiveHomeDir as Tt, resolveConfigPath as U, isNixMode as V, resolveConfigPathCandidate as W, resolveNewStateDir as X, resolveLegacyStateDirs as Y, resolveOAuthDir as Z, clearActiveProgressLine as _, getPositiveIntFlagValue as _t, parseBooleanValue as a, formatChannelSelectionLine as at, danger as b, hasFlag as bt, enableConsoleCapture as c, normalizeAnyChannelId as ct, setConsoleTimestampPrefix as d, getActivePluginRegistry as dt, resolvePreferredOpenClawTmpDir as et, shouldLogSubsystemToConsole as f, requireActivePluginRegistry as ft, restoreTerminalState as g, getFlagValue as gt, defaultRuntime as h, getCommandPath as ht, normalizeEnv as i, formatChannelPrimerLine as it, isRich as j, warn as k, routeLogsToStderr as l, normalizeChannelId as lt, createNonExitingRuntime as m, buildParseArgv as mt, isTruthyEnvValue as n, CHAT_CHANNEL_ORDER as nt, createSubsystemLogger as o, getChatChannelMeta as ot, visibleWidth as p, setActivePluginRegistry as pt, resolveGatewayPort as q, logAcceptedEnvOption as r, DEFAULT_CHAT_CHANNEL as rt, runtimeForLogger as s, listChatChannels as st, installProcessWarningFilter as t, CHANNEL_IDS as tt, setConsoleSubsystemFilter as u, normalizeChatChannelId as ut, registerActiveProgressLine as v, getPrimaryCommand as vt, logVerbose as w, expandHomePrefix as wt, info as x, hasHelpOrVersion as xt, unregisterActiveProgressLine as y, getVerboseFlag as yt, DEFAULT_GATEWAY_PORT as z };
...
import { i as resolveAgentConfig } from "./agent-scope-bjWqU22i.js";
...
import { K as analyzeArgvCommand, Q as resolvePlannedSegmentArgv, St as resolveInlineCommandMatch, Tt as normalizeExecutableToken, bt as POSIX_INLINE_COMMAND_FLAGS, ft as resolveExecutableFromPathEnv, it as resolveApprovalAuditCandidatePath, mt as POSIX_SHELL_WRAPPERS, ot as resolveCommandResolutionFromArgv, s as loadConfig, wt as unwrapKnownDispatchWrapperInvocation, yt as unwrapKnownShellMultiplexerInvocation } from "./io-y3Az_Onx.js";
import { d as sanitizeHostExecEnv, p as sanitizeSystemRunEnvOverrides, s as inspectHostExecEnvOverrides } from "./shell-env-BOu7XeT_.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-BYFJPaZy.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DlNoT_tA.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-DOEOEFe-.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-lubXrOfs.js";
...
import { r as writeJsonAtomic } from "./json-files-2-D1jkJB.js";
import { dn as loadOrCreateDeviceIdentity, u as GatewayClient } from "./method-scopes-BiEi0X2g.js";
...
import { f as buildDaemonServiceSnapshot, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, u as resolveRuntimeStatusColor } from "./shared-CaPOEZsR.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DvBn5bxv.js";
import "./logging-CznuqaMu.js";
import { t as parsePort } from "./parse-port-BdJPfG31.js";
import "./commands-C6oAw_H-.js";
import "./issue-format-BtLIwOtN.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DUBuppms.js";
import { t as formatHelpExamples } from "./help-format-C_5MeE_w.js";
import "./identity-Dp-UIak4.js";
import "./heartbeat-Bdfr_onc.js";
import { Ap as formatExecCommand, Ip as normalizeSystemRunApprovalPlan, g as withTimeout, iC as getMachineDisplayName, jp as resolveSystemRunCommandRequest } from "./pi-embedded-CbCYZxIb.js";
...
import { t as detectMime } from "./mime-CsUtzcn2.js";
...
import { D as requestJsonlSocket, S as evaluateShellAllowlist, T as resolveAllowAlwaysPatterns, b as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, g as resolveExecApprovals, h as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, x as evaluateExecAllowlist } from "./exec-approvals-BF_Qfdq8.js";
...
import { n as resolveBrowserConfig } from "./config-CLRQPUSt.js";
import { _ as startBrowserControlServiceFromConfig, f as redactCdpUrl, g as createBrowserControlContext, h as createBrowserRouteDispatcher } from "./routes-XT2JfvT-.js";
...
import { i as isInterpreterLikeSafeBin, n as detectInterpreterInlineEvalArgv, o as resolveExecSafeBinRuntimePolicy, t as describeInterpreterInlineEval } from "./exec-inline-eval-CpmxWJsW.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-BjkQG0S1.js";
import { n as normalizeBrowserRequestPath, r as resolveRequestedBrowserProfile, t as isPersistentBrowserProfileMutation } from "./request-policy-Z4bqaQ0G.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-BWlu9FbU.js";
import { t as resolveNodeService } from "./node-service-D4mvvQIK.js";
...
async function runBrowserProxyCommand(paramsJSON) {
	...
	if (allowedProfiles.length > 0) {
		if (isPersistentBrowserProfileMutation(method, path)) throw new Error("INVALID_REQUEST: browser.proxy cannot create or delete persistent browser profiles when allowProfiles is configured");
		if (path !== "/profiles") {
			if (!isProfileAllowed({
...
async function evaluateSystemRunPolicyPhase(opts, parsed) {
	...
	const inlineEvalHit = agentExec?.strictInlineEval === true || cfg.tools?.exec?.strictInlineEval === true ? segments.map((segment) => detectInterpreterInlineEvalArgv(segment.resolution?.effectiveArgv ?? segment.argv)).find((entry) => entry !== null) ?? null : null;
...
async function executeSystemRunPhase(opts, phase) {
	...
	if (phase.policy.approvalDecision === "allow-always" && phase.security === "allowlist" && phase.inlineEvalHit === null) {
	...
	if (phase.allowlistMatches.length > 0) {
		...
		for (const match of phase.allowlistMatches) {
			...
			recordAllowlistUse(phase.approvals.file, phase.agentId, match, phase.commandText, resolveApprovalAuditCandidatePath(phase.segments[0]?.resolution ?? null, phase.cwd));
		}
	}

...
import { f as normalizeVerboseLevel, l as normalizeReasoningLevel, o as normalizeElevatedLevel, s as normalizeFastMode, u as normalizeThinkLevel } from "./thinking.shared-B8IAgSi8.js";
import { C as splitTrailingAuthProfile } from "./model-selection-8a6zD_aX.js";
import { S as takeDirectiveToken, b as extractQueueDirective, x as skipDirectiveArgPrefix } from "./queue-CrmMgtZc.js";
import "./thinking-EUyzvAQE.js";
import { _ as normalizeExecTarget } from "./exec-approvals-D6YTmZxM.js";
...
function parseInlineDirectives(body, options) {
	...
	const { cleaned: fastCleaned, fastMode, rawLevel: rawFastMode, hasDirective: hasFastDirective } = extractFastDirective(verboseCleaned);
...
function isDirectiveOnly(params) {
	...
	if (!directives.hasThinkDirective && !directives.hasVerboseDirective && !directives.hasFastDirective && !directives.hasReasoningDirective && !directives.hasElevatedDirective && !directives.hasExecDirective && !directives.hasModelDirective && !directives.hasQueueDirective) return false;
	const stripped = stripStructuralPrefixes(cleanedBody ?? "");
	return (isGroup ? stripMentions(stripped, ctx, cfg, agentId) : stripped).length === 0;
}
//#endregion
export { parseInlineDirectives as n, isDirectiveOnly as t };

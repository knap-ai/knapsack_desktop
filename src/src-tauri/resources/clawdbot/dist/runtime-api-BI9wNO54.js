...
import { i as getChildLogger } from "./logger-kwZIqwuw.js";
import { a as logVerbose, d as warn, l as shouldLogVerbose, t as danger } from "./globals-DBUMOBZ8.js";
import { p as createNonExitingRuntime } from "./subsystem-DISldKSB.js";
import { _ as normalizeAccountId, d as resolveThreadSessionKeys, l as normalizeMainKey } from "./session-key-DAhnzjyr.js";
import { r as normalizeStringEntries } from "./string-normalization-CohoSMRS.js";
import { g as writeConfigFile, s as loadConfig } from "./io-y3Az_Onx.js";
import { c as normalizeResolvedSecretInputString } from "./types.secrets-DgX397vI.js";
import { A as resolveSlackNativeStreaming, O as mapStreamingModeToSlackLegacyDraftStreamMode, j as resolveSlackStreamingMode } from "./zod-schema.providers-core-COy5nBQ0.js";
import { c as updateLastRoute, i as readSessionUpdatedAt } from "./store-C5UK26Ce.js";
...
import { a as resolveChannelEntryMatchWithFallback, n as buildChannelKeyCandidates, t as applyChannelMatchMeta } from "./channel-config-D4OY8L18.js";
import { m as resolveSessionKey } from "./sessions-D9ZgHCHb.js";
import { l as resolveStorePath } from "./paths-rhN9LKM_.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-C6oAw_H-.js";
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-Dp-UIak4.js";
import { $c as resolveSlackWebClientOptions, Bc as removeSlackReaction, Dv as resolveEnvelopeFormatOptions, Et as dispatchPluginInteractiveHandler, Ib as mergeAllowlist, Jc as resolveSlackMedia, Kc as normalizeSlackOutboundText, Lb as patchAllowlistUsersInConfigEntries, Lc as reactSlackMessage, Nb as addAllowlistUserEntriesFromConfigEntry, Oc as truncateSlackText, Pb as buildAllowlistResolutionSummary, Pv as dispatchInboundMessage, Qc as createSlackWebClient, Rb as summarizeMapping, Sc as registerSlackHttpHandler, Tv as formatInboundEnvelope, Uc as sendMessageSlack, Wc as SLACK_TEXT_LIMIT, Xc as resolveSlackThreadStarter, Yc as resolveSlackThreadHistory, Yx as resolveChannelConfigWrites, _v as hasControlCommand, cc as allowListMatches, dc as normalizeSlackAllowOwnerEntry, dl as resolveSlackReplyToMode, el as require_dist$5, fc as normalizeSlackSlug, fl as resolveSlackAppToken, gv as shouldDebounceTextInbound, hv as createChannelInboundDebouncer, jc as editSlackMessage, kc as deleteSlackMessage, lc as normalizeAllowList, lv as resolveNativeCommandSessionTargets, mc as resolveSlackUserAllowed, mv as resolveMentionGatingWithBypass, oc as hasSlackThreadParticipation, pc as resolveSlackAllowListMatch, pl as resolveSlackBotToken, qc as resolveSlackAttachmentContent, sc as recordSlackThreadParticipation, tl as require_eventemitter3, uc as normalizeAllowListLower, ul as resolveSlackAccount, xc as normalizeSlackWebhookPath, zv as createReplyDispatcherWithTyping } from "./pi-embedded-CbCYZxIb.js";
import { t as generateSecureToken } from "./secure-random-2W4K8IQm.js";
import { i as resolveAgentRoute } from "./resolve-route-DwFWP4JW.js";
import { n as resolveAgentOutboundIdentity } from "./outbound-runtime-m-y0nd6F.js";
import { S as resolveTextChunkLimit, r as chunkItems, t as withTimeout } from "./text-runtime-DVXt5xhi.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-D8ugNNDZ.js";
import { F as resolvePluginConversationBindingApproval, N as parsePluginBindingApprovalCustomId, T as buildPluginBindingResolvedText, s as recordInboundSession } from "./conversation-runtime-nmWgJSXS.js";
import { d as upsertChannelPairingRequest } from "./pairing-store-BGKLrjo6.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BrG9NqjP.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist, l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, u as resolveControlCommandGate } from "./dm-policy-shared-DtcQProI.js";
...
import { c as logInboundDrop, l as logTypingFailure, s as logAckFailure } from "./channel-feedback-BSaFwmB3.js";
import { M as installRequestBodyLimitGuard } from "./webhook-ingress-D-H5frou.js";
import { r as enqueueSystemEvent } from "./system-events-BU_NYynX.js";
import { t as evaluateGroupRouteAccessForPolicy } from "./group-access-BlqfIxg6.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-CiQ7TPgp.js";
import { E as finalizeInboundContext } from "./templating-BDXRiJUh.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-BxH4-AP2.js";
import { a as buildPendingHistoryContextFromMap, f as buildMentionRegexes, m as matchesMentionWithExplicit, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-n7nOPLta.js";
import { y as shouldHandleTextCommands } from "./commands-registry-Bh9pJ817.js";
import { t as buildUntrustedChannelMetadata } from "./security-runtime-xlw0Fxx2.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-Dqv2kG4v.js";
import { n as createConnectedChannelStatusPatch } from "./gateway-runtime-Dn2qAGY7.js";
import { f as createDraftStreamLoop } from "./channel-lifecycle-DmiShiUP.js";
import { t as require_axios } from "./axios-CEyceml2.js";
import { n as resolveSlackChannelAllowlist, t as resolveSlackUserAllowlist } from "./resolve-users-BA71J77K.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-D7mxFmXm.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-CUpUCIsP.js";
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/errors.js
var require_errors$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function asCodedError(error) {
		if (error.code !== void 0) return error;
	...
	var ContextMissingPropertyError = class extends Error {
	...
	var MultipleListenerError = class extends Error {
	...
	*/
	...
	var CustomFunctionCompleteSuccessError = class extends Error {
	...
	var CustomFunctionCompleteFailError = class extends Error {
		code = ErrorCode.CustomFunctionCompleteFailError;
	};
	exports.CustomFunctionCompleteFailError = CustomFunctionCompleteFailError;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/middleware/builtin.js
var require_builtin = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function isBlockPayload(payload) {
		return "action_id" in payload && payload.action_id !== void 0;
	}
	function isCallbackIdentifiedBody(body) {
		return "callback_id" in body && body.callback_id !== void 0;
	}
	/** Type predicate that can narrow event bodies to ones containing Views */
	function isViewBody(body) {
		return "view" in body && body.view !== void 0;
	}
	function isEventArgs(args) {
		return "event" in args && args.event !== void 0;
	}
	...
	*/
	const onlyActions = async (args) => {
		if ("action" in args && args.action) await args.next();
	};
	...
	*/
	const onlyShortcuts = async (args) => {
		if ("shortcut" in args && args.shortcut) await args.next();
	};
	...
	*/
	const onlyCommands = async (args) => {
		if ("command" in args && args.command) await args.next();
	};
	...
	*/
	const onlyOptions = async (args) => {
		if ("options" in args && args.options) await args.next();
	};
	...
	*/
	const onlyEvents = async (args) => {
		if (isEventArgs(args)) await args.next();
	};
	...
	*/
	const onlyViewActions = async (args) => {
		if ("view" in args) await args.next();
	};
	...
	*/
	const autoAcknowledge = async (args) => {
		if ("ack" in args && args.ack !== void 0) await args.ack();
		await args.next();
	};
	...
	*/
	function matchConstraints(constraints) {
		return async ({ payload, body, next, context }) => {
			...
			if ("block_id" in constraints || "action_id" in constraints) {
				if (!isBlockPayload(payload)) return;
				if (constraints.block_id !== void 0) if (typeof constraints.block_id === "string") {
					if (payload.block_id !== constraints.block_id) return;
				} else {
					tempMatches = payload.block_id.match(constraints.block_id);
					if (tempMatches !== null) context.blockIdMatches = tempMatches;
					else return;
				}
				if (constraints.action_id !== void 0) if (typeof constraints.action_id === "string") {
					if (payload.action_id !== constraints.action_id) return;
				} else {
					tempMatches = payload.action_id.match(constraints.action_id);
					if (tempMatches !== null) context.actionIdMatches = tempMatches;
					else return;
				}
			}
			if ("callback_id" in constraints && constraints.callback_id !== void 0) {
				let callbackId = "";
				if (isViewBody(body)) callbackId = body.view.callback_id;
				else if (isCallbackIdentifiedBody(body)) callbackId = body.callback_id;
				else return;
				if (typeof constraints.callback_id === "string") {
					if (callbackId !== constraints.callback_id) return;
				} else {
					tempMatches = callbackId.match(constraints.callback_id);
					if (tempMatches !== null) context.callbackIdMatches = tempMatches;
					else return;
				}
			}
	...
	function matchMessage(pattern) {
		return async ({ event, context, next }) => {
			let tempMatches;
			if (!("text" in event) || event.text === void 0) return;
			if (typeof pattern === "string") {
				if (!event.text.includes(pattern)) return;
			} else {
				tempMatches = event.text.match(pattern);
				if (tempMatches !== null) context.matches = tempMatches;
				else return;
			}
			await next();
		};
	...
	*/
	function matchCommandName(pattern) {
		return async ({ command, next }) => {
			if (!matchesPattern(pattern, command.command)) return;
			await next();
		};
	}
	exports.matchCommandName = matchCommandName;
	function matchesPattern(pattern, candidate) {
		if (typeof pattern === "string") return pattern === candidate;
		return pattern.test(candidate);
	}
	function matchEventType(pattern) {
		return async ({ event, context, next }) => {
			let tempMatches;
			if (!("type" in event) || event.type === void 0) return;
			if (typeof pattern === "string") {
	...
	const ignoreSelf = async (args) => {
		...
		if (isEventArgs(args)) {
			if (isMessageEventArgs(args)) {
				const { message } = args;
				if (message.subtype === "bot_message" && message.bot_id === botId) return;
			}
			if (botUserId !== void 0 && "user" in args.event && args.event.user === botUserId && !["member_joined_channel", "member_left_channel"].includes(args.event.type)) return;
		}
		await args.next();
	};
	...
	*/
	function subtype(subtype1) {
		return async ({ message, next }) => {
			if (message && message.subtype === subtype1) await next();
		};
	}
	...
	*/
	const directMention = async ({ message, context, next }) => {
		if (context.botUserId === void 0) throw new errors_1.ContextMissingPropertyError("botUserId", "Cannot match direct mentions of the app without a bot user ID. Ensure authorize callback returns a botUserId.");
		if (!message || !("text" in message) || message.text === void 0) return;
		const text = message.text.trim();
		const matches = slackLink.exec(text);
		if (matches === null || matches.index !== 0 || matches.groups === void 0 || matches.groups.type !== "@" || matches.groups.link !== context.botUserId) return;
		await next();
	};
	exports.directMention = directMention;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/CustomFunction.js
var require_CustomFunction = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const errors_1 = require_errors$2();
	const builtin_1 = require_builtin();
	function matchCallbackId(callbackId) {
		return async ({ payload, next }) => {
			if (payload.function.callback_id === callbackId) await next();
		};
	}
	exports.matchCallbackId = matchCallbackId;
	/** Class */
	var CustomFunction = class {
		...
		getListeners() {
			if (this.options.autoAcknowledge) return [
	...
	function validate(callbackId, middleware) {
		if (typeof callbackId !== "string") throw new errors_1.CustomFunctionInitializationError("CustomFunction expects a callback_id as the first argument");
		if (typeof middleware !== "function" && !Array.isArray(middleware)) throw new errors_1.CustomFunctionInitializationError("CustomFunction expects a function or array of functions as the second argument");
		if (Array.isArray(middleware)) {
			for (const fn of middleware) if (!(fn instanceof Function)) throw new errors_1.CustomFunctionInitializationError("All CustomFunction middleware must be functions");
		}
	}
	...
	*/
	function createFunctionComplete(context, client) {
		...
		if (!functionExecutionId) throw new errors_1.CustomFunctionCompleteSuccessError("No function_execution_id found");
		let called = false;
	...
	*/
	function createFunctionFail(context, client) {
		const { functionExecutionId } = context;
		if (!functionExecutionId) throw new errors_1.CustomFunctionCompleteFailError("No function_execution_id found");
		let called = false;
		const fail = (params) => {
			called = true;
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/helpers.js
var require_helpers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function getTypeAndConversation(body) {
		if (body.event !== void 0) {
			const { event } = body;
			return {
				conversationId: (() => {
					let foundConversationId;
					if ("channel" in event) {
						if (typeof event?.channel === "string") foundConversationId = event.channel;
						else if (typeof event?.channel === "object" && "id" in event.channel) foundConversationId = event.channel.id;
					}
					if ("channel_id" in event) foundConversationId = event.channel_id;
					if ("item" in event && "channel" in event.item) foundConversationId = event.item.channel;
					return foundConversationId || void 0;
				})(),
				type: IncomingEventType.Event
			};
		}
		if (body.command !== void 0) return {
			type: IncomingEventType.Command,
			conversationId: body.channel_id
		};
		if (body.name !== void 0 || body.type === "block_suggestion") {
			const optionsBody = body;
			return {
				type: IncomingEventType.Options,
				conversationId: optionsBody.channel !== void 0 ? optionsBody.channel.id : void 0
			};
		}
		if (body.actions !== void 0 || body.type === "dialog_submission" || body.type === "workflow_step_edit") {
			const actionBody = body;
			return {
				type: IncomingEventType.Action,
				conversationId: actionBody.channel !== void 0 ? actionBody.channel.id : void 0
			};
		}
		if (body.type === "shortcut") return { type: IncomingEventType.Shortcut };
		if (body.type === "message_action") {
			const shortcutBody = body;
			return {
				type: IncomingEventType.Shortcut,
				conversationId: shortcutBody.channel !== void 0 ? shortcutBody.channel.id : void 0
			};
		}
		if (body.type === "view_submission" || body.type === "view_closed") return { type: IncomingEventType.ViewAction };
		return {};
	}
	...
	*/
	function isBodyWithTypeEnterpriseInstall(body, type) {
		if ((type !== void 0 ? type : getTypeAndConversation(body).type) === IncomingEventType.Event) {
			const bodyAsEvent = body;
			if (Array.isArray(bodyAsEvent.authorizations) && bodyAsEvent.authorizations[0] !== void 0) return !!bodyAsEvent.authorizations[0].is_enterprise_install;
		}
		if (typeof body.is_enterprise_install === "string") return body.is_enterprise_install === "true";
		if (body.is_enterprise_install !== void 0) return body.is_enterprise_install;
		return false;
	}
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/conversation-store.js
var require_conversation_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
			...
			return new Promise((resolve, reject) => {
				...
				if (entry !== void 0) {
					if (entry.expiresAt !== void 0 && Date.now() > entry.expiresAt) {
						...
						reject(/* @__PURE__ */ new Error("Conversation expired"));
					}
					resolve(entry.value);
				}
				reject(/* @__PURE__ */ new Error("Conversation not found"));
			});
		}
	};
		...
		return async ({ body, context, next, logger }) => {
			...
			if (conversationId !== void 0) {
				...
				try {
					...
					const e = error;
					if (e.message !== void 0 && e.message !== "Conversation not found") logger.debug(`Conversation context failed loading for ID: ${conversationId}, error: ${e.message}`);
				}
			} else logger.debug("No conversation ID for incoming event");
			await next();
		};
	}
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/middleware/process.js
var require_process = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	async function processMiddleware(middleware, initialArgs, context, client, logger, last) {
		...
		async function invokeMiddleware(toCallMiddlewareIndex) {
			if (lastCalledMiddlewareIndex >= toCallMiddlewareIndex) throw Error("next() called multiple times");
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/errors.js
var require_errors$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	exports.InstallerInitializationError = function(_super) {
	...
	exports.GenerateInstallUrlError = function(_super) {
	...
	exports.MissingStateError = function(_super) {
	...
	exports.InvalidStateError = function(_super) {
	...
	exports.MissingCodeError = function(_super) {
	...
	exports.UnknownError = function(_super) {
	...
	exports.AuthorizationError = function(_super) {
		...
		function AuthorizationError(message, original) {
			...
			if (original !== void 0) _this.original = original;
			return _this;
		}
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/callback-options.js
var require_callback_options = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function defaultCallbackSuccess(installation, _options, _req, res) {
		var redirectUrl;
		if (isNotOrgInstall(installation) && installation.appId !== void 0) redirectUrl = "slack://app?team=".concat(installation.team.id, "&id=").concat(installation.appId);
		else if (isOrgInstall(installation)) redirectUrl = "".concat(installation.enterpriseUrl, "manage/organization/apps/profile/").concat(installation.appId, "/workspaces/add");
		else redirectUrl = "slack://open";
		var browserUrl = redirectUrl;
		if (isNotOrgInstall(installation)) browserUrl = "https://app.slack.com/client/".concat(installation.team.id);
	...
	function escapeHtml(input) {
		if (input) return input.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;");
		return "";
	}
}));
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/default-render-html-for-install-path.js
var require_default_render_html_for_install_path = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/installation-stores/file-store.js
var require_file_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var node_fs_1$1 = __importDefault(__require("node:fs"));
	var node_os_1$1 = __require("node:os");
	var node_path_1$1 = __importDefault(__require("node:path"));
	exports.default = function() {
		function FileInstallationStore(_a) {
			var _b = _a === void 0 ? {} : _a, _c = _b.baseDir, baseDir = _c === void 0 ? "".concat((0, node_os_1$1.homedir)(), "/.bolt-js-app-installation") : _c, clientId = _b.clientId, _d = _b.historicalDataEnabled, historicalDataEnabled = _d === void 0 ? true : _d;
			this.baseDir = clientId !== void 0 ? "".concat(baseDir, "/").concat(clientId) : baseDir;
		...
		FileInstallationStore.prototype.storeInstallation = function(installation, logger) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					...
					node_fs_1$1.default.mkdirSync(installationDir, { recursive: true });
					try {
		...
		FileInstallationStore.prototype.fetchInstallation = function(query, logger) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					...
					if (logger !== void 0) logger.info("Retrieving installation from ".concat(installationDir, " with the following query: ").concat(JSON.stringify(query)));
					if (isEnterpriseInstall && enterpriseId === void 0) throw new Error("enterpriseId is required to fetch data of an enterprise installation");
					try {
						data = node_fs_1$1.default.readFileSync(node_path_1$1.default.resolve("".concat(installationDir, "/app-latest")));
						installation = JSON.parse(data.toString());
						if (query.userId && installation.user.id !== query.userId) try {
							userData = node_fs_1$1.default.readFileSync(node_path_1$1.default.resolve("".concat(installationDir, "/user-").concat(query.userId, "-latest")));
							if (userData !== void 0 && userData !== null) {
								userInstallation = JSON.parse(userData.toString());
								installation.user = userInstallation.user;
							}
						} catch (_err) {
							logger === null || logger === void 0 || logger.debug("The user-token installation for the request user (user_id: ".concat(query.userId, ") was not found."));
							installation.user.token = void 0;
							installation.user.refreshToken = void 0;
							installation.user.expiresAt = void 0;
							installation.user.scopes = void 0;
						}
						return [2, installation];
					} catch (_err) {
		...
		FileInstallationStore.prototype.deleteInstallation = function(query, logger) {
			return __awaiter(this, void 0, void 0, function() {
				var enterpriseId, teamId, userId, installationDir, filesToDelete, allFiles, userFiles, _i, filesToDelete_1, filePath;
				return __generator(this, function(_a) {
					...
					if (logger !== void 0) logger.info("Deleting installations in ".concat(installationDir, " with the following query: ").concat(JSON.stringify(query)));
					filesToDelete = [];
					if (userId === void 0) {
						allFiles = node_fs_1$1.default.readdirSync(installationDir);
						filesToDelete = filesToDelete.concat(allFiles);
					} else {
						userFiles = node_fs_1$1.default.readdirSync(installationDir).filter(function(file) {
					...
					try {
						for (_i = 0, filesToDelete_1 = filesToDelete; _i < filesToDelete_1.length; _i++) {
							...
							deleteFile(node_path_1$1.default.resolve("".concat(installationDir, "/").concat(filePath)));
						}
					} catch (err) {
		...
		FileInstallationStore.prototype.getInstallationDir = function(enterpriseId, teamId, isEnterpriseInstall) {
			...
			if (teamId !== "" && !isEnterpriseInstall) installDir += enterpriseId !== "" ? "-".concat(teamId) : "".concat(teamId);
			return installDir;
		};
		return FileInstallationStore;
	}();
	function writeToFile(filePath, data) {
		node_fs_1$1.default.writeFileSync(filePath, data);
	}
	function deleteFile(filePath) {
		node_fs_1$1.default.unlinkSync(node_path_1$1.default.resolve(filePath));
	}
}));
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/installation-stores/memory-store.js
var require_memory_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
	...
	exports.default = function() {
		...
		MemoryInstallationStore.prototype.storeInstallation = function(installation, logger) {
			return __awaiter(this, void 0, void 0, function() {
				return __generator(this, function(_a) {
					if (logger !== void 0) logger.warn("Storing Access Token. Please use a real Installation Store for production!");
					if (installation.isEnterpriseInstall && installation.enterprise !== void 0) {
						if (logger !== void 0) logger.debug("storing org installation");
						this.devDB[installation.enterprise.id] = installation;
					} else if (!installation.isEnterpriseInstall && installation.team !== void 0) {
						if (logger !== void 0) logger.debug("storing single team installation");
		...
		MemoryInstallationStore.prototype.fetchInstallation = function(query, logger) {
			return __awaiter(this, void 0, void 0, function() {
				return __generator(this, function(_a) {
					if (logger !== void 0) logger.warn("Retrieving Access Token from DB. Please use a real Installation Store for production!");
					if (query.isEnterpriseInstall) {
						if (query.enterpriseId !== void 0) {
							if (logger !== void 0) logger.debug("fetching org installation");
							return [2, this.devDB[query.enterpriseId]];
						}
					}
					if (query.teamId !== void 0) {
						if (logger !== void 0) logger.debug("fetching single team installation");
						return [2, this.devDB[query.teamId]];
					}
		...
		MemoryInstallationStore.prototype.deleteInstallation = function(query, logger) {
			return __awaiter(this, void 0, void 0, function() {
				var _a, _b, devDB, _c, _d, devDB;
				return __generator(this, function(_e) {
					if (logger !== void 0) logger.warn("Deleting Access Token from DB. Please use a real Installation Store for production!");
					if (query.isEnterpriseInstall && query.enterpriseId !== void 0) {
						if (logger !== void 0) logger.debug("deleting org installation");
						_a = this.devDB, _b = query.enterpriseId, _a[_b], devDB = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
						this.devDB = devDB;
					} else if (query.teamId !== void 0) {
						if (logger !== void 0) logger.debug("deleting single team installation");
						_c = this.devDB, _d = query.teamId, _c[_d], devDB = __rest(_c, [typeof _d === "symbol" ? _d : _d + ""]);
						this.devDB = devDB;
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/installation-stores/index.js
var require_installation_stores = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.MemoryInstallationStore = exports.FileInstallationStore = void 0;
	var file_store_1 = require_file_store();
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/logger.js
var require_logger$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.LogLevel = void 0;
	exports.getLogger = getLogger;
	var logger_1 = require_dist$4();
	var logger_2 = require_dist$4();
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/state-stores/clear-state-store.js
var require_clear_state_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
		...
		ClearStateStore.prototype.generateStateParam = function(installOptions, now) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					...
					return [2, (0, jsonwebtoken_1.sign)(source, this.stateSecret)];
				});
			});
		};
		ClearStateStore.prototype.verifyStateParam = function(now, state) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					...
					passedSeconds = Math.floor((now.getTime() - generatedAt.getTime()) / 1e3);
					if (passedSeconds > this.stateExpirationSeconds) throw new errors_1.InvalidStateError("The state value is already expired");
					return [2, decoded.installOptions];
				});
			});
		};
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/state-stores/file-state-store.js
var require_file_state_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
	...
	var logger_1 = require_dist$4();
	var errors_1 = require_errors$1();
	exports.FileStateStore = function() {
		function FileStateStore(args) {
			this.baseDir = args.baseDir !== void 0 ? args.baseDir : "".concat((0, node_os_1.homedir)(), "/.bolt-js-oauth-states");
			this.stateExpirationSeconds = args.stateExpirationSeconds !== void 0 ? args.stateExpirationSeconds : 600;
			this.logger = args.logger !== void 0 ? args.logger : new logger_1.ConsoleLogger();
		}
		FileStateStore.prototype.generateStateParam = function(installOptions, now) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					...
					while (this.alreadyExists(state)) state = generateRandomString();
					source = {
						installOptions,
						now
					};
		...
		FileStateStore.prototype.readFile = function(filename) {
			...
			try {
				...
				if (data !== void 0) return JSON.parse(data.toString());
				return;
			} catch (e) {
		...
		FileStateStore.prototype.deleteFile = function(filename) {
			var fullpath = node_path_1.default.resolve("".concat(this.baseDir, "/").concat(filename));
			if (node_fs_1.default.existsSync(fullpath)) node_fs_1.default.unlinkSync(fullpath);
		};
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/state-stores/index.js
var require_state_stores = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.FileStateStore = exports.ClearStateStore = void 0;
	var clear_state_store_1 = require_clear_state_store();
	...
	var file_state_store_1 = require_file_state_store();
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/install-provider.js
var require_install_provider = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var node_url_1$2 = __require("node:url");
	var web_api_1 = require_dist$5();
	var callback_options_1 = require_callback_options();
	var default_render_html_for_install_path_1 = __importDefault(require_default_render_html_for_install_path());
	var errors_1 = require_errors$1();
	var installation_stores_1 = require_installation_stores();
	var logger_1 = require_logger$1();
	var state_stores_1 = require_state_stores();
	exports.InstallProvider = function() {
		function InstallProvider(_a) {
			var clientId = _a.clientId, clientSecret = _a.clientSecret, _b = _a.stateSecret, stateSecret = _b === void 0 ? void 0 : _b, _c = _a.stateStore, stateStore = _c === void 0 ? void 0 : _c, _d = _a.stateVerification, stateVerification = _d === void 0 ? true : _d, _e = _a.legacyStateVerification, legacyStateVerification = _e === void 0 ? false : _e, _f = _a.stateCookieName, stateCookieName = _f === void 0 ? "slack-app-oauth-state" : _f, _g = _a.stateCookieExpirationSeconds, stateCookieExpirationSeconds = _g === void 0 ? 600 : _g, _h = _a.directInstall, directInstall = _h === void 0 ? false : _h, _j = _a.installationStore, installationStore = _j === void 0 ? new installation_stores_1.MemoryInstallationStore() : _j, _k = _a.installUrlOptions, installUrlOptions = _k === void 0 ? void 0 : _k, _l = _a.renderHtmlForInstallPath, renderHtmlForInstallPath = _l === void 0 ? default_render_html_for_install_path_1.default : _l, _m = _a.authVersion, authVersion = _m === void 0 ? "v2" : _m, _o = _a.logger, logger = _o === void 0 ? void 0 : _o, _p = _a.logLevel, logLevel = _p === void 0 ? void 0 : _p, _q = _a.clientOptions, clientOptions = _q === void 0 ? {} : _q, _r = _a.authorizationUrl, authorizationUrl = _r === void 0 ? "https://slack.com/oauth/v2/authorize" : _r;
			if (clientId === void 0 || clientSecret === void 0) throw new errors_1.InstallerInitializationError("You must provide a valid clientId and clientSecret");
			if (typeof logger !== "undefined") {
				this.logger = logger;
				if (typeof logLevel !== "undefined") this.logger.debug("The logLevel given to OAuth was ignored as you also gave logger");
			} else this.logger = (0, logger_1.getLogger)("OAuth:InstallProvider", logLevel !== null && logLevel !== void 0 ? logLevel : logger_1.LogLevel.INFO, logger);
			...
			if (!stateVerification) this.logger.warn("You've set InstallProvider#stateVerification to false. This flag is intended to enable org-wide app installations from admin pages. If this isn't your scenario, we recommend setting stateVerification to true and starting your OAuth flow from the provided `/slack/install` or your own starting endpoint.");
			if (stateStore !== void 0) this.stateStore = stateStore;
			else if (this.stateVerification) if (stateSecret !== void 0) this.stateStore = new state_stores_1.ClearStateStore(stateSecret, this.stateCookieExpirationSeconds);
			else throw new errors_1.InstallerInitializationError("To use the built-in state store you must provide a State Secret");
			...
			if (authorizationUrl !== "https://slack.com/oauth/v2/authorize" && authVersion === "v1") this.logger.info("You provided both an authorizationUrl and an authVersion! The authVersion will be ignored in favor of the authorizationUrl.");
			else if (authVersion === "v1") this.authorizationUrl = "https://slack.com/oauth/authorize";
			this.clientOptions = __assign({
				logger,
				logLevel: this.logger.getLevel()
			}, clientOptions);
			this.noTokenClient = new web_api_1.WebClient(void 0, this.clientOptions);
		}
		/**
				...
				return __generator(this, function(_e) {
					switch (_e.label) {
						...
						case 1:
							...
							return [4, this.installationStore.fetchInstallation(source, this.logger)];
						case 2:
							queryResult = _e.sent();
							if (queryResult === void 0 || queryResult === null) throw new Error("Failed fetching data from the Installation Store (source: ".concat(sourceForLogging, ")"));
							authResult = {};
							if (queryResult.user) authResult.userToken = queryResult.user.token;
							if ((_a = queryResult.team) === null || _a === void 0 ? void 0 : _a.id) authResult.teamId = queryResult.team.id;
 ...
 /**
							...
							*/
							...
							if (((_b = queryResult === null || queryResult === void 0 ? void 0 : queryResult.enterprise) === null || _b === void 0 ? void 0 : _b.id) || (source === null || source === void 0 ? void 0 : source.enterpriseId)) authResult.enterpriseId = ((_c = queryResult === null || queryResult === void 0 ? void 0 : queryResult.enterprise) === null || _c === void 0 ? void 0 : _c.id) || (source === null || source === void 0 ? void 0 : source.enterpriseId);
							if (queryResult.bot) {
								...
								if (queryResult.bot.refreshToken) {
									...
									authResult.botTokenExpiresAt = queryResult.bot.expiresAt;
								}
							}
							if ((_d = queryResult.user) === null || _d === void 0 ? void 0 : _d.refreshToken) {
								authResult.userRefreshToken = queryResult.user.refreshToken;
								authResult.userTokenExpiresAt = queryResult.user.expiresAt;
							}
							if (!(authResult.botRefreshToken || authResult.userRefreshToken)) return [3, 6];
							currentUTCSec = Math.floor(Date.now() / 1e3);
							tokensToRefresh = detectExpiredOrExpiringTokens(authResult, currentUTCSec);
							if (!(tokensToRefresh.length > 0)) return [3, 6];
							...
							return [4, this.refreshExpiringTokens(tokensToRefresh)];
						case 3:
							refreshResponses = _e.sent();
							if (!refreshResponses.length) return [3, 5];
							...
							return [4, this.installationStore.storeInstallation(installationUpdates)];
						case 4:
							_e.sent();
		...
		*/
			...
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					switch (_a.label) {
						...
						case 1: return [2, _a.sent().filter(function(res) {
		...
		InstallProvider.prototype.refreshExpiringToken = function(refreshToken) {
			return __awaiter(this, void 0, void 0, function() {
				var _this = this;
				return __generator(this, function(_a) {
					return [2, this.noTokenClient.oauth.v2.access({
		...
		InstallProvider.prototype.handleInstallPath = function(req, res, options, installOptions) {
			return __awaiter(this, void 0, void 0, function() {
				...
				return __generator(this, function(_a) {
					switch (_a.label) {
						case 0:
							if (installOptions === void 0 && this.installUrlOptions === void 0) {
						...
						case 1:
							...
							shouldProceed = true;
							if (!((options === null || options === void 0 ? void 0 : options.beforeRedirection) !== void 0)) return [3, 3];
							return [4, options.beforeRedirection(req, res, installOptions)];
						case 2:
						...
						case 3:
							...
							state = void 0;
							if (!this.stateVerification) return [3, 6];
							if (!this.stateStore) return [3, 5];
							return [4, this.stateStore.generateStateParam(_installOptions, /* @__PURE__ */ new Date())];
						case 4:
							state = _a.sent();
							...
							if (res.getHeader("Set-Cookie")) {
								...
								allCookies = [];
								if (Array.isArray(existingCookies)) allCookies.push.apply(allCookies, existingCookies);
								else if (typeof existingCookies === "string") allCookies.push(existingCookies);
								else allCookies.push(existingCookies.toString());
								allCookies.push(stateCookie);
								res.setHeader("Set-Cookie", allCookies);
							} else res.setHeader("Set-Cookie", stateCookie);
							return [3, 6];
						case 5:
							if (this.stateStore === void 0) throw new errors_1.GenerateInstallUrlError("StateStore is not properly configured");
							_a.label = 6;
						case 6: return [4, this.generateInstallUrl(_installOptions, this.stateVerification, state)];
						case 7:
							url = _a.sent();
							this.logger.debug("Generated authorize URL: ".concat(url));
							if (this.directInstall !== void 0 && this.directInstall) {
		...
		InstallProvider.prototype.generateInstallUrl = function(options_1) {
			return __awaiter(this, arguments, void 0, function(options, stateVerification, state) {
				...
				return __generator(this, function(_a) {
					switch (_a.label) {
						case 0:
							slackURL = new node_url_1$2.URL(this.authorizationUrl);
							if (options.scopes === void 0 || options.scopes === null) throw new errors_1.GenerateInstallUrlError("You must provide a scope parameter when calling generateInstallUrl");
							if (Array.isArray(options.scopes)) scopes = options.scopes.join(",");
							else scopes = options.scopes;
							params = new node_url_1$2.URLSearchParams("scope=".concat(scopes));
							if (!stateVerification) return [3, 4];
							_state = state;
							if (!(_state === void 0)) return [3, 3];
							if (!this.stateStore) return [3, 2];
							return [4, this.stateStore.generateStateParam(options, /* @__PURE__ */ new Date())];
						case 1:
							_state = _a.sent();
							return [3, 3];
						case 2:
						...
						case 4:
							...
							if (options.redirectUri !== void 0) params.append("redirect_uri", options.redirectUri);
							if (options.teamId !== void 0) params.append("team", options.teamId);
							if (options.userScopes !== void 0 && this.authVersion === "v2") {
								userScopes = void 0;
								if (Array.isArray(options.userScopes)) userScopes = options.userScopes.join(",");
								else userScopes = options.userScopes;
								params.append("user_scope", userScopes);
							}
							slackURL.search = params.toString();
							return [2, slackURL.toString()];
					}
				});
			});
		};
					...
					switch (_b.label) {
						case 0:
							...
							if (req.url !== void 0) {
								...
								if (flowError === "access_denied") throw new errors_1.AuthorizationError("User cancelled the OAuth installation flow!");
								code = searchParams.get("code");
								stateInQueryString = searchParams.get("state");
								if (!code) throw new errors_1.MissingCodeError("Redirect url is missing the required code query parameter");
								if (this.stateVerification && !stateInQueryString) throw new errors_1.MissingStateError("Redirect url is missing the state query parameter. If this is intentional, see options for disabling default state verification.");
							} else throw new errors_1.UnknownError("Something went wrong");
							if (!this.stateVerification) return [3, 6];
							_b.label = 1;
						case 1:
							_b.trys.push([
							...
							if (this.legacyStateVerification) this.logger.warn("Enabling legacyStateVerification is not recommended as it does not properly work for OAuth CSRF protection. Please consider migrating from directly using InstallProvider#generateInstallUrl() to InstallProvider#handleInstallPath() for serving the install path.");
							else {
								stateInBrowserSession = extractCookieValue(req, this.stateCookieName);
								if (!stateInBrowserSession || stateInBrowserSession !== stateInQueryString) throw new errors_1.InvalidStateError("The state parameter is not for this browser session.");
							}
							if (!this.stateStore) return [3, 3];
							return [4, this.stateStore.verifyStateParam(/* @__PURE__ */ new Date(), stateInQueryString)];
						case 2:
						...
						case 6:
							...
							shouldProceed = true;
							if (!((options === null || options === void 0 ? void 0 : options.beforeInstallation) !== void 0)) return [3, 8];
							return [4, options.beforeInstallation(installOptions, req, res)];
						case 7:
							shouldProceed = _b.sent();
							_b.label = 8;
						case 8:
							if (!shouldProceed) return [2];
							installation = void 0;
							resp = void 0;
							if (!(this.authVersion === "v1")) return [3, 12];
							return [4, this.noTokenClient.oauth.access({
								code,
								client_id: this.clientId,
								client_secret: this.clientSecret,
						...
						case 9:
							...
							v1Installation = {
								...
								enterprise: v1Resp.enterprise_id === null ? void 0 : { id: v1Resp.enterprise_id },
								user: {
							...
							if (!(v1Resp.bot !== void 0)) return [3, 11];
							return [4, runAuthTest(v1Resp.bot.bot_access_token, this.clientOptions)];
						case 10:
							authResult = _b.sent();
						...
						case 11:
							...
							return [3, 19];
						case 12: return [4, this.noTokenClient.oauth.v2.access({
							code,
							client_id: this.clientId,
							client_secret: this.clientSecret,
							redirect_uri: installOptions.redirectUri
						...
						case 13:
							v2Resp = _b.sent();
							v2Installation = {
								team: v2Resp.team === null ? void 0 : v2Resp.team,
								enterprise: v2Resp.enterprise == null ? void 0 : v2Resp.enterprise,
								user: {
							...
							currentUTC = Math.floor(Date.now() / 1e3);
							if (!(v2Resp.access_token !== void 0 && v2Resp.scope !== void 0 && v2Resp.bot_user_id !== void 0)) return [3, 15];
							return [4, runAuthTest(v2Resp.access_token, this.clientOptions)];
						case 14:
							authResult = _b.sent();
							v2Installation.bot = {
							...
							if (v2Resp.is_enterprise_install) v2Installation.enterpriseUrl = authResult.url;
							if (v2Resp.refresh_token !== void 0 && v2Resp.expires_in !== void 0) {
								v2Installation.bot.refreshToken = v2Resp.refresh_token;
								v2Installation.bot.expiresAt = currentUTC + v2Resp.expires_in;
							}
							_b.label = 15;
						case 15:
							if (!(v2Resp.authed_user !== void 0 && v2Resp.authed_user.access_token !== void 0)) return [3, 18];
							if (!(v2Resp.is_enterprise_install && v2Installation.enterpriseUrl === void 0)) return [3, 17];
							return [4, runAuthTest(v2Resp.authed_user.access_token, this.clientOptions)];
						case 16:
							authResult = _b.sent();
							v2Installation.enterpriseUrl = authResult.url;
							_b.label = 17;
						case 17:
							if (v2Resp.authed_user.refresh_token !== void 0 && v2Resp.authed_user.expires_in !== void 0) {
								v2Installation.user.refreshToken = v2Resp.authed_user.refresh_token;
								v2Installation.user.expiresAt = currentUTC + v2Resp.authed_user.expires_in;
							}
							_b.label = 18;
						case 18:
							resp = v2Resp;
							...
							_b.label = 19;
						case 19:
							if (resp.incoming_webhook !== void 0) installation.incomingWebhook = {
							...
							if (installOptions && installOptions.metadata !== void 0) installation.metadata = installOptions.metadata;
							if (!((options === null || options === void 0 ? void 0 : options.afterInstallation) !== void 0)) return [3, 21];
							return [4, options.afterInstallation(installation, installOptions, req, res)];
						case 20:
							shouldProceed = _b.sent();
							_b.label = 21;
						case 21:
							if (!shouldProceed) return [2];
							return [4, this.installationStore.storeInstallation(installation, this.logger)];
						case 22:
							_b.sent();
							if (!(options !== void 0 && (options.success !== void 0 || options.successAsync !== void 0))) return [3, 25];
							...
							if (!(options.successAsync !== void 0)) return [3, 24];
							this.logger.debug("Calling passed function as callbackOptions.successAsync");
							return [4, options.successAsync(installation, installOptions, req, res)];
						case 23:
							_b.sent();
							_b.label = 24;
						case 24: return [3, 26];
						...
						case 27:
							...
							codedError = error_2;
							if (codedError.code === void 0) codedError.code = errors_1.ErrorCode.UnknownError;
							if (!(options !== void 0 && (options.failure !== void 0 || options.failureAsync !== void 0))) return [3, 30];
							if (options.failure !== void 0) {
								this.logger.debug("Calling passed function as callbackOptions.failure");
								options.failure(codedError, installOptions, req, res);
							}
							if (!(options.failureAsync !== void 0)) return [3, 29];
							this.logger.debug("Calling passed function as callbackOptions.failureAsync");
							return [4, options.failureAsync(codedError, installOptions, req, res)];
						case 28:
							_b.sent();
							_b.label = 29;
						case 29: return [3, 31];
	...
	*/
	function detectExpiredOrExpiringTokens(authResult, currentUTCSec) {
		var tokensToRefresh = [];
		var EXPIRY_WINDOW = 7200;
		if (authResult.botRefreshToken && authResult.botTokenExpiresAt !== void 0 && authResult.botTokenExpiresAt !== null) {
			if (authResult.botTokenExpiresAt - currentUTCSec <= EXPIRY_WINDOW) tokensToRefresh.push(authResult.botRefreshToken);
		}
		if (authResult.userRefreshToken && authResult.userTokenExpiresAt !== void 0 && authResult.userTokenExpiresAt !== null) {
			if (authResult.userTokenExpiresAt - currentUTCSec <= EXPIRY_WINDOW) tokensToRefresh.push(authResult.userRefreshToken);
		}
	...
	*/
	function extractSearchParams(req) {
		return new node_url_1$2.URL(req.url, "https://".concat(req.headers.host)).searchParams;
	}
...
//#endregion
//#region node_modules/.pnpm/@slack+oauth@3.0.4/node_modules/@slack/oauth/dist/index.js
var require_dist$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var install_provider_1 = require_install_provider();
	...
	var default_render_html_for_install_path_1 = require_default_render_html_for_install_path();
	...
	__exportStar(require_installation_stores(), exports);
	__exportStar(require_state_stores(), exports);
...
//#endregion
//#region node_modules/.pnpm/path-to-regexp@8.3.0/node_modules/path-to-regexp/dist/index.js
var require_dist$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function* flatten(tokens, index, init) {
		...
		if (token.type === "group") for (const seq of flatten(token.tokens, 0, init.slice())) yield* flatten(tokens, index + 1, seq);
	...
	*/
	function stringifyTokens(tokens) {
		...
		let i = 0;
		function name(value) {
			return isNameSafe(value) && isNextNameSafe(tokens[i]) ? value : JSON.stringify(value);
		}
...
var require_http_errors = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	function populateConstructorExports(exports$7, codes, HttpError) {
		codes.forEach(function forEachCode(code) {
			...
			if (CodeError) {
				exports$7[code] = CodeError;
				exports$7[name] = CodeError;
			}
		});
	}
	/**
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/lib/bom-handling.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/lib/helpers/merge-exports.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/internal.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/utf32.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/utf16.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/utf7.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/sbcs-codec.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/sbcs-data.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/sbcs-data-generated.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/dbcs-codec.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/shiftjis.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/eucjp.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/cp936.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/gbk-added.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/gb18030-ranges.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/cp949.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/cp950.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/tables/big5-added.json
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/dbcs-data.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/encodings/index.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/lib/streams.js
...
//#endregion
//#region node_modules/.pnpm/iconv-lite@0.7.2/node_modules/iconv-lite/lib/index.js
...
//#endregion
//#region node_modules/.pnpm/tsscmp@1.0.6/node_modules/tsscmp/lib/index.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function timeSafeCompare(a, b) {
		...
		return bufferEqual(crypto.createHmac("sha256", key).update(sa).digest(), crypto.createHmac("sha256", key).update(sb).digest()) && a === b;
	}
	module.exports = timeSafeCompare;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/verify-request.js
var require_verify_request = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const tsscmp_1 = __importDefault(require_lib());
	...
	*/
	function verifySlackRequest(options) {
		...
		if (Number.isNaN(requestTimestampSec)) throw new Error(`${verifyErrorPrefix}: header x-slack-request-timestamp did not have the expected type (${requestTimestampSec})`);
		const nowMs = options.nowMilliseconds ?? Date.now();
		const requestTimestampMaxDeltaMin = 5;
		if (requestTimestampSec < Math.floor(nowMs / 1e3) - 60 * requestTimestampMaxDeltaMin) throw new Error(`${verifyErrorPrefix}: x-slack-request-timestamp must differ from system time by no more than ${requestTimestampMaxDeltaMin} minutes or request is stale`);
		const [signatureVersion, signatureHash] = signature.split("=");
		if (signatureVersion !== "v0") throw new Error(`${verifyErrorPrefix}: unknown signature version`);
		const hmac = (0, node_crypto_1$2.createHmac)("sha256", options.signingSecret);
		hmac.update(`${signatureVersion}:${requestTimestampSec}:${options.body}`);
		const ourSignatureHash = hmac.digest("hex");
		if (!signatureHash || !(0, tsscmp_1.default)(signatureHash, ourSignatureHash)) throw new Error(`${verifyErrorPrefix}: signature mismatch`);
	}
	...
	*/
	function isValidSlackRequest(options) {
		try {
			...
			if (options.logger) options.logger.debug(`Signature verification error: ${e}`);
		}
		return false;
	}
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/HTTPModuleFunctions.js
var require_HTTPModuleFunctions = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const node_querystring_1$2 = __require("node:querystring");
	const raw_body_1 = __importDefault(require_raw_body());
	const errors_1 = require_errors$2();
	const verify_request_1 = require_verify_request();
	const verifyErrorPrefix = "Failed to verify authenticity";
	const extractRetryNumFromHTTPRequest = (req) => {
		let retryNum;
		const retryNumHeaderValue = req.headers["x-slack-retry-num"];
		if (retryNumHeaderValue === void 0) retryNum = void 0;
		else if (typeof retryNumHeaderValue === "string") retryNum = Number.parseInt(retryNumHeaderValue, 10);
		else if (Array.isArray(retryNumHeaderValue) && retryNumHeaderValue.length > 0) retryNum = Number.parseInt(retryNumHeaderValue[0], 10);
		return retryNum;
	};
	...
	const extractRetryReasonFromHTTPRequest = (req) => {
		...
		if (retryReasonHeaderValue === void 0) retryReason = void 0;
		else if (typeof retryReasonHeaderValue === "string") retryReason = retryReasonHeaderValue;
		else if (Array.isArray(retryReasonHeaderValue) && retryReasonHeaderValue.length > 0) retryReason = retryReasonHeaderValue[0];
		return retryReason;
	};
	...
	const parseHTTPRequestBody = (req) => {
		...
		if (req.headers["content-type"] === "application/x-www-form-urlencoded") {
			const parsedQs = (0, node_querystring_1$2.parse)(bodyAsString);
	...
	const parseAndVerifyHTTPRequest = async (options, req, _res) => {
		...
		if (options.enabled !== void 0 && !options.enabled) return bufferedReq;
		const textBody = bufferedReq.rawBody.toString();
		if (req.headers["content-type"] === "application/x-www-form-urlencoded") {
			if ((0, node_querystring_1$2.parse)(textBody)?.ssl_check) return bufferedReq;
		}
	...
	const getHeader = (req, header) => {
		...
		if (value === void 0 || Array.isArray(value)) throw new Error(`${verifyErrorPrefix}: header ${header} did not have the expected type (received ${typeof value}, expected string)`);
		return value;
	};
	exports.getHeader = getHeader;
	const bufferIncomingMessage = async (req) => {
		if ((0, exports.isBufferedIncomingMessage)(req)) return req;
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/HTTPResponseAck.js
var require_HTTPResponseAck = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	const errors_1 = require_errors$2();
	const httpFunc = __importStar(require_HTTPModuleFunctions());
	var HTTPResponseAck = class {
		logger;
		isAcknowledged;
		...
		constructor(args) {
			...
			this.storedResponse = void 0;
			this.noAckTimeoutId = void 0;
			this.init();
		}
		init() {
			/**
		...
		determineRequestTimeout() {
			if (this.httpRequestBody?.event?.type === "function_executed") return this.unhandledFunctionRequestTimeoutMillis;
			return this.unhandledRequestTimeoutMillis;
		}
		bind() {
			return async (responseBody) => {
				this.logger.debug(`ack() call begins (body: ${responseBody})`);
				if (this.isAcknowledged) throw new errors_1.ReceiverMultipleAckError();
				this.ack();
				if (this.processBeforeResponse) {
					if (!responseBody) this.storedResponse = "";
					else this.storedResponse = responseBody;
		...
		ack() {
			...
			if (this.noAckTimeoutId) clearTimeout(this.noAckTimeoutId);
		}
	};
	exports.HTTPResponseAck = HTTPResponseAck;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/custom-routes.js
var require_custom_routes = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	function validateCustomRoutes(customRoutes) {
		...
		const missingKeys = [];
		for (const route of customRoutes) for (const key of requiredKeys) if (route[key] === void 0 && !missingKeys.includes(key)) missingKeys.push(key);
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/verify-redirect-opts.js
var require_verify_redirect_opts = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	*/
	...
	function verifyRedirectOpts({ redirectUri, redirectUriPath }) {
		if (redirectUri && !redirectUriPath) throw new errors_1.AppInitializationError(" You have set a redirectUri but not a matching redirectUriPath. Please provide this via installerOptions.redirectUriPath Note: These should be consistent, e.g. https://example.com/redirect and /redirect");
		if (redirectUri && redirectUriPath && !redirectUri?.endsWith(redirectUriPath)) throw new errors_1.AppInitializationError("redirectUri and installerOptions.redirectUriPath should be consistent e.g. https://example.com/redirect and /redirect");
	}
	exports.verifyRedirectOpts = verifyRedirectOpts;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/HTTPReceiver.js
var require_HTTPReceiver = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	const node_http_1$2 = __require("node:http");
	const node_https_1$1 = __require("node:https");
	const node_url_1$1 = __require("node:url");
	const logger_1 = require_dist$4();
	const oauth_1 = require_dist$3();
	const path_to_regexp_1 = require_dist$2();
	const errors_1 = require_errors$2();
	const httpFunc = __importStar(require_HTTPModuleFunctions());
	const HTTPResponseAck_1 = require_HTTPResponseAck();
	const custom_routes_1 = require_custom_routes();
	const verify_redirect_opts_1 = require_verify_redirect_opts();
	...
	*/
	var HTTPReceiver = class {
		...
		unhandledRequestHandler;
		unhandledRequestTimeoutMillis;
		constructor({ signingSecret = "", endpoints = ["/slack/events"], port = 3e3, customRoutes = [], logger = void 0, logLevel = logger_1.LogLevel.INFO, processBeforeResponse = false, signatureVerification = true, clientId = void 0, clientSecret = void 0, stateSecret = void 0, redirectUri = void 0, installationStore = void 0, scopes = void 0, installerOptions = {}, customPropertiesExtractor = (_req) => ({}), dispatchErrorHandler = httpFunc.defaultDispatchErrorHandler, processEventErrorHandler = httpFunc.defaultProcessEventErrorHandler, unhandledRequestHandler = httpFunc.defaultUnhandledRequestHandler, unhandledRequestTimeoutMillis = 3001 }) {
			...
			if (clientId !== void 0 && clientSecret !== void 0 && (this.stateVerification === false || stateSecret !== void 0 || installerOptions.stateStore !== void 0)) {
		...
		start(portOrListenOptions, serverOptions = {}) {
			let createServerFn = node_http_1$2.createServer;
			if (Object.keys(serverOptions).filter((k) => httpsOptionKeys.includes(k)).length > 0) createServerFn = node_https_1$1.createServer;
			if (this.server !== void 0) return Promise.reject(new errors_1.ReceiverInconsistentStateError("The receiver cannot be started because it was already started."));
			...
			return new Promise((resolve, reject) => {
				if (this.server === void 0) throw new errors_1.ReceiverInconsistentStateError(missingServerErrorDescription);
				...
				if (portOrListenOptions !== void 0) {
					if (typeof portOrListenOptions === "number") listenOptions = portOrListenOptions;
					else if (typeof portOrListenOptions === "string") listenOptions = Number(portOrListenOptions);
					else if (typeof portOrListenOptions === "object") listenOptions = portOrListenOptions;
				}
				this.server.listen(listenOptions, () => {
					if (this.server === void 0) return reject(new errors_1.ReceiverInconsistentStateError(missingServerErrorDescription));
					return resolve(this.server);
				});
			});
		}
		stop() {
			if (this.server === void 0) return Promise.reject(new errors_1.ReceiverInconsistentStateError("The receiver cannot be stopped because it was not started."));
			return new Promise((resolve, reject) => {
				this.server?.close((error) => {
					if (error !== void 0) return reject(error);
					this.server = void 0;
					return resolve();
				});
			});
		...
		unboundRequestListener(req, res) {
			const { pathname: path } = new node_url_1$1.URL(req.url, "http://localhost");
			const method = req.method.toUpperCase();
			if (this.endpoints.includes(path) && method === "POST") return this.handleIncomingEvent(req, res);
			if (this.installer !== void 0 && method === "GET") {
				const [installPath, installRedirectUriPath] = [this.installPath, this.installRedirectUriPath];
				if (path === installPath) return this.handleInstallPathRequest(req, res);
				if (path === installRedirectUriPath) return this.handleInstallRedirectRequest(req, res);
			}
			const routes = Object.keys(this.routes);
			for (let i = 0; i < routes.length; i += 1) {
				const route = routes[i];
				const pathMatch = (0, path_to_regexp_1.match)(route, { decode: decodeURIComponent })(path);
		...
		handleIncomingEvent(req, res) {
			(async () => {
				...
				try {
					...
					const e = err;
					if (this.signatureVerification) this.logger.warn(`Failed to parse and verify the request data: ${e.message}`);
					else this.logger.warn(`Failed to parse the request body: ${e.message}`);
				...
				try {
					...
					if (ack.storedResponse !== void 0) {
						httpFunc.buildContentResponse(res, ack.storedResponse);
						this.logger.debug("stored response sent");
					}
				} catch (error) {
					if (await this.processEventErrorHandler({
						error,
						logger: this.logger,
						request: req,
						response: res,
		...
		handleInstallRedirectRequest(req, res) {
			...
			if (this.stateVerification === false) installer.handleCallback(req, res, installCallbackOptions, installUrlOptions).catch(errorHandler);
			else installer.handleCallback(req, res, installCallbackOptions).catch(errorHandler);
		}
	};
...
var require_SocketModeClient = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const web_api_1 = require_dist$5();
	const eventemitter3_1 = require_eventemitter3();
	const package_json_1 = __importDefault(require_package$1());
	const errors_1 = require_errors();
	const logger_1 = __importStar(require_logger());
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/SocketModeFunctions.js
var require_SocketModeFunctions = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	async function defaultProcessEventErrorHandler(args) {
		...
		if ((0, errors_1.isCodedError)(error) && error.code === errors_1.ErrorCode.AuthorizationError) return true;
		return false;
	}
	exports.defaultProcessEventErrorHandler = defaultProcessEventErrorHandler;
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/SocketModeResponseAck.js
var require_SocketModeResponseAck = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.SocketModeResponseAck = void 0;
	var SocketModeResponseAck = class {
		logger;
		isAcknowledged;
		socketModeClientAck;
		constructor(args) {
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/SocketModeReceiver.js
var require_SocketModeReceiver = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	const node_http_1$1 = __require("node:http");
	const node_url_1 = __require("node:url");
	const logger_1 = require_dist$4();
	const oauth_1 = require_dist$3();
	const socket_mode_1 = require_src();
	const path_to_regexp_1 = require_dist$2();
	const SocketModeFunctions_1 = require_SocketModeFunctions();
	const SocketModeResponseAck_1 = require_SocketModeResponseAck();
	const custom_routes_1 = require_custom_routes();
	const verify_redirect_opts_1 = require_verify_redirect_opts();
	/**
	* Receives Events, Slash Commands, and Actions of a web socket connection
	*/
	var SocketModeReceiver = class {
		client;
		app;
		logger;
		installer = void 0;
		...
		routes;
		processEventErrorHandler;
		constructor({ appToken, logger = void 0, logLevel = logger_1.LogLevel.INFO, clientId = void 0, clientSecret = void 0, stateSecret = void 0, redirectUri = void 0, installationStore = void 0, scopes = void 0, installerOptions = {}, customRoutes = [], customPropertiesExtractor = (_args) => ({}), processEventErrorHandler = SocketModeFunctions_1.defaultProcessEventErrorHandler }) {
			...
			if (clientId !== void 0 && clientSecret !== void 0 && (installerOptions.stateVerification === false || stateSecret !== void 0 || installerOptions.stateStore !== void 0)) this.installer = new oauth_1.InstallProvider({
				clientId,
				clientSecret,
				stateSecret,
				installationStore,
			...
			if (this.installer !== void 0 || customRoutes.length) {
				const installPath = installerOptions.installPath === void 0 ? "/slack/install" : installerOptions.installPath;
				this.httpServerPort = installerOptions.port === void 0 ? 3e3 : installerOptions.port;
				this.httpServer = (0, node_http_1$1.createServer)(async (req, res) => {
					const method = req.method.toUpperCase();
					if (this.installer) {
						...
						const redirectUriPath = installerOptions.redirectUriPath === void 0 ? "/slack/oauth_redirect" : installerOptions.redirectUriPath;
						if (req.url?.startsWith(redirectUriPath)) {
							const { stateVerification, callbackOptions } = installerOptions;
							if (stateVerification === false) await this.installer.handleCallback(req, res, callbackOptions, installUrlOptions);
							else await this.installer.handleCallback(req, res, callbackOptions);
							return;
						}
				...
				if (this.installer) this.logger.debug(`Go to http://localhost:${this.httpServerPort}${installPath} to initiate OAuth flow`);
			}
			this.client.on("slack_event", async (args) => {
				const { body, retry_num, retry_reason } = args;
				const event = {
					body,
					ack: new SocketModeResponseAck_1.SocketModeResponseAck({
						logger: this.logger,
		...
		start() {
			if (this.httpServer !== void 0) this.httpServer.listen(this.httpServerPort);
			return this.client.start();
		}
		stop() {
			if (this.httpServer !== void 0) this.httpServer.close((error) => {
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/utilities.js
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/middleware.js
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/actions/block-action.js
var require_block_action = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/actions/interactive-message.js
var require_interactive_message = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/actions/dialog-action.js
var require_dialog_action = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/actions/workflow-step-edit.js
var require_workflow_step_edit = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/actions/index.js
var require_actions = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	__exportStar(require_interactive_message(), exports);
	__exportStar(require_dialog_action(), exports);
	__exportStar(require_workflow_step_edit(), exports);
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/command/index.js
var require_command = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/events/index.js
...
*/
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/options/index.js
var require_options = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/view/index.js
var require_view = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/receiver.js
var require_receiver = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/shortcuts/global-shortcut.js
var require_global_shortcut = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/shortcuts/message-shortcut.js
var require_message_shortcut = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/shortcuts/index.js
var require_shortcuts = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/types/index.js
var require_types = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	__exportStar(require_events$1(), exports);
	__exportStar(require_options(), exports);
	__exportStar(require_view(), exports);
	__exportStar(require_receiver(), exports);
	__exportStar(require_shortcuts(), exports);
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/package.json
var require_package = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		...
		"bugs": { "url": "https://github.com/slackapi/bolt-js/issues" },
		"dependencies": {
			"@slack/logger": "^4.0.0",
			"@slack/oauth": "^3.0.4",
		...
		"peerDependencies": { "@types/express": "^5.0.0" }
	};
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/App.js
var require_App = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.LogLevel = void 0;
	const node_util_1 = __importDefault(__require("node:util"));
	const logger_1 = require_dist$4();
	const web_api_1 = require_dist$5();
	const axios_1 = __importDefault(require_axios());
	const CustomFunction_1 = require_CustomFunction();
	const conversation_store_1 = require_conversation_store();
	const errors_1 = require_errors$2();
	const helpers_1 = require_helpers();
	const builtin_1 = require_builtin();
	const process_1 = __importDefault(require_process());
	const HTTPReceiver_1 = __importDefault(require_HTTPReceiver());
	const SocketModeReceiver_1 = __importDefault(require_SocketModeReceiver());
	...
	var WebClientPool = class {
		pool = {};
		getOrCreate(token, clientOptions) {
			const cachedClient = this.pool[token];
			if (typeof cachedClient !== "undefined") return cachedClient;
	...
	*/
	var App = class {
		...
		initialized;
		attachFunctionToken;
		constructor({ signingSecret = void 0, endpoints = void 0, port = void 0, customRoutes = void 0, agent = void 0, clientTls = void 0, receiver = void 0, convoStore = void 0, token = void 0, appToken = void 0, botId = void 0, botUserId = void 0, authorize = void 0, logger = void 0, logLevel = void 0, ignoreSelf = true, clientOptions = void 0, processBeforeResponse = false, signatureVerification = true, clientId = void 0, clientSecret = void 0, stateSecret = void 0, redirectUri = void 0, installationStore = void 0, scopes = void 0, installerOptions = void 0, socketMode = void 0, developerMode = false, tokenVerificationEnabled = true, extendedErrorHandler = false, deferInitialization = false, attachFunctionToken = true } = {}) {
			...
			if (typeof this.logLevel !== "undefined" && this.logger.getLevel() !== this.logLevel) this.logger.setLevel(this.logLevel);
			...
			this.clientOptions = clientOptions !== void 0 ? clientOptions : {};
			if (agent !== void 0 && this.clientOptions.agent === void 0) this.clientOptions.agent = agent;
			if (clientTls !== void 0 && this.clientOptions.tls === void 0) this.clientOptions.tls = clientTls;
			if (logLevel !== void 0 && logger === void 0) this.clientOptions.logLevel = logLevel;
			else this.clientOptions.logger = this.logger;
			...
			if (socketMode && port !== void 0 && this.installerOptions.port === void 0) this.installerOptions.port = port;
			if (this.developerMode && this.installerOptions && (typeof this.installerOptions.callbackOptions === "undefined" || typeof this.installerOptions.callbackOptions !== "undefined" && typeof this.installerOptions.callbackOptions.failure === "undefined")) {
				...
				this.installerOptions.callbackOptions = { failure: (error, _installOptions, _req, res) => {
			...
			if (token !== void 0) argAuthorization = {
				botId,
				botUserId,
				botToken: token
			};
			...
			if (ignoreSelf) this.use(builtin_1.ignoreSelf);
			if (convoStore !== false) {
				const store = convoStore === void 0 ? new conversation_store_1.MemoryStore() : convoStore;
		...
		async init() {
			...
			try {
				...
				if (initializedAuthorize !== void 0) {
					this.authorize = initializedAuthorize;
					return;
				}
				if (this.argToken !== void 0 && this.argAuthorization !== void 0) {
					...
					if (this.tokenVerificationEnabled) {
						...
						if (authTestResult.ok) authorization = {
		...
		*/
		...
		function(callbackId, ...optionOrListeners) {
			const options = (0, builtin_1.isSlackEventMiddlewareArgsOptions)(optionOrListeners[0]) ? optionOrListeners[0] : { autoAcknowledge: true };
		...
		*/
		start(...args) {
			if (!this.initialized) throw new errors_1.AppInitializationError("This App instance is not yet initialized. Call `await App#init()` before starting the app.");
		...
		event(eventNameOrPattern, ...listeners) {
			...
			if (typeof eventNameOrPattern === "string") invalidEventName = eventNameOrPattern.startsWith("message.");
			else if (eventNameOrPattern instanceof RegExp) invalidEventName = eventNameOrPattern.source.startsWith("message\\.");
			if (invalidEventName) throw new errors_1.AppInitializationError(`Although the document mentions "${eventNameOrPattern}", it is not a valid event type. Use "message" instead. If you want to filter message events, you can use event.channel_type for it.`);
		...
		message(...patternsOrMiddleware) {
			const messageMiddleware = patternsOrMiddleware.map((patternOrMiddleware) => {
				if (typeof patternOrMiddleware === "string" || node_util_1.default.types.isRegExp(patternOrMiddleware)) return (0, builtin_1.matchMessage)(patternOrMiddleware);
		...
		shortcut(callbackIdOrConstraints, ...listeners) {
			const constraints = typeof callbackIdOrConstraints === "string" || node_util_1.default.types.isRegExp(callbackIdOrConstraints) ? { callback_id: callbackIdOrConstraints } : callbackIdOrConstraints;
		...
		action(actionIdOrConstraints, ...listeners) {
			const constraints = typeof actionIdOrConstraints === "string" || node_util_1.default.types.isRegExp(actionIdOrConstraints) ? { action_id: actionIdOrConstraints } : actionIdOrConstraints;
		...
		view(callbackIdOrConstraints, ...listeners) {
			...
			if (constraints.type !== void 0 && !validViewTypes.includes(constraints.type)) {
		...
		*/
		async processEvent(event) {
			...
			if (this.developerMode) this.logger.debug(JSON.stringify(body));
			...
			let authorizeResult;
			if (type === helpers_1.IncomingEventType.Event && (0, helpers_1.isEventTypeToSkipAuthorize)(event)) authorizeResult = {
			...
			if (authorizeResult.userId === void 0 && source.userId !== void 0) authorizeResult.userId = source.userId;
			if (authorizeResult.teamId === void 0 && source.teamId !== void 0) authorizeResult.teamId = source.teamId;
			if (authorizeResult.enterpriseId === void 0 && source.enterpriseId !== void 0) authorizeResult.enterpriseId = source.enterpriseId;
			if (typeof event.customProperties !== "undefined") {
				const customProps = event.customProperties;
				if (typeof types_1.contextBuiltinKeys.find((key) => key in customProps) !== "undefined") throw new errors_1.InvalidCustomPropertyError("customProperties cannot have the same names with the built-in ones");
			}
			const context = {
				...authorizeResult,
			...
			const createSay = (channelId) => {
				...
				return (message) => {
					...
					if (typeof message === "string") postMessageArguments = {
						token,
						text: message,
						channel: channelId
					};
					else postMessageArguments = {
						...message,
						token,
						channel: channelId
					};
			...
			switch (type) {
				...
				case helpers_1.IncomingEventType.Shortcut:
					payload = bodyArg;
					break;
				case helpers_1.IncomingEventType.Action: if (isBlockActionOrInteractiveMessageBody(bodyArg)) {
			...
			if (token !== void 0) {
				...
				if (authorizeResult.teamId !== void 0) {
					pool = this.clients[authorizeResult.teamId];
					if (pool === void 0) pool = this.clients[authorizeResult.teamId] = new WebClientPool();
					clientOptionsCopy.teamId = authorizeResult.teamId;
				} else if (authorizeResult.enterpriseId !== void 0) {
					pool = this.clients[authorizeResult.enterpriseId];
					if (pool === void 0) pool = this.clients[authorizeResult.enterpriseId] = new WebClientPool();
				}
				if (this.attachFunctionToken && context.functionBotAccessToken) client = new web_api_1.WebClient(token, clientOptionsCopy);
				else if (pool !== void 0) client = pool.getOrCreate(token, clientOptionsCopy);
			}
			if (type === helpers_1.IncomingEventType.Event) {
				...
				if (context.functionExecutionId !== void 0) {
					listenerArgs.complete = (0, CustomFunction_1.createFunctionComplete)(context, client);
					listenerArgs.fail = (0, CustomFunction_1.createFunctionFail)(context, client);
			...
			if (conversationId !== void 0 && type !== helpers_1.IncomingEventType.Options) listenerArgs.say = createSay(conversationId);
			if (body.response_url) listenerArgs.respond = buildRespondFn(this.axios, body.response_url);
			else if (typeof body.response_urls !== "undefined" && body.response_urls.length > 0) listenerArgs.respond = buildRespondFn(this.axios, body.response_urls[0].response_url);
			if (type !== helpers_1.IncomingEventType.Event) listenerArgs.ack = ack;
			else if (listenerArgs.event?.type === "function_executed") listenerArgs.ack = ack;
			else await ack();
			try {
				await (0, process_1.default)(this.middleware, listenerArgs, context, client, this.logger, async () => {
					const listenerResults = this.listeners.map(async (origListenerMiddleware) => {
						...
						return (0, process_1.default)(listenerMiddleware, listenerArgs, context, client, this.logger, async () => listener({
							...listenerArgs,
							context,
							client,
							logger: this.logger,
					...
					const rejectedListenerResults = (await Promise.allSettled(listenerResults)).filter(utilities_1.isRejected);
					if (rejectedListenerResults.length === 1) throw rejectedListenerResults[0].reason;
					else if (rejectedListenerResults.length > 1) throw new errors_1.MultipleListenerError(rejectedListenerResults.map((rlr) => rlr.reason));
				});
			} catch (error) {
				const e = error;
				return this.handleError({
		...
		*/
		...
		initReceiver(receiver, signingSecret, endpoints, port, customRoutes, processBeforeResponse, signatureVerification, clientId, clientSecret, stateSecret, redirectUri, installationStore, scopes, appToken, logger) {
			if (receiver !== void 0) {
				if (this.socketMode === true && !(receiver instanceof SocketModeReceiver_1.default)) throw new errors_1.AppInitializationError("You cannot supply a custom receiver when socketMode is set to true.");
				return receiver;
			}
			if (this.socketMode === true) {
				if (appToken === void 0) throw new errors_1.AppInitializationError("You must provide an appToken when socketMode is set to true. To generate an appToken see: https://api.slack.com/apis/connections/socket#token");
			...
			if (signatureVerification === true && signingSecret === void 0) throw new errors_1.AppInitializationError("signingSecret is required to initialize the default receiver. Set signingSecret or use a custom receiver. You can find your Signing Secret in your Slack App Settings.");
		...
		initAuthorizeIfNoTokenIsGiven(token, authorize) {
			...
			if (httpReceiver.installer !== void 0 && httpReceiver.installer.authorize !== void 0) usingOauth = true;
			if (token !== void 0) {
				if (usingOauth || authorize !== void 0) throw new errors_1.AppInitializationError(`You cannot provide a token along with either oauth installer options or authorize. ${tokenUsage}`);
				return;
			}
			if (authorize === void 0 && !usingOauth) throw new errors_1.AppInitializationError(`${tokenUsage} \n\nSince you have not provided a token or authorize, you might be missing one or more required oauth installer options. See https://tools.slack.dev/bolt-js/concepts/authenticating-oauth/ for these required fields.\n`);
			else if (authorize !== void 0 && usingOauth) throw new errors_1.AppInitializationError(`You cannot provide both authorize and oauth installer options. ${tokenUsage}`);
			else if (authorize === void 0 && usingOauth) return httpReceiver.installer.authorize;
			else if (authorize !== void 0 && !usingOauth) return authorize;
		}
		initAuthorizeInConstructor(token, authorize, authorization) {
			...
			if (initializedAuthorize !== void 0) return initializedAuthorize;
			if (token !== void 0 && authorization !== void 0) return singleAuthorization(this.client, authorization, this.tokenVerificationEnabled);
			const errorMessage = `Something has gone wrong in #initAuthorizeInConstructor method (hasToken: ${token !== void 0 && token.length > 0}, authorize: ${authorize}). Please report this issue to the maintainers. https://github.com/slackapi/bolt-js/issues`;
	...
	function runAuthTestForBotToken(client, authorization) {
		return authorization.botUserId !== void 0 && authorization.botId !== void 0 ? Promise.resolve({
	...
	*/
	function buildSource(type, channelId, body, isEnterpriseInstall) {
		const teamId = (() => {
			if (type === helpers_1.IncomingEventType.Event) {
				const bodyAsEvent = body;
				if (Array.isArray(bodyAsEvent.authorizations) && bodyAsEvent.authorizations[0] !== void 0 && bodyAsEvent.authorizations[0].team_id !== null) return bodyAsEvent.authorizations[0].team_id;
				return bodyAsEvent.team_id;
			}
			if (type === helpers_1.IncomingEventType.Command) return body.team_id;
			const parseTeamId = (bodyAs) => {
				if (typeof bodyAs.team !== "undefined" && bodyAs.team !== null) return bodyAs.team.id;
				return bodyAs.user.team_id;
			};
			if (type === helpers_1.IncomingEventType.ViewAction) {
				const bodyAsView = body;
				if (bodyAsView.view.app_installed_team_id) return bodyAsView.view.app_installed_team_id;
				return parseTeamId(bodyAsView);
			}
			if (type === helpers_1.IncomingEventType.Action || type === helpers_1.IncomingEventType.Options || type === helpers_1.IncomingEventType.Shortcut) return parseTeamId(body);
			return (0, helpers_1.assertNever)(type);
		})();
		const enterpriseId = (() => {
			if (type === helpers_1.IncomingEventType.Event) {
				const bodyAsEvent = body;
				if (Array.isArray(bodyAsEvent.authorizations) && bodyAsEvent.authorizations[0] !== void 0) {
					const theId = bodyAsEvent.authorizations[0].enterprise_id;
					return theId !== null ? theId : void 0;
				}
				return bodyAsEvent.enterprise_id;
			}
			if (type === helpers_1.IncomingEventType.Command) return body.enterprise_id;
			if (type === helpers_1.IncomingEventType.Action || type === helpers_1.IncomingEventType.Options || type === helpers_1.IncomingEventType.ViewAction || type === helpers_1.IncomingEventType.Shortcut) {
				...
				if (typeof bodyAsActionOrOptionsOrViewActionOrShortcut.team !== "undefined" && bodyAsActionOrOptionsOrViewActionOrShortcut.team !== null) return bodyAsActionOrOptionsOrViewActionOrShortcut.team.enterprise_id;
				return;
			}
			return (0, helpers_1.assertNever)(type);
		})();
			...
			userId: (() => {
				if (type === helpers_1.IncomingEventType.Event) {
					...
					if ("user" in event) {
						...
						if (typeof event.user === "object") return event.user.id;
					}
					if ("channel" in event && typeof event.channel !== "string" && "creator" in event.channel) return event.channel.creator;
					if ("subteam" in event && event.subteam.created_by !== void 0) return event.subteam.created_by;
					return;
				}
				if (type === helpers_1.IncomingEventType.Action || type === helpers_1.IncomingEventType.Options || type === helpers_1.IncomingEventType.ViewAction || type === helpers_1.IncomingEventType.Shortcut) return body.user.id;
				if (type === helpers_1.IncomingEventType.Command) return body.user_id;
				return (0, helpers_1.assertNever)(type);
			})(),
			isEnterpriseInstall,
			teamId,
	...
	function isBlockActionOrInteractiveMessageBody(body) {
		return body.actions !== void 0;
	}
	function selectToken(context, attachFunctionToken) {
		if (attachFunctionToken && context.functionBotAccessToken) return context.functionBotAccessToken;
		return context.botToken !== void 0 ? context.botToken : context.userToken;
	}
	...
	function extractFunctionContext(body) {
		let functionExecutionId = void 0;
		let functionBotAccessToken = void 0;
		let functionInputs = void 0;
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/ExpressReceiver.js
var require_ExpressReceiver = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	const node_crypto_1$1 = __importDefault(__require("node:crypto"));
	const node_http_1 = __require("node:http");
	const node_https_1 = __require("node:https");
	const node_querystring_1$1 = __importDefault(__require("node:querystring"));
	const logger_1 = require_dist$4();
	const oauth_1 = require_dist$3();
	const express_1 = __importStar(__require("express"));
	const raw_body_1 = __importDefault(require_raw_body());
	const tsscmp_1 = __importDefault(require_lib());
	const errors_1 = require_errors$2();
	const httpFunc = __importStar(require_HTTPModuleFunctions());
	...
	*/
	var ExpressReceiver = class {
		...
		unhandledRequestHandler;
		unhandledRequestTimeoutMillis;
		constructor({ signingSecret = "", logger = void 0, logLevel = logger_1.LogLevel.INFO, endpoints = { events: "/slack/events" }, processBeforeResponse = false, signatureVerification = true, clientId = void 0, clientSecret = void 0, stateSecret = void 0, redirectUri = void 0, installationStore = void 0, scopes = void 0, installerOptions = {}, app = void 0, router = void 0, customPropertiesExtractor = (_req) => ({}), dispatchErrorHandler = httpFunc.defaultAsyncDispatchErrorHandler, processEventErrorHandler = httpFunc.defaultProcessEventErrorHandler, unhandledRequestHandler = httpFunc.defaultUnhandledRequestHandler, unhandledRequestTimeoutMillis = 3001 }) {
			...
			const expressMiddleware = [
				this.signatureVerification ? buildVerificationBodyParserMiddleware(this.logger, signingSecret) : buildBodyParserMiddleware(this.logger),
			...
			this.router = router !== void 0 ? router : (0, express_1.Router)();
			for (const endpoint of endpointList) this.router.post(endpoint, ...expressMiddleware);
			this.customPropertiesExtractor = customPropertiesExtractor;
			this.dispatchErrorHandler = dispatchErrorHandler;
			this.processEventErrorHandler = processEventErrorHandler;
			this.unhandledRequestHandler = unhandledRequestHandler;
			...
			if (this.installer !== void 0) {
				const { installer } = this;
				const redirectUriPath = installerOptions.redirectUriPath === void 0 ? "/slack/oauth_redirect" : installerOptions.redirectUriPath;
				const { callbackOptions, stateVerification } = installerOptions;
				this.router.use(redirectUriPath, async (req, res) => {
					try {
						if (stateVerification === false) await installer.handleCallback(req, res, callbackOptions, installUrlOptions);
						else await installer.handleCallback(req, res, callbackOptions);
					} catch (e) {
		...
		start(portOrListenOptions, serverOptions = {}) {
			...
			if (Object.keys(serverOptions).filter((k) => httpsOptionKeys.includes(k)).length > 0) createServerFn = node_https_1.createServer;
			if (this.server !== void 0) return Promise.reject(new errors_1.ReceiverInconsistentStateError("The receiver cannot be started because it was already started."));
	...
	*/
	...
	function verifyRequestSignature(signingSecret, body, signature, requestTimestamp) {
		if (signature === void 0 || requestTimestamp === void 0) throw new errors_1.ReceiverAuthenticityError("Slack request signing verification failed. Some headers are missing.");
		const ts = Number(requestTimestamp);
		if (Number.isNaN(ts)) throw new errors_1.ReceiverAuthenticityError("Slack request signing verification failed. Timestamp is invalid.");
		if (ts < Math.floor(Date.now() / 1e3) - 300) throw new errors_1.ReceiverAuthenticityError("Slack request signing verification failed. Timestamp is too old.");
		const hmac = node_crypto_1$1.default.createHmac("sha256", signingSecret);
		const [version, hash] = signature.split("=");
		hmac.update(`${version}:${ts}:${body}`);
		if (!(0, tsscmp_1.default)(hash, hmac.digest("hex"))) throw new errors_1.ReceiverAuthenticityError("Slack request signing verification failed. Signature mismatch.");
	}
	/**
	* This request handler has two responsibilities:
	* - Verify the request signature
	...
	*/
	...
	function parseRequestBody(stringBody, contentType) {
		if (contentType === "application/x-www-form-urlencoded") {
			const parsedBody = node_querystring_1$1.default.parse(stringBody);
	...
	async function parseExpressRequestRawBody(req) {
		if ("rawBody" in req && req.rawBody) return Promise.resolve(req.rawBody.toString());
		return (await (0, raw_body_1.default)(req)).toString();
	}
}));
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/receivers/AwsLambdaReceiver.js
var require_AwsLambdaReceiver = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	const node_crypto_1 = __importDefault(__require("node:crypto"));
	const node_querystring_1 = __importDefault(__require("node:querystring"));
	const logger_1 = require_dist$4();
	const tsscmp_1 = __importDefault(require_lib());
	const errors_1 = require_errors$2();
	var AwsLambdaReceiver = class {
		signingSecret;
		app;
		_logger;
		get logger() {
		...
		unhandledRequestTimeoutMillis;
		constructor({ signingSecret, logger = void 0, logLevel = logger_1.LogLevel.INFO, signatureVerification = true, customPropertiesExtractor = (_) => ({}), invalidRequestSignatureHandler, unhandledRequestTimeoutMillis = 3001 }) {
			this.signingSecret = signingSecret;
			this.signatureVerification = signatureVerification;
			this.unhandledRequestTimeoutMillis = unhandledRequestTimeoutMillis;
			this._logger = logger ?? (() => {
			...
			this.customPropertiesExtractor = customPropertiesExtractor;
			if (invalidRequestSignatureHandler) this.invalidRequestSignatureHandler = invalidRequestSignatureHandler;
			else this.invalidRequestSignatureHandler = this.defaultInvalidRequestSignatureHandler;
		}
		init(app) {
			this.app = app;
		}
		...
		toHandler() {
			return async (awsEvent, _awsContext, _awsCallback) => {
				...
				if (typeof body !== "undefined" && body != null && typeof body.ssl_check !== "undefined" && body.ssl_check != null) return Promise.resolve({
					statusCode: 200,
					body: ""
				});
				...
				if (typeof body !== "undefined" && body != null && typeof body.type !== "undefined" && body.type != null && body.type === "url_verification") return Promise.resolve({
					statusCode: 200,
				...
				const noAckTimeoutId = setTimeout(() => {
					if (!isAcknowledged) this.logger.error(`An incoming event was not acknowledged within ${this.unhandledRequestTimeoutMillis} ms. Ensure that the ack() argument is called in a listener.`);
				}, this.unhandledRequestTimeoutMillis);
				let storedResponse;
				const event = {
					body,
					ack: async (response) => {
						if (isAcknowledged) throw new errors_1.ReceiverMultipleAckError();
						isAcknowledged = true;
						clearTimeout(noAckTimeoutId);
						if (typeof response === "undefined" || response == null) storedResponse = "";
						else storedResponse = response;
					},
				...
				try {
					await this.app?.processEvent(event);
					if (storedResponse !== void 0) {
						if (typeof storedResponse === "string") return {
							statusCode: 200,
							body: storedResponse
						};
						return {
				...
				clearTimeout(noAckTimeoutId);
				let path;
				if ("path" in awsEvent) path = awsEvent.path;
				else path = awsEvent.rawPath;
		...
		getRawBody(awsEvent) {
			if (typeof awsEvent.body === "undefined" || awsEvent.body == null) return "";
			if (awsEvent.isBase64Encoded) return Buffer.from(awsEvent.body, "base64").toString("ascii");
		...
		parseRequestBody(stringBody, contentType, logger) {
			...
			if (contentType === "application/json") return JSON.parse(stringBody);
		...
		isValidRequestSignature(signingSecret, body, signature, requestTimestamp) {
			if (!signature || !requestTimestamp) return false;
			if (requestTimestamp < Math.floor(Date.now() / 1e3) - 300) return false;
			const hmac = node_crypto_1.default.createHmac("sha256", signingSecret);
			const [version, hash] = signature.split("=");
			hmac.update(`${version}:${requestTimestamp}:${body}`);
			if (!(0, tsscmp_1.default)(hash, hmac.digest("hex"))) return false;
			return true;
		}
		getHeaderValue(headers, key) {
			const caseInsensitiveKey = Object.keys(headers).find((it) => key.toLowerCase() === it.toLowerCase());
			return caseInsensitiveKey !== void 0 ? headers[caseInsensitiveKey] : void 0;
		}
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/AssistantThreadContextStore.js
var require_AssistantThreadContextStore = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.DefaultThreadContextStore = void 0;
	const Assistant_1 = require_Assistant();
	var DefaultThreadContextStore = class {
		context = {};
		async get(args) {
			const { context, client, payload, logger } = args;
			logger.debug("DefaultAssistantThreadStore: get method called");
			if (this.context.channel_id) return this.context;
			...
			return (initialMsg?.metadata ? initialMsg.metadata.event_payload : null) || {};
		}
		async save(args) {
			const { context, client, payload, logger } = args;
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/Assistant.js
var require_Assistant = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const AssistantThreadContextStore_1 = require_AssistantThreadContextStore();
	const errors_1 = require_errors$2();
	const process_1 = __importDefault(require_process());
	/** Constants */
	const ASSISTANT_PAYLOAD_TYPES = new Set([
	...
	var Assistant = class {
		...
		constructor(config) {
			validate(config);
			const { threadContextStore = new AssistantThreadContextStore_1.DefaultThreadContextStore(), threadStarted, threadContextChanged = (args) => threadContextStore.save(args), userMessage } = config;
		...
		async processEvent(args) {
			const { payload } = args;
			return processAssistantMiddleware(enrichAssistantArgs(this.threadContextStore, args), this.getAssistantMiddleware(payload));
		}
		/**
		...
		*/
		getAssistantMiddleware(payload) {
			switch (payload.type) {
				case "assistant_thread_started": return this.threadStarted;
				case "assistant_thread_context_changed": return this.threadContextChanged;
				case "message": return this.userMessage;
				default: return [];
			}
		}
	};
	...
	*/
	function isAssistantMessage(payload) {
		...
		const inAssistantContainer = "channel_type" in payload && payload.channel_type === "im" && (!("subtype" in payload) || payload.subtype === "file_share" || payload.subtype === void 0);
	...
	*/
	function validate(config) {
		if (typeof config !== "object") throw new errors_1.AssistantInitializationError("Assistant expects a configuration object as the argument");
		const requiredKeys = ["threadStarted", "userMessage"];
		const missingKeys = [];
		for (const key of requiredKeys) if (config[key] === void 0) missingKeys.push(key);
		if (missingKeys.length > 0) {
		...
		for (const fn of requiredFns) if (typeof config[fn] !== "function" && !Array.isArray(config[fn])) {
			const errorMsg = `Assistant ${fn} property must be a function or an array of functions`;
			throw new errors_1.AssistantInitializationError(errorMsg);
		}
		if (config.threadContextStore) {
			if (typeof config.threadContextStore !== "object") throw new errors_1.AssistantInitializationError("Assistant expects threadContextStore to be a configuration object");
			const requiredContextKeys = ["get", "save"];
			const missingContextKeys = [];
			for (const k of requiredContextKeys) if (config.threadContextStore && config.threadContextStore[k] === void 0) missingContextKeys.push(k);
			if (missingContextKeys.length > 0) {
				const errorMsg = `threadContextStore is missing required keys: ${missingContextKeys.join(", ")}`;
				throw new errors_1.AssistantInitializationError(errorMsg);
			}
			for (const fn of ["get", "save"]) if (config.threadContextStore && typeof config.threadContextStore[fn] !== "function") {
	...
	*/
	async function processAssistantMiddleware(args, middleware) {
		...
		if (lastCallback !== void 0) await (0, process_1.default)(callbacks, args, context, client, logger, async () => lastCallback({
			...args,
			context,
			client,
			logger
	...
	*/
	function createSay(args) {
		...
		return async (message) => {
			...
			const postMessageArgument = typeof message === "string" ? {
				text: message,
				channel,
				thread_ts
			} : {
			...
			if (threadContext || postMessageArgument.metadata) postMessageArgument.metadata = {
	...
	*/
	function createSetStatus(args) {
		...
		return (status) => {
			if (typeof status === "string") return client.assistant.threads.setStatus({
				channel_id,
				thread_ts,
				status
			});
	...
	*/
	function extractThreadInfo(payload) {
		...
		let threadTs = "";
		let context = {};
		if ("assistant_thread" in payload && payload.assistant_thread && typeof payload.assistant_thread.channel_id === "string" && typeof payload.assistant_thread.thread_ts === "string") {
			channelId = payload.assistant_thread.channel_id;
			threadTs = payload.assistant_thread.thread_ts;
			if (typeof payload.assistant_thread.context === "object" && payload.assistant_thread.context !== null) context = payload.assistant_thread.context;
		}
		if ("channel" in payload && "thread_ts" in payload && payload.thread_ts !== void 0) {
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/WorkflowStep.js
var require_WorkflowStep = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __importDefault = exports && exports.__importDefault || function(mod) {
		return mod && mod.__esModule ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	const process_1 = __importDefault(require_process());
	/** Constants */
	const VALID_PAYLOAD_TYPES = new Set([
		"workflow_step_edit",
		"workflow_step",
	...
	*/
	var WorkflowStep = class {
		...
		getMiddleware() {
			return async (args) => {
				if (isStepEvent(args) && this.matchesConstraints(args)) return this.processEvent(args);
				return args.next();
			};
		}
		...
		async processEvent(args) {
			const { payload } = args;
			return processStepMiddleware(prepareStepArgs(args), this.getStepMiddleware(payload));
		}
		getStepMiddleware(payload) {
			switch (payload.type) {
				case "workflow_step_edit": return this.edit;
				case "workflow_step": return this.save;
				case "workflow_step_execute": return this.execute;
				default: return [];
			}
		}
	};
	...
	*/
	function validate(callbackId, config) {
		if (typeof callbackId !== "string") throw new errors_1.WorkflowStepInitializationError("WorkflowStep expects a callback_id as the first argument");
		if (typeof config !== "object") throw new errors_1.WorkflowStepInitializationError("WorkflowStep expects a configuration object as the second argument");
		const requiredKeys = [
			"save",
			"edit",
			"execute"
...
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/block-kit/block-elements.js
var require_block_elements = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/block-kit/blocks.js
var require_blocks = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/block-kit/composition-objects.js
var require_composition_objects = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/block-kit/extensions.js
var require_extensions = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/calls.js
var require_calls = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/chunk.js
var require_chunk = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/dialog.js
var require_dialog = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/app.js
var require_app = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/assistant.js
var require_assistant = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/call.js
var require_call = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/channel.js
var require_channel = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/dnd.js
var require_dnd = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/email.js
var require_email = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/emoji.js
var require_emoji = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/file.js
var require_file = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/function.js
var require_function = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/grid-migration.js
var require_grid_migration = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/group.js
var require_group = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/im.js
var require_im = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/invite.js
var require_invite = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/link-shared.js
var require_link_shared = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/member.js
var require_member = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/message.js
var require_message = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/message-metadata.js
var require_message_metadata$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/pin.js
var require_pin = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/reaction.js
var require_reaction = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/shared-channel.js
var require_shared_channel = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/star.js
var require_star = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/steps-from-apps.js
var require_steps_from_apps = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/subteam.js
var require_subteam = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/team.js
var require_team = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/token.js
var require_token = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/user.js
var require_user = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/events/index.js
var require_events = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	__exportStar(require_message_metadata$1(), exports);
...
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/message-attachments.js
var require_message_attachments = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/message-metadata.js
var require_message_metadata = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/views.js
var require_views = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/.pnpm/@slack+types@2.20.0/node_modules/@slack/types/dist/index.js
...
//#endregion
//#region node_modules/.pnpm/@slack+bolt@4.6.0_@types+express@5.0.6/node_modules/@slack/bolt/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.webApi = exports.types = exports.FileInstallationStore = exports.MemoryInstallationStore = exports.WorkflowStep = exports.Assistant = exports.buildReceiverRoutes = exports.MemoryStore = exports.defaultProcessEventErrorHandler = exports.HTTPResponseAck = exports.HTTPModuleFunctions = exports.AwsLambdaReceiver = exports.HTTPReceiver = exports.SocketModeReceiver = exports.ExpressReceiver = exports.isValidSlackRequest = exports.verifySlackRequest = exports.App = exports.LogLevel = void 0;
	const App_1 = __importDefault(require_App());
	exports.App = App_1.default;
	var App_2 = require_App();
	Object.defineProperty(exports, "LogLevel", {
		enumerable: true,
		get: function() {
			return App_2.LogLevel;
		}
	});
	exports.default = App_1.default;
	var verify_request_1 = require_verify_request();
	...
	var ExpressReceiver_1 = require_ExpressReceiver();
	...
	var SocketModeReceiver_1 = require_SocketModeReceiver();
	...
	var HTTPReceiver_1 = require_HTTPReceiver();
	...
	var AwsLambdaReceiver_1 = require_AwsLambdaReceiver();
	...
	exports.HTTPModuleFunctions = __importStar(require_HTTPModuleFunctions());
	var HTTPResponseAck_1 = require_HTTPResponseAck();
	...
	Object.defineProperty(exports, "defaultProcessEventErrorHandler", {
		enumerable: true,
		get: function() {
			return SocketModeFunctions_1.defaultProcessEventErrorHandler;
		}
	});
	__exportStar(require_errors$2(), exports);
	__exportStar(require_builtin(), exports);
	__exportStar(require_types(), exports);
	var conversation_store_1 = require_conversation_store();
	...
	var custom_routes_1 = require_custom_routes();
	...
	exports.types = __importStar(require_dist$1());
	exports.webApi = __importStar(require_dist$5());
}));
//#endregion
...
async function dispatchPreparedSlackMessage(prepared) {
	...
	const { dispatcher, replyOptions, markDispatchIdle } = createReplyDispatcherWithTyping({
		...
		deliver: async (payload) => {
			...
			if (previewStreamingEnabled && streamMode !== "status_final" && !reply.hasMedia && !payload.isError && (trimmedFinalText.length > 0 || Boolean(slackBlocks?.length)) && typeof draftMessageId === "string" && typeof draftChannelId === "string") {
				draftStream?.stop();
				try {
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-BgE-jAn0.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-C7Db5ylu.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-BpIBuQEN.js");
...
const { App, HTTPReceiver } = resolveSlackBoltInterop({
	defaultImport: import_dist.default,
	namespaceImport: import_dist
});
...
//#endregion
export { listSlackDirectoryPeersLive as i, monitorSlackProvider as n, listSlackDirectoryGroupsLive as r, probeSlack as t };

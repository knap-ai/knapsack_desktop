...
import { f as resolveAuthStorePathForDisplay, n as ensureAuthProfileStore } from "./store-CY-e50gT.js";
...
import { n as formatXHighModelHint } from "./thinking.shared-B8IAgSi8.js";
import { h as resolveConfiguredModelRef, l as modelKey, v as resolveModelRefFromString } from "./model-selection-8a6zD_aX.js";
import { a as resolveAgentDir, i as resolveAgentConfig, v as resolveSessionAgentId } from "./agent-scope-CYXg_wTS.js";
import { i as coerceSecretRef } from "./types.secrets-DTXJhyWe.js";
import { n as resolveAuthProfileOrder, s as isProfileInCooldown } from "./order-CJ_D8C7W.js";
import { d as updateSessionStore } from "./store-BGmy-Wot.js";
import "./sessions-DC7OiAdD.js";
import { t as resolveEnvApiKey } from "./model-auth-env-Cr_twdPk.js";
import { C as resolveFastModeState, o as refreshQueuedFollowupSession, t as resolveQueueSettings } from "./queue-CrmMgtZc.js";
...
import { l as resolveUsableCustomProviderApiKey } from "./model-auth-BxuwOp1l.js";
import { h as resolveExecTarget, n as resolveSelectedAndActiveModel, p as renderExecTargetLabel } from "./model-runtime-D4KJqIwp.js";
...
import { a as buildBrowseProvidersButton, i as resolveModelsCommandReply } from "./commands-models-C7cfE2pl.js";
...
import { r as formatRemainingShort } from "./auth-health-C5tf25Tf.js";
...
function resolveExecDefaults(params) {
	...
	const host = params.sessionEntry?.execHost ?? agentExec?.host ?? globalExec?.host ?? "auto";
	return {
		host,
...
async function handleDirectiveOnly(params) {
	...
	if (directives.hasFastDirective && directives.fastMode === void 0) {
		if (!directives.rawFastMode || directives.rawFastMode.toLowerCase() === "status") return { text: withOptions(`Current fast mode: ${effectiveFastMode ? "on" : "off"}${effectiveFastModeSource === "config" ? " (config)" : effectiveFastModeSource === "default" ? " (default)" : ""}.`, "status, on, off") };

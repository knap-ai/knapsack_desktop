...
import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as readStringValue, l as normalizeOptionalStringifiedId, s as normalizeOptionalLowercaseString } from "./string-coerce-C1IzJjqi.js";
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-CfZ08GnU.js";
import { b as truncateUtf16Safe, l as isRecord$1, m as resolveUserPath } from "./utils-BMRcljdi.js";
...
import { t as logDebug } from "./logger-bvytzgs1.js";
import { n as resolveManifestContractOwnerPluginId, t as loadPluginManifestRegistry } from "./manifest-registry-pYrbrdHJ.js";
...
import { a as loadConfig, o as parseConfigJson5, v as resolveConfigSnapshotHash } from "./io-Dv_xNAZB.js";
import { c as parseThreadSessionSuffix, o as parseAgentSessionKey } from "./session-key-utils-BT0y7mVK.js";
import { n as normalizeAccountId } from "./account-id-C3j_3_su.js";
import { c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-EpIbK3Oz.js";
import { r as normalizeProviderId } from "./provider-id-BLh32HP1.js";
import { o as normalizeChannelId } from "./registry-B9khhdbq.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-B2TRwbJD.js";
import { i as applyMergePatch } from "./schema-validator-BKDxqOUA.js";
import { u as selectApplicableRuntimeConfig } from "./runtime-snapshot-C5PRsFS9.js";
...
import { _ as resolveAgentConfig, b as resolveAgentWorkspaceDir, m as resolveSessionAgentIds, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-_6dFncNS.js";
import { t as parseDurationMs } from "./parse-duration-DH3x5y_9.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-CSaG5vJt.js";
import { n as isRestartEnabled } from "./commands.flags-w1EXgeVc.js";
import "./config-yDDhhyz6.js";
import { h as GATEWAY_CLIENT_MODES, m as GATEWAY_CLIENT_IDS, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-3ccLmc54.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-AqnPMQnc.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-CaCkOLoa.js";
import "./plugins-BZ_I3cWH.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-C1HXSRlX.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BVdekRwH.js";
import { b as normalizeModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as modelKey } from "./model-selection-shared-grYiFZof.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-hTT37jzm.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CkOd5v2f.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-Btrjl2l2.js";
import { r as loadModelCatalog } from "./model-catalog-CcBUIGOS.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-BQ5UBGfb.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-DvU8Tgvw.js";
...
import { t as extractDeliveryInfo } from "./sessions-DIdqAx7y.js";
import { n as resolveSessionConversationRef } from "./session-conversation-Dm8mOmqO.js";
import { n as capArrayByJsonBytes, o as readSessionTitleFieldsFromTranscript, p as jsonUtf8Bytes } from "./session-utils.fs-BDLex3kU.js";
import { f as resolveSessionModelIdentityRef, t as deriveSessionTitle } from "./session-utils-0WhEvb4B.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-C_v_J0E7.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-Zn7U6BSf.js";
import { A as describeSessionsListTool, C as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, D as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, E as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, M as describeSessionsSpawnTool, N as describeUpdatePlanTool, O as describeSessionStatusTool, S as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, T as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, j as describeSessionsSendTool, k as describeSessionsHistoryTool, w as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, y as CRON_TOOL_DISPLAY_SUMMARY } from "./tool-policy-DArLXMH2.js";
import { r as resolvePluginTools } from "./tools-CZr3orc0.js";
import { w as textToSpeech } from "./tts-VTd__uez.js";
import { p as extractTextFromChatContent } from "./sanitize-user-facing-text-BDMAKrLb.js";
import { a as getImageMetadata } from "./image-ops-DFAxz8Ri.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-CE0bWSrm.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-SKQWPWlq.js";
import { a as listChannelSupportedActions, r as listAllChannelSupportedActions } from "./channel-tools-DeYKQo13.js";
import { r as getApiKeyForModel } from "./model-auth-Di2YDk33.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-DjhWl8zC.js";
import { t as SsrFBlockedError } from "./ssrf-MkDHylX_.js";
import { u as parseReplyDirectives } from "./payloads-YFQezhXJ.js";
import { n as runWithImageModelFallback } from "./model-fallback-CHc4qFzF.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-4z6MTScR.js";
import { t as extractAssistantText } from "./pi-embedded-utils-MBVK794z.js";
import { r as callGateway } from "./call-Gv9tybWD.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-B4WrK_Ib.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-ChidttH0.js";
import { g as writeFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError, u as readFileWithinRoot } from "./fs-safe-CezDxq3P.js";
import { t as isWindowsDrivePath } from "./archive-path-BDaI7bPv.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-DTMBM8Rh.js";
import { n as assertSandboxPath } from "./sandbox-paths-11MZW8so.js";
import { c as resolveWorkspaceRoot, d as toRelativeWorkspacePath, s as normalizeWorkspaceDir } from "./read-capability-NRo6-_mG.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata } from "./runtime-rZgU3obN.js";
import "./delivery-context-CEfA2BWP.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-5TiaOW1T.js";
...
import { a as resolveDisplaySessionKey, c as resolveSessionReference, i as resolveSandboxedSessionToolContext, l as resolveVisibleSessionReference, n as deriveChannel, o as resolveInternalSessionKey, r as resolveSessionToolContext, s as resolveMainSessionAlias, t as classifySessionKind, u as shouldResolveSessionIdInput } from "./sessions-helpers-BBstmhzg.js";
import { r as stripToolMessages } from "./chat-history-text-Di3xj5tF.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-8RYOZvGZ.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BT2K9A8q.js";
...
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-BeXIJGUe.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-WIpFQ1d8.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-C2S8RnSi.js";
import { t as inferLegacyName } from "./normalize-D6fIgRu7.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-GrfNsneR.js";
import { d as writeRestartSentinel, n as buildRestartSuccessContinuation, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile } from "./restart-sentinel-C0D17vX5.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-BEePx4vW.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Bm3QYlyr.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-jGQ_-hxv.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Bs-fdato.js";
import { n as resolveConfiguredMediaMaxBytes } from "./configured-max-bytes-y3bQz4xu.js";
import { l as saveMediaBuffer } from "./store-B9O3InEv.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-r3yk8NLU.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CA1OunRg.js";
import { a as coerceImageModelConfig, c as resolveProviderVisionModelFromConfig, d as hasAuthForProvider, f as hasToolModelConfig, l as buildToolModelConfigFromCandidates, n as isMinimaxVlmProvider, o as decodeDataUrl, p as resolveDefaultModelRef, u as coerceToolModelConfig } from "./minimax-vlm-wLVAvt_v.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-B9X1-tSa.js";
import { b as resolveAutoMediaKeyProviders, w as getMediaUnderstandingProvider, x as resolveDefaultMediaModel, y as providerSupportsNativePdfDocument } from "./resolve-uanx1GVd.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-tqu_Maks.js";
import { t as buildProviderRegistry } from "./runner-DxwBmbs2.js";
import "./media-understanding-CQEEIK7j.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-B1bkqhG_.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CDSwZO_q.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-5rfgNL2Q.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-XHSiiyAO.js";
import { t as sendMessage } from "./message-C1nEanJA.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-BSHeg81Q.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-BpeZ-O_G.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-CfMmk4Zz.js";
...
import { a as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-D2eWnRin.js";
import "./task-registry-delivery-runtime-cJwevSqS.js";
import { t as formatAgentInternalEventsForPrompt } from "./internal-events-C_Gw-Kkr.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-Bem23fvt.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CNCokGPz.js";
import { t as parseTimeoutMs } from "./parse-timeout-CHQvQw9J.js";
import { t as extractPdfContent } from "./pdf-extract-CBOjF7uM.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DIP-LQp_.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CN9Sdqx6.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-D62u4fEs.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-DRGolfg3.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, n as readLatestAssistantReply, r as readLatestAssistantReplySnapshot } from "./run-wait-49CgZWUJ.js";
import { d as runAgentStep, f as ANNOUNCE_SKIP_TOKEN, h as isReplySkip, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-announce-output-D4bBoO2Y.js";
import { p as registerSubagentRun } from "./subagent-registry-Cx_UMX3T.js";
import { n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-BxkfDpwx.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-Bo28iIzz.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-BrXDBBlp.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-DRp677-D.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-BE1x6zAF.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BNyMCWFo.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-CeKhNFZo.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-qxtsbeaw.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-I_0Jr7ES.js";
import { a as runWebSearch, i as resolveWebSearchDefinition } from "./runtime-CWcUaGyA.js";
import "./web-search-provider-common-R-M-_9hO.js";
...
function hasCronCreateSignal(value) {
	return value.schedule !== void 0 || value.payload !== void 0 || value.message !== void 0 || value.text !== void 0;
}
...
async function getRuntime() {
	if (!runtimeMod) runtimeMod = await import("./embedded-gateway-stub.runtime-DDuarG2e.js");
	return runtimeMod;
}
...
const SUPPORTED_OPENAI_BACKGROUNDS = [
	"transparent",
	"opaque",
	"auto"
];
...
const ImageGenerateToolSchema = Type.Object({
	...
	model: Type.Optional(Type.String({ description: "Optional provider/model override, e.g. openai/gpt-image-2." })),
	...
	openai: Type.Optional(Type.Object({
		background: optionalStringEnum(SUPPORTED_OPENAI_BACKGROUNDS, { description: "OpenAI-only background hint: transparent, opaque, or auto." }),
...
function normalizeOpenAIBackground(raw) {
	const normalized = raw?.trim().toLowerCase();
	if (!normalized) return;
	if (SUPPORTED_OPENAI_BACKGROUNDS.includes(normalized)) return normalized;
...
function buildMessageToolDescription(options) {
	...
	if (currentChannel && messageToolDiscoveryParams) {
		...
		if (channelActions.length > 0) {
			...
			for (const plugin of listChannelPlugins()) {
				if (plugin.id === currentChannel) continue;
				const actions = listCrossChannelSchemaSupportedMessageActions(buildMessageActionDiscoveryInput(messageToolDiscoveryParams, plugin.id));
				if (actions.length > 0) {
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./session-status.runtime-pFj7Q5Un.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-GfQsJ3MY.js");
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-CDcqPILD.js");
...
function resolveBundledWebContentExtractorCompatPluginIds(params) {
	...
	return loadPluginManifestRegistry({
		...
		env: params.env
	}).plugins.filter((plugin) => plugin.origin === "bundled" && (!onlyPluginIdSet || onlyPluginIdSet.has(plugin.id)) && (plugin.contracts?.webContentExtractors?.length ?? 0) > 0).map((plugin) => plugin.id).toSorted((left, right) => left.localeCompare(right));
}
...
async function loadWebFetchRuntime() {
	webFetchRuntimePromise ??= import("./runtime-DmGd90SN.js");
	return await webFetchRuntimePromise;
}
async function loadWebGuardedFetch() {
	webGuardedFetchPromise ??= import("./web-guarded-fetch-DaPlgVXr.js");

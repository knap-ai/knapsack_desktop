...
import { I as requireOpenAllowFrom, b as ReplyRuntimeConfigSchemaShape, h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "./zod-schema.core-BR1v7ukx.js";
...
import { r as deliverFormattedTextWithAttachments } from "./reply-payload-COWCxmsk.js";
import { t as clearAccountEntryFields } from "./config-helpers-CsJ8cmDG.js";
import { l as createScopedDmSecurityResolver, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-D7luFLJH.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-CZjBtZxE.js";
import { t as convertMarkdownTables } from "./tables-BHEdR14m.js";
import "./text-runtime-B1c54bxG.js";
import { r as describeWebhookAccountSnapshot, s as resolveMergedAccountConfig, t as createAccountListHelpers } from "./account-helpers-BXEoBg1h.js";
...
import { i as createChatChannelPlugin } from "./core-C7AkvHZx.js";
...
import { v as createAllowlistProviderRouteAllowlistWarningCollector } from "./channel-policy-z64fOzIr.js";
...
import { J as setSetupChannelEnabled, f as createStandardChannelSetupStatus, j as promptParsedAllowFromForAccount, v as mergeAllowFromEntries, z as resolveSetupAccountId } from "./setup-wizard-helpers-B8Qrpsoj.js";
import "./channel-targets-Cnyzt4b1.js";
import { i as createPairingPrefixStripper, n as createChannelPairingController, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-DF6gWII4.js";
import { d as createDefaultChannelRuntimeState, s as buildWebhookChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Jbf-oZqp.js";
...
import "./setup-runtime-BlAaSkSz.js";
import "./setup-tools-D8G7pP_W.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-452MOY8n.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-6zM7eEzu.js";
import { t as requireRuntimeConfig } from "./config-runtime-Dutm3Ah0.js";
import { n as dispatchInboundReplyWithBase } from "./inbound-reply-dispatch-C2ZcRBQy.js";
import { f as ssrfPolicyFromPrivateNetworkOptIn, r as createLegacyPrivateNetworkDoctorContract } from "./ssrf-policy-fyM1MW87.js";
import "./ssrf-runtime-DjO5-xxH.js";
import "./secret-file-runtime-S7myzm5R.js";
import { f as requireChannelOpenAllowFrom, h as runStoppablePassiveMonitor, m as resolveLoggerBackedRuntime } from "./extension-shared-Q-mKNOcc.js";
import "./channel-plugin-common-sL_tiHFP.js";
import "./channel-lifecycle-BDUDmCw3.js";
import { t as createClaimableDedupe } from "./persistent-dedupe-DA7VEhEi.js";
import { t as zod_exports } from "./zod-DNylboy1.js";
import { t as getNextcloudTalkRuntime } from "./runtime-api-V5AFGIwA.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Cu-Kql4e.js";
...
const NextcloudTalkRoomSchema = zod_exports.z.object({
...
const NextcloudTalkNetworkSchema = zod_exports.z.object({ dangerouslyAllowPrivateNetwork: zod_exports.z.boolean().optional() }).strict().optional();
const NextcloudTalkAccountSchemaBase = zod_exports.z.object({
	name: zod_exports.z.string().optional(),
	enabled: zod_exports.z.boolean().optional(),
	markdown: MarkdownConfigSchema,
	baseUrl: zod_exports.z.string().optional(),
	botSecret: buildSecretInputSchema().optional(),
	botSecretFile: zod_exports.z.string().optional(),
	apiUser: zod_exports.z.string().optional(),
	apiPassword: buildSecretInputSchema().optional(),
	apiPasswordFile: zod_exports.z.string().optional(),
	...
	webhookPublicUrl: zod_exports.z.string().optional(),
	allowFrom: zod_exports.z.array(zod_exports.z.string()).optional(),
	groupAllowFrom: zod_exports.z.array(zod_exports.z.string()).optional(),
	groupPolicy: GroupPolicySchema.optional().default("allowlist"),
	rooms: zod_exports.z.record(zod_exports.z.string(), NextcloudTalkRoomSchema.optional()).optional(),
...
const NextcloudTalkConfigSchema = NextcloudTalkAccountSchemaBase.extend({
	accounts: zod_exports.z.record(zod_exports.z.string(), NextcloudTalkAccountSchema.optional()).optional(),

...
import { r as isInternalMessageChannel, u as normalizeMessageChannel } from "./message-channel-C2Lnao8s.js";
...
function resolveCommandAuthorization(params) {
	...
	const isAuthorizedSender = resolveCommandSenderAuthorization({
		commandAuthorized,
		isOwnerForCommands: !(enforceOwner || ownerAllowlistConfigured) ? true : ownerState.ownerAllowAll ? true : ownerAllowlistConfigured ? senderIsOwner : senderIsOwnerByScope || Boolean(matchedCommandOwner),
		senderCandidates,

import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName, r as GATEWAY_SERVICE_MARKER } from "./constants-Clj4_p8-.js";
import { r as resolveHomeDir } from "./runtime-parse-DSaZz1Oy.js";
import { a as execSchtasks } from "./service-BaabAHxx.js";
...
function isLegacyLabel(label) {
	return label.toLowerCase().includes("clawdbot");
}

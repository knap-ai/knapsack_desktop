...
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-pGqC7ROI.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-CwrAI6Ec.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BVhjPMoF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
async function loadBotFrameworkJwtDeps() {
	botFrameworkJwtDepsPromise ??= Promise.all([import("./jsonwebtoken-CJ_qFTpM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-sLilRSfL.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([jwt, { JwksClient }]) => ({
		jwt,
		JwksClient
	}));

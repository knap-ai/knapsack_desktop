...
import { B as resolveUserPath, D as clampInt, O as clampNumber, l as createSubsystemLogger, q as truncateUtf16Safe } from "./exec-DBtWJ4Ld.js";
import { n as resolveAgentConfig, r as resolveAgentDir$1, s as resolveAgentWorkspaceDir } from "./agent-scope-xZu8sXcF.js";
import { i as resolveApiKeyForProvider, q as isTruthyEnvValue, r as requireApiKey } from "./model-auth-BffKC6OJ.js";
import { n as formatErrorMessage } from "./errors-Daa2hz8x.js";
import { o as resolveSessionTranscriptsDirForAgent } from "./paths-CpGplyYJ.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-JGGQViao.js";
import { a as buildFileEntry, c as ensureDir, d as listMemoryFiles, f as normalizeExtraMemoryPaths, h as runWithConcurrency$2, i as sessionPathForFile, l as hashText, m as remapChunkLines, n as buildSessionEntry, o as chunkMarkdown, p as parseEmbedding, r as listSessionFilesForAgent, s as cosineSimilarity, t as requireNodeSqlite, u as isMemoryPath } from "./sqlite-Dashr12i.js";
import { n as retryAsync } from "./retry-BhlI4gtw.js";
...
var MemoryManagerSyncOps = class {
	...
	ensureWatcher() {
		...
		const additionalPaths = normalizeExtraMemoryPaths(this.workspaceDir, this.settings.extraPaths).map((entry) => {
			try {
				return fs$1.lstatSync(entry).isSymbolicLink() ? null : entry;
			} catch {
				return null;
			}

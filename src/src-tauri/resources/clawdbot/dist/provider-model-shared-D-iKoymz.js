...
import "./provider-attribution-DMdhUxEe.js";
...
import "./moonshot-thinking-stream-wrappers-BWKJoBJT.js";
...
function buildProviderReplayFamilyHooks(options) {
	switch (options.family) {
		case "openai-compatible": {
			...
			return { buildReplayPolicy: (ctx) => buildOpenAICompatibleReplayPolicy(ctx.modelApi, policyOptions) };
		}

...
import { t as expandHomePrefix } from "./home-dir-CfZ08GnU.js";
...
function parseEnvInvocationPrelude(argv) {
	...
	if (expectsOptionValue || idx >= argv.length) return null;
	return {
		assignmentKeys,
		commandIndex: idx
	};
...
//#endregion
export { unwrapKnownShellMultiplexerInvocation as A, SAFE_BIN_PROFILES as B, POWERSHELL_WRAPPERS as C, isShellWrapperExecutable as D, hasEnvManipulationBeforeShellWrapper as E, isDispatchWrapperExecutable as F, resolveSafeBinProfiles as H, unwrapDispatchWrappersForResolution as I, unwrapKnownDispatchWrapperInvocation as L, POWERSHELL_INLINE_COMMAND_FLAGS as M, resolveInlineCommandMatch as N, isShellWrapperInvocation as O, extractEnvAssignmentKeysFromDispatchWrappers as P, normalizeExecutableToken as R, POSIX_SHELL_WRAPPERS as S, extractShellWrapperInlineCommand as T, normalizeSafeBinProfileFixtures as V, resolvePolicyTargetCandidatePath as _, validateSafeBinArgv as a, resolveExecutablePath as b, matchAllowlist as c, resolveApprovalAuditCandidatePath as d, resolveCommandResolution as f, resolvePolicyAllowlistCandidatePath as g, resolveExecutionTargetResolution as h, normalizeTrustedSafeBinDirs as i, POSIX_INLINE_COMMAND_FLAGS as j, resolveShellWrapperTransportArgv as k, parseExecArgvToken as l, resolveExecutionTargetCandidatePath as m, isTrustedSafeBinPath as n, listRiskyConfiguredSafeBins as o, resolveCommandResolutionFromArgv as p, listWritableExplicitTrustedSafeBinDirs as r, normalizeSafeBinName as s, getTrustedSafeBinDirs as t, resolveAllowlistCandidatePath as u, resolvePolicyTargetResolution as v, extractShellWrapperCommand as w, resolveExecWrapperTrustPlan as x, resolveExecutableFromPathEnv as y, DEFAULT_SAFE_BINS as z };

...
import { a as resolveLeastPrivilegeOperatorScopesForMethod, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-B1c_GUbd.js";
import { t as loadGatewayTlsRuntime } from "./gateway-C4I_N3QF.js";
...
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-BzvSveST.js";
...
async function executeGatewayRequestWithScopes(params) {
	...
	return await new Promise((resolve, reject) => {
		...
		const client = gatewayCallDeps.createGatewayClient({
			...
			role: "operator",
			scopes,
			deviceIdentity: opts.deviceIdentity === void 0 ? resolveDeviceIdentityForGatewayCall() : opts.deviceIdentity,

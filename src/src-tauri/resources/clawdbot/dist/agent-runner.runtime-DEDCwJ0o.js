...
import { f as normalizeVerboseLevel, p as resolveResponseUsageMode } from "./thinking.shared-B8IAgSi8.js";
import { s as isCliProvider } from "./model-selection-8a6zD_aX.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-D7XpmyVq.js";
import { r as logVerbose } from "./globals-BJZkpw-q.js";
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-CYXg_wTS.js";
import { c as loadConfig } from "./io-DhtVmzAJ.js";
import "./config-CJQx-9zo.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-D19EDm2g.js";
import { C as resolveGroupSessionKey, d as updateSessionStore, f as updateSessionStoreEntry, i as loadSessionStore } from "./store-BGmy-Wot.js";
import "./sessions-DC7OiAdD.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-DBIQqSpZ.js";
import { a as resolveFreshSessionTotalTokens } from "./types-KyI2zD1Y.js";
import { u as resolveMemoryFlushPlan } from "./memory-state-sKCT2k_7.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-Bot0VGKf.js";
import { a as stripHeartbeatToken } from "./heartbeat-CguHGkad.js";
import { Rn as emitAgentEvent, Vn as registerAgentRunContext, at as buildFallbackNotice, b as estimateMessagesTokens, cr as queueEmbeddedPiMessage, er as isFallbackSummaryError, g as compactEmbeddedPiSession, it as buildFallbackClearedNotice, nr as LiveSessionModelSwitchError, ot as resolveFallbackTransition, p as resolveBootstrapWarningSignaturesSeen, t as runEmbeddedPiAgent, tr as runWithModelFallback, x as readPostCompactionContext } from "./pi-embedded-BYdcxQ5A.js";
import { a as generateSecureUuid } from "./secure-random-CzuMrSfY.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-ROhwFcx1.js";
import { a as scheduleFollowupDrain, n as enqueueFollowupRun, o as refreshQueuedFollowupSession } from "./queue-CrmMgtZc.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-Fnf3A9Vj.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CbUPNPyH.js";
import "./thinking-EUyzvAQE.js";
import { c as resolveModelAuthMode } from "./model-auth-BxuwOp1l.js";
import { a as isAudioFileName } from "./mime-C9472kP8.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-COznanRn.js";
import { h as resolvePathFromInput, o as parseReplyDirectives, p as resolveEffectiveToolFsWorkspaceOnly } from "./deliver-BV9UlnxV.js";
import { r as enqueueSystemEvent } from "./system-events-DOxYwk9w.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DD2udaMP.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-SzVz53hc.js";
import { i as isRenderablePayload, n as applyReplyThreading, o as createReplyToModeFilterForChannel, s as resolveReplyToMode, t as applyReplyTagsToPayload } from "./reply-payloads-esYr_ziX.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-vIPnaLe1.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BBjY9kE8.js";
import { _ as readSessionMessages } from "./session-utils-CttsvsO6.js";
import { t as lookupContextTokens } from "./context-awuvPcZd.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-BIAAz1Jw.js";
import { i as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-DD-9lWqe.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BhVEIUhH.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-8_5I9UOx.js";
import { t as createTypingSignaler } from "./typing-mode-DmLAtO_L.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-ctIeXkUk.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-CY7Mj0mY.js";
import { a as resolveModelFallbackOptions, i as isBunFetchSocketError, o as resolveRunAuthProfile, r as formatBunFetchSocketError, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-B-C2CPDc.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-PsCTP6oT.js";
...
function buildExternalRunFailureText(message) {
	if (isToolResultTurnMismatchError(message)) return "⚠️ Session history got out of sync. Please try again, or use /new to start a fresh session.";
						...
						const result = await runEmbeddedPiAgent({
							...
							onAgentEvent: async (evt) => {
								...
								if (evt.stream === "compaction") {
									const phase = typeof evt.data.phase === "string" ? evt.data.phase : "";
									if (phase === "start") {
										const notifyUser = params.followupRun.run.config.agents?.defaults?.compaction?.notifyUser === true;
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-2drgUKse.js");

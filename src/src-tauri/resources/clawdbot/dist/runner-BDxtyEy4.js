...
import { H as resolveApiKeyForProvider, Ot as resolveOpenClawAgentDir, V as requireApiKey, s as normalizeProviderId, x as normalizeGoogleModelId } from "./model-selection-D37iyQY4.js";
import { i as loadConfig } from "./config-CWifpzL_.js";
import { b as normalizeChatType } from "./plugins-CLo5nH74.js";
import { t as describeImageWithModel, v as ensureOpenClawModelsJson } from "./image-w4Unf0wW.js";
import { r as formatUncaughtError, t as extractErrorCode } from "./errors-BeAy8PFi.js";
import { c as getFileExtension, f as kindFromMime, o as detectMime, u as isAudioFileName } from "./image-ops-DS83Z7J2.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-_IAZS3Vz.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-EwKVHlZB.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Dkdkt9EO.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
...
function extractLastJsonObject$1(raw) {
...
function extractGeminiResponse$1(raw) {
	const payload = extractLastJsonObject$1(raw);
...
async function resolveCliOutput(params) {
	...
	if (commandId === "gemini") {
		const response = extractGeminiResponse$1(params.stdout);
...
//#endregion
export { CLI_OUTPUT_MAX_BUFFER as _, runCapability as a, modelSupportsVision as c, installUnhandledRejectionHandler as d, registerUnhandledRejectionHandler as f, resolveMediaUnderstandingScope as g, normalizeMediaUnderstandingChatType as h, resolveAutoImageModel as i, isAudioAttachment as l, resolveTimeoutMs as m, createMediaAttachmentCache as n, findModelInCatalog as o, resolveConcurrency as p, normalizeMediaAttachments as r, loadModelCatalog as s, buildProviderRegistry as t, resolveAttachmentKind as u, applyTemplate as v };
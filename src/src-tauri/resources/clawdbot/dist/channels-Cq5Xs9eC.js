...
import { r as loadAuthProfileStore } from "./store-CY-e50gT.js";
import "./auth-profiles-bVW1e9Dr.js";
import { _ as normalizeAccountId } from "./session-key-D7XpmyVq.js";
import { t as danger } from "./globals-BJZkpw-q.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CjYO5YkF.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BsTwPM1c.js";
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-CFlEb0hP.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-BHCzBKcU.js";
import { n as formatTimeAgo } from "./format-relative-hwB9KFeB.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-suG8crmH.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-CAEFn2QM.js";
import { t as createClackPrompter } from "./clack-prompter-D0YWkrDK.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CA5euzSo.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-CdAegc9O.js";
import { t as parseLogLine } from "./parse-log-line-BnAJRCSp.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-azyn4qzx.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-BI9etwvg.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-Ca-uMIye.js"), import("./onboard-channels-BWAtMpCw.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-oUwhh3Ly.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-oUwhh3Ly.js");
			const prompter = createClackPrompter();

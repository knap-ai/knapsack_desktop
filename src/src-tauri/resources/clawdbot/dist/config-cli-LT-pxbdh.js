...
import { n as info, t as danger, u as success } from "./globals-DBUMOBZ8.js";
...
import { d as readConfigFileSnapshot, g as writeConfigFile, y as validateConfigObjectRaw } from "./io-y3Az_Onx.js";
import "./shell-env-BOu7XeT_.js";
import "./safe-text-yavot2qw.js";
import "./version-CD3oP1-d.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-DgX397vI.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-D3ri29cK.js";
import { C as SecretProviderSchema } from "./zod-schema.core-BuVz8Rk7.js";
import "./config-D4zN4BRl.js";
import "./audit-fs-DTQIjp2r.js";
import { a as resolveSecretRefValue } from "./resolve-B7S4PlnO.js";
import { t as formatCliCommand } from "./command-format-DBQUhADm.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-BtLIwOtN.js";
import { t as OLLAMA_DEFAULT_BASE_URL } from "./ollama-defaults-h0YFzsNK.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-9OUOvlxj.js";
import "./timeouts-BnOxp0oI.js";
import "./timeouts-DKbQkIWS.js";
import { t as redactConfigObject } from "./redact-snapshot-B_3oaPCI.js";
import { n as setCommandJsonMode } from "./json-mode-j7MCM3tY.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CoTg1r-6.js");

...
import { t as clearActiveProgressLine } from "./progress-line-xDw3PVgH.js";
import { S as isVerbose, _ as levelToMinLevel, a as getLogger, b as readLoggingConfig, d as formatLocalIsoWithOffset, f as formatTimestamp, h as loggingState, i as getChildLogger, m as resolveEnvLogLevelOverride, s as isFileLogLevelEnabled, v as normalizeLogLevel, x as shouldSkipMutatingLoggingConfigRead } from "./logger-x0IvPL2B.js";
import { r as normalizeChatChannelId } from "./ids-2bZIXJNM.js";
import { n as defaultRuntime } from "./runtime-Dx7oeLYq.js";
import { r as stripAnsi } from "./ansi-BZHMLcUk.js";
...
function createSubsystemLogger(subsystem) {
	...
	const emitLog = (level, message, meta) => {
		...
		if (fileEnabled) {
			if (!fileLogger) fileLogger = getChildLogger({ subsystem: resolvedSubsystem });

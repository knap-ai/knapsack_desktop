import{i as e,n as t}from"./lit-BZwq2xLD.js";import{i as n}from"./index-sc9GrLxu.js";function r(r){let i=(r.status&&typeof r.status==`object`?r.status.securityAudit:null)?.summary??null,a=i?.critical??0,o=i?.warn??0,s=i?.info??0,c=a>0?`danger`:o>0?`warn`:`success`,l=a>0?`${a} critical`:o>0?`${o} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
      ...
      <div class="card">
        ...
        ${r.callError?e`<div class="callout danger" style="margin-top: 12px;">
              ${r.callError}
            </div>`:t}
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <pre class="code-block" style="margin-top: 12px;">${JSON.stringify(r.models??[],null,2)}</pre>
    </section>

    <section class="card" style="margin-top: 18px;">
      <div class="card-title">Event Log</div>
      <div class="card-sub">Latest gateway events.</div>
      ${r.eventLog.length===0?e`
              ...
              ${r.eventLog.map(t=>e`
                  <div class="list-item debug-event-log__item">
                    ...
                    <div class="list-meta debug-event-log__meta">
                      <pre class="code-block debug-event-log__payload">${n(t.payload)}</pre>
                    </div>
                  </div>
                `)}
            </div>
...
//# sourceMappingURL=debug-YIHGg52o.js.map
import{i as e,n as t}from"./lit-BZwq2xLD.js";import{O as n,o as r}from"./index-sc9GrLxu.js";var i=!1;function a(r){let a=!i;return e`
    <section class="card">
      ...
      ${r.lastError?e`<div class="callout danger" style="margin-top: 12px;">
            ${r.lastError}
          </div>`:t}
      ${r.statusMessage?e`<div class="callout" style="margin-top: 12px;">
            ${r.statusMessage}
          </div>`:t}
      <div class="list" style="margin-top: 16px;">
        ${r.entries.length===0?e`
                <div class="muted">No instances reported yet.</div>
              `:r.entries.map(e=>o(e,a))}
      </div>
    </section>
  `}function o(n,i){let a=n.lastInputSeconds==null?`n/a`:`${n.lastInputSeconds}s ago`,o=n.mode??`unknown`,s=n.host??`unknown host`,c=n.ip??null,l=Array.isArray(n.roles)?n.roles.filter(Boolean):[],u=Array.isArray(n.scopes)?n.scopes.filter(Boolean):[],d=u.length>0?u.length>3?`${u.length} scopes`:`scopes: ${u.join(`, `)}`:null;return e`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">
          ${c?e`<span class="${i?`redacted`:``}">${c}</span> `:t}${o} ${n.version??``}
        </div>
        <div class="chip-row">
...
//# sourceMappingURL=instances-C8om8LL2.js.map
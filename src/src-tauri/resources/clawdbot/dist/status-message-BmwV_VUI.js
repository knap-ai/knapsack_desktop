...
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-grYiFZof.js";
...
import { c as resolveSessionPluginTraceLines, s as resolveSessionPluginStatusLines } from "./types--vJusqfs.js";
import "./sessions-DIdqAx7y.js";
import { a as resolveContextTokensForModel } from "./context-BenUsVLX.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount$1 } from "./usage-format-CQv_DQWN.js";
import { r as readLatestSessionUsageFromTranscript } from "./session-utils.fs-BDLex3kU.js";
...
import { n as findDecisionReason, s as summarizeDecisionReason } from "./runner.entries-aiQXQXfz.js";
import "./sandbox-DzHIjKfO.js";
import { i as resolveExtraParams } from "./extra-params-BSCrTsfs.js";
...
import { n as resolveSelectedAndActiveModel, t as formatProviderModelRef } from "./model-runtime-DS9NMbVq.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-D7zu9JGR.js";
...
function buildStatusMessage(args) {
	...
	const channelModelNote = (() => {
		...
		if (normalizeOptionalString(entry.modelOverride) || normalizeOptionalString(entry.providerOverride)) return;

...
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-BLh32HP1.js";
import { t as getChannelPlugin } from "./registry-B2TRwbJD.js";
import { p as resolveSessionAgentId, y as resolveAgentDir } from "./agent-scope-_6dFncNS.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-C1TCb8El.js";
import { f as resolveConfiguredModelRef, h as resolveModelRefFromString, y as modelKey } from "./model-selection-shared-grYiFZof.js";
...
import { u as isProfileInCooldown } from "./usage-DiHkmNRE.js";
import { n as resolveAuthProfileOrder } from "./order-DWH5eSW2.js";
import { l as resolveUsableCustomProviderApiKey } from "./model-auth-Di2YDk33.js";
import { i as enqueueSystemEvent } from "./system-events-B6vO-QxY.js";
import { n as resolveQueueSettings, s as refreshQueuedFollowupSession } from "./queue-DHEUr0Dd.js";
...
import { n as applyVerboseOverride, t as applyTraceOverride } from "./level-overrides-xpqKLTb9.js";
import { d as renderExecTargetLabel } from "./bash-tools.exec-runtime-DHmKQe9a.js";
import { n as resolveExecDefaults } from "./exec-defaults-B7H_PKCQ.js";
import { i as resolveModelsCommandReply } from "./commands-models-C2HGwidV.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-DS9NMbVq.js";
import { r as formatRemainingShort } from "./auth-health-Cmwwkt8U.js";
...
async function handleDirectiveOnly(params) {
	...
	})) return { text: `Thinking level "${directives.thinkLevel}" is not supported for ${resolvedProvider}/${resolvedModel}. Use one of: ${formatThinkingLevels(resolvedProvider, resolvedModel)}.` };
